...
<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	...
	<tr>
			<td width=519 bgcolor="f1f1f1" colspan = 2 align=center valign=top>
							 ...
							 <FORM METHOD=POST ACTION="./title_report_navum.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#user_id_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=10&company_id=#company_id#" name="frm" ENABLECAB="Yes">
							<FONT FACE=ARIAL SIZE=1 color="gray">
							Selected HUD type:
					...
					</cfif>	&nbsp;&nbsp; <input type="image" src="/images/button_modify.gif" border=0 alt="Modify">
		</td>
