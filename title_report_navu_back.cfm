...
<!--- ====================================================================== --->
	...
	<!--- <tr>
		<td width=830 align=left valign=top bgcolor=e1e1e1>
		<nobr><a href="javascript:window.close();"><img src="./images/button_close.gif" border=0></a></NOBR>



			</TD>
		<td width=98 align=center valign=top bgcolor=d3d3d3><img src="./images/clear.gif" width=98 height=2><img src="./images/clear.gif" width=99 height=2><br><NOBR><a href="./form_title_closing_order_request.cfm?A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_title_order_req.gif" border=0 ALT="Manage the Title Order Request for this order"></a><a href="./Title_Closing_Order_Request_View_Only.cfm?A_Update_DB_Flag=0uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#"></a>
		</td>
