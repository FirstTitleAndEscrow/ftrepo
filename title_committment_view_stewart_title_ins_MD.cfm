...
<cfif read_title_data.pstate eq 'MD'>
...
<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
		    <td><cfoutput>#auto_number#</cfoutput>.</td>
       <td>
Subject to the proper instrument(s) creating the estate or interest to be insured must be executed and duly filed for record to wit:<br>
<ol type="a">
<li>Subject to the final order of ratification and audit.</li>
<li>Record trustee deed from __________________, Trustee to __________________ in the amount of _____________.</li>
<li>Record deed from __________________ to __________________ in the amount of _____________.</li>
<li>Record deed of trust from __________________ to __________________ in the amount of _____________.</li>
</ol>
			</td>
		</tr>
...
<ol type="a">
<li>homeowners association fees (if applicable)</li>
<li>condominium fees (if applicable)</li>
<li>water usage bills (if applicable)</li>
</ol>
			</td>
		</tr>
	<tr>
