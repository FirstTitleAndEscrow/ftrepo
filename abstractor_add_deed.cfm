...
function put() 
{
	var frm; var VSummary; var ErrorMessages;
	...
	//alert("The effective date cannot be left blank")
		ErrorMessages+="<li>The effective date cannot be left blank</li>";			
	//return false;
 }
	
	if (frm.select1.value=='') {
		//alert("The type of Vesting cannot be left blank")
		ErrorMessages+="<li>The type of Vesting cannot be left blank</li>";
		//return false;
	}
	
	/*
		 * Validation Rules for form fields like Grantor1, Grantor 2, Grantee1, Grantee2
	*/
		
	if (frm.grantor1.value == "")
		{
			//alert("You must enter a Grantor1's NAME");
			ErrorMessages+="<li>You must enter a Grantor1's NAME</li>";			
			//return false;
		}
	
	if (frm.grantee1.value == "")
		{
			//alert("You must enter a Grantee1's NAME");
			ErrorMessages+="<li>You must enter a Grantee1's NAME</li>";			
			//return false;
		}
		
	
	if (frm.deedtype.value=='') {
		//alert("The type of Deed cannot be left blank")
		ErrorMessages+="<li>The type of Deed cannot be left blank</li>";
		//return false;
	}
	
	if (frm.mannertitle.value=='') {
	//alert("The Manner of Title cannot be left blank")
		ErrorMessages+="<li>The Manner of Title cannot be left blank</li>";
	//return false;
	}
			...
			if (frm.book.value=='' || frm.page.value=='')
			 {
				...
				ErrorMessages+="<li>When document Number is empty book and page fields should be filled in</li>";
				frm.book.focus();
				//return false; 
			}
	}
	...
	if (frm.inst_mon.value=='' || frm.inst_day.value=='' || frm.inst_year.value=='') {
		...
		ErrorMessages+="<li>The Instrument date cannot be left blank</li>";
		//return false;
	 }
	
	if (frm.rec_mon.value=='' || frm.rec_day.value=='' || frm.rec_year.value=='') {
		//alert("The Recording date cannot be left blank")
			ErrorMessages+="<li>The recording date cannot be left blank</li>";
		//return false; 
	}	
	...
	*/
	...
	if (frm.vest.value=="")
	{
		//alert("Vesting cannot be left blank")
		ErrorMessages+="<li>Vesting cannot be left blank</li>";
		
		//return false;
	}
	
	if (frm.consider.value == ""){
		//alert("Consideration must be filled in")
		ErrorMessages+="<li>Consideration must be filled in</li>";
		
		//return false;
	}	
	
	VSummary.innerHTML=ErrorMessages;
...
<tr>
	<td>
			<div id="ValidationSummary" style="color:red; list-style-type:disc;">
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/abstractor_add_deed_submit.cfm?username=#url.username#&password=#url.password#&rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<select name="year"
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="No" Message="You must enter a Grantor's NAME" type=text name="grantor1"  size=40 maxlength=600
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="No" Message="You must enter a Grantee 1 name" type=text name="grantee1"  size=40 maxlength=600
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
		  ...
		  <OPTION VALUE="An Unmarried Man">An Unmarried Man</OPTION>
			...
			<OPTION VALUE="A Married Person">A Married Person</OPTION>
			<OPTION VALUE="An Unmarried Person">An Unmarried Person</OPTION>
