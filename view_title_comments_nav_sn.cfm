...
<CFFORM NAME="frm" ACTION="./view_Title_comments_nav_sn.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#url.rec_id#&a_trigger=1&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=1&code=#url.code#" onsubmit="javascript:return locate(this)" ENCTYPE="multipart/form-data" METHOD=POST>
