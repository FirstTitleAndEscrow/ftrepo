...
FROM="#from_email#"
SERVER="127.0.0.1"
Subject="North American Title Insurance Company Commitment for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#, Loan No: #read_title.loan_number#"
TIMEOUT="600"
type="HTML"
>
<cfoutput>
View/Print <A HREF="https://#cgi.server_name#/title_committment_view_natic_title_ins_TX.cfm?comp_id=115&user_id_1=723&lo_id=1217&rec_id=#rec_id#&a_trigger=1&company_id=0">North American Title Insurance Company Commitment</a> for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#</B></font><br><br>
...
<br><br><br>
		 ...
		 ISSUED BY:<BR>
<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/natic_logo.jpg">
			<br>
			1855 Gateway Boulevard, Suite 600, Concord, California 94520 (800) 374-8475 or (800) 869-3434</div>
            <BR><BR>
...
<br>
                     ...
                     <div align="center"><img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/natic_sigs.jpg"></div><br>
<br>
...
<table width="93%" cellpadding=0 cellspacing=0 border=0 >
    <tr>
		 ...
		 <div align="center">
		 <BR>
<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/natic_logo.jpg" width="288" height="74">
			<br></div>
          </td>
    </tr>
</table><br>
...
<br>
<br>
Title V of the Gramm-Leach-Bliley Act (GLBA) generally prohibits any financial institution, directly or through its affiliates, from sharing nonpublic personal information about you with a nonaffiliated third party unless the institution provides you with a notice of its privacy policies and practices, such as the type of information that it collects about you and the categories of persons or entities to whom it may be disclosed. In compliance with the GLBA, we are providing you with this document, which notifies you of the privacy policies and practices of North American Title Company.<br>
<br>
