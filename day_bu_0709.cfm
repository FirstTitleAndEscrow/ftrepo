...
<cfif #a_flag# EQ "1">
      <cfquery datasource="#request.dsn#" name="getList">
               ...
               Where (YearMonth = '#YearMonthDay#') AND (comp_id = #getcompany.id#)
               order by c_time
      </cfquery>

      <cfquery datasource="#request.dsn#" name="getList2">
               select * From Title_Closing_Order_Request a, EventList b where a.title_id = b.title_id and a.request_date = '#YearMonthDay#' and b.yearmonth is null AND comp_id = #getcompany.id#
               order by b.c_time
      </cfquery>
...
<cfif #getlist2.recordcount# neq 0>
						<tr>
							<td bgcolor="ffffff" colspan = 9 width="100%" align=center valign=top>
								<FONT FACE=verdana SIZE=1 color="black">
								<cfif #getlist2.recordcount# neq 0>
									#getlist2.recordcount# are <b>REQUESTED</b> for #DateFormat(ThisDate,'m/d/yyyy')#. See below
								</cfif>
							</td>
						</tr>
</cfif>
...
<cfif #getlist.recordcount# neq 0>
						<tr>
							<td bgcolor="white" colspan = 9 width="100%" align=center valign=top>
								<FONT FACE=verdana SIZE=1 color="black">
<cfif #getlist.recordcount# neq 0>
	#getlist.recordcount# are <b>SCHEDULED</b> for #DateFormat(ThisDate,'m/d/yyyy')#. See below
</cfif>
							</td>
						</tr>
</cfif>
