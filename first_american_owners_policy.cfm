...
<br>
<br>
<a href="#"><cfoutput><input disabled type="button" value="Modify Form" onclick="window.location='first_american_owners_policy_modify.cfm?uid=#session.ft_user_id#&al=1&rec_id=#url.rec_id#&a_trigger=0&company_id=0';"></cfoutput></a>
...
Issued by:<br>
<cfif read_FT_company.streamline_client eq 'True'>Streamline Title<cfelse>First Title</cfif>
 & Escrow Services, LLC<br>
...
<cfset num_count = num_count + 1>
        <tr>
		<td width="3%" valign="top"><cfoutput><span class="small_font">#num_count#</span></cfoutput></td>
