...
<CFFORM NAME="frm" ACTION="./loan_amount_verify_c.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=0&company_id=0" METHOD="POST">
<CFOUTPUT QUERY="read_title">
  ...
  <tr>
    ...
    <td valign="top" width="22%"> <b><font size="4">Chicago Title Insurance Company </font></b></td>
     ...
     <cfoutput> <p>Dated <b>#get_titleid.loan_end_date_c#</b> and Issued By: </p>
    <p>#read_agency.title_FT_Agency_name# </p></cfoutput>
