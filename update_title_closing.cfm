...
<CFIF #get_order.comp_id# eq "859" or #get_order.comp_id# eq "919" or #get_order.comp_id# eq "953" 
	or #get_order.comp_id# eq "947" or #get_order.comp_id# eq "946" or #get_order.comp_id# eq "948" 
	or #get_order.comp_id# eq "944" or #get_order.comp_id# eq "949" or #get_order.comp_id# eq "951" 
	or #get_order.comp_id# eq "945" or #get_order.comp_id# eq "950" or #get_order.comp_id# eq "943" 
	or #get_order.comp_id# eq "941" or #get_order.comp_id# eq "942">
        <CFSET  #b_emails_to_first_title# = "kklos@weichertfinancial.com">
</CFIF>

<CFMAIL
TO="#getorderinfo.A_Req_By_Email#,#b_emails_to_first_title#"
FROM="#team_email#"
Subject="#get_order.blastname1#, #get_order.bfirstname1#: Closing Infomation for order #get_order.title_id# -- Loan Number-#get_order.loan_number#"
TIMEOUT="600"
type="html"
><center>
