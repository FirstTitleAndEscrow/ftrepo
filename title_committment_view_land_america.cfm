...
SERVER="127.0.0.1"
Subject="Land America Insurance Commitment for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#, Loan No: #read_title.loan_number#"
TIMEOUT="600"
type="HTML"
>

View/Print <A HREF="https://#cgi.server_name#/title_committment_view_land_america.cfm?comp_id=115&user_id_1=723&lo_id=1217&rec_id=#rec_id#&a_trigger=1&company_id=0" >Land America Title Insurance Commitment</a> for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#</B></font><br><br>
...
<tr>
    ...
    <TR>
        <td>
            ...
            commitment is issued through Land America Lawyers Title Insurance Corporation.
...
<table width="93%" cellpadding=0 cellspacing=0 border=0 >
	<tr>
		...
		<td align="Center">
            <NOBR>Land America Lawyers Title Insurance Corporation</NOBR>
         </td>
...
<TABLE WIDTH="100%">
<tr>
<td ALIGN="LEFT"><img src="./images/land_america_logo_halfsize.GIF"></td>
<TD ALIGN="RIGHT"><em>Lawyers Title Insurance Corporation is a member of the LandAmerica family of title insurance underwriters</em>.</TD>
</tr>
</TABLE>
<br><br>

<div align="left">The Title Insurance Commitment is a legal contract between you and the Company. It is issued to show the basis on which we will issue a Title Insurance Policy to you. The Policy will insure you against certain risks to the land title, subject to the limitations shown in the Policy.<br>
<br>
The Company will give you a sample of the Policy form, if you ask.<br>
<br>
<em>The Policy contains an arbitration clause. All arbitration matters when the Amount of Insurance is $2,000,000 or less shall be arbitrated t the option of either the Company or you as the exclusive rememdy of the parties. You may receive a copy of the arbitration rulesat https://www.alta.org</em><br>
<br>
The Commitment is based on the land title as of the Commitment Date. Any changes in the land title or the transaction may affect the Commitment and the Policy.<br>
<br>
The Commitment is subject to its Requirements, Exceptions and Conditions.<br>
<br></div><br>
<div align="center"><strong>THIS INFORMATION IS NOT PART OF THE TITLE INSURANCE COMMITMENT<br>
<br>
YOU SHOULD READ THE COMMITMENT VERY CAREFULLY</strong><br>
</div><br>
If you have any questions about the Commitment, contact:<br>
<br>
<div align="center">LAWYERS TITLE INSURANCE CORPORATION<br>
5600 COX ROAD<br>
GLEN ALLEN, VIRGINIA 23060-9266<br>
<br>
<strong>TABLE OF CONTENTS</strong></div><br>
<br>
<table width="100%">
<tr>
<td align="left">AGREEMENT TO ISSUE POLICY</td>
<td align="right">See Other Side of Front Cover</td>
</tr>
</table><br>
<br>
SCHEDULE A<br>
...
<li>Policies to be issued, Amounts and Proposed Insureds</li>
<li>Interest in the Land and Owner</li>
<li>Description of the Land</li>
</ol><br>
<br>
SCHEDULE B-I - REQUIREMENTS<br>
<br>
SCHEDULE B-II - EXCEPTIONS<br>
<br>
...
<br>
<br>
ALTA Commitment 2006<br>
<strong>Form 1182-10</strong>
          </td>
    </tr>
</table>
<p>
...
<br>
		 ...
		 <div align="center"><img src="./images/land_america_logo_halfsize.GIF"><br>
<br>
<strong>
AGREEMENT TO ISSUE POLICY</strong><br>
</div><br>


We agree to issue a policy to you according to the terms of this Commitment. When we show the policy amount and your name as the proposed insured in Schedule A, this Commitment becomes effective as of the Commitment Date shown in Schedule A.<br>
<br>
If the Requirements shown in this Commitment have not been met within twelve (12) months after the Commitment Date, our obligation under this Commitment will end. Also, our obligation under this Commitment will end when the Policy is issued and then our obligation to you will be under the Policy.<br>
<br>
Our obligation under this Commitment is limited by the following:<br>
<blockquote>
The Provisions in Schedule A<br>
The Requirements in Schedule B-I<br>
The Exceptions in Schedule B-II<br>
The Conditions listed below<br>
This commitment is not valid without Schedule A and Sections I and II of Schedule B<br>
<br>
</blockquote>



<div align="center"><img src="./images/land_america_sigs.jpg"></div>
...
<div align="center"><strong>CONDITIONS</strong></div><br>
<br>
<OL>
<LI>DEFINITIONS
<OL type="a"><LI>"Mortgage" means mortgage, deed of trust or other security instrument</LI>
<li>"Public Records" means title records that give constructive notice of matters affecting your title according to the state statutes where your land is located.</li></OL></LI>
<BR>
<li>LATER DEFECTS<br>
The Exceptions in Schedule B - Section II may be ammended to show any defects, liens or encumbrances that appear for the first time in the public records or are created or attached between the Commitment Date and the date on which all of the Requirements (a) and (c) of Schedule B - Section I are met. We shall have no liability to you because of this amendment.</li>
<BR><BR>
<li>EXISTING DEFECTS<br>
If any defects, liens or encumbrances existing at Commitment Date are not shown in Schedule B, we may amend Schedule B to show them. If we do amend Schedule B to show these defects, liens or encumbrances, we shall be liable to you according to Paragraph 4 below unless you knew of this information and did not tell us about it in writing.</li>
<BR><BR>
<li>LIMITATION OF OUR LIABILITY<br>
Our only obligation is to issue to you the Policy referred to in this Commitment, when you have met its Requirements. If we have any liability to you for any loss you incur because of an error in this Commitment, our liability will be limited to your actual loss caused by your relying on this Commitment when you acted in good faith to:<br>
Comply with the Requirements shown in Schedule B - Section I<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;or<br>
Eliminate with our written consent any Exceptions shown in Schedule B - Section II.<br>
We shall not be liable for more than the Policy Amount shown in Schedule A of this Commitment and our liability is subject to the terms of the Policy form to be issued to you.</li>
<BR><BR>
<li>CLAIMS MUST BE BASED ON THIS COMMITMENT<br>
...
<br>Lawyers Title Insurance Corporation<br>
5600 Cox Road
      ...
      <table width="93%" cellpadding=1 cellspacing=1 border=0 valign="top" >
          ...
          <tr>
            ...
            <td valign="top"> <table width="100%" valign="top" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td width="20">&nbsp;</td>
                  <td><B><cfif #read_title.purchase# neq ""><cfif Len(read_title.company1)>#read_title.company1#<cfelse>#Buyer_1#, &nbsp;&nbsp;#Buyer_2#<cfif Len(read_title.blastname3)>, &nbsp;&nbsp;#read_title.bfirstname3# #read_title.blastname3#</cfif></cfif></cfif></td>
                </tr>
              </table></td>
          ...
          <tr>
            ...
            <td valign="top"> <table width="100%" valign="top" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="right">(b)</td>
                  <td width="20">&nbsp;</td>
				  <cfif read_title.searchtype contains 'Second Mortgage' and read_title.jlp_policy eq 1>                  <td>Junior Loan Policy - Short Form Res. Limited Cov. 1996</td>
				  <cfelse>
				  <td>Loan Policy (6/17/06)</td>
				  </cfif>
        ...
        <tr>
          ...
          <td colspan="2" valign="top">The estate or interest in the land described
            or referred to in this committment is:</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td colspan="2" valign="top">Title to the estate or interest in the land is at the Effective Date vested
            in:</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td colspan="4" valign="top"> <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <!--- <tr>
                <td valign="middle" align="left" colspan="2">Countersigned</font><br>
<hr><br>
<div align="center">Authorized Officer or Agent</div></td>
              </tr> --->
        <cfoutput><tr>
          <td width="60%"><p>&nbsp;</p></td>
          <td width="40%" rowspan="2" valign="middle">
		  <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
		  Issued By:<br><CFIF #read_title.comp_ID# eq 324><!---Eastern Residential will always be Superior Title--->
<cfif NOT DateDiff("d", Now(), "1/30/2012")>
		   <B>Superior Title & Escrow, LLC<br>
		   <B>30 West Gude Drive</B><BR>
		   <B>Rockville, MD 20850</B><BR>
<cfelse>
		   <B>Superior Title & Escrow, LLC<br>
		   <B>7361 Calhoun Place, Suite 200</B><BR>
		   <B>Rockville, MD 20855</B><BR>
</cfif>

		   <CFELSE>
		  <B>#read_Title_FT_Agency_company.Company#<br>
...
<TABLE WIDTH="100%">
<tr>
<td ALIGN="LEFT">ALTA Commitment - Schedule A<br>
Form 1004-321L (Rev. 6/06)</td>
<TD ALIGN="RIGHT">Valid only if Schedule B and Cover are attached.</TD>
</tr>
</TABLE><br>
	  ...
	  <table width="100%" cellpadding=0 cellspacing=0 border=0 >
	   ...
	   <table width="93%" cellpadding=0 cellspacing=0 border=0>
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_tax">
            ...
            <td align="Center"><NOBR>Land America Lawyers Title Insurance Corporation</NOBR></td>
...
#read_title_data.data14#<br><br>
     ...
     <!---    <tr align="right" valign="top">
          <td COLSPAN = 2><img src="./images/land_america_logo.GIF"></td>
        </tr> --->
      </table>
	   </IE:DEVICERECT>
...
<br><br><b>LEGAL DESCRIPTION</b></td>
        </tr>
...
<br>
    ...
    <tr>
		...
		<td>Payment to or for the account of the grantors or mortgagors of the full consideration for the estate or interest to be issued.</td>
	</tr>
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
    <tr>
		...
		<td>Proper instrument(s) creating the estate or interest to be insured must be executed and duly filed for record, to-wit:</td>
	</tr>
<cfset auto_number = 2>
...
<a href="../admin_area/title_abstract_doc_assign.cfm"></a>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage13.data5# 
		  ...
		  <cfelse> in Document #read_mortgage13.data14#
					...
					<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif> </cfif><cfif #read_mortgage13.data18# neq "">Assigned to #read_mortgage13.data18# recorded on #DateFormat(read_mortgage13.data22, "mm")#/#DateFormat(read_mortgage13.data22, "dd")#/#DateFormat(read_mortgage13.data22, "yyyy")#, <cfif #read_mortgage13.data19# eq "">in Book #read_mortgage13.data20#, at Page #read_mortgage13.data21# <cfelse> in Document #read_mortgage13.data19# </cfif> </cfif><cfif #read_mortgage13.data23# neq "">Assigned to #read_mortgage13.data23# recorded on #DateFormat(read_mortgage13.data27, "mm")#/#DateFormat(read_mortgage13.data27, "dd")#/#DateFormat(read_mortgage13.data27, "yyyy")#, <cfif #read_mortgage13.data24# eq ""> in Book #read_mortgage13.data25#, at Page #read_mortgage13.data26# 
...
<TABLE WIDTH="100%">
<tr>
<TD COLSPAN=2 ALIGN="RIGHT">Commitment No. D-<cfoutput>#read_title.title_id#</cfoutput><br>
Schedule B, Section I<br>
<br>
<br>
Valid only if Insuring Provisions and Schedules A and B are attached.</TD>
</tr>
<tr>
<td ALIGN="LEFT">Commitment - Schedule B, Section I<br>
Form 1004-265</td>
<TD ALIGN="RIGHT">NJRB-307<br>
Revised: 9/10/07</TD>
</tr>
</TABLE><br>
...
<TD ALIGN="RIGHT"><em>Lawyers Title Insurance Corporation is a member of the LandAmerica family of title insurance underwriters</em>.</TD>
	...
	<tr>
        ...
        <tr>
		  <td colspan=2>The policy or policies to be issued will contain exceptions to the following unless the same are disposed of to the satisfaction of the Company</td>
		</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
	</tr>
...
#text_1#
	    ...
	    <tr align="right" valign="top">
          <td colspan="2">NOTE: If policy is to be issued in support of a mortgage loan, attention is directed to the fact that the Company can assume no liability, under its policy, the closing instructions, or Insured Closing Service for complaiance with the requirements of any consumer credit protection or truth in lending law in connection with said mortgage loan.<br>
<br>
<div align="right">Schedule B, Section II, Commitment No. D-<cfoutput>#read_title.title_id#</cfoutput></div>
		  </td>
	</tr>
	</cfif>
...
<br>
<br>
Commitment - Schedule B, Section II<br>
Form 1004-266</td>
<TD ALIGN="RIGHT">Valid only if Insuring Provisions and Schedules A and B are attached.</TD>
</tr>
</TABLE>
<!--- ====================================================================== --->
<!--- =================[ END OF SCHEDULE B         ]======================== --->
...
<cfif read_title.pstate eq 'DE'>
<center>Effective: July 7, 2015</center><br>
<br>
ACCOUNT NAME: PC Law Associates, DE Rule 1.15A Attorney Escrow Account<BR>
ACCOUNT NO.: 6454176055<BR>
ROUTING NO.: 121000248<BR>
RECEIVING BANK: Wells Fargo Bank, NA<BR>
420 Montgomery Street<BR>
San Francisco, CA 94104<BR>
Please reference borrower name and file number<br>
<br>
FOR SAME DAY FUNDING: All required disbursement documents and wires must be received by PCN by 3:00pm EST to guarantee same day funding. If the information is sent after 3:00pm EST, we will make our best effort to fund the file in a timely manner.<br>
<br>
...
<IE:DEVICERECT ID="<CFOUTPUT><CFIF #read_Title.pstate# eq "CA" OR #read_Title.pstate# eq "NV">page8<CFELSE>Page7</CFIF></cfoutput>" CLASS="masterstyle" MEDIA="print">
	...
	<img src="images/land_america_logo_HALFSIZE.gif"   width="133"   height="38"><BR>
...
By: <img src="images/land_america_sigs.jpg"><BR>
Kenneth P. Bayne <BR>
...
<br>
        ...
        <tr align="right" valign="top">
          <td COLSPAN = 2><img src="./images/land_america_logo_HALFSIZE.gif"></td>
        </tr>
      </table>
	</IE:DEVICERECT>
</cfif>
