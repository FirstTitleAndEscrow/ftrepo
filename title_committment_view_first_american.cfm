...
<cfFORM NAME="Search" METHOD="post" ACTION="https://#cgi.server_name#/admin_area/Title_committment_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#company_ID#&a_trigger=7&from_page=commitment&go_through=1&iclonly=1">
  <FONT FACE=ARIAL SIZE=2 color="black">Enter email to send ICL only</font> <input type=text name="email" size=20 maxlength=100
								size="1"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
...
<table width="93%" cellpadding=1 cellspacing=1 border=0 >
    <tr>
          <td><cfif read_title.pstate eq 'DC'><br>
		  <table style="border-color:000000; border-style:solid; border-width:1px;"><tr><td><B>
Please read the exceptions and the terms shown or referred to herein carefully. The exceptions are meant to provide you
...
all liens, defects, and encumbrances affecting title to the land.</B></td></tr></table></cfif>
            <BR><BR>
          </td>
    </tr>
    <tr>
...
<input type="checkbox" checked>&nbsp;ALTA Junior Loan Policy - Short Form Res. Limited Cov. 1996<br>
<cfelseif read_title.searchtype eq 'Refinance'>
<input type="checkbox" checked>&nbsp;ALTA 2006 Policy (Form 1056.06, 6/17/06)<br>
<cfelse>
...
<td>Payment to or for the account of the grantor(s) or mortgagor(s) of the full consideration for the estate
or interest to be insured.<br>
<br>
</td>
</tr>
...
<td>Pay us the premiums, fees and charges for the policy.<br>
<br>
</td>
</tr>
...
<td>Pay all taxes, charges, assessments, levied and assessed against subject premises, which are due
and payable.<br>
<br>
</td>
</tr>
...
<cfelseif read_title.pstate eq 'MD' and get_comp_info.streamline_client eq 1>
<td width="5%" valign="top">1.</td>
		<td>Payment to or for the account of the grantor(s) or mortgagor(s) of the full consideration for the estate or interest to be insured.</td>
<cfelseif read_title.pstate neq 'DC'>
<td width="5%" valign="top">1.</td>
...
<cfif read_title.pstate neq 'MD' and read_title.pstate neq 'DC' and get_comp_info.streamline_client neq 1>
<tr>
		  <td width="5%" valign="top">5.</td>
...
<cfset auto_number = #auto_number# + 1>
<tr>
		  <td align="left" valign="top">#auto_number#.</td>
		<td>
...
<cfif #read_mortgage.data1# NEQ "">
	...
	<cfelse>Satisfaction and/or release of
		</cfif> Mortgage from #read_mortgage.data2#
			<cfif #read_mortgage.data3# neq "">
				and #read_mortgage.data3#
			</cfif> securing #read_mortgage.data1# in the original principal amount of #read_mortgage.data4#, as dated #DateFormat(read_mortgage.data8, "mm")#/#DateFormat(read_mortgage.data8, "dd")#/#DateFormat(read_mortgage.data8, "yyyy")# and recorded on #DateFormat(read_mortgage.data9, "mm")#/#DateFormat(read_mortgage.data9, "dd")#/#DateFormat(read_mortgage.data9, "yyyy")# among the Land Records of #Read_title.pcounty# County,
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		  <tr align="left" valign="top">
			...
			<cfif read_mortgage2.lienintro neq "" and read_mortgage2.lienintro neq 'NULL' or Len(read_mortgage2.lienintro) eq 0>
				#read_mortgage2.lienintro#<cfelse>Satisfaction and/or release of
			</cfif> Mortgage from #read_mortgage2.data2#
			<cfif #read_mortgage2.data3# neq "">
				and #read_mortgage2.data3#
			</cfif> securing #read_mortgage2.data1# in the original principal amount of #read_mortgage2.data4#, as dated #DateFormat(read_mortgage2.data8, "mm")#/#DateFormat(read_mortgage2.data8, "dd")#/#DateFormat(read_mortgage2.data8, "yyyy")# and recorded on #DateFormat(read_mortgage2.data9, "mm")#/#DateFormat(read_mortgage2.data9, "dd")#/#DateFormat(read_mortgage2.data9, "yyyy")# among the Land Records of #Read_title.pcounty# County, <cfif #read_mortgage2.data5# eq ""><cfif #read_mortgage2.data6# neq "">
			...
			in Book <cfif #read_mortgage2.data14# eq "">
	...
	<cfset auto_number = #auto_number# + 1>
	      ...
	      <tr align="left" valign="top">
			...
			#read_lien.lienintro# Judgment against #read_lien.data7# in favor of #read_lien.data6# in the amount of #read_lien.data5#,
			  ...
			  <cfif #read_lien.data1# eq ""> in Book #read_lien.data2# at Page #read_lien.data3# <cfelse>
		    ...
		    <td>
             <cfif #read_mortgage5.data1# NEQ ""> <cfif read_mortgage5.lienintro neq "" and read_mortgage5.lienintro neq 'NULL' or Len(read_mortgage5.lienintro) eq 0>#read_mortgage5.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage5.data2# <cfif #read_mortgage5.data3# neq ""> and #read_mortgage5.data3#</cfif> securing #read_mortgage5.data1# in the original principal amount of #read_mortgage5.data4#, as dated #DateFormat(read_mortgage5.data8, "mm")#/#DateFormat(read_mortgage5.data8, "dd")#/#DateFormat(read_mortgage5.data8, "yyyy")# and recorded on #DateFormat(read_mortgage5.data9, "mm")#/#DateFormat(read_mortgage5.data9, "dd")#/#DateFormat(read_mortgage5.data9, "yyyy")# among the Land Records of #Read_title.pcounty# County, <cfif #read_mortgage5.data5# eq ""><cfif #read_mortgage5.data6# neq "">
				...
				in Document Number #read_mortgage5.data5#
				  ...
				  in Book
				  <cfif #read_mortgage5.data14# eq "">#read_mortgage5.data15#, at Page #read_mortgage5.data16#
					  <cfelse>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfif read_mortgage6.lienintro neq "" and read_mortgage6.lienintro neq 'NULL' or Len(read_mortgage6.lienintro) eq 0>
			#read_mortgage6.lienintro#
		<cfelse>
			Satisfaction and/or release of
		</cfif> Mortgage from #read_mortgage6.data2#
		<cfif #read_mortgage6.data3# neq "">
			and #read_mortgage6.data3#</cfif> securing #read_mortgage6.data1# in the original principal amount of #read_mortgage6.data4#, as dated #DateFormat(read_mortgage6.data8, "mm")#/#DateFormat(read_mortgage6.data8, "dd")#/#DateFormat(read_mortgage6.data8, "yyyy")# and recorded on #DateFormat(read_mortgage6.data9, "mm")#/#DateFormat(read_mortgage6.data9, "dd")#/#DateFormat(read_mortgage6.data9, "yyyy")# among the Land Records of #Read_title.pcounty# County, <cfif #read_mortgage6.data5# eq ""><cfif #read_mortgage6.data6# neq "">
					...
					in Book <cfif #read_mortgage8.data14# eq "">#read_mortgage8.data15#, at Page #read_mortgage8.data16#
						<cfelse> in Document #read_mortgage8.data14#
							...
							<cfif #len(read_mortgage8.data30)# gt 0 AND #len(read_mortgage8.data31)# gt 0 >
								in Book #read_mortgage8.data31# at Page #read_mortgage8.data31#
							</cfif>
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
          ...
          <cfif #read_mortgage14.data1# NEQ ""> <cfif read_mortgage14.lienintro neq "" and read_mortgage14.lienintro neq 'NULL' or Len(read_mortgage14.lienintro) eq 0>#read_mortgage14.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage14.data2# <cfif #read_mortgage14.data3# neq ""> and #read_mortgage14.data3#</cfif> securing #read_mortgage14.data1# in the original principal amount of #read_mortgage14.data4#, as dated #DateFormat(read_mortgage14.data8, "mm")#/#DateFormat(read_mortgage14.data8, "dd")#/#DateFormat(read_mortgage14.data8, "yyyy")# and recorded on #DateFormat(read_mortgage14.data9, "mm")#/#DateFormat(read_mortgage14.data9, "dd")#/#DateFormat(read_mortgage14.data9, "yyyy")# among the Land Records of #Read_title.pcounty# County, <cfif #read_mortgage14.data5# eq ""><cfif #read_mortgage14.data6# neq "">
			...
			in Book <cfif #read_mortgage14.data14# eq "">
				#read_mortgage14.data15#, at Page #read_mortgage14.data16#
				...
				<cfelse>
				 in Document #read_mortgage14.data19#
				<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
				...
				<cfelse>
				in Document #read_mortgage14.data29#
				<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
	      ...
	      <tr align="left" valign="top">
		    ...
		    <td>
              <cfif #read_lien43.data7# NEQ ""> #read_lien43.lienintro# Judgment against #read_lien43.data7# in favor of #read_lien43.data6# in the amount of #read_lien43.data5#, dated #DateFormat(read_lien43.data4, "mm")#/#DateFormat(read_lien43.data4, "dd")#/#DateFormat(read_lien43.data4, "yyyy")# and recorded #DateFormat(read_lien43.data9, "mm")#/#DateFormat(read_lien43.data9, "dd")#/#DateFormat(read_lien43.data9, "yyyy")#
			    <cfif #read_lien43.data1# eq ""> in Book #read_lien43.data2# at Page #read_lien43.data3#
	      ...
	      <tr align="left" valign="top">
		    ...
		    <td>
              <cfif #read_lien50.data7# NEQ ""> #read_lien50.lienintro# Judgment against #read_lien50.data7# in favor of #read_lien50.data6# in the amount of #read_lien50.data5#, dated #DateFormat(read_lien50.data4, "mm")#/#DateFormat(read_lien50.data4, "dd")#/#DateFormat(read_lien50.data4, "yyyy")# and recorded #DateFormat(read_lien50.data9, "mm")#/#DateFormat(read_lien50.data9, "dd")#/#DateFormat(read_lien50.data9, "yyyy")#
			    <cfif #read_lien50.data1# eq ""> in Book #read_lien50.data2# at Page #read_lien50.data3# <cfelse>
			    in Document #read_lien50.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
...
<cfif read_title.pstate eq 'MD' and get_comp_info.streamline_client eq 1>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Foreclosure action filed in Circuit Court for ___________ County, Maryland Case No. _______________ against _______________ in regard to that certain deed of trust recorded in liber ______ at folio ___________ TO BE DISMISSED WITH PREJUDICE or, if the property is to be conveyed pursuant to the foreclosure case, verification of compliance with Maryland Real Property Code Sections 7-105 et seq., Maryland Rules 14-201 et seq., and Maryland Rules 14-301 et seq. including review of the following: </td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Order to Docket containing the following items:
...
6.  A copy of the deed of appointment of a substitute trustee.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">If Order to Docket filed on or after July 1, 2010, copy of the Final Loss Mitigation Affidavit filed and served with the Order to Docket, or if not so filed and served, filed at least 30 days before the sale, but not sooner than 28 days after filing Order to Docket.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Affidavit of mailing of notice of intent to foreclose (Must have been sent no sooner than 45 days after default under the note and at least 45 days prior to the filing of the Order to Docket).</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Proof of personal service of Order to Docket (including all other papers filed) on owner/borrower in accordance with the provisions of Maryland Rule 14-209.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">If Mediation requested by borrower, report from Office of Administrative Hearings showing outcome of Mediation.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Proof of Publication of Advertisement of Sale (must be published once a week for 3 weeks; first publication must not be less than 15 days prior to the foreclosure/last publication not more than one week prior to foreclosure sale. (NOTE: A sale may not be advertised until 20 days after the Final Loss Mitigation affidavit is filed, but if a request for Mediation is filed within that time and not stricken, a sale may not be advertised until the report from the Office of Administrative Hearings is filed with the court).</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Verification that the foreclosure sale was made at least 45 days after personal service on mortgagor and owner of Order to Docket</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Proof of Notice of Sale on all junior or subordinate lien holders in accordance with the provisions of Maryland Rule 14-206(b)(2) and (3).</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Proof of bond filed prior to sale.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Report of Sale filed within 30 days following the sale. (NOTE: Report must contain an affirmation of the fairness of the sale and the truth of the report.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Affidavit of Purchaser.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Clerk's notice following sale (order nisi) stating that the sale will be ratified unless cause to the contrary is shown within 30 days.  A copy of such notice shall be published at least once a week in each of three successive weeks before the expiration of the 30-day period.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Final Order of Ratification.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">If objections to sale filed, time to appeal must have expired (i.e. 30 days from entry of order of final ratification).</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Receipt of adequate proof that the borrowers/property owners are not currently under the protection of the Bankruptcy Court and/or were not in bankruptcy before or during the foreclosure process.  If bankruptcy filed by owner/borrower, Order of bankruptcy court lifting the automatic stay as to foreclosed deed of trust.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Receipt of adequate proof that the property owners are not currently on active duty in the U.S. Military.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Receipt of adequate proof of proper notice to the IRS of its subordinate lien, if applicable.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Evidence that 120 days have passed since the date of foreclosure sale OR receipt of waiver from the IRS of their right to redeem the foreclosed property, if applicable.</td></tr>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Proof that the borrower/foreclosed owner has vacated the property and that it is not occupied by anyone claiming rights under or through such person.</td></tr>
...
<tr><td colspan="2"><center><strong>END OF REQUIREMENTS</strong></center></td>
	</tr>
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
...
<cfset months = 0>
<cfif IsDefined("read_deed.data11")	and IsDate("read_deed.data11") and IsDefined("read_title.order_date") and IsDate("read_title.order_date")>
...
<cfif months LTE 24>
		...
		<td valign="top">&nbsp;</td>
		  ...
		  <tr>
		  <td align="left" valign="top">RECORDED</td><td align="left" valign="top">#read_deed.data11#  <cfif read_deed.data7 neq ''>as Instrument No. #read_deed.data7#,</cfif> <cfif read_deed.data8 neq ''>Book #read_deed.data8#,</cfif> <cfif read_deed.data9 neq ''>Page #read_deed.data9#,</cfif> of official records.</td>
		  </tr>
		  </table>
		 </td>
        </tr></cfoutput>
...
afforded by covered matter 2(c) is hereby deleted.
NOTE: As to issuance of the Eagle Protection Owner's Policy (Form 1490, 6/98), this exception
...
regulations adopted thereunder.</td>
	</tr>
...
<cfelse>
	...
	<tr>
        ...
        <tr>
		  <td width="5%" valign="top">2.</td>
		<td>Any claim that acsquisition of said land, whether by conveyance or operation of law, is subject to a claim of fraudulent conveyance or preference under the federal bankruptcy code or state insolvency or creditor's rights laws.<br>
<br>
Said exception will be eliminated upon recording a deed in favor of a bona fide purchaser provided no evidence of insolvency appears.<br></td>
	</tr>
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
        <tr>
		  <td width="5%" valign="top">3.</td>
		<td>Any First American Title policy issued pursuant hereto (except extended covereage) will contain under Schedule B the standard exceptions set forth at the inside cover hereof.</td>
	</tr>
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
...
<tr>
          <td colspan="3"><center><strong>END OF SCHEDULE B</strong></center></td>
        </tr>
</table>
...
<IE:DEVICERECT ID="Page8" CLASS="masterstyle" MEDIA="print">
	    ...
	    <tr>
		  <td colspan="2" align="center" valign="middle" bgcolor="000000" height="30"><B><font color="FFFFFF" size="4">&nbsp;
           </font></B></td>
	</tr>
	</table>
	   <table width="93%" cellpadding=0 cellspacing=0 border=0 >
...
<cfinclude template="icl_default_fa.cfm">
