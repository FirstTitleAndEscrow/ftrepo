          ...
          <tr>
            ...
            <td valign="top"> <table width="100%" valign="top" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td width="20">&nbsp;</td>
                  <td><B><cfif read_title.comp_id eq 3943 or read_title.comp_id eq 4043 or read_title.comp_id eq 4042>#ReplaceNoCase(read_title.insured, "RHF/", "", "ALL")#<cfelse>#read_title.insured#</cfif>, its successors and/or <cfif read_FT_company.company does not contain 'Wells Fargo'>as their interest may appear</cfif></B><br></td>
                </tr>
              </table></td>
...
<cfset text_3 = Mid(temp, stop_number + 1, Len(temp))>
        ...
        <tr>
		 ...
		 <font size=-1> <cfif len(read_Title_Data.addex) LTE 500>
...
<!--- <p style="page-break-after:always;">&nbsp;</p> --->
<IE:DEVICERECT ID="<CFOUTPUT><CFIF #read_Title.pstate# eq "CA" OR #read_Title.pstate# eq "NV">page9<CFELSE>Page8</CFIF></cfoutput>" CLASS="masterstyle" MEDIA="print">
	    <table width="100%" cellpadding=0 cellspacing=0 border=0 >

	    <tr>
		  <td colspan="2" align="center" valign="middle" bgcolor="000000" height="30"><B><font color="FFFFFF" size="4">Tax Information </font></B></td>
	</tr>
	</table>
	   <table width="93%" cellpadding=0 cellspacing=0 border=0 >
	   <tr>
