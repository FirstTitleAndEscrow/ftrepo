...
<CFSET order_date_adj = '#DateFormat(Now(), "mm/dd/yyyy")# #TimeFormat(Now(), "HH:mm:ss")#'>
		...
		<CFQUERY datasource="#request.dsn#">
				...
				VALUES('#read_user.FName#', '#read_user.LName#', #URL.rec_id#, 'Abstract Received - Title In Typing', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T', '1', '1')
		</CFQUERY>
...
SERVER="127.0.0.1"
Subject="Abstract uploaded for order #read_title.title_id#"
TIMEOUT="600"
	>
