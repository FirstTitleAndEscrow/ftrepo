...
<center>
	...
	<CFFORM METHOD=POST ACTION="./loan_procs_add_submit_order.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&emp=#emp#&ordering_co=#ordering_co#&page=#page#" name="frm"  ENABLECAB="Yes">
...
<!--- ===/ LOAN PROCESSOR INFO \=== --->
	...
	<tr>
		...
		<td width=300 align=left valign=top bgcolor="e6e6e6">
		<input type="hidden" 	name="lp_email_required"	value="You must enter a Processors EMAIL Address">
			<CFINPUT name="lp_email" type=text  size=30 maxlength=160 Required="yes" Message="You must enter a Processors EMAIL Address"
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
