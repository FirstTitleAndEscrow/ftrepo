...
<table width=700 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
  ...
  <center> <font face=verdana size=2 color=black> If you would like to modify this closing information click here
   <a href="./form_anc_closing_order_request_modify.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_title.anc_id#&company_id=#company_ID#&Title_Ins_Co_Is=#Title_Ins_Co_Is#"><img src="./images/button_modify.gif" border=0 ALT="Modify Closing info"></a>
          </center>   <br>
</cfoutput>
			</TD>
		</TR>
	...
	<table width=699 cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
		<tr>
			<td width=699 align=center valign=top bgcolor=e1e1e1>
				...
				Papermaster & Weltman, <cfoutput>#session.site.long_name#</cfoutput>/American Title Services<br>
