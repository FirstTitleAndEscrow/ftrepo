  ...
  <tr>
    <td colspan="3" align="center"> <font size="5">GENERAL ENDORSEMENT</font><br>
      ...
      <p> <font size="1">ISSUED BY</font><br>
        <font size="4"><b>First American Title Insurance Company</b></font>
      <p>
    </td>
  </tr>
  <tr>
    <CFFORM NAME="frm" ACTION="./proposed_insured_verify_natic.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=0&company_id=0" METHOD="POST">
<CFOUTPUT QUERY="read_title">
  ...
  <tr>
    <td colspan="3">
	  ...
	  <tr>
    <td valign="top" width="22%"> <b><font size="4">First American Title Insurance Company </font></b></td>
	  <td colspan="2">
