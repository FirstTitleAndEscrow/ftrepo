...
<cfelseif #property# neq "">
					<img src="./images/property_title.gif">
<cfelseif #appraisal# neq "">
					<img src="./images/appraisal_title.gif">
<cfelseif #other# neq "">
					<img src="./images/ancillary_title.gif">
</cfif>
					<p>
<CFFORM NAME="frm" ACTION="./calyx_form_title_request_addr_verify.cfm?Temp_Loan_ID=#Temp_Loan_ID#&property=0&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&appraisal=#appraisal#&other=0&zip_id=0&zip_trigger=0&a_trigger=7&emp=#emp#" ENCTYPE="multipart/form-data" METHOD=POST>
				<center>
