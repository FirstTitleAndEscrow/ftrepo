...
<cfparam name="form.loanamt_float" default="">
<cfparam name="form.purchase" default="">
<cfparam name="form.estimated_loan_float" default="">
<cfparam name="form.prev_loan_year" default="">
<cfparam name="form.prev_loan_mo" default="">
...
<cfquery  datasource="#request.dsn#">
INSERT INTO TITLE (proptype,dateandtime, hud_type, piggy, ins, secloan, loan_number, check_date, check_time, user_id, comp_id, loan_off_id, oname, ophone, oext, ofax, o_email, pname, pphone, pext, pfax, p_email, blastname1, bfirstname1, bminame1, bssn1, bhphone1, bwphone1, bext1, blastname2, bfirstname2, bminame2, bssn2, bhphone2, bwphone2, bext2, slastname1, sfirstname1, sminame1, sssn1, shphone1, swphone1, sext1, slastname2, sfirstname2, sminame2, sssn2, shphone2, swphone2, sext2, paddress, pcity, pstate, pzip, pcounty, plegaldesc, condo_pud, a_comment, verifyemail, verifyemail_2, verifyemail_3, fax_no, rptbyemail, a_insert_date, a_insert_time, duedate, request_icl, order_date_adjusted, oda_day, oda_month, oda_year, oda_day_of_year, appraisal_status, a_day, a_month, a_year, a_day_of_year, polender1, poacctno1, pophone1, polender2, poacctno2, pophone2, order_status, SearchType, purchase, Deedtransfer, Insured, loanamt_float, loan_type_111, loan_program_333, prop_use_type, codeT, search_type, cleartoclose, company1, company2, taxID1, taxID2, estimated_loan_float, order_date, prev_loan_mo, prev_loan_year, calyxdc_id, encompass_id, integra_id, piggy_reference_id) VALUES ('#proptype#','#order_date#', '#hud_type#', '#piggy#', '#ins#', '#secloan#', '#loan_number#', '#DateFormat(Now(),"mm-dd-yyyy")#', '#TimeFormat(Now(),"HH:mm:ss")#', #user_id_1#, #RU.comp_id#, #lo_id#, '#rlo_name#', '#RLO.lo_phone#', '#RLO.lo_ext#', '#RLO.lo_fax#', '#RLO.lo_email#', '#ru_name#', '#RU.lp_phone#', '#RU.lp_ext#', '#RU.lp_fax#', '#RU.lp_email#', '#blastname1#', '#bfirstname1#', '#bminame1#', '#bssn1#', '#bhphone1#', '#bwphone1#', '#bext1#', '#blastname2#', '#bfirstname2#', '#bminame2#', '#bssn2#', '#bhphone2#', '#bwphone2#', '#bext2#', '#slastname1#', '#sfirstname1#', '#sminame1#', '#sssn1#', '#shphone1#', '#swphone1#', '#sext1#', '#slastname2#', '#sfirstname2#', '#sminame2#', '#sssn2#', '#shphone2#', '#swphone2#', '#sext2#', '#paddress#', '#pcity#', '#pstate#', '#pzip#', '#pcounty#', '#plegaldesc#', '#condo_pud#', '#a_comment#', '#verifyemail#', '#verifyemail_2#', '#verifyemail_3#', '#fax_no#', '#rptbyemail#', '#a_insert_date#', '#a_insert_time#', '#duedate#', <cfif calyxdc_id neq 0>'Yes'<cfelse>'#request_icl#'</cfif>, '#order_date_adj#', #a_day_1#, #a_month_1#, #a_year_1#, #oda_day_of_year_1#, '#app_stat#', #a_day_1#, #a_month_1#, #a_year_1#, #a_day_of_year_1#, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#polender1#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#poacctno1#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#pophone1#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#polender2#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#poacctno2#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#pophone2#'</cfif>, 1, '#SearchType#', '#purchase#', '#Deedtransfer#', '#Insured#', '#loanamt_float#', '#loan_type_111#', '#loan_program_333#', '#prop_use_type#', 'T','#search_type#','#ctc_name#','#trim(company1)#','#trim(company2)#','#trim(taxID1)#','#trim(taxID2)#','#trim(estimated_loan_float)#', #CreateODBCDate(Now())#, #prev_loan_mo#, #prev_loan_year#, '#calyxdc_id#', '#encompass_id#', '#integra_id#', '#get_titleid.title_id#')
</cfquery>
...
<!--- if this is an encompass order, check to see if any PDFs are attached to the order, and save them in MiscDocs --->
...
<cfcatch type="any">
<cfmail to="rjermain@firsttitleservices.com" from="rjermain@firsttitleservices.com" subject="Failed Encompass Attachment Upload" type="html">
<cfoutput>
...
INSERT INTO Title_Notes(FName, LName, Order_ID, N_Note, N_Date, N_Time, note_type)
  ...
  <cfif #RU.comp_id# EQ 324>
    ...
    <cfelseif #RU.comp_id# EQ 729 OR #RU.comp_id# EQ 1460  or (#RU.comp_id# eq 2632) or (#read_company.master_co_id# eq 2632) or (#RU.comp_id# eq 2368) or (#RU.comp_id# eq 2372)>
    <!---Eastern Residential Mortgage--->
    <CFQUERY datasource="#request.dsn#" >
      ...
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            ...
            <tr>
              ...
              <td COLSPAN=3 width=394 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#loanamt_float#</b></td>
            </tr>
            <tr>
...
<cfinclude template="rick_tests/update_hud_fee_calc.cfm">
      <cfcatch type="Any">
        <cfoutput>
          <cfmail from="rjermain@firsttitleservices.com" to="rjermain@firsttitleservices.com" subject="Update Fees Failure: Customer Ordering: #rec_id#">
            <hr>
            <h1>Other Error:#cfcatch.Type#</h1>
            <ul>
              <li><b>Message:</b>#cfcatch.Message#
...
<cfmail to="rjermain@firsttitleservices.com" cc="spape@firsttitleservices.com; pgibb@firsttitleservices.com" from="rjermain@firsttitleservices.com" subject="Order Error:  #get_comp_info.company# (#get_comp_info.ID#)" type="html">
<cfoutput>
The Error occurred in:<br>
<cfdump var="#cfcatch.tagcontext[1].template#"><br>
<br>
...
<cfif IsDefined("get_titleid.title_id") and get_titleid.title_id neq "">
<CFQUERY datasource="#request.dsn#">
