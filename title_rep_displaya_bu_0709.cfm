...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			where a.title_id = b.title_id and b.A_Req_Closing_Day is null and a.comp_id = '#comp_id#'
...
<INPUT type="hidden" name="uid" value="URL.uid">
	<INPUT type="hidden" name="al" value="URL.al"><A HREF="./title_rep_displaya.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.title_id#&title_id=#title_id#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&yearmonthday=#yearmonthday#&count=#count_forward#&a_trigger=1">
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFOUTPUT><A HREF="./title_rep_view.cfm?comp_id=#comp_id#&yearmonthday=#yearmonthday#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.title_id#&title_id=#title_id#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=1"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>
<INPUT type="hidden" name="uid" value="URL.uid">
	<INPUT type="hidden" name="al" value="URL.al"><A HREF="./title_rep_displaya.cfm?comp_id=#comp_id#&yearmonthday=#yearmonthday#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.title_id#&title_id=#title_id#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=1"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
				...
				<CFOUTPUT>
<INPUT type="hidden" name="uid" value="URL.uid">
	<INPUT type="hidden" name="al" value="URL.al"><A HREF="./title_rep_displaya.cfm?comp_id=#comp_id#&yearmonthday=#yearmonthday#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.title_id#&title_id=#title_id#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=1">
				Next Screen</a></CFOUTPUT>
				</CFIF></td>
