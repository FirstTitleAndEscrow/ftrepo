...
<CFPARAM NAME="A_Update_DB_Flag" DEFAULT="0">
	...
	<CFIF #A_Update_DB_Flag# GT "0">
		...
		<CFQUERY datasource="#request.dsn#">
				...
				VALUES('#username#', #URL.rec_id#, '#N_Note_1#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'FDR', '1', '1')
			</CFQUERY>
...
<table width=590 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
		...
		<tr>
			...
			<td width=590 align=center valign=top bgcolor=green>
				...
				<b>View Comments for order FDR-<CFOUTPUT>#url.rec_id#</CFOUTPUT></a>
		</tr>
...
<CFFORM NAME="frm" ACTION="./view_FDR_comments_nav.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#url.rec_id#&a_trigger=1&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=1&code=FDR" onsubmit="javascript:return locate(this)" ENCTYPE="multipart/form-data" METHOD=POST>

	<table width=590 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
		<tr>
			<td width=590 align=center valign=top bgcolor=green>
				<font face=verdana size=1 color=white>
				<b>Add Comments for order FDR-<CFOUTPUT>#url.rec_id#</CFOUTPUT></a>
