...
<tr><td width=590 align=center valign=top bgcolor=d3d3d3>
	...
	<tr>
		<td width=607 align=center valign=top>
				...
				<p>
	<CFFORM NAME="frm" ACTION="./order_verify_title.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_id=#zip_id#" METHOD=POST>
...
<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
		<tr>
			<td width=519 align=left valign=top bgcolor=d3d3d3>
				<FONT FACE=ARIAL SIZE=2 color="black">
				<CENTER><B>COLLATERAL MANAGEMENT PRODUCTS:</B></CENTER>
			</TD>
		</TR>
			...
			<TD width=519 align=center valign=top bgcolor=d3d3d3>
				...
				<table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
					<tr>
						...
						<td width=310 bgcolor="f1f1f1" align=left valign=top>
	<INPUT TYPE="checkbox"
   NAME="SelectedOrgs" VALUE=1>
     Broker's Price Opinion (FHLMC 1092)<BR>

						</td>


						<td width=209 bgcolor="f1f1f1" align=left valign=top>
									<INPUT TYPE="checkbox"
   NAME="SelectedOrgs" VALUE=2>
     Basic Flood Certification<BR>
						</td>
					</tr>
	...
	<td width=310 bgcolor="f1f1f1" align=left valign=top>
										<INPUT TYPE="checkbox"
   NAME="SelectedOrgs" VALUE=3>
  Uniform Resid. Appr. Report (FNMA 1004)<BR>
						</td>
...
<td width=209  bgcolor="f1f1f1" align=left valign=top>
 ...
 Life of Loan Certification<BR>
				...
				<td width=310 bgcolor="f1f1f1" align=left valign=top>
							<INPUT TYPE="checkbox"
   NAME="SelectedOrgs" VALUE=5>
  Desktop UW Appr. Report (FNMA 2055)<BR>
						</td>

						<td width=209 bgcolor="f1f1f1" align=left valign=top>
							<INPUT TYPE="checkbox"
   NAME="SelectedOrgs" VALUE=6>
  HMDA<BR>
						</td>
					</tr>
					...
					<tr>
						<td  width=310 bgcolor="f1f1f1" align=left valign=top>
							<INPUT TYPE="checkbox"
   NAME="SelectedOrgs" VALUE=7>
  Home Value Explorer (AVM)<BR>

  <td width=209 bgcolor="f1f1f1" align=left valign=top>
							<INPUT TYPE="checkbox"
   NAME="SelectedOrgs" VALUE=8>
 First AVM<BR>
						</td>
