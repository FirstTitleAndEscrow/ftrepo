        ...
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            ...
            <tr>
              ...
              <td width=134 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue">
                <cfif read_title.loan_off_id eq 0 and (read_title.CalyxDC_ID neq 'NULL' or read_title.Encompass_ID neq 'NULL')>
...
>
    ...
    <cfif get_titleid.loan_off_id eq 0 and (get_titleid.CalyxDC_ID neq 'NULL' or get_titleid.Encompass_ID neq 'NULL')>
...
--->
    ...
    <p> <img src="./images/ancillary_title.gif">
      ...
      <cfif calyxdc_id eq 0 and encompass_id eq 0>
        ...
        <cfelseif calyxdc_id eq 0 and encompass_id neq 0>
	...
	<cfelseif calyxdc_id neq 0 and encompass_id eq 0>
        <cfhttp url="http://www.firsttitleservices.com/title_view_hud_pg1a.cfm?emp=#emp#&rec_id=#get_titleid.title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" method="get" resolveURL="true">
        </cfhttp>
