	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<cfoutput>	<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER(S)</B></center><br><p>
				...
				<center>Your Property Request Order has been Processed. Order number is <a href="./view_the_prop_order.cfm?comp_id=#comp_id#&rec_id=#read_prop.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_flag=7"><b>P-0232#read_prop.prop_id#</b></a></center><br>
				<cfif #read_prop.hud# eq 1>
					<center>A HUD-1 has been instant prepared for you! Click
					<cfif #read_prop.hud_type# eq "0">
						<a href="./prop_view_hud_pg1.cfm?rec_id=#prop_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a>
					<cfelse>
						<a href="./prop_view_hud1a.cfm?rec_id=#prop_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a>
					</cfif>now.</center><br>
				</cfif>
