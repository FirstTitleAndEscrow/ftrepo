...
<CFPARAM NAME="ordering_co" DEFAULT="">
...
<CFOUTPUT><TR>
            ...
            <td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onmouseover="this.bgColor='00FF66'" onmouseout="this.bgColor='CCD2D2'" onClick="document.location.href='./loan_offcr_add.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#';return false;"> <a class="menu1"  href="./loan_offcr_add.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New"><nobr><img src="/client/images/arrowvendor.jpg" border=0>&nbsp;<strong>USER ADMIN</strong>&nbsp;</nobr></a></td>
     ...
     <CFIF #emp# neq "0">
        <CFIF #read_company_user.Administrator# eq "1">
	               <tr>
                    ...
                    <br><font face="arial" size="2" color="black">Modify a Processor > <a href="./loan_proc_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&zip_trigger=0&ordering_co=#ordering_co#&page=admin"><img src="./images/button_modify.gif" border=0></a>. Add a new Processor > </font> <a href="./loan_proc_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&zip_trigger=0&ordering_co=#ordering_co#&page=admin"><img src="./images/button_add.gif" border=0></a>
                    </td>
                </tr>
        </CFIF>
    <CFELSE>
		...
		<tr>
			...
			<td bgcolor=f1f1f1 width="145" align="center" valign="top" bgcolor="a2a3fe">
				...
				<CFOUTPUT QUERY="read_loan_offcr">
					<option value="#read_loan_offcr.ID#">#read_loan_offcr.oname#</option>
				</CFOUTPUT>
				</SELECT>
			</td>
		</tr>
<CFOUTPUT>
        <CFIF #emp# neq "0">
            <CFIF #read_company_user.Administrator# eq "1">
		        <tr>
			        <td bgcolor=f1f1f1 colspan = 2 width="425" align="center" valign="top">
	                <br><font face="arial" size="2" color="black">Modify an Officer > <a href="./loan_offcr_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&zip_trigger=0&ordering_co=#ordering_co#&page=admin"><img src="./images/button_modify.gif" border=0></a>. Add a new Officer > <a href="./loan_offcr_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&zip_trigger=0&ordering_co=#ordering_co#&page=admin"><img src="./images/button_add.gif" border=0></a></font>
                    </td>
                </tr>
            </CFIF>
        <CFELSE>
...
<nobr><cfoutput><a href="./client_acct_mgt.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&emp=#emp#"><FONT FACE=ARIAL SIZE=2 color="red"><b>Back to main</b></font></a></cfoutput></nobr>
