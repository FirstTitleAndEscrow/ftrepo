		...
		<cfif #title# eq 1>
			<cfif #pstate# eq "CA">
				<script type="text/javascript">
					window.alert("The state of California title insurance fees are not yet in our system. There will be a HUD1 generated for yout title order but without Title Insurance fees calculations!")
				</script>
			</CFIF>
		</cfif>
	</cfif>
...
<CFFORM NAME="frm" ACTION="./calyx_form_title_request_addr_verify.cfm?emp=#emp#&Temp_Loan_ID=#Temp_Loan_ID#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=0&appraisal=#appraisal#&other=#other#&zip_trigger=1&zip_id=0&a_trigger=21" METHOD=POST>
							<center>
							<table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
		<!--- =================================== --->
		<!--- ===/ Property  Info [ FIRST ]  \=== --->
		...
		<tr><td width=770 align=center valign=bottom>
			<NOBR><cfoutput><a href="./client_acct_mgt.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><img src="./images/button_go_back.gif" border=0 ALT="Go to main menu"></a>
...
<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<CFFORM NAME="frm" ACTION="./calyx_form_title_request_addr_verify.cfm?emp=#emp#&Temp_Loan_ID=#Temp_Loan_ID#&comp_id=#comp_id#&property=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_trigger=2&pstate=#pstate#&pcity=#pcity#&title=#title#&property=0&appraisal=#appraisal#&other=#other#" METHOD=POST>
...
<CFOUTPUT>
					<tr>
						<td width=205  bgcolor="f1f1f1" align=right>
							<a href="./form_title_request_addr.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&property=0&lo_id=#lo_id#&zip_trigger=1&pcity1=#pcity#&pstate1=#pstate#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img border=0 src="./images/button_go_back.gif"></a>
						</td>
						<td width=314  bgcolor="f1f1f1" align=left>
...
<CFOUTPUT>
					...
					<!---Update Temp Table with State, county, zip --->
					<cfquery  datasource="#request.dsn#">
					Update
					TITLE_TEMP
					Set pstate =  '#read_zip_code.state#',
						pcity =  '#read_zip_code.city#',
						pcounty = '#read_zip_code.county#',
						pzip =  '#read_zip_code.zip#'
...
<CFOUTPUT>
					<tr>
						<td width=205  bgcolor="f1f1f1" align=right>
							<a href="./calyx_form_title_request_addr.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_trigger=1&pcity1=#pcity#&pstate1=#pstate#&pzip1=#pzip#&title=#title#&property=0&appraisal=#appraisal#&other=#other#"><img border=0 src="./images/button_go_back.gif"></a>
						</td>
						<td width=314  bgcolor="f1f1f1" align=left>
							<a href="./form_calyx_title_request.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_trigger=1&pcity=#pcity#&pstate=#pstate#&zip_id=#read_zip_code.zip_id#&title=#title#&property=0&appraisal=#appraisal#&other=#other#&Temp_Loan_ID=#Temp_Loan_ID#"><img border=0 src="./images/button_continue.gif"></a>
					</tr>
</CFOUTPUT>
