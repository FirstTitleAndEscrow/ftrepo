...
<CFPARAM NAME="pstate" DEFAULT="VA">
<CFPARAM NAME="pzip" DEFAULT="">
<CFPARAM NAME="pcounty" DEFAULT="Fairfax">
...
<CFPARAM NAME="loanamt_float" DEFAULT="1000">
<CFPARAM NAME="loan_type_111" DEFAULT="">
<CFPARAM NAME="loan_program_333" DEFAULT="">
<CFPARAM NAME="Verifyemail" DEFAULT="rjermain@firsttitleservices.com">
...
<cfif #purchase# eq "" or #purchase# eq "0">
<cfset purchase = 1000>
</cfif>
</cfif>
<cfif #loanamt_float# eq "" or #loanamt_float# eq "0">
<cfset loanamt_float = 1000>
</cfif>
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				...
				VALUES ('#loan_number#', '#DateFormat(Now(), "mm-dd-yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', #RU.id#, #RU.comp_id#,	#RLO.id#, '#rlo_name#', '#RLO.lo_phone#',
...
<CFSET b_emails_to_first_title = "webmaster@firsttitleservices.com,jslattery@firsttitleservices.com,spape@firsttitleservices.com,akumar@firsttitleservices.com">
				...
				Subject="Summary of Order #get_titleid.title_id#-#get_titleid.bfirstname1# #get_titleid.blastname1#"
				TIMEOUT="600"
				type="HTML"
				>
...
#get_titleid.title_id#-#get_titleid.bfirstname1# #get_titleid.blastname1#"
TIMEOUT="600"
type="HTML"
>
...
<TABLE WIDTH=770 BORDER=1 CELLSPACING=1 align="center" bgcolor=GRAY>
		...
		<td width=770 align=center valign=top bgcolor=ELELEL>
			<p><br><br>
			<CENTER><FONT FACE=ARIAL color=BLUE SIZE=3><b>ORDER ID PLACED: <CFOUTPUT><OrderID>#get_titleid.title_id#</OrderID></CFOUTPUT></b></FONT></center>
				<p><br><br>
				</td>
				</tr>
