...
<CFQUERY datasource="#request.dsn#" NAME="read_type">
			...
			SELECT type
			FROM TRANSUNIONSVCS
			where order_num = '#rec_id#' and type = 'TAX'
</CFQUERY>
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				TRANSUNIONSVCS (order_num, type, seq_num, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19)
				VALUES ('#rec_id#', 'TAX', '#seq_num#', '#proptype#', '#taxid#', '#parcel#', '#exempt#', '#amount#', '#extype#', '#land#', '#impass#', '#other#', '#val#', '#tx#', '#tax_year#', '#DateFormat(instdate, "mm/dd/yyyy")#', '#stat#', '#txamt#', '#del_year#', '#info#', '#info2#', '#DateFormat(recdate, "mm/dd/yyyy")#')

</cfquery>
<!--- <cfquery  datasource="#request.dsn#">
			INSERT INTO
				SVCS0006 (title_id, type, seq_num, status, insert_date, insert_time, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19)
