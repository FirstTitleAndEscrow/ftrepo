...
<CFLOCATION URL="./loan_proc_offcr_add.cfm?comp_id=#comp_id#&user_id_1=#user_id_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&a_trigger=11&emp=#emp#&ordering_co=#ordering_co#&page=#page#">
...
<CFQUERY datasource="#request.dsn#" NAME="get_sales">
		SELECT *
		FROM First_Admin
		WHERE ID = #read_companies.intSales#
</CFQUERY>
...
<table width=430 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	...
	<cfoutput><font face="arial" size="2" color="black">To go back click here > </font>
	...
	<a href="./loan_proc_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#user_id_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&ordering_co=#ordering_co#" ><img src="./images/button_return.gif" border=0></a></td>	</td></tr>
...
<font face="arial" size="2" color="black">To modify this entry click here > </font> <a href="./loan_officer_modify_view.cfm?emp=#emp#&uid=60&al=1&comp_id=#comp_id#&proc_id=#read_offcr.id#&ordering_co=#ordering_co#"><img src="/admin_area/images/button_modify.gif" border=0></a></td>	</td></tr>
</table>
					</td>
