...
<td align="left" valign="top" width="60"><cfif mods.recordcount and mods.tenancy eq 1>___<font size=+1>X</font>__<cfelse>_______</cfif></td>
...
<tr>
<td align="left" valign="top" width="45">&nbsp;</td>
<td align="left" valign="top" width="60"><cfif mods.recordcount and mods.tenancy eq 2>___<font size=+1>X</font>__<cfelse>_______</cfif></td>
...
<tr>
<td align="left" valign="top" width="45">&nbsp;</td>
<td align="left" valign="top" width="60"><cfif mods.recordcount and mods.tenancy eq 3>___<font size=+1>X</font>__<cfelse>_______</cfif></td>
<td align="left" valign="top"><strong>SOLE OWNERSHIP</strong>: 100% title vested in Grantee.</td>
</tr>
<tr>
<td align="left" valign="top" width="45">&nbsp;</td>
<td align="left" valign="top" width="60"><cfif mods.recordcount and mods.tenancy eq 4>___<font size=+1>X</font>__<cfelse>_______</cfif></td>
...
<br>
<cfif Len(mods.bforwarding)><cfoutput>____<u>#mods.bforwarding#</u>______________________</cfoutput><cfelse>________________________</cfif><br>
<br>
Buyer's Email Address:<br>
<br>
<cfif Len(mods.bemail)><cfoutput>____<u>#mods.bemail#</u>______________________</cfoutput><cfelse>________________________</cfif><br>
<br>
Buyer's or Borrower's phone numbers:<br>
<br>
Work: <cfif Len(mods.bworkphone)><cfoutput>____<u>#mods.bworkphone#</u>______________________</cfoutput><cfelseif Len(get_titleid.bwphone1)><cfoutput>____<u>#get_titleid.bwphone1#</u>______________________</cfoutput><cfelse>______________________________</cfif><br>
<br>
Home: <cfif Len(mods.bhomephone)><cfoutput>____<u>#mods.bhomephone#</u>______________________</cfoutput><cfelseif Len(get_titleid.bhphone1)><cfoutput>____<u>#get_titleid.bhphone1#</u>______________________</cfoutput><cfelse>________________________</cfif><br>
<br>
Cell: <cfif Len(mods.bcellphone)><cfoutput>____<u>#mods.bcellphone#</u>______________________</cfoutput><cfelse>________________________</cfif><br>
<br>
