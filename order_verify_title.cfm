...
<cfparam name="form.auto_feed" default="0">
<cfparam name="form.REO_Number" default="">
<cfparam name="form.loanType" default="">
<cfparam name="form.assessed_value" default="">
...
<cfparam name="form.opt_alta_8_1" default="1">
<cfparam name="form.opt_alta_9" default="1">
...
<!--- FOR ROA HUTTON FEED --->
<cfparam name="form.RealEC_TransactionID" default="">
...
<cfparam name="form.prev_purch_amount" default="">
<cfparam name="form.prev_purch_mo" default="">
<cfparam name="form.prev_purch_year" default="">
<cfparam name="form.seller_rep" default="False">
...
<cfparam name="rlo_name" default="">
<cfparam name="ru_name" default="">
<cfparam name="url.title" default=1>
<cfparam name="proptype" default=1>
<cfparam name="form.hud_type" default=0>
<cfparam name="form.LOGSTransactionID" default="">

<cfset hud_type = form.hud_type>
...
<cfset form.prev_purch_amount = ReplaceNoCase(form.prev_purch_amount, " ", "", "ALL")>
<cfset form.prev_purch_amount = ReplaceNoCase(form.prev_purch_amount, ",", "", "ALL")>
<cfset form.prev_purch_amount = ReplaceNoCase(form.prev_purch_amount, "$", "", "ALL")>
...
<CFPARAM NAME="seller_rep" DEFAULT="False">
<cfparam name="form.piggy" default="0">
<cfparam name="form.payoff_needed" default="0">


<cfif IsDefined("url.comp_id") and url.comp_id neq 0 and Len(url.comp_id) neq 0>
<cfset comp_id = url.comp_id>
<cfset RU.comp_id = url.comp_id>
<cfelseif IsDefined("form.comp_id") and form.comp_id neq 0 and Len(form.comp_id) neq 0>
<cfset comp_id = form.comp_id>
<cfset RU.comp_id = form.comp_id>
<cfelseif IsDefined("session.comp_id") and session.comp_id neq 0>
<cfset comp_id = session.comp_id>
<cfset RU.comp_id = session.comp_id>
</cfif>

<cfif form.auto_feed eq 1 OR isDefined("url.comp_id")>
<cfset comp_id = url.comp_id>
<cfset ru.comp_id = url.comp_id>
</cfif>
...
<cfif IsDefined("form.pstate") and (read_company.alta_8_1 eq 1)>
<cfset form.opt_alta_8_1 = 1>
</cfif>
<cfif IsDefined("form.pstate") and (read_company.alta_9 eq 1)>
<cfset form.opt_alta_9 = 1>
</cfif>

<cfif IsDefined("pstate") and (read_company.alta_8_1 eq 1)>
<cfset opt_alta_8_1 = 1>
</cfif>
<cfif IsDefined("pstate") and (read_company.alta_9 eq 1)>
<cfset opt_alta_9 = 1>
</cfif>

<cfcatch type="any">
<cfmail to="rick@jermain.com" from="rjermain@firsttitleservices.com" subject="code failure">
oops...automatically setting the altas didn't work...lines 14 - 19 in order_title_verify.cfm
</cfmail>
</cfcatch>
...
<!--- if there is a duplicate order, send the following errors --->
...
<cfelse>
<!--- ok this is not a duplicate order, safe to proceed --->
...
<CFSET a_insert_time = #TimeFormat(Now(), "HH:mm:ss")#>
<CFSET a_insert_date = #DateFormat(Now(), "mm-dd-yyyy")#>
<CFSET a_day_1 = #DateFormat(Now(), "d")#>
<CFSET a_month_1 = #DateFormat(Now(), "m")#>
...
<cfparam name="rlo.lo_fax" default="">
<cfparam name="rlo.lo_email" default="">
<cfparam name="rlo.lo_name" default="">
<cfparam name="rlo.lo_phone" default="">
<cfparam name="rlo.lo_ext" default="">
<cfparam name="rlo.lo_name" default="">

<cfparam name="ru.lp_fax" default="">
<cfparam name="ru.lp_email" default="">
<cfparam name="ru.lp_name" default="">
<cfparam name="ru.lp_phone" default="">
<cfparam name="ru.lp_ext" default="">
<cfparam name="ru.lp_name" default="">
...
<cfif Len(lo_ext)>
<cfset rlo.lo_ext = lo_ext>
</cfif>

<cfif Len(lp_fax)>
<cfset ru.lp_fax = lp_fax>
</cfif>
<cfif Len(lp_email)>
<cfset ru.lp_email = lp_email>
</cfif>
<cfif Len(lp_name)>
<cfset ru.lp_name = lp_name>
<cfset ru_name = lp_name>
</cfif>
<cfif Len(lp_phone)>
<cfset ru.lp_phone = lp_phone>
</cfif>
<cfif Len(lp_ext)>
<cfset ru.lp_ext = lp_ext>
</cfif>


<CFQUERY datasource="#request.dsn#" NAME="is_streamline">
SELECT * FROM users WHERE ID = #form.user_id_1#
</CFQUERY>
<cfif is_streamline.streamline_emp eq 'True'>
<cfif form.auto_feed eq 1>
<cfset RU.comp_id = url.comp_id>
</cfif>
<CFIF #URL.Title# eq "1">
...
<cfif IsDefined("form.user_id_1") and form.user_id_1 neq 0>
		  <CFQUERY datasource="#request.dsn#" NAME="RU">
		  SELECT * FROM users WHERE ID = #form.user_id_1#
		  </CFQUERY>
		  <cfif RU.recordcount>
		  <CFSET ru_name = #RU.lp_fname# & " " & #RU.lp_lname#>
		  <cfset Ru.lp_phone = RU.lp_phone>
		  <cfset Ru.lp_fax = RU.lp_fax>
		  <cfset Ru.lp_email = RU.lp_email>
		  <cfset Ru.lp_ext = "">
		  </cfif>
</cfif>
<cfif IsDefined("form.lo_id") and form.lo_id neq 0>
		  <CFQUERY datasource="#request.dsn#" NAME="RLO">
		  SELECT * FROM Loan_Officers WHERE ID = #form.lo_id#
		  </CFQUERY>
		  <cfif RLO.recordcount>
		  <CFSET rlo_name = #RLO.lo_fname# & " " & #RLO.lo_lname#>
		  <cfset RLO.lo_phone = RLO.lo_phone>
		  <cfset RLO.lo_fax = RLO.lo_fax>
		  <cfset RLO.lo_email = RLO.lo_email>
		  <cfset RLO.lo_ext = "">
		  </cfif>
</cfif>
<cfif IsDefined("form.RptbyEmail")>
 <cfset RptbyEmail = #form.RptbyEmail#>
</cfif>
<cfif IsDefined("form.verifyemail")>
 <cfset verifyemail = #form.verifyemail#>
</cfif>
<cfif IsDefined("form.verifyemail_2")>
 <cfset verifyemail_2 = #form.verifyemail_2#>
</cfif>
<cfif IsDefined("form.verifyemail_3")>
 <cfset verifyemail_3 = #form.verifyemail_3#>
</cfif>

<cfif IsDefined("form.comp_id") and Len(form.comp_id)>
<cfset ru.comp_id = form.comp_id>
</cfif>
...
<cfif Len(form.RealEC_TransactionID)>
<cfif pstate EQ "MD" OR pstate EQ "VA">
	<cfset newcomp_id = 7402>
<cfelse>
	<cfset newcomp_id = 7393>
</cfif>
<cfelse>
	<cfset newcomp_id = comp_id>
</cfif>
...
update companies set last_order_date = #CreateODBCDate(Now())# where ID = #newcomp_id#
</CFQUERY>


<cftry>
	<cfif searchtype EQ "Purchase" and get_titleid.comp_id neq 9016 and get_titleid.comp_id neq 8307>
		...
		<cfmail to="#lookup_team.email#" cc="sflickinger@firsttitleservices.com" from="webmaster@firsttitleservices.com" subject="New Order Placed">
...
<!--- first we need to set the underwriter so let's create an entry in the table--->
    <CFQUERY datasource="#request.dsn#" >
    INSERT INTO Doc_Title_Insurance_Title(title_id) VALUES(#get_titleid.title_id#)
    </CFQUERY>

<!--- now choose the right underwriter, by state --->
<cfset underwriter_set = 0>

<!--- if it's a streamline client, it automatically goes to First AM --->
<cfif underwriter_set eq 0>
...
where comp_id = #get_titleid.comp_id#
and state = '#get_titleid.pstate#'
</CFQUERY>
...
<!--- if underwriter still not set, let's continue --->
<cfif underwriter_set eq 0>
	<!--- first, check if it's an upload state --->
	<CFQUERY datasource="#request.dsn#" name="check_uw" maxrows="1">
	SELECT    St_ID, Title_Co_id, St_Abbrev, site
	FROM         Title_Companies_States
	WHERE     (Title_Co_id = 19) and st_abbrev = '#get_titleid.pstate#'
	</CFQUERY>

	<cfif check_uw.recordcount eq 1>
		<CFQUERY datasource="#request.dsn#" >
		update Doc_Title_Insurance_Title
		set insurance_co = 19
		where title_id = #get_titleid.title_id#
...
<!--- if underwriter still not set, let's continue --->
<cfif underwriter_set eq 0>
	<!--- next, check if it's a a Stewart-served state --->
	<CFQUERY datasource="#request.dsn#" name="check_uw" maxrows="1">
	SELECT    St_ID, Title_Co_id, St_Abbrev, site
	FROM         Title_Companies_States
	WHERE     (Title_Co_id = 16) and st_abbrev = '#get_titleid.pstate#'
	</CFQUERY>
...
<!--- if underwriter still not set, let's continue --->
<cfif underwriter_set eq 0>
	<!--- finally, check if it's a a First-Am-served state --->
	<CFQUERY datasource="#request.dsn#" name="check_uw" maxrows="1">
	SELECT    St_ID, Title_Co_id, St_Abbrev, site
	FROM         Title_Companies_States
	WHERE     (Title_Co_id = 25) and st_abbrev = '#get_titleid.pstate#'
	</CFQUERY>
...
<!--- if underwriter still not set, wow...who knows...let's set it to Stewart and hope for the best :) --->
<cfif underwriter_set eq 0>
	<!--- finally, check if it's a a First-Am-served state --->
		<CFQUERY datasource="#request.dsn#" >
		update Doc_Title_Insurance_Title
...
<!--- let's see if this client has applicable Bulk Rates, and apply them --->
<cfif get_titleid.loanamt_float LTE 1500000>
...
<!--- check if client is activated have bulk rates in this state, and in this tier --->
	<cfif get_titleid.loanamt_float LTE 1500000>
				<cfif get_titleid.loanamt_float GTE 1250001>
				<cfset this_tier = 'tier_1500000'>
				<cfelseif get_titleid.loanamt_float GTE 1000001>
				<cfset this_tier = 'tier_1250000'>
				<cfelseif get_titleid.loanamt_float GTE 750001>
				<cfset this_tier = 'tier_1000000'>
				<cfelseif get_titleid.loanamt_float GTE 500001>
				<cfset this_tier = 'tier_750000'>
				<cfelseif get_titleid.loanamt_float GTE 250001>
				<cfset this_tier = 'tier_500000'>
				<cfelseif get_titleid.loanamt_float GTE 175001>
				<cfset this_tier = 'tier_250000'>
				<cfelseif get_titleid.loanamt_float GTE 100001>
		...
		where comp_id = #get_titleid.comp_id#
		and #this_tier# = 'True'
		and (state = '#get_titleid.pstate#' or state = 'All')
		</CFQUERY>
...
<!--- end let's check Bulk Rates --->





<!--- now we know the underwriter, we can safely update the fees --->
...
<cftry>
<cfset temp = #routingSys.CheckForRouting(get_titleid.title_id, 'T', 'File_Ordered')#>
<cfcatch type="any">
</cfcatch>
</cftry>


<cfhttp url="http://machine1.firsttitleservices.com/disclosures/disclosure/index.cfm?rec_id=#get_titleid.title_id#&mode=pdf&type=buyer" method="get" resolveURL="true">
</cfhttp>
<cfhttp url="http://machine1.firsttitleservices.com/disclosures/disclosure/index.cfm?rec_id=#get_titleid.title_id#&mode=pdf&type=buyer" method="get" resolveURL="true">
</cfhttp>

<!--- this part creates the HUD and reads it back into a PDF --->
<cfhttp url="http://machine1.firsttitleservices.com/HUD1_2010_PDF.cfm?rec_id=#get_titleid.title_id#" method="get" resolveURL="true">
</cfhttp>
        <cfdocument format="PDF" pagetype="custom" pageheight="14" pagewidth="8.5" margintop=".25" marginbottom=".25" marginleft=".25" marginright=".25" filename="c:\huds\HUD_#get_titleid.title_id#.pdf" overwrite="yes"> <cfoutput>#cfhttp.filecontent#</cfoutput> </cfdocument>
...
<cffile action="write" addnewline="yes" file="c:\uploads\Upload_#get_titleid.title_id#.pdf" output="#temp2#" nameconflict="overwrite">

<cfset temp2 = BinaryDecode(MyXml.request.ORDER_INFO.TITLE_REQUEST.ATTACHMENT.XmlText, 'Base64')>
<cffile action="write" addnewline="yes" file="c:\uploads\Upload_RICK_TESTING_X.pdf" output="#temp2#" nameconflict="overwrite">
...
<!--- if you change this, also change admin_area/title_abstract_doc_view.cfm and admin_area/title_commitment.cfm --->
  ...
  <cfif getcompany.team_id eq 70>
    <CFSET b_emails_to_first_title = b_emails_to_first_title & ";arobinson@firsttitleservices.com;hrippy@firsttitleservices.com">
  </cfif>

<!--- if this is an outside sales salesperson, send them an email --->
  <CFQUERY datasource="#request.dsn#" NAME="lookup_sales">
  SELECT * FROM first_admin  WHERE ID = #getcompany.intsales#
  </CFQUERY>

<cfif lookup_sales.role_id eq '24'>
  <CFSET b_emails_to_first_title = b_emails_to_first_title & ";" & #lookup_sales.email#>
</cfif>

<cfif lookup_sales.id eq '408' or lookup_sales.va_employee eq 'True'>
  <CFSET b_emails_to_first_title = b_emails_to_first_title & ";" & "lshields@firsttitleservices.com">
</cfif>
        ...
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            ...
            <tr>
              ...
              <td width=100 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Social Sec. No.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>*****#Right(bssn1, 4)#</b></td>
            ...
            <tr>
              ...
              <td width=100 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Social Sec. No.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>*****#Right(bssn2, 4)#</b></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Home Ph.<br>
      ...
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            ...
            <tr>
              ...
              <td width=100 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Social Sec. No.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>*****#Right(sssn1, 4)#</b></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Home Ph.<br>
            ...
            <tr>
              ...
              <td width=100 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Social Sec. No.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>*****#Right(sssn2, 4)#</b></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Home Ph.<br>
...
</cfif> <!--- this one closes "cfif update_order eq 0 and recalculate_hud eq 0" on 1020 --->

<cfif #a_COMMENT# NEQ "">
<CFQUERY DATASOURCE="#request.dsn#">
						INSERT INTO Title_Notes(FName, LName, Order_ID, N_Note, N_Date, N_Time, note_type)
						VALUES('Web', 'System', #get_titleid.Title_ID#, 'Comment from order: #a_COMMENT#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T')
					</CFQUERY>
</cfif>
...
<cfquery name="addFile" datasource="#request.dsn#">
	INSERT INTO upload_many (title_id, fileDate, filetime, fileupload)
			VALUES('#get_titleid.Title_ID#', '#a_insert_date#', '#a_insert_time#', '#new_file_name#')
</cfquery>
<CFQUERY DATASOURCE="#request.dsn#">
						INSERT INTO Title_Notes(FName, LName, Order_ID, N_Note, N_Date, N_Time, note_type)
						VALUES('Web', 'System', #get_titleid.Title_ID#, 'Borrower Authorization Uploaded to Misc Docs: #new_file_name#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T')
					</CFQUERY>
...
<!--- comment out all of this once automation is turned on --->
<cfif get_titleid.comp_ID neq 8258>
...
SELECT ID, username, role_id, fname, lname,role_mgr FROM First_Admin WHERE (role_id = 17) and (id = 277)
</CFQUERY>
...
<!--- END comment out all of this once automation is turned on --->
...
<cfif (#get_titleid.comp_id# neq "115") OR (#get_titleid.comp_id# neq "621")>
  <cfif #insert_user.cc_email_1# neq "" and #insert_user.cc_email_2# neq "">
		...
		<cfmail  TO="#to_addr#;#cc_email#"
			...
			TIMEOUT="600"
			type="HTML">
<cfif get_titleid.comp_id neq 3889 and get_titleid.comp_id neq 11739>
<cfmailparam
					  ...
					  <tr>
						<td width=770 align=center valign=top bgcolor=elelel><!---  <img src="./images/label_title.gif">  --->
						  ...
						  <p>
							...
							<cfif get_titleid.comp_id neq 3889 and get_titleid.comp_id neq 11739>
			<center>
							 A HUD-1 has been instantly prepared for you and is attached to this email! OR view<a href="https://#cgi.server_name#/fee_sheet.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>closing fees</b></a>.
...
<CFMAIL
TO="#to_addr#;#cc_email#"
cc="rjermain@firsttitleservices.com"
FROM="#get_team_info.email#"
SERVER="127.0.0.1"
Subject="Copy of Customer Order with #title_co_name# #get_titleid.title_id#-#get_titleid.bfirstname1# #get_titleid.blastname1#, Loan Number - #get_titleid.loan_number#"
TIMEOUT="600"
...
<cfif get_titleid.comp_id neq 3889 and get_titleid.comp_id neq 11739 and read_company.company does not contain 'Prime Lending'>
<cfmailparam
          ...
          <tr>
            <td width=770 align=center valign=top bgcolor=elelel><!---  <img src="./images/label_title.gif">  --->
              ...
              <p>
                ...
                <cfif get_titleid.comp_id neq 3889 and get_titleid.comp_id neq 11739>
<center>
                  A Closing Disclosure has been instantly prepared for you and is a ttached to this email! OR view<a href="https://#cgi.server_name#/fee_sheet.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>closing fees</b></a>.
                </center></cfif>
                <br>
                <br></TD>
          </tr>
        ...
        <TBODY>
          <tr>
            <td width=770 align=center valign=top bgcolor=elelel><!---  <img src="./images/label_title.gif">  --->
              ...
              <p>
                <center>
                  Your Title Commitment Request Order has been Processed. Order number is<a href="https://#ReplaceNoCase(cgi.server_name, 'www', 'machine1', 'ALL')#/view_the_order.cfm?emp=#emp#&comp_id=#comp_id#&order_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>T-#get_titleid.title_id#</b></a>
                </center>
                <br>
                <cfif get_titleid.comp_id neq 3889 and get_titleid.comp_id neq 11739>
<center>
...
<cfinclude template="rick_tests/update_hud_fee_calc_2010.cfm">
<cfhttp url="https://machine1.firsttitleservices.com/HUD1_2010_PDF.cfm?rec_id=#get_titleid.title_id#" method="get" resolveURL="true">
</cfhttp>
        <cfdocument format="PDF" pagetype="custom" pageheight="14" pagewidth="8.5" margintop=".25" marginbottom=".25" marginleft=".25" marginright=".25" filename="c:\huds\HUD_#get_titleid.title_id#.pdf" overwrite="yes"> <cfoutput>#cfhttp.filecontent#</cfoutput> </cfdocument>
        ...
        <!--- <cfif read_company.company contains "Encompass Test">
		  <cfinclude template="encompass_testing/calculator_xml.cfm">
        <cfelse>
...
<cfhttp url="https://machine1.firsttitleservices.com/HUD1_2010_PDF.cfm?rec_id=#get_titleid.title_id#" method="get" resolveURL="true">
        ...
        <!--- <cffile action="READBINARY" file="c:\huds\HUD_#get_titleid.title_id#.pdf" variable="pdf">
