<!--- AL, FL, GA, KS, MN, NY, OK, TN, VA --->

<cfparam name="url.estimated_loan" default="">

<cfif IsDefined("url.LOANAMT_FLOAT") and url.LOANAMT_FLOAT neq "">
<cfset url.LNMT = url.LOANAMT_FLOAT>
</cfif>
<cfif IsDefined("url.ESTIMATED_LOAN") and url.ESTIMATED_LOAN neq "">
<cfset FORM.existing_loan = url.ESTIMATED_LOAN>
</cfif>
<cffunction name="GetMortStamps">
<cfif #searchtype# eq "Purchase">
	<cfif pstate eq "MD">
	<!--- for Maryland Purchases, if the Loan Amount (loanamt_float) is greater than the purchase price (loanamt_float4), then Mortgage Stamps are calculated based on the difference between the Loan Amount and Purchase price. If Purchase Price is greater than Loan Amount, No Mortgage Stamps --->
	<cfif isDefined("url.LOANAMT_FLOAT")>
	<cfset url.LNMT = url.LOANAMT_FLOAT>
	</cfif>
	<cfif isDefined("url.LOANAMT_FLOAT4")>
	<cfset url.LNMT4 = url.LOANAMT_FLOAT4>
	</cfif>
		<cfif url.LNMT gt url.LNMT4>
			<cfset city_mort_stamps = read_rec_fees.mort_stamps * (url.LNMT - LNMT4)>
		<cfelse>
			<cfset city_mort_stamps = 0>
		</cfif>
	<cfelse>
	<cfif isDefined("url.LOANAMT_FLOAT")><cfset url.LNMT = url.LOANAMT_FLOAT></cfif>
		<CFSET city_mort_stamps = #round(url.LNMT)# * #read_rec_fees.mort_stamps#>
	</cfif>
...
<cfif (#pstate# EQ "MD")>
<!--- If this is not a purchase (it's a refi or a 2nd) and the Porperty Use Type is Primary Residence, Mortgage Stamps are based on the loan amount (loanamt_float) minus the existing loan (orig_loan_amt), otherwise, use the regular calculation --->
	<cfif form.property_use eq '1'>
		<cfset city_mort_stamps=#NumberFormat(ROUND((url.LNMT-form.estimated_loan)*read_rec_fees.mort_stamps),'_____.__')#>
	<cfelse>
	<cfif isDefined("url.LOANAMT_FLOAT")><cfset url.LNMT = url.LOANAMT_FLOAT></cfif>
		<cfset city_mort_stamps=#NumberFormat(ROUND((url.LNMT)*read_rec_fees.mort_stamps),'_____.__')#>
	</cfif>
...
<cfelseif pstate eq "NY">
	...
	<CFSET city_mort_stamps = #round(url.LNMT-form.existing_loan)# * #percent_calc#>
<cfelse>
<cfif isDefined("url.LOANAMT_FLOAT")><cfset url.LNMT = url.LOANAMT_FLOAT></cfif>
	<CFSET city_mort_stamps = #round(url.LNMT)# * #read_rec_fees.mort_stamps#>
...
<cfset state_deed_1 = "0">
	...
	<!--- NJ Transfer Tax --->
		<cfif pstate eq "NJ">
		<cfset state_deed_1 = 0>
		  <cfif loanamt_float LT 350000>
			<cfif loanamt_float GT 150000>
			  <cfset state_deed_1 = 150000 * 0.004>
			<cfelse>
			  <cfset state_deed_1 = loanamt_float * 0.004>
			</cfif>

			<cfif loanamt_float GT 200000>
			  <cfset state_deed_1 = state_deed_1 + (50000 * 0.0067)>
			  <cfset state_deed_1 = state_deed_1 + ((loanamt_float - 200000) * 0.0078)>
			<cfelse>
			  <cfset state_deed_1 = state_deed_1 + ((loanamt_float - 150000) * 0.0067)>
			</cfif>
		  ...
		  <cfelse>
			<cfset state_deed_1 = loanamt_float * 0.0058>
		  </cfif>

		  <cfif loanamt_float GT 200000>
			<cfset state_deed_1 = state_deed_1 + (50000 * 0.0085)>
		  <cfelse>
			<cfset state_deed_1 = state_deed_1 + ((loanamt_float - 150000) * 0.0085)>
		  </cfif>

		  <cfif loanamt_float GT 550000>
			<cfset state_deed_1 = state_deed_1 + (250000 * 0.0096)>
		  <cfelse>
			<cfset state_deed_1 = state_deed_1 + ((loanamt_float - 2000000) * 0.0096)>
		  </cfif>

		  <cfif loanamt_float GT 850000>
			<cfset state_deed_1 = state_deed_1 + (300000 * 0.0106)>
		  <cfelse>
			<cfset state_deed_1 = state_deed_1 + ((loanamt_float - 550000) * 0.0106)>
		  </cfif>

		  <cfif loanamt_float GT 1000000>
			<cfset state_deed_1 = state_deed_1 + (150000 * 0.0116)>
			<cfset state_deed_1 = state_deed_1 + ((loanamt_float - 850000) * 0.0121)>
		  <cfelse>
			<cfset state_deed_1 = state_deed_1 + ((loanamt_float - 850000) * 0.0116)>
		  </cfif>
		  </cfif>
		  <cfif loanamt_float GT 1000000>
			<cfset state_deed_1 = state_deed_1 + (loanamt_float * 0.01)>
		</cfif>
		</cfif>
	<!--- END NJ Transfer Tax --->
	...
	<!--- HI Transfer Tax --->
		<cfif pstate eq "HI">
		<cfset state_deed_1 = 0>
		  <cfif loanamt_float LT 600000>
			<cfset state_deed_1 = loanamt_float * 0.0015>
		  <cfelseif loanamt_float LT 1000000>
			<cfset state_deed_1 = loanamt_float * 0.0025>
		  <cfelse>
			<cfset state_deed_1 = loanamt_float * 0.0035>
		  </cfif>
		</cfif>
	<!--- END HI Transfer Tax --->
	...
	<!--- DC Transfer Tax --->
		<cfif pstate eq "DC">
		<cfset state_deed_1 = 0>
		  <cfif loanamt_float LT 400000>
			<cfset state_deed_1 = loanamt_float * 0.022>
		  <cfelse>
			<cfset state_deed_1 = loanamt_float * 0.029>
		  </cfif>
		</cfif>
	<!--- END DC Transfer Tax --->
	...
	<!--- VT Transfer Tax --->
		...
		<cfset state_deed_1 = 0>
		  <cfif loanamt_float GT 100000>
			<cfset state_deed_1 = 100000 * 0.005>
			<cfset state_deed_1 = state_deed_1 + ((loanamt_float-100000) * 0.0125)>
		  <cfelse>
			<cfset state_deed_1 = loanamt_float * 0.005>
		  </cfif>
		</cfif>
	<!--- END VT Transfer Tax --->
	...
	<!--- CT Transfer Tax --->
		<cfif pstate eq "CT">
		<cfset state_deed_1 = 0>
		  <cfif loanamt_float GT 800000>
			<cfset state_deed_1 = 800000 * 0.0075>
			<cfset state_deed_1 = loanamt_float-800000 * 0.0125>
		  <cfelse>
			<cfset state_deed_1 = loanamt_float * 0.0075>
		  </cfif>
		</cfif>
	<!--- END CT Transfer Tax --->
	...
	<!--- NY Transfer Tax --->
		<cfif pstate eq "NY">
		   <cfif #url.PCNT# eq "Bronx" or #url.PCNT# eq "Kings" or #url.PCNT# eq "New York" or #url.PCNT# eq "Queens" or #url.PCNT# eq "Richmond">
				<cfif loanamt_float GT 1000000>
				   <cfset state_deed_1 = (loanamt_float) * 0.01825>
					  <cfelseif loanamt_float GTE 500000>
						<cfset state_deed_1 = (loanamt_float) * 0.01825>
					  <cfelse>
						 <cfset state_deed_1 = (loanamt_float) * 0.014>
					  </cfif>
				 </cfif>
		<cfif loanamt_float GT 1000000>
			<cfset state_deed_1 = state_deed_1 + (loanamt_float * 0.01)>
...
<cfif url.estimated_loan eq "">
<cfset url.estimated_loan = 0>
</cfif>
...
<cffunction name="get_state_deed">
	<cfargument name="current_state_deed" default="#state_deed_1#">
...
<cfset split_states_list = "AR,DC,DE,ME,NH,PA,MD">
<cfset temp = "">
...
<tr>
                    ...
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=blue face=arial> #NumberFormat(current_state_deed, '_____.__')# (Seller)</td>
                  </tr>
...
<tr>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=black face=arial> 1203. <img src='./images/info-01.gif' ALT='State Deed'> State Deed </td>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=blue face=arial> #NumberFormat(current_state_deed, '_____.__')#</td>
                  </tr>
...
<tr>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=black face=arial> 1203. <img src='./images/info-01.gif' ALT='State Deed'> State Deed </td>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=blue face=arial> #NumberFormat((current_state_deed / 2), '_____.__')#</td>
                  </tr>
<tr>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=black face=arial> 1203. <img src='./images/info-01.gif' ALT='State Deed'> State Deed </td>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=blue face=arial> #NumberFormat((current_state_deed / 2), '_____.__')# (Seller)</td>
                  </tr>
<cfelse>
  <cfif arguments.current_state eq 'HI'>
<tr>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=black face=arial> 1203. <img src='./images/info-01.gif' ALT='State Deed'> State Deed </td>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=blue face=arial> #NumberFormat((current_state_deed * .60), '_____.__')# (Seller)</td>
                  </tr>
<tr>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=black face=arial> 1203. <img src='./images/info-01.gif' ALT='State Deed'> State Deed </td>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=blue face=arial> #NumberFormat((current_state_deed * .40), '_____.__')#</td>
                  </tr>
...
<tr>
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=black face=arial> 1203. <img src='./images/info-01.gif' ALT='State Deed'> Mansion Tax </td>
...
<CFPARAM NAME="FORM.loanamt_float4"    DEFAULT="0">
...
if (((document.frm.pstate.value == "CA")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "MI")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "AL")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "FL")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "GA")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "KS")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "MN")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "NY")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "OK")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "TN")&&(document.frm.SearchType.value == "Purchase") || (document.frm.pstate.value == "VA")&&(document.frm.SearchType.value == "Purchase")  || (document.frm.pstate.value == "MD")&&(document.frm.SearchType.value == "Purchase")) || (current_comp_id == 729 && (document.frm.pstate.value == "AZ")&&(document.frm.SearchType.value == "Purchase"))) {
        ...
        <cfif (#FORM.pstate# NEQ "CA") and (#FORM.pstate# NEQ "AL") and (#FORM.pstate# NEQ "NE") and (#FORM.pstate# NEQ "CO") and (#FORM.pstate# NEQ "GA") and (#FORM.pstate# NEQ "MI") and (#FORM.pstate# NEQ "NY") and (#FORM.pstate# NEQ "TN") and (#FORM.pstate# NEQ "AZ") and (#FORM.pstate# NEQ "WA")>
          <CFIF #pstate# EQ "AR">
            ...
            <CFELSEIF #pstate# EQ "MT">
						 <CFIF (#read_company.id# eq 729 or #read_company.id# eq 2632) >
...
<!--- figure out Kentucky Premium Taxes --->
<!--- <CFIF (#pstate# eq "KY")>
          ...
          <CFOUTPUT>
		    ...
		    <CFIF IsDefined("read_rec_fees.mort_stamps")>
			   <cfif #searchtype# eq "Purchase">
			     <cfif ListFindNoCase(states_mort_stamps_loan, pstate, ",")>
				   <CFSET city_mort_stamps = #round(loanamt_float4-estimated_loan)# * #read_rec_fees.mort_stamps#>
				 <cfelse>
			...
			<CFELSEIF #read_rec_fees2.recordcount# gt "1">
              ...
              <CFIF #read_rec_fees.intangible_tax# NEQ "0" and  #read_rec_fees.intangible_tax# NEQ "">
                <cfif #searchtype# eq "Purchase">
			     <cfif ListFindNoCase(states_mort_stamps_loan, pstate, ",")>
				   <CFSET intang_tax = #round(loanamt_float4)# * #read_rec_fees.intangible_tax#>
				 <cfelse>
...
<cfset temp = StateDeedCalc()>
<cfif #state_deed_1# neq "0">
<cfset get_state_deed(#state_deed_1#, #this_state#)>
</cfif>
              ...
              <table width=500 cellpadding=0 cellspacing=0 border=1 bgcolor=e3e3e3>
                ...
                <cfif #read_this_sets_billing_values.a_1101b# neq "" OR #FORM.pstate# EQ "OR" OR #FORM.pstate# EQ "NV">
                  <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=black face=arial> 1101. <img src="./images/info-01.gif" ALT="Settlement or Closing Fee"> Settlement or Closing Fee </td>
                    ...
                    <td width=250 align=left valign=top bgcolor=e6e6e6><font size=2 color=blue face=arial>
                      <cfif #FORM.pstate# EQ "OR" OR #FORM.pstate# EQ "NV" and (#read_company.id# eq 729 or #read_company.id# eq 2632 or #read_company.master_co_id# eq 2632)>
                        <cfif #read_ins_calc.escrow# EQ "">
      ...
      <CFOUTPUT>
        ...
        <CFIF #read_rec_fees.recordcount# gt "0">
          <CFIF #read_rec_fees.mort_stamps# NEQ "0">
                <cfif #searchtype# eq "Purchase">
			     <cfif ListFindNoCase(states_mort_stamps_loan, pstate, ",")>
				   <CFSET city_mort_stamps = #round(loanamt_float4)# * #read_rec_fees.mort_stamps#>
				 <cfelse>
...
<cfinclude template="state_deed_calc_insert.cfm">
