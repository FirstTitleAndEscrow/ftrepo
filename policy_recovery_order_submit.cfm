...
<FONT FACE=ARIAL SIZE=2 color="red">
	<br><br>
<center><B>OUR RECORDS INDICATE THAT YOU HAVE RECENTLY ORDERED POLICY RECOVERY WITH US!
...
<CFQUERY datasource="#request.dsn#" NAME="get_prid">
	SELECT *
	FROM Policy_Recovery
...
<CFQUERY DATASOURCE="#request.dsn#">
						...
						VALUES('Web', 'System', #get_prid.PR_ID#, 'Comment from order: #a_COMMENT#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'PR')
					</CFQUERY>
</cfif>
...
<CFSET b_emails_to_first_title = "UWMdocs@firsttitleservices.com">
...
<CFQUERY datasource="#request.dsn#" NAME="get_sales_email">
 ...
 <cfset b_emails_to_first_title = b_emails_to_first_title & "; " & read_prop_company.email>
				...
				SERVER="127.0.0.1"
				Subject="Summary of Policy Recovery order PR-#get_prid.pr_id#-#get_prid.bfirstname1# #get_prid.blastname1#--#read_prop_company.company#"
				TIMEOUT="600"
				type="HTML"
				>
...
<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	...
	<tr>
		<td width=519 align=left valign=top bgcolor=d3d3d3>
			<FONT FACE=ARIAL SIZE=2 color="black">
			<CENTER><B> Order PR-#get_prid.pr_id#</B></CENTER>
		</TD>
	</TR>
	<tr>
		<td width=519 align=left valign=top bgcolor=d3d3d3>
...
<cfif (#get_prid.comp_id# neq "115") OR (#get_prid.comp_id# neq "621")>
	<cfif #read_user.cc_email_1# neq "" and #read_user.cc_email_2# neq "">

<CFMAIL
TO="#get_prid.verifyemail#,#insert_user.cc_email_1#,#insert_user.cc_email_2#"
FROM="webmaster@firsttitleservices.com"
SERVER="127.0.0.1"
Subject="Copy of Customer Order with 1st Title & Escrow, Inc. PR-#get_prid.pr_id#-#get_prid.bfirstname1# #get_prid.blastname1#"
TIMEOUT="600"
type="HTML"
>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Policy Recovery Order has been Processed. Order number is <a href="https://#cgi.server_name#/view_the_pr_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_prid.pr_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>PR-#get_prid.pr_id#</b></a></center><br>
...
<CFMAIL
	TO="#get_prid.verifyemail#,#insert_user.cc_email_1#"
	FROM="webmaster@firsttitleservices.com"
	SERVER="127.0.0.1"
	Subject="Copy of Customer Order with 1st Title & Escrow, Inc. PR-#get_prid.pr_id#-#get_prid.bfirstname1# #get_prid.blastname1#"
	TIMEOUT="600"
...
<CFMAIL
 TO="#get_prid.verifyemail#,#insert_user.cc_email_2#"
FROM="webmaster@firsttitleservices.com"
SERVER="127.0.0.1"
Subject="Copy of Customer Order with 1st Title & Escrow, Inc. PR-#get_prid.pr_id#-#get_prid.bfirstname1# #get_prid.blastname1#"
TIMEOUT="600"
...
<cfelseif LEN(get_prid.verifyemail)>

<CFMAIL
TO="#get_prid.verifyemail#"
FROM="webmaster@firsttitleservices.com"
SERVER="127.0.0.1"
Subject="Copy of Customer Order with 1st Title & Escrow, Inc. PR-#get_prid.pr_id#-#get_prid.bfirstname1# #get_prid.blastname1#"
TIMEOUT="600"
...
<CFLOCATION URL="./order_pr_verify_display.cfm?emp=#emp#&comp_id=#comp_id#&pr_id=#get_prid.pr_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#">
