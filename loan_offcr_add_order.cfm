...
<CFOUTPUT>
	...
	<CFFORM METHOD=POST ACTION="./loan_offcr_add_submit_order.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&emp=#emp#&ordering_co=#ordering_co#&page=#page#">
...
<!--- ===/ LOAN PROCESSOR INFO \=== --->
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor="e6e6e6">
			<CFINPUT Required="Yes" Message="You must enter an Officer's FIRST NAME" type=text name="lo_fname"  size=20 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor="e6e6e6">
			<CFINPUT  Required="Yes" Message="You must enter an Officer's LAST NAME" type=text name="lo_lname"  size=20 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
    ...
    <!---Switch = 1 means that this company is utilizing Companies_User--->
    <CFIF #read_company.Companies_Switch# eq "1">
        <tr>
		    <td width=130 align=right valign=top bgcolor="e6e6e6">
			    <font size=2 color=black face=arial>
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor="e6e6e6">
			<CFINPUT  Required="Yes" Message="You must enter an Officer's EMAIL ADDRESS" type=text name="lo_email"  size=30 maxlength=160
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor="e6e6e6">
			<CFINPUT  Required="Yes" Message="You must enter an Officer's PHONE NUMBER" type=text name="lo_phone"  size=23 maxlength=15
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
        ...
        <tr>
            ...
            <td width=300 align=left valign=top bgcolor="e6e6e6">
                ...
                <input type=Radio Name = "Administrator" Value = "0" Checked >No
            </TD>
        </tr>
    </CFIF>
