...
location.href='vendor_performance_report.cfm?uid=<cfoutput>#url.uid#</cfoutput>&al=<cfoutput>#url.al#</cfoutput>&a_trigger=10&foo=' + frm.state.value;
}
...
location.href='vendor_performance_report.cfm?uid=<cfoutput>#url.uid#</cfoutput>&al=<cfoutput>#url.al#</cfoutput>&a_trigger=11&foo=' + frm.state.value + '&coo=' + frm.county.value;
}
...
<cfFORM name = "frm"  ACTION="./vendor_performance_report_result.cfm?uid=#URL.uid#&al=#URL.al#&a_trigger=1" METHOD=POST>
...
<tr>
		...
		order by company
			...
			<!--- AND UPPER(a.ct_name) = UPPER('#read_state.ct_name#') AND a.abstractor_id = b.abstractor_id --->
					<tr>
...
<td bgcolor=d3d3d3 width="100%" align=center valign=top>
				...
				Select Abstractor   <select name="vendor">
							<option value="">N/A</option>
...
<td bgcolor=d3d3d3 width="100%" align=center valign=top>
				...
				Select Abstractor   <select name="vendor">
							<option value="">N/A</option>
					<cfoutput query="read_vendor_list"><option value="#abstractor_ID#">#COMPANY#</option></cfoutput>
