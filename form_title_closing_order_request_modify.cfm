...
alert("The date for the closing schedule should be a future date")
...
<CFFORM NAME="frm" ACTION="./form_title_closing_order_request_update.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=2" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
<CFOUTPUT>
...
<cfINPUT TYPE="Text" NAME="input_date" size=12 maxlength=20
								...
								style="font-size: 9;
									...
									border-style: bar;
									clear: none;" >
							</CFOUTPUT>		Click <cfoutput><A href="javascript:ShowCalendar(document.all('calpic'),document.all('input_date'),document.all('null'),'01/1/2002', '12/31/2009')" onClick="event.cancelBubble=true;"><img src="https://#cgi.server_name#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic" style="POSITION: relative"></A></cfoutput> to change date.
	<CFOUTPUT>
<!---
