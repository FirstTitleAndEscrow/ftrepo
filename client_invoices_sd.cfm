...
<CFQUERY datasource="#request.dsn#" NAME="getorders">
	...
	where (comp_id = 9506
	OR comp_id IN (select ID from companies where master_co_id = 9506)
...
<cfif excel NEQ 1>
<cfoutput>
<form action="client_invoices_sd.cfm" method="post">
...
<tr>
	...
	<td style="background-color:#d4d4d4">S&D Number</td>
	<!---
...
<cfoutput query="getOrders" group="prop_id">
	...
	<tr>
		...
		<cfset totalPrice =0>
	<!---	
	<cfif listFind("18145,18147,18169,18222,18223",prop_id)>
		<cfset getorders.product_ordered[currentrow] = "full_search">
	</cfif>
	--->
	<cfif product_ordered EQ "full_search">
		<cfif pstate EQ "PA">
