...
<input type="text" class="text" name="G_PROPERTYSTREET" /> <br />
<input type="text" class="text" name="G_PROPERTYSTREET2" /> <br />
<input type="text" class="text" name="G_PROPERTYCOUNTY" /> <br />
<input type="text" class="text" name="G_PROPERTYCITY" /> <br />
<input type="text" class="text" name="G_PROPERTYSTATE" /> <br />
<input type="text" class="text" name="G_PROPERTYZIP" />
</td>
...
<tr>
<td class="bsilver">1204. State Recordation Tax &nbsp; &nbsp; &nbsp;
Deed $<input type="text" class="text" name="A_1204_STATERECTAXDEED"/>
Mortgage $<input type="text" class="text" name="A_1204_STATERECTAXMORTGAGE"/></td>
<td class="bordered"><input type="text" class="text" name="A_1204_BORROWER_STATERECTAX"/></td>
<td class="bordered"><input type="text" class="text" name="A_1204_SELLER_STATERECTAX"/></td>
</tr>
<tr>
<td class="bsilver">1205. State transfer tax &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
...
<tr>
<td class="bsilver">1206. County transfer tax &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
Deed $<input type="text" class="text" name="A_1206_COUNTYTRANSTAXDEED"/>
Mortgage $<input type="text" class="text" name="A_1206_COUNTYTRANSTAXMORTGAGE"/></td>
<td class="bordered"><input type="text" class="text" name="A_1206_BORROWER_COUNTYTRANSTAX"/></td>
<td class="bordered"><input type="text" class="text" name="A_1206_SELLER_COUNTYTRANSTAX"/></td>
</tr>
<tr>
<td class="bsilver">1207. <input type="text" class="userout" name="A_1207_USERDESC"/>
Deed $<input type="text" class="userout" name="A_1207_USERDEED"/>
Mortgage $<input type="text" class="userout" name="A_1207_USERMORTGAGE"/></td>
...
<td class="bordered" style="text-align:left;">
<input type="radio"  name="TERMS_05_CANITERESTRISE" value="NO" checked> No.
<input type="radio"  name="TERMS_05_CANITERESTRISE" value="YES" checked> Yes, it can rise to a
...
<td class="bordered" style="text-align:left;">
<input type="radio"  name="TERMS_10_TOTALWESCRO" value="NO"> You do not have a monthly escrow payment for items, such as property taxes and homeowner's insurance. You must pay these items directly yourself.
<br /> <input type="radio"  name="TERMS_10_TOTALWESCRO" value="YES" CHECKED> You have an additional monthly escrow
