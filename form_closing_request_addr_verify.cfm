...
<!--- ===/ to ensure it is accurate      \=== --->
	...
	<CFFORM NAME="frm" ACTION="./form_closing_request_addr_verify.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_trigger=1&zip_id=0" METHOD=POST>
...
<table width=607 border="0" cellpadding="0" cellspacing="0" background="./images/back_02.gif">
	...
	<tr>
		<td width=607 align=center valign=top>
				<img src="./images/label_property.gif">
				<p>
	<CFFORM NAME="frm" ACTION="./form_closing_request_addr_verify.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_trigger=2&pstate=#pstate#&pcity=#pcity#" METHOD=POST>
				<table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
...
<CFOUTPUT>
					<tr>
						<td width=205  bgcolor="f1f1f1" align=right>
							<a href="./form_closing_request_addr.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_trigger=1&pcity1=#pcity#&pstate1=#pstate#"><img border=0 src="./images/button_go_back.gif"></a>
						</td>
						<td width=314  bgcolor="f1f1f1" align=left>
							<a href="./form_title_closing_order_request.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_trigger=1&pcity=#pcity#&pstate=#pstate#&zip_id=#read_zip_code.zip_id#"><img border=0 src="./images/button_continue.gif"></a>
