...
<table>
<tr>
<td align="right" width="405"><img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_logo.jpg"></td>
<td width="40">&nbsp;</td>
...
<cfif len(read_Title_Data.addreq) GT 650>
<cfset extra_text = Mid(read_Title_Data.addreq, 650, Len(read_Title_Data.addreq))>
<cfset stop_number = FindNoCase(" ", read_Title_Data.addreq, 650)>

<cfset stop_number = stop_number -1 >
<cfset addreq_text_1 = Mid(read_Title_Data.addreq, 1, stop_number)>
<cfset addreq_text_2 = Mid(read_Title_Data.addreq, stop_number + 1, Len(read_Title_Data.addreq))>
<cfelse>
<cfset addreq_text_1 = read_Title_Data.addreq>
</cfif>
...
<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td><cfoutput>#auto_number#</cfoutput>.</td>
		    <td>
              <cfoutput>#addreq_text_1#</cfoutput>
		</td>
	</tr>
</cfif>
...
<cfif IsDefined("addreq_text_2") and Len(addreq_text_2)>
...
<table width="93%" cellpadding=0 cellspacing=0 border=0 >
    ...
    <tr>
		...
		<td><cfoutput>#addreq_text_2#</cfoutput></td>
	</tr>
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
...
<cfparam name = "auto_number" default="8">
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
    <tr>
...
#text_1#
        ...
        <cfif FindNoCase("construction",read_title.searchtype) OR 1 EQ 1>
				<tr><td colspan="2">
				<p><b>
