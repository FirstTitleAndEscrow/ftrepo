...
<cffunction name="FixDecimals" >
	...
	<cfif IsNumeric(arguments.input_num) and arguments.input_num contains ".">
      ...
      <tr>
         <td align="center">
          ...
          <tr valign="top">
            ...
            <td width="76%"><b><font face="Arial, Helvetica, sans-serif" size="1" color="blue">#read_data.d_bname# <cfif get_titleid.bfirstname2 neq '' and get_titleid.bfirstname2 neq 'NULL'>, #get_titleid.bfirstname2#</cfif> <cfif get_titleid.blastname2 neq '' and get_titleid.blastname2 neq 'NULL'>#get_titleid.blastname2#</cfif></font></b></td>
          </tr>
          <tr valign="top">
            ...
            <table align="center" cellspacing=0 cellpadding=0 width="100%" border="1">
               ...
               <tr valign="top">
                  <td width="37%"><font face="Arial, Helvetica, sans-serif" size="1">120.
                     GROSS AMOUNT DUE FROM BORROWER </font></td>
                  <td width="13%">
                     <div align="right"><font face="Arial, Helvetica, sans-serif" size="1">&nbsp;<b><font color="blue"><cfif get_titleid.comp_id eq 3276><cfset read_data.a_120 = read_data.a_120 - get_titleid.purchase><cfset read_data.a_301 = read_data.a_120></cfif>#FixDecimals(read_data.a_120)#</font></b></font></div>
                  </td>
...
<cfif #read_data2.a_1102_b# neq "0">&nbsp;
 ...
 <cfif (read_data2.a_1105_a neq '' and read_data2.a_1105_a neq 'NULL') or (read_data2.a_1105_b neq '' and read_data2.a_1105_b neq 'NULL')>
    ...
    <tr >
      <td > <font size="1" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif"><font color=black>1112. <font color=blue> #get_line_costs.a_1112_text# <cfif (read_data2.a_1112_a neq '' and read_data2.a_1112_a neq 'NULL') or (read_data2.a_1112_b neq '' and read_data2.a_1112_b neq 'NULL')>
        <font color=blue><cfif #read_data2.a_1112_c# neq "0" AND #read_data2.a_1112_c# neq ""> <b>#read_data2.a_1112_c#</b><cfelse> <b>#read_agency.title_ft_agency_name#</b></cfif></font></font></cfif>
      </td>
    ...
    <tr >
      <td > <font size="1" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif"><font color=black>1113. <font color=blue> #get_line_costs.a_1113_text# <cfif (read_data2.a_1113_a neq '' and read_data2.a_1113_a neq 'NULL') or (read_data2.a_1113_b neq '' and read_data2.a_1113_b neq 'NULL')>
        <font color=blue><cfif #read_data2.a_1113_c# neq "0" AND #read_data2.a_1113_c# neq ""> <b>#read_data2.a_1113_c#</b><cfelse> <b>#read_agency.title_ft_agency_name#</b></cfif></font></font></cfif>
      </td>
      ...
      <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1113_b# neq "0">
        <b>#FixDecimals(read_data2.a_1113_b)#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
	<tr >
      <td > <font size="1" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif"><font color=black>1114. <font color=blue> #read_data2.a_1114_c# <cfif (read_data2.a_1114_a neq '' and read_data2.a_1114_a neq 'NULL') or (read_data2.a_1114_b neq '' and read_data2.a_1114_b neq 'NULL')>
    ...
    <tr >
      <td> <font size="1" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif"><font color=black>1201. Recording Fees Deed $ &nbsp;&nbsp;<font color=blue>
        ...
        </font></font><cfif get_titleid.pstate eq 'MD' and (Len(get_titleid.CalyxDC_ID) gt 6)>&nbsp;&nbsp;Credit will be given on prior loan amount for Primary Residence</cfif></font> </td>
