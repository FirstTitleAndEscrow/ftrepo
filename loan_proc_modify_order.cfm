...
{
var foo;
location.href='loan_proc_modify_order.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&title=<cfoutput>#title#</cfoutput>&property=<cfoutput>#property#</cfoutput>&appraisal=<cfoutput>#appraisal#</cfoutput>&other=<cfoutput>#other#</CFOUTPUT>&ordering_co=<cfoutput>#ordering_co#</cfoutput>&page=<cfoutput>#page#</CFOUTPUT>&a_trigger=10&foo=' + frm.user_id_1.value;
}}
</script>
</HEAD>
...
<CFIF #read_company.Companies_Switch# eq 1>
    <CFQUERY datasource="#request.dsn#" NAME="read_users">
        ...
        WHERE     (Users.comp_id = #read_company.id#)
...
<CFFORM METHOD=POST ACTION="./loan_procs_modify_submit_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&ordering_co=#ordering_co#&page=#page#" name="frm"  ENABLECAB="Yes">
            ...
            <CFQUERY datasource="#request.dsn#" NAME="read_foo_users">
        	    ...
        	    ORDER BY  lp_lname, lp_fname ASC
			                                                            ...
			                                                            <SELECT NAME="user_id_1" onchange="prodSelect()"
			                                                                ...
			                                                                cols="45"
			                                                                >
			                                                                <cfoutput><option value="#foo#">#read_foo_users.lp_fname# #read_foo_users.lp_lname#</option></cfoutput>
