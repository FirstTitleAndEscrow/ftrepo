...
<cfoutput>
	<map name="pp">
<area alt="Click to view general information for this order" coords="4,41,155,84" href="https://#cgi.server_name#/prop_client_report_nav.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_title_order.prop_id#">

<area alt="Click here to view preclosing data" coords="4,292,154,339" href="https://#cgi.server_name#/prop_client_report_nav_pre.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_title_order.prop_id#">

<area alt="click here to view post closing data" coords="5,552,159,599" href="https://#cgi.server_name#/prop_client_report_nav_post.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_title_order.prop_id#">

<area alt="click here to view your order" coords="230,4,370,28" href="./prop_report_navu.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">

<area alt="click here to view uploaded files" coords="307,50,439,73" href="./prop_uploaded_file.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">



<area alt="click here to upload file for this order" coords="234,96,371,119" href="./prop_client_upload.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">
<cfif #read_payoff_info_1.payoff1_upload# NEQ "">
<area alt="click here to view pay off 1" coords="231,186,375,209" href="./pay_off_prop_1_view_only.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">
</cfif><cfif #read_payoff_info_2.payoff2_upload# NEQ "">
<area alt="click here to view payoff 2" coords="297,225,456,248" href="./pay_off_prop_2_view_only.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">
...
<area alt="click here to view HUD 1" coords="466,304,615,329" href="./prop_view_hud_pg1.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new">
<cfelse>
<area alt="click here to view HUD 1" coords="466,304,615,329" href="./prop_view_hud1a.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new">
</cfif>
...
<area alt="click here to request OR view a closing for this order" coords="234,518,388,541" href="./form_prop_closing_order_request.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">
<cfelse>
<area alt="click here to request OR view a closing for this order" coords="234,518,388,541" href="./prop_closing_report_nav.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">

</cfif>
<CFIF (#Read_Title_Order_info.c_month# GT "")>
<area alt="click here to view information about scheduled closing" coords="234,606,387,630" href="./Prop_Closing_View_info.cfm?comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#">
...
<cfoutput><tr>
<td HEIGHT="17" VALIGN="Middle" BGCOLOR="CCDAF0"><a class="lnk_mhtab" href="./prop_client_report_nav.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#"><b><font face="verdana,arial,helvetica" color="003399" size="1">General</font></b></a></td>
<td HEIGHT="17" VALIGN="Middle" BGCOLOR="White"><a class="lnk_mhtab" href="./prop_client_report_nav_pre.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#"><b><font face="verdana,arial,helvetica" color="003399" size="1">Pre-Closing Data</font></b></a></td>
...
<cfoutput>
<td><cfif #read_payoff_info_1.payoff1_upload# NEQ ""><a class="lnk_mhsubnavsel" href="./pay_off_prop_1_view_only.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">Pay Off-1</font></a>
...
<a class="lnk_mhsubnav" href="./pay_off_prop_2_view_only.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">Pay Off-2</font></a>
<cfelse>
<font face="arial,helvetica" color="gray" size="2">Pay Off-2</font>
</cfif>

<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
<!---<CFIF (#read_current_Commitment_Clauses.s_status# GT "")><a class="lnk_mhsubnav" href="./title_Committment.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Title Insurance</font></a>
<cfelse>
...
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
<cfif #read_title_order.hud_type# EQ "0">
<a class="lnk_mhsubnav" href="./prop_view_hud_pg1.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><font face="arial,helvetica" color="0033CC" size="2">PRE HUD-1</font></a>
<cfelse>
<a class="lnk_mhsubnav" href="./prop_view_hud1a.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><font face="arial,helvetica" color="0033CC" size="2">PRE HUD-1A</font></a>
</cfif>
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" /><a class="lnk_mhsubnav" href="./merge_endorsements_prop.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">HUD-Endorse</font></a>
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
<cfif #read_current_Commitment_Clauses.insurance_co# EQ "15">

				<cfif #read_title_order.e_status# EQ "1"><a class="lnk_mhsubnav" href="./view_loan_amount_verify.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Loan Endorsement</font></a>
				<CFELSE><font face="arial,helvetica" color="gray" size="2">Loan Endorsement</font>
				</cfif>
			<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />

				<cfif #read_title_order.e_status# EQ "2"><a class="lnk_mhsubnav" href="./view_proposed_insured_verify.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Property Endorsement</font></a>
				<CFELSE><font face="arial,helvetica" color="gray" size="2">Property Endorsement</font></cfif>

			<CFELSEIF #read_current_Commitment_Clauses.insurance_co# EQ "16">
				<cfif #read_title_order.e_status# EQ "5"><a class="lnk_mhsubnav" href="./view_loan_amount_verify_S.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Loan Endorsement</font></a>
				<CFELSE><font face="arial,helvetica" color="gray" size="2">Loan Endorsement</font></cfif>

			<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />

				<cfif #read_title_order.e_status# EQ "6"><a class="lnk_mhsubnav" href="./view_proposed_insured_verify_s.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Property Endorsement</font></a>
				<CFELSE><font face="arial,helvetica" color="gray" size="2">Property Endorsement</font></cfif>

			<CFELSEIF #read_current_Commitment_Clauses.insurance_co# EQ "17">
				<cfif #read_title_order.e_status# EQ "3"><a class="lnk_mhsubnav" href="./view_loan_amount_verify_c.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Loan Endorsement</font></a>
				<CFELSE><font face="arial,helvetica" color="gray" size="2">Loan Endorsement</font>
				</cfif>

			<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />

				<cfif #read_title_order.e_status# EQ "4"><a class="lnk_mhsubnav" href="./view_proposed_insured_verify_c.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Property Endorsement</font></a>
...
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
				...
				<a class="lnk_mhsubnav" href="./ICL_view.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">ICL</font></a>
