...
SELECT * FROM title WHERE (bfirstname1 = '#bfirstname1#') AND (blastname1= '#blastname1#') AND (bssn1 = '#bssn1#') AND (loanamt_float = '#loanamt_float#') AND (paddress = '#paddress#') AND (codeT is not null) AND (DATEDIFF(day, check_date, getdate())< 30)
</CFQUERY>
<cfif (#check_order.recordcount# GT 0) and comp_id neq 100 and comp_id NEQ 1982>
...
--->
          <CFOUTPUT>
            <TR>
              ...
              <td valign="middle"  align = "center" width="115" height="20" bgcolor="CCD2D2" nowrap onmouseover="this.bgColor='FF0000'" onmouseout="this.bgColor='CCD2D2'" onClick="document.location.href='./coverage_areas.cfm" target="ft_states">
...
<cfquery  datasource="#request.dsn#">
INSERT INTO TITLE (proptype,dateandtime, hud_type, piggy, ins, secloan, loan_number, check_date, check_time, user_id, comp_id, loan_off_id, oname, ophone, oext, ofax, o_email, pname, pphone, pext, pfax, p_email, blastname1, bfirstname1, bminame1, bssn1, bhphone1, bwphone1, bext1, blastname2, bfirstname2, bminame2, bssn2, bhphone2, bwphone2, bext2, slastname1, sfirstname1, sminame1, sssn1, shphone1, swphone1, sext1, slastname2, sfirstname2, sminame2, sssn2, shphone2, swphone2, sext2, paddress, pcity, pstate, pzip, pcounty, plegaldesc, condo_pud, a_comment, verifyemail, verifyemail_2, verifyemail_3, fax_no, rptbyemail, a_insert_date, a_insert_time, duedate, request_icl, order_date_adjusted, oda_day, oda_month, oda_year, oda_day_of_year, appraisal_status, a_day, a_month, a_year, a_day_of_year, polender1, poacctno1, pophone1, polender2, poacctno2, pophone2, order_status, SearchType, purchase, Deedtransfer, Insured, loanamt_float, loan_type_111, loan_program_333, prop_use_type, codeT, search_type, cleartoclose, company1, company2, taxID1, taxID2, estimated_loan_float, order_date, prev_loan_mo, prev_loan_year, calyxdc_id, integra_id, piggy_reference_id) VALUES ('#proptype#','#order_date#', '#hud_type#', '#piggy#', '#ins#', '0', '#loan_number#', '#DateFormat(Now(),"mm-dd-yyyy")#', '#TimeFormat(Now(),"HH:mm:ss")#', #user_id_1#, #RU.comp_id#, #lo_id#, '#rlo_name#', '#RLO.lo_phone#', '#RLO.lo_ext#', '#RLO.lo_fax#', '#RLO.lo_email#', '#ru_name#', '#RU.lp_phone#', '#RU.lp_ext#', '#RU.lp_fax#', '#RU.lp_email#', '#blastname1#', '#bfirstname1#', '#bminame1#', '#bssn1#', '#bhphone1#', '#bwphone1#', '#bext1#', '#blastname2#', '#bfirstname2#', '#bminame2#', '#bssn2#', '#bhphone2#', '#bwphone2#', '#bext2#', '#slastname1#', '#sfirstname1#', '#sminame1#', '#sssn1#', '#shphone1#', '#swphone1#', '#sext1#', '#slastname2#', '#sfirstname2#', '#sminame2#', '#sssn2#', '#shphone2#', '#swphone2#', '#sext2#', '#paddress#', '#pcity#', '#pstate#', '#pzip#', '#pcounty#', '#plegaldesc#', '#condo_pud#', '#a_comment#', '#verifyemail#', '#verifyemail_2#', '#verifyemail_3#', '#fax_no#', '#rptbyemail#', '#a_insert_date#', '#a_insert_time#', '#duedate#', <cfif calyxdc_id neq 0>'Yes'<cfelse>'#request_icl#'</cfif>, '#order_date_adj#', #a_day_1#, #a_month_1#, #a_year_1#, #oda_day_of_year_1#, '#app_stat#', #a_day_1#, #a_month_1#, #a_year_1#, #a_day_of_year_1#, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#polender1#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#poacctno1#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#pophone1#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#polender2#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#poacctno2#'</cfif>, <cfif calyxdc_id neq 0>'Call Customer'<cfelse>'#pophone2#'</cfif>, 1, '#SearchType#', '#purchase#', '#Deedtransfer#', '#Insured#', '#sec_loan#', '#loan_type_111#', '#loan_program_333#', '#prop_use_type#', 'T','#search_type#','#ctc_name#','#trim(company1)#','#trim(company2)#','#trim(taxID1)#','#trim(taxID2)#','#trim(estimated_loan_float)#', #CreateODBCDate(Now())#, #prev_loan_mo#, #prev_loan_year#, '#calyxdc_id#', '#encompass_id#', '#integra_id#', '#get_titleid.title_id#')
</cfquery>
</cfif> --->
</cfif> <!--- end of cfif update_order eq 0 and recalculate_hud eq 0 (line 671)--->
...
INSERT INTO Title_Notes(FName, LName, Order_ID, N_Note, N_Date, N_Time, note_type)
  ...
  <cfif #RU.comp_id# EQ 324>
    ...
    <CFQUERY datasource="#request.dsn#" >
    INSERT INTO Doc_Title_Insurance_Title(title_id, insurance_co) VALUES(#get_titleid.title_id#, 15)
    </CFQUERY>
    <cfelseif #RU.comp_id# EQ 729 OR #RU.comp_id# EQ 1460>
    <!---Eastern Residential Mortgage--->
    <CFQUERY datasource="#request.dsn#" >
  ...
  <cfif getcompany.id eq "1407">
    <CFSET b_emails_to_first_title = b_emails_to_first_title & ",nholton@firsttitleservices.com">
  </cfif>
  <CFMAIL
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      ...
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <tr>
              <td colspan=2 width=259 align=left valign=top bgcolor=d3d3d3><FONT FACE=ARIAL SIZE=2 color="maroon"><b>Unit No./Loan Officer:</b></font></TD>
              <td colspan=2 width=259 align=left valign=top bgcolor=d3d3d3><FONT FACE=ARIAL SIZE=2 color="maroon"><b>Unit No./Loan Processor:</b></font></TD>
            </tr>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">LO Name (Last, First)</font></td>
              ...
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">LP Name (Last, First)</font></td>
              <td width=134 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue">
                <cfif read_title.loan_off_id eq 0 and (read_title.CalyxDC_ID neq 'NULL' or read_title.Encompass_ID neq 'NULL' or read_title.Integra_ID neq 'NULL')>
            ...
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Phone No.</font></td>
              <td width=134 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue">
            ...
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Ext.</font></td>
              <td width=134 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#read_loan_offcr.lo_ext#</b></font></td>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Ext.</font></td>
              <td width=134 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#read_user.lp_ext#</b></font></td>
            </tr>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Fax</font></td>
              <td width=134 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue">
                <cfif read_title.loan_off_id eq 0 and read_title.CalyxDC_ID neq 'NULL'>
                  <B>#read_title.ofax#</B>
                  <cfelse>
            ...
            <tr>
              <td width=256 colspan=2 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Email</font></td>
              <td width=256 colspan=2 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Email</font></td>
            </tr>
            <tr>
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      <tr>
        <td width=519 align=left valign=top bgcolor=d3d3d3><FONT FACE=ARIAL SIZE=2 color="black">
          ...
          <br>
          <FONT FACE=ARIAL SIZE=2 color="maroon"><b>Borrowers Info:</b></font></font></TD>
      </TR>
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <!--- =================================== --->
            ...
            <tr>
              <td width=25 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">
                <p><br>
                  2.>></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Last Name<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#blastname2#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">First Name<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#bfirstname2#</b></font></font></td>
              <td width=30 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">MI.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#bminame2#</b></font></font></td>
              <td width=100 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Social Sec. No.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#bssn2#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Home Ph.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#bhphone2#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Work Ph.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#bwphone2#</b></font></font></td>
              <td width=40 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Ext.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#bext2#</b></font></font></td>
            </tr>
            <tr>
              <td width=335 colspan=5 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">^&nbsp;&nbsp;<FONT FACE=ARIAL SIZE=1 color="blue">xxx-xx-xxxx</font>&nbsp;&nbsp;^&nbsp;&nbsp;</font></td>
              <td width=180 colspan=2 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">^&nbsp;&nbsp;<FONT FACE=ARIAL SIZE=1 color="blue">xxx-xxx-xxxx</font>&nbsp;&nbsp;^</font></td>
              <td width=40 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">&nbsp;</font></td>
            </tr>
            <tr>
...
&nbsp;</font></td>
              <td width=90 colspan=2 bgcolor="f1f1f1" align=center valign=top><b><FONT FACE=ARIAL SIZE=1 color="gray">Company Name<br>
                </font></b><FONT FACE=ARIAL SIZE=1 color="gray"><FONT FACE=verdana SIZE=1 color="blue"><b>#company1#</b></font></font></td>
              <td width=90 colspan=2 bgcolor="f1f1f1" align=center valign=top><b><FONT FACE=ARIAL SIZE=1 color="gray">Tax ID<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#taxID1#</b></font></font></b></td>
            </tr>
          </table></td>
      </tr>
      <!--- ======================================================================= --->
      <tr>
        <td width=519 align=left valign=top bgcolor=d3d3d3><FONT FACE=ARIAL SIZE=2 color="maroon"><b>Sellers Info:</b></font></TD>
      </TR>
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <!--- ================================== --->
            ...
            <tr>
              <td width=25 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">
                <p><br>
                  1.>></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Last Name<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#slastname1#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">First Name<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sfirstname1#</b></font></font></td>
              <td width=30 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">MI.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sminame1#</b></font></font></td>
              <td width=100 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Social Sec. No.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sssn1#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Home Ph.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#shphone1#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Work Ph.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#swphone1#</b></font></font></td>
              <td width=40 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Ext.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sext1#</b></font></font></td>
            </tr>
            <!--- ================================== --->
            <!--- ===/ SELLERS  Info [ SECOND ] \=== --->
            <!--- ================================== --->
            <tr>
              <td width=25 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">
                <p><br>
                  2.>></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Last Name<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#slastname2#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">First Name<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sfirstname2#</b></font></font></td>
              <td width=30 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">MI.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sminame2#</b></font></font></td>
              <td width=100 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Social Sec. No.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sssn2#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Home Ph.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#shphone2#</b></font></font></td>
              <td width=90 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Work Ph.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#swphone2#</b></font></font></td>
              <td width=40 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Ext.<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#sext2#</b></font></font></td>
            </tr>
            <tr>
              <td width=335 colspan=5 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">^&nbsp;&nbsp;<FONT FACE=ARIAL SIZE=1 color="blue">xxx-xx-xxxx</font>&nbsp;&nbsp;^&nbsp;&nbsp;</font></td>
              <td width=180 colspan=2 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">^&nbsp;&nbsp;<FONT FACE=ARIAL SIZE=1 color="blue">xxx-xxx-xxxx</font>&nbsp;&nbsp;^</font></td>
...
&nbsp;</font></td>
              <td width=90 colspan=2 bgcolor="f1f1f1" align=center valign=top><b><FONT FACE=ARIAL SIZE=1 color="gray">Company Name<br>
                </font></b><FONT FACE=ARIAL SIZE=1 color="gray"><FONT FACE=verdana SIZE=1 color="blue"><b>#company2#</b></font></font></td>
              <td width=90 colspan=2 bgcolor="f1f1f1" align=center valign=top><b><FONT FACE=ARIAL SIZE=1 color="gray">Tax ID<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#taxID2#</b></font></font></b></td>
            </tr>
          </table></td>
      </tr>
    </table>
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      ...
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            ...
            <!--- =================================== --->
            <tr>
              <td width=205 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Street Address<br></font></td>
              <td width=314  bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#paddress#</b></font></td>
            </tr>
            <tr>
              <td width=205  bgcolor="f1f1f1" align=right><FONT FACE=ARIAL SIZE=1 color="gray">City, State, Zip:</font></td>
              <td width=314  bgcolor="f1f1f1" align=left><NOBR><FONT FACE=verdana SIZE=1 color="blue"><b>#pcity#,&nbsp;#pstate##pzip#</b></NOBR></font></td>
            </tr>
            <tr>
              <td width=205 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">County<br></font></td>
              <td width=314  bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#pcounty#</b></font></td>
            </tr>
            <tr>
              <td width=205 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Legal Description<br></font></td>
              <td width=314  bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#plegaldesc#</b></font></td>
            </tr>
            <tr>
              <td width=205 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Property Use<br></font></td>
              <td width=314  bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#prop_use_type#</B></font></td>
            </tr>
            <tr>
              <td width=205 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Is this a Condo or PUD<br></font></td>
              <td width=314  bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#condo_pud#</b></font></td>
            </tr>
          </table></td>
      </tr>
    </table>
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      ...
      <tr>
        <td width=205 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Loan Number<br></font></td>
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      ...
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <tr>
              <td width=519 bgcolor="f1f1f1" align=center valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#a_COMMENT#</B></font></td>
            </tr>
          </table></td>
      </tr>
    </table>
        ...
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            ...
            <tr>
              <td width=172 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Second Lender<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#polender2#</b></font></font></td>
              <td width=172 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Account Number<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#poacctno2#</b></font></font></td>
              <td width=172 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Phone Number<br>
                <FONT FACE=verdana SIZE=1 color="blue"><b>#pophone2#</b></font></font></td>
            </tr>
            <tr>
              <td width=172 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">&nbsp;</font></td>
              <td width=172  bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">&nbsp;</font></td>
              <td width=172 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=1 color="gray">^&nbsp;&nbsp;<FONT FACE=ARIAL SIZE=1 color="blue">xxx-xxx-xxxx</font>&nbsp;&nbsp;^</font></td>
            </tr>
          </table></td>
      </tr>
      <!--- ======================================================================= --->
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      ...
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Transaction Type</font></td>
              <td width=150 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#SearchType#</b></font></td>
              <td width=100 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Deed Transfer</font></td>
              <td width=144 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#Deedtransfer#</b></font></td>
            </tr>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Proposed Insured</font></td>
              <td COLSPAN=3 width=394 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#Insured#</b></font></td>
            </tr>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Loan Amt</font></td>
              <td COLSPAN=3 width=394 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#loanamt_float#</b></font></td>
            </tr>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Purchase price</font></td>
              <td COLSPAN=3 width=394 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#purchase#</b></font></td>
            </tr>
            <tr>
            ...
            <tr>
              <td width=519 colspan = 4 bgcolor="f1f1f1" align=left valign=top><NOBR><FONT FACE=ARIAL SIZE=1 color="gray">What is the loan amount of this second mortgage loan?#secloan#</font></td>
            </TR>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Loan Type</font></td>
              <td COLSPAN=3 width=394 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#loan_type_111#</b></font></td>
            </tr>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">Loan Program</font></td>
              <td COLSPAN=3 width=394 bgcolor="f1f1f1" align=left valign=top><FONT FACE=verdana SIZE=1 color="blue"><b>#loan_program_333#</b></font></td>
            </tr>
          </table></td>
      </tr>
      <!--- ======================================================================= --->
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      ...
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <tr>
              <td width=125 bgcolor="f1f1f1" align=right valign=top><FONT FACE=ARIAL SIZE=1 color="gray">ICL REQUEST</font></td>
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      <tr>
        <td width=519 align=left valign=top bgcolor=d3d3d3><FONT FACE=ARIAL SIZE=2 color="black">
          ...
          <br>
          <FONT FACE=arial SIZE=1 color="black"><B>By providing us with an email address, you will receive a confirmation e-mail of your order having been received by us.</b></font></font></TD>
      </TR>
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <tr>
              <td width=519 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=2 color=gray>Your E-Mail:</FONT><FONT FACE=verdana SIZE=1 color="blue"><b>#Verifyemail#</b></font></td>
            </tr>
            <tr>
              <td width=519 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL color=black SIZE=1>You may also have verification sent to up to two other e-mail addresses.</FONT><br>
                ...
                <FONT FACE=ARIAL SIZE=2 color=gray>Fax:</FONT><FONT FACE=verdana SIZE=1 color="blue"><b>#fax_no#</b></font></font></td>
            </tr>
          </table></td>
      </tr>
    </table>
    ...
    <table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
      <tr>
        <td width=519 align=left valign=top bgcolor=d3d3d3><FONT FACE=ARIAL SIZE=2 color="black">
          ...
          <FONT FACE=ARIAL SIZE=2 color=gray>Other E-Mail:</FONT><FONT FACE=verdana SIZE=1 color="blue"><b>#Verifyemail_3#</b></font></font></font></TD>
      </TR>
      <TR>
        <TD width=519 align=center valign=top bgcolor=d3d3d3><table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
            <tr>
              <td width=519 bgcolor="f1f1f1" align=center valign=top><FONT FACE=ARIAL SIZE=2 color=gray>E-Mail:</FONT><FONT FACE=verdana SIZE=1 color="blue"><b>#RptbyEmail#</b></font></td>
            </tr>
          </table></td>
      </tr>
    </table>
...
>
    ...
    COMMENTS:#a_COMMENT#PAYOFF INFORMATION First Lender:#polender1#Account Number:#poacctno1#Phone Number:#pophone1#Second Lender:#polender2#Account Number:#poacctno2#Phone Number:#pophone2#TITLE INSURANCE INFORMATION Transaction Type:#SearchType#Deed Transfer:#Deedtransfer#Proposed Insured:#Insured#Loan Amt:#loanamt_float#Purchase price:#purchase#Will there be a piggyback second mortgage closed with the above loan?
    <CFIF #piggy# EQ "0">
      NO
      <CFELSE>
      YES
...
<cfif (getcompany.test_account eq 0 and getcompany.a_status eq 1)>
...
</center><cfif (#get_titleid.comp_id# neq "115") OR (#get_titleid.comp_id# neq "621")><cfif #insert_user.cc_email_1# neq "" and #insert_user.cc_email_2# neq "">
  <center>
          ...
          <tr>
            <td width=770 align=center valign=top bgcolor=elelel><!---  <img src="./images/label_title.gif">  --->
              ...
              <p>
                ...
                </font></center><font size=3 color=black face=arial>
                <br>
              <p>
                <center>
        ...
        <center>
          <tr>
            <td width=770 align=center colspan = 4 valign=top bgcolor=elelel><p>
                <CENTER>
                  <FONT FACE=ARIAL color=red SIZE=2><b>THIS IS YOUR FIRST TITLE CONTACT LIST</b></FONT>
                </center>
              <p></td>
          </tr>
          </center>
  ...
  <cfif #get_p.recordcount# GT 0>
    <cfloop query="get_p">
      <cfif comp_id eq '1407'>
        <CFSET email = email & ",nholton@firsttitleservices.com">
      </cfif>
      <CFMAIL
TO="#email#"
FROM="webmaster@firsttitleservices.com"
...
--->
    ...
    </CENTER><p><center> <img src="./images/ancillary_title.gif">
      ...
      <CFIF #pstate# eq "TX" and searchType neq "Purchase">
        ...
        SELECT * FROM #a_tble_to_read# WHERE a_to >= #loanamt_float# order by a_to
        </CFQUERY>
        <CFQUERY datasource="#request.dsn#" NAME="read_prev_ins_calc" maxrows="1">
      ...
      <cfif calyxdc_id eq 0 and encompass_id eq 0 and integra_id eq 0>
        ...
        <cfelseif calyxdc_id eq 0 and encompass_id neq 0 and integra_id eq 0>

        <cfhttp url="http://www.firsttitleservices.com/title_view_hud_pg1a.cfm?emp=#emp#&rec_id=#get_titleid.title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" method="get" resolveURL="true">
        </cfhttp>
        <cfdocument format="PDF" pagetype="custom" pageheight="16" pagewidth="8" margintop="0" marginbottom="0" marginleft="0" marginright="0" filename="c:\inetpub\wwwroot\clients\firsttitleservices.com\www\encompass\tcs\HUD-#get_titleid.title_id#.pdf" overwrite="yes"> <cfoutput>#cfhttp.filecontent#</cfoutput> </cfdocument>
	...
	<cfelseif calyxdc_id neq 0 and encompass_id eq 0 and integra_id eq 0>
        <cfhttp url="http://www.firsttitleservices.com/title_view_hud_pg1a.cfm?emp=#emp#&rec_id=#get_titleid.title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" method="get" resolveURL="true">
        </cfhttp>
        <cfdocument format="PDF" pagetype="custom" pageheight="16" pagewidth="8" margintop="0" marginbottom="0" marginleft="0" marginright="0" filename="c:\inetpub\wwwroot\clients\firsttitleservices.com\www\calyxdc\tcs\HUD-#get_titleid.title_id#.pdf" overwrite="yes"> <cfoutput>#cfhttp.filecontent#</cfoutput> </cfdocument>
        <cffile action="READBINARY" file="C:\inetpub\wwwroot\clients\firsttitleservices.com\www\calyxdc\tcs\HUD-#get_titleid.title_id#.pdf" variable="pdf">
        <cfset send_pdf = ToBase64(pdf)>
      ...
      <cfelseif calyxdc_id eq 0 and encompass_id eq 0 and integra_id neq 0>

        <cfhttp url="http://www.firsttitleservices.com/title_view_hud_pg1a.cfm?emp=#emp#&rec_id=#get_titleid.title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" method="get" resolveURL="true">
        </cfhttp>
        <cfdocument format="PDF" pagetype="custom" pageheight="16" pagewidth="8" margintop="0" marginbottom="0" marginleft="0" marginright="0" filename="c:\inetpub\wwwroot\clients\firsttitleservices.com\www\integra\tcs\HUD-#get_titleid.title_id#.pdf" overwrite="yes"> <cfoutput>#cfhttp.filecontent#</cfoutput> </cfdocument>
        <!--- <cffile action="READBINARY" file="C:\inetpub\wwwroot\clients\firsttitleservices.com\www\encompass\tcs\HUD-#get_titleid.title_id#.pdf" variable="pdf">
        <cfset send_pdf = ToBase64(pdf)> --->
...
<!--- if there is any problem at all, send an email with the erro message --->
<cfmail to="rjermain@firsttitleservices.com" cc="rjermain@firsttitleservices.com" from="rjermain@firsttitleservices.com" subject="Order Error:  #get_comp_info.company# (#get_comp_info.ID#)" type="html">
<cfoutput>
The Error occurred in:<br>
<cfdump var="#cfcatch.tagcontext[1].template#"><br>
<br>
Line: <cfdump var="#cfcatch.tagcontext[1].line#"><br>
<br>
#cfcatch.message#<br>
<br><br>
Company Logged In: #get_comp_info.company# (#get_comp_info.ID#)<br>
<br>
URL:<br>
<cfdump var="#url#"><br>
<br>
...
<!--- if an order got created, then we should cancel it --->
<cfif get_titleid.title_id neq "">
<CFQUERY datasource="#request.dsn#">
...
Update title
set cancelled = 1,
appraisal_status = 'Order Cancelled'
where title_id = #get_titleid.title_id#
</CFQUERY>
<CFQUERY datasource="#request.dsn#">
...
<!--- now pop up an alert and let them know there wasa problem --->
<cfoutput><script language="javascript">
alert("There was a problem with your submission. Please go back and make certain all pertinent fields have been filled in correctly. If you continue to receive this error, please contact your First Title Sales representative, #get_sales_rep.fname# #get_sales_rep.lname#.");
history.back();
</script></cfoutput>
</cfcatch>
</cftry>
