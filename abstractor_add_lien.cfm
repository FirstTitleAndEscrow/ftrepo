...
if (frm.inst_mon.value=='' || frm.inst_day.value=='' || frm.inst_year.value=='') {
	...
	ErrorMessages+="<li>The date cannot be left blank</li>";
	//return false;
 }
...
if (frm.amount.value == "")
 ...
 if (frm.lien.value == "")
 {
 	ErrorMessages+="<li>You must enter Lienholder</li>";
 }

 if (frm.dept.value == "")
 {
 	
	ErrorMessages+="<li>You must enter the debtor</li>";
 }
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/abstractor_add_lien_submit.cfm?username=#url.username#&password=#url.password#&rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<option value="UCC Financing Statement">UCC Financing Statement</option>
</select>
	<tr>
		<td width=183 align=right valign=top bgcolor=e6e6e6>
			<font size=2 color=black face=arial>
...
<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="No" Message="You must enter an amount" type=text name="amount"  size=25 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="No" Message="You must enter a Lienholder" type=text name="lien"  size=40 maxlength=50
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT  type=text name="dept" Required="No" Message="You must enter a debtor"  size=40 maxlength=50
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
