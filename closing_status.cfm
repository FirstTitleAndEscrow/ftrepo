...
<html>
<head>
	<title>1st Title & Escrow, Inc. - Closing Status</title>
</head>
...
<TR>
<TD align=middle>
<FONT FACE=ARIAL COLOR="red" SIZE=4><b>Closing Status</b></FONT>
<p>
...
<FORM METHOD=post ACTION="./closing_report.cfm">
...
<OPTION value="#oname#">#oname#</OPTION>
  ...
  <TR><TD ALIGN=right bgcolor="#a2a3fe"><FONT FACE=ARIAL SIZE=2>Loan Processor:</FONT></TD><TD bgcolor="#a2a3fe"><SELECT name="oname">
<OPTION value=""></OPTION>
