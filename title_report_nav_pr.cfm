...
<cfoutput><td><a class="lnk_mhsubnavsel" href="./title_report_nav_pr.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title.comp_ID#&code=#URL.code#"><font face="arial,helvetica" color="0033CC" size="2">View Order</font></a><img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
	...
	<tr>
		...
		<TR>
			<TD width=519 align=left valign=top bgcolor=blue>
				...
				Order Number is...<b>PR-#read_title.pr_id#</b></FONT>
			</TD>
			</tr>
		<TR>
