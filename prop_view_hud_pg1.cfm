...
<!--
    function Locate(){
		 ...
		 window.location= "https://<cfoutput>#cgi.server_name#</cfoutput>/prop_view_hud_pg1_modify.cfm?uid=<cfoutput>#uid#</cfoutput>&rec_id=<cfoutput>#rec_id#</cfoutput>&a_trigger=2";
...
<div id=idControls align="center" class="noprint">
 ...
 <p>
 <cfoutput>
 <FORM METHOD=POST ACTION="./prop_view_hud_pg1.cfm?uid=#uid#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#" name="frm" ENABLECAB="Yes">
</cfoutput>
...
<!--- <input type="Hidden" name="al" value="#al#">--->
 ...
 <input type="Hidden" name="rec_id" value="#rec_id#">
								...
								border-style: bar;
								clear: none;"
								> <input type="image" src="https://<cfoutput>#cgi.server_name#</cfoutput>/images/button_submit.gif" border=0 alt="send email">
...
<!--- <input id=idPrint disabled type="button" value="Print the PDF"
 ...
 <table align="center" width="98%" cellspacing=0 cellpadding=0>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_103">
			...
			WHERE prop_id = #rec_id# and a_103 is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_104_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_104_a is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_104_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_104_b is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_105_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_105_a is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_105_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_105_b is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 105(b) was changed from #a_105_b# to #a105_b# by #fname#&nbsp;&nbsp;#lname#<br>
   ...
   <CFQUERY datasource="#request.dsn#" NAME="read_a_301">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_301 is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_302">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_302 is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_303">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_303 is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 303 was changed from #a_303# to #a303# by #fname#&nbsp;&nbsp;#lname#<br>
   ...
   <CFQUERY datasource="#request.dsn#" NAME="read_a_504">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_504 is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 504 was changed from #a_504# to #a504# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_505">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_505 is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_801_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_801_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 801(a) was changed from #a_801_a# to #a801_a# by #fname#&nbsp;&nbsp;#lname#<br>
   ...
   <CFQUERY datasource="#request.dsn#" NAME="read_a_801_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_801_b is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_801_d">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_801_d is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 801(d) was changed from #a_801_d# to #a801_d# by #fname#&nbsp;&nbsp;#lname#<br>
   ...
   <CFQUERY datasource="#request.dsn#" NAME="read_a_802_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_802_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 802(a) was changed from #a_802_a# to #a802_a# by #fname#&nbsp;&nbsp;#lname#<br>
   ...
   <CFQUERY datasource="#request.dsn#" NAME="read_a_802_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_802_b is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_802_d">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_802_d is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 802(d) was changed from #a_802_d# to #a802_d# by #fname#&nbsp;&nbsp;#lname#<br>
   ...
   <CFQUERY datasource="#request.dsn#" NAME="read_a_803_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_803_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 803(a) was changed from #a_803_a# to #a803_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_803_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_803_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_804_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_804_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 804(a) was changed from #a_804_a# to #a804_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_804_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_804_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_805_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_805_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 805(a) was changed from #a_805_a# to #a805_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_805_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_805_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_806_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_806_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 806(a) was changed from #a_806_a# to #a806_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_806_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_806_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_807_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_807_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 807(a) was changed from #a_807_a# to #a807_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_807_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_807_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_808_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_808_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 808(a) was changed from #a_808_a# to #a808_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_808_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_808_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_809_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_809_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 809(a) was changed from #a_809_a# to #a809_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_809_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_809_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_810_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_810_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 810(a) was changed from #a_810_a# to #a810_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_810_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_810_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_811_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_811_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 811(a) was changed from #a_811_a# to #a811_a# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_811_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_811_b is not null order by c_date, c_time
	</cfquery>
  <cfoutput query = "read_a_810_b">
  <tr>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 811(b) was changed from #a_811_b# to #a811_b# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_901_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_901_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 901(a) was changed from #a_901_a# to #a901_a# by #fname#&nbsp;&nbsp;#lname#<br>
     ...
     <CFQUERY datasource="#request.dsn#" NAME="read_a_901_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_901_b is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 901(b) was changed from #a_901_b# to #a901_b# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_901_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_901_c is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 901(c) was changed from #a_901_c# to #a901_c# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_901_d">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_901_d is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_902_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_902_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 902(a) was changed from #a_902_a# to #a902_a# by #fname#&nbsp;&nbsp;#lname#<br>
     ...
     <CFQUERY datasource="#request.dsn#" NAME="read_a_902_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_902_b is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 902(b) was changed from #a_902_b# to #a902_b# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_902_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_902_c is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_903_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_903_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 903(a) was changed from #a_903_a# to #a903_a# by #fname#&nbsp;&nbsp;#lname#<br>
     ...
     <CFQUERY datasource="#request.dsn#" NAME="read_a_903_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_903_b is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 903(b) was changed from #a_903_b# to #a903_b# by #fname#&nbsp;&nbsp;#lname#<br>
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_a_903_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_903_c is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_904_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_904_a is not null order by c_date, c_time
	</cfquery>
  ...
  #c_date#&nbsp;&nbsp;#c_time#:&nbsp;&nbsp;&nbsp;Line 904(a) was changed from #a_904_a# to #a904_a# by #fname#&nbsp;&nbsp;#lname#<br>
     ...
     <CFQUERY datasource="#request.dsn#" NAME="read_a_904_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_904_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_905_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_905_a is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_1001_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1001_a is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1001_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1001_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_1001_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1001_c is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1002_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1002_a is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1002_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1002_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_1002_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1002_c is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1003_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1003_a is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1003_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1003_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_1003_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1003_c is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1004_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1004_a is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1004_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1004_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_1004_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1004_c is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1005_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1005_a is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1005_b">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1005_b is not null order by c_date, c_time
	</cfquery>
 ...
 <CFQUERY datasource="#request.dsn#" NAME="read_a_1005_c">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1005_c is not null order by c_date, c_time
	</cfquery>
  ...
  <CFQUERY datasource="#request.dsn#" NAME="read_a_1400_a">
			Select * from hud_modify
			WHERE prop_id = #rec_id# and a_1400_a is not null order by c_date, c_time
	</cfquery>
  ...
  <table align="center" width="100%">
    ...
    <tr>
      <td> <font size="1" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif"><font size=1 color=black face="Arial, Helvetica, sans-serif">
            801. Loan Origination Fee&nbsp;&nbsp;<b>#read_data2.a_801_a#</b>%
            <font color=blue>&nbsp;&nbsp;
            <b>#read_data2.a_801_d#</b>
            </font>
            </font>
      </td>
      <td align="right">
    ...
    <tr>
      <td>
            ...
            802. Loan Discount &nbsp;&nbsp;<b>#read_data2.a_802_a#</b>%
            <font color=blue>&nbsp;&nbsp;
            <b>#read_data2.a_802_d#</b>
            </font>
            </font>
      </td>
      <td align="right">
    ...
    <tr>
        <td>
            <font size="1" face="Arial, Helvetica, sans-serif">
            <font size=1 color=black face="Arial, Helvetica, sans-serif">
            803. Appraisal Fee&nbsp;&nbsp;<b>#read_data2.a_803_a#</b>
            </font>
        </td>
        <td align="right">
            <font size="1" face="Arial, Helvetica, sans-serif">
    ...
    <tr>
        <td>
            <font size="1" face="Arial, Helvetica, sans-serif">
            <font size=1 color=black face="Arial, Helvetica, sans-serif">
            804. Credit Report&nbsp;&nbsp;<b>#read_data2.a_804_a#</b>
            </font>
       </td>
        <td align="right">
            <font size="1" face="Arial, Helvetica, sans-serif">
    ...
    <tr>
      ...
      <td align="right"><font size=1 color=blue face="Arial, Helvetica, sans-serif"><cfif #read_data2.a_1101_f# neq "0">
        &nbsp;<b>#read_data2.a_1101_f#</b></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
    <tr>
...
<cfif #read_data2.a_1102_a# neq "0">&nbsp;
      ...
      <td align="right">
<cfif #read_data2.a_1102_f# neq "0">&nbsp;
          <b><font color="##0000FF" size="1" face="Arial, Helvetica, sans-serif">#read_data2.a_1102_f#</font></b>
        </cfif></td>
    </tr>
    <tr valign="top">
      ...
      <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1103_f# neq "0">
        <b>#read_data2.a_1103_f#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
    <tr>
      <td> <font size="1" face="Arial, Helvetica, sans-serif">1104. Title
        Insurance Binder&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to
        <font color=blue>
        <cfif #read_data2.a_1104_a# neq "0" OR #read_data2.a_1104_b# neq "">
            <CFIF #get_titleid.pstate# eq "CA">
                <b>First Title & Escrow, inc.</b>
      ...
      <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1104_f# neq "0">
        <b>#read_data2.a_1104_f#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
    <tr>
 ...
 <font color=blue>
        ...
        <cfif #read_data2.a_1105_a# neq "0" OR #read_data2.a_1105_b# neq "">
         <CFIF #get_titleid.pstate# eq "CA">
                <b>First Title & Escrow, inc.</b>
            <CFELSEIF #get_titleid.pstate# eq "NV">
                <b>First Title & Escrow, inc.</b>
      ...
      <td align="right" ><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1105_f# neq "0">
        <b>#read_data2.a_1105_f#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
    <tr >
      <td> <font size="1" face="Arial, Helvetica, sans-serif">1106. NotaryFees&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to

        <font color=blue><b>
        <cfif #read_data2.a_1106_a# neq "0" OR #read_data2.a_1106_b# neq "">
            <CFIF #get_titleid.pstate# eq "CA">
                <b>First Title & Escrow, inc.</b>
            <CFELSEIF #get_titleid.pstate# eq "NV">
                <b>First Title & Escrow, inc.</b>
      ...
      <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1106_f# neq "0">
        <b>#read_data2.a_1106_f#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
    <tr>
      ...
      <td align="right" ><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1107_f# neq "0">
        <b>#read_data2.a_1107_f#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
    <tr >
        ...
        <td>
            ...
            <cfif #read_data2.a_1108_a# neq "0" OR #read_data2.a_1108_b# neq "">
                ...
                <CFELSEIF #get_titleid.pstate# eq "NV">
                    <b>Stewart Title Guaranty Company</b>
                <CFELSE>
                    <b>First Title/#get_ins.company#</b>
                </CFIF>
            </cfif>
            </font>
            </font>
    ...
    <tr>
      <td ><font size="1" face="Arial, Helvetica, sans-serif">1111. <font color=blue>
        <cfif #get_titleid.pstate# eq "NV" or #get_titleid.pstate# eq "CA">
				Delivery
				<cfelse>
				#get_line_costs.a_1111_text# </cfif>
        <cfif #read_data2.a_1111_a# neq "0" OR #read_data2.a_1111_b# neq "">
            <CFIF #get_titleid.pstate# eq "CA">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>First Title & Escrow</b>
                <CFELSEIF #get_titleid.pstate# eq "NV">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>First Title & Escrow</b>
                <CFELSE>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>#read_agency.title_ft_agency_name#</b>
      ...
      <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1111_f# neq "0">
        <b>#read_data2.a_1111_f#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
    <tr >
      ...
      <td align="right" ><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue><cfif #read_data2.a_1112_f# neq "0"><b>#read_data2.a_1112_f#</b></font></font>
    ...
    <tr >
      ...
      <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue> <cfif #read_data2.a_1113_f# neq "0">
        <b>#read_data2.a_1113_f#</b></font></font> <font size="1" face="Arial, Helvetica, sans-serif"></cfif></font></td>
    </tr>
	<tr >
    ...
    <tr >
      ...
      <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue>
        <cfif #read_data2.a_1205_f# neq "0">
          <b>#read_data2.a_1205_f#</b>
        </cfif>
        </font></font> </td>
    </tr>
    <tr>
    ...
    <tr >
      ...
      <td align="right" ><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue>
        <cfif #read_data2.a_1303_f# neq "0">
          <b>#read_data2.a_1303_f#</b>
        </cfif>
        </font></font> </td>
    </tr>
    <tr >
      ...
      <td align="right" ><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue>
        <cfif #read_data2.a_1304_f# neq "0">
          <b>#read_data2.a_1304_f#</b>
        </cfif>
        </font></font> </td>
    </tr>
    <tr>
      ...
      <td align="right" ><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<font color=blue>
        <cfif #read_data2.a_1305_f# neq "0">
          <b>#read_data2.a_1305_f#</b>
        </cfif>
        </font></font> </td>
    </tr>
    <tr>
