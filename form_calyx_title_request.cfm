...
<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<CFFORM NAME="frm" ACTION="./order_verify_title.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=0&appraisal=#appraisal#&other=0&emp=#emp#" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST >
...
<CFOUTPUT>
						<td width=314  bgcolor="yellow" align=left valign=top>
							<CFINPUT TYPE="Text" NAME="paddress" REQUIRED="Yes" Message="You must enter the PROPRTY ADDRESS" SIZE=50 MAXLENGTH=80 VALUE="#Trim(read_title_temp.paddress)#"
									style="font-size: 9;
									font-family: verdana;
									font-style: normal;
									color: 003F1E;
...
<cfoutput>
			...
			<td width=519 align=left colspan=2 valign=top bgcolor=d3d3d3>
				<FONT FACE=ARIAL SIZE=2 color="black">
				<CENTER><B><a href="./thirdpartyhelp.cfm" target="thirdpartyhelp" onClick="window.open('','thirdpartyhelp','width=420,height=200,status=0,resizable=0,scrollbars=0')">Third Party Access Request</a></B></CENTER><br>
		...
		<tr>
			<td width=519 bgcolor="f1f1f1" align=center valign=top>
					...
					<INPUT NAME="thirdp" VALUE="" SIZE=30 MAXLENGTH=120
						  ...
						  <font color="990000" size="2" face="Times New Roman, Times, serif"><a href="./thirdpartyid.cfm" target="thirdpartyid" onClick="window.open('','thirdpartyid','width=420,height=200,status=0,resizable=0,scrollbars=0')">Don't have an ID? Click here</a>
	</font>
		</td>
...
<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<CFFORM NAME="frm" ACTION="./order_verify_property.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=0&appraisal=#appraisal#&other=0&emp=#emp#" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
...
<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<CFFORM NAME="frm" ACTION="./title_appraisal_form.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=0&appraisal=#appraisal#&other=0&emp=#emp#" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
...
<CFOUTPUT>
						<td width=314  bgcolor="yellow" align=left valign=top>
							<CFINPUT TYPE="Text" NAME="paddress" REQUIRED="Yes" Message="You must enter the PROPERTY ADDRESS" SIZE=50 MAXLENGTH=80 VALUE="#Trim(read_title_temp.paddress)#"
									style="font-size: 9;
									font-family: verdana;
									font-style: normal;
									color: 003F1E;
...
<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<CFFORM NAME="frm" ACTION="./order_verify_title_ancillary.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=0&appraisal=#appraisal#&other=0&emp=#emp#" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
