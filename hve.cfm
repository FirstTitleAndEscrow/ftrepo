...
<CFFORM name = "frm" ACTION="./form_title_request_addr.cfm?comp_id=#comp_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&zip_trigger=0" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
