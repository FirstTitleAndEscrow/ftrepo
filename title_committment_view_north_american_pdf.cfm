...
<CFQUERY datasource="#request.dsn#" NAME="read_title_data">
            select * from title_ins_view WHERE title_id = #rec_ID# and selectedOrgs
            is not null </cfquery>
...
View/Print <A HREF="https://#cgi.server_name#/title_committment_view_first_american.cfm?comp_id=115&user_id_1=723&lo_id=1217&rec_id=#rec_id#&a_trigger=1&company_id=0" >North American Title Insurance Commitment</a> for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#</B></font><br><br>
	      ...
	      <tr align="left" valign="top">
		    ...
		    <td>
              <cfif #read_lien45.data7# NEQ ""> #read_lien45.lienintro# <cfif read_lien45.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien45.data7# in favor of #read_lien45.data6# in the amount of #read_lien45.data5#, dated #DateFormat(read_lien45.data4, "mm")#/#DateFormat(read_lien45.data4, "dd")#/#DateFormat(read_lien45.data4, "yyyy")# and recorded #DateFormat(read_lien45.data9, "mm")#/#DateFormat(read_lien45.data9, "dd")#/#DateFormat(read_lien45.data9, "yyyy")#
			    <cfif #read_lien45.data1# eq ""> in Book #read_lien45.data2# at Page #read_lien45.data3# <cfelse> in Document #read_lien45.data1# </cfif> #read_lien45.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfif len(read_Title_Data.addex) GT 2000>
<cfset extra_text = Mid(read_Title_Data.addex, 2000, Len(read_Title_Data.addex))>
<cfset stop_number = Find(" ", read_Title_Data.addex, 2000)>
...
<cfif len(read_Title_Data.addex) LTE 2000>
<P>
<IE:DEVICERECT ID="<CFOUTPUT><CFIF #read_Title.pstate# eq "CA" OR #read_Title.pstate# eq "NV">page6<CFELSE>Page5</CFIF></cfoutput>" CLASS="masterstyle" MEDIA="print">
<table width="100%" cellpadding=0 cellspacing=0 border=0 >
    <tr>
...
<table cellpadding=0 cellspacing=0 border=0 width="93%">
        ...
        <tr>
		<td width="3%" valign="top"></td>
          <td align = "left" colspan="3" valign="top"><cfoutput>#text_1#</cfoutput>
		 </td>
        </tr>
...
<table cellpadding=0 cellspacing=0 border=0 width="93%">
        ...
        <tr>
		<td width="3%" valign="top"></td>
          <td align = "left" colspan="3" valign="top"><br>
<br>
<cfoutput>#text_2#</cfoutput>
		 </td>
        </tr>
