...
<CFQUERY datasource="#request.dsn#"  NAME="Read_default_rates">
			select *
			from Company_Billing_Values where company_id = 2418
</CFQUERY>
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_agency_assoc">		
			...
			where company_id = 2418 and billing_id = #old_billing_id#
</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states11">		
			...
			select * from company_billing_states
			where company_id = 2418 and a_states in ('IN')
			</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states1">		
			...
			select * from company_billing_states
			where company_id = 2418 and a_states in ('AZ')
			</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states2">		
			select * from company_billing_states
			where company_id = 2418 and a_states in ('CA')
</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states3">		
			select * from company_billing_states
			where company_id = 2418 and a_states in ('DE','GA','MA','NC','SC','WV')
</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states4">		
			select * from company_billing_states
			where company_id = 2418 and a_states in ('NJ')
</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states5">		
			select * from company_billing_states
			where company_id = 2418 and a_states in ('PA')
</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states6">		
			select * from company_billing_states
			where company_id = 2418 and a_states in ('NV')
</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states10">		
			...
			select * from company_billing_states
			where company_id = 2418 and a_states in ('NE')
			</CFQUERY>	
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states7">		
			...
			select * from company_billing_states
			where company_id = 2418 and a_states in ('AL','AR','CO','CT','DC','FL','HI','IA','IL','KS','KY','LA','MD','ME','MI','MN','MO','MS','MT','ND','NH','NY','OH','RI','TN','VA','VT','WI')
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states111">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 41386 
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states1">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 3269
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states2">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 1976
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states3">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 1157
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states4">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 997
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states5">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 998
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states6">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 2672
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states112">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 41396  
...
<CFQUERY datasource="#request.dsn#"  NAME="Read_billing_states7">		
			select * from company_agency_assoc
			where company_id = 2418 and billing_id = 996
