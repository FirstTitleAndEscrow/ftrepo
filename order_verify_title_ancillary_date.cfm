...
<CFPARAM NAME="flood" DEFAULT="">
<CFPARAM NAME="avm" DEFAULT="">
<CFPARAM NAME="credit" DEFAULT="">
<CFPARAM NAME="signing" DEFAULT="0">
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				Ancillary (loan_number, check_date, <cfif #flood# neq "">codeFlood,</cfif> <cfif #AVM# neq "">codeAVM,</cfif> <cfif #credit# neq "">codeCR, </cfif><cfif #signing# neq "">codeSigning, </cfif>check_time, user_id, comp_id, loan_off_id, oname, ophone, oext, ofax, o_email, pname,
						...
						rptbyemail, a_insert_date, a_insert_time, duedate, order_date_adjusted, oda_day, oda_month, oda_year, oda_day_of_year, appraisal_status, a_day, a_month, a_year, a_day_of_year, polender1, poacctno1, pophone1, polender2, poacctno2, pophone2, order_status, prop_use_type, condo_pud, flood, avm, credit, signing)
				VALUES ('#loan_number#', '#DateFormat(Now(), "mm-dd-yyyy")#', <cfif #flood# neq "">'F', </cfif><cfif #AVM# neq "">'AVM',</cfif> <cfif #credit# neq "">'CR',</cfif> <cfif #signing# neq "">'SN',</cfif> '#TimeFormat(Now(), "HH:mm:ss")#', #user_id_1#, #RU.comp_id#,	#lo_id#, '#rlo_name#', '#RLO.lo_phone#',
						...
						'#order_date_adj#', #a_day_1#, #a_month_1#, #a_year_1#, #oda_day_of_year_1#, '#app_stat#', #a_day_1#, #a_month_1#, #a_year_1#,	#a_day_of_year_1#, '#polender1#', '#poacctno1#', '#pophone1#', '#polender2#', '#poacctno2#', '#pophone2#', 1, '#prop_use_type#', '#condo_pud#',
						'#flood#', '#avm#', '#credit#', '#signing#')
...
SAMPLE [do not process]
				...
				[ ORDER ID ]
					Your Order ID is - #get_titleid.anc_id# - Please use this when communicationg with our associates.
...
<A HREF="https://#cgi.server_name#/send_info.cfm?id_pass=#get_titleid.anc_id#">
...
<td align=left>#get_titleid.anc_id#</td>
</tr>
<tr align="middle" valign="center">
...
<CFLOCATION URL="https://#cgi.server_name#/order_verify_display_title.cfm?comp_id=#comp_id#&title_id=#title_id#&prop_id=#prop_id#&app_id=#app_id#&anc_id=#get_titleid.anc_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#">
