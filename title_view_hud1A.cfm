...
<!--
    function Locate(){
		 ...
		 window.location= "https://<cfoutput>#cgi.server_name#</cfoutput>/title_view_hud_A_modify.cfm?uid=<cfoutput>#uid#</cfoutput>&rec_id=<cfoutput>#rec_id#</cfoutput>&a_trigger=2";
...
<div id=idControls align="center" class="noprint">
 ...
 <p>
 <cfoutput>
 <FORM METHOD=POST ACTION="./title_view_hud1A.cfm?uid=#uid#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#" name="frm" ENABLECAB="Yes">
</cfoutput>
 ...
 onclick="factory.printing.Preview()">
   <a href="./title_view_hud_A_modify.cfm?uid=#uid#&al=#al#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#"><input class=ie55 disabled type="button" value="Modify..." onclick="Locate();"></a>
</form>
<cfoutput>
<FORM NAME="Search" METHOD="post" ACTION="./title_view_hudA.cfm">
...
<cfelse>
  ...
  <tr>
    <td width="46%" valign="top"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;904. #read_data2.a_904_a#&nbsp;&nbsp;&nbsp;#read_data2.a_904_c#
      </font></td>
  ...
  <tr>
    <td valign="top"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;1111.
				...
				Delivery
				<cfelse>
		#get_line_costs.a_1111_text# </cfif> <cfif #read_data2.a_1111_a# neq "0" OR #read_data2.a_1111_b# neq "">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>#read_agency.title_ft_agency_name#</b>
        </cfif>
      </font></td>
