...
<cfparam name="url.oda_month" default="NONE">
<cfparam name="form.oda_month" default="NONE">
<cfif url.oda_month neq 'NONE'>
<cfset form.oda_month = url.oda_month>
</cfif>
...
<cfparam name="fdr_id" default="">
<cfparam name="pr_id" default="">
...
<cfif Len(read_company.child_ids) eq 0>
<cfset read_company.child_ids = '999999999999999999999'>
</cfif>
...
SELECT *
    ...
    or master_co_id = '#comp_id#'
    ORDER BY company ASC
</CFQUERY>
<cfset master_co_list = valuelist(read_branches.ID, ",")>

<cfif Len(master_co_list) eq 0>
<cfset master_co_list = '999999999999999999999999'>
</cfif>
<!---</cfif>--->
...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			FROM Title
			WHERE
			<cfif form.oda_month neq 'NONE'>
			oda_month = '#form.oda_month#' and
			</cfif>
			<!--- <cfif #comp_id# eq "154">
			...
			<cfelse>
			(comp_id = '#comp_id#' or comp_id in (#master_co_list#)
			</cfif>
			<cfif read_company.child_ids neq '' and read_company.child_ids neq 'NULL'>
		...
		<cfif (#confirm_mon# NEQ "Month" and #comfirm_day# NEQ "Day" and #confirm_year# NEQ "Year") and (#confirm_mon_to# NEQ "Month" and #comfirm_day_to# NEQ "Day" and #confirm_year_to# NEQ "Year")>
			<CFSET YearMon = CreateODBCDate('#confirm_mon#/#comfirm_day#/#confirm_year#')>
			<CFSET YearMonto = CreateODBCDate('#confirm_mon_to#/#comfirm_day_to#/#confirm_year_to#')>

			and (order_date >= '#DateFormat(YearMon, "m/d/yyyy")#' and order_date <= '#DateFormat(YearMonTo, "m/d/yyyy")#')
			</cfif>
...
<table width="770" height="110" border=0 cellpadding=0 cellspacing=0 background="/client/images/banner_black_wout_logo.jpg" valign=top>
  <tr>
	...
	<table border=0 align="right" cellpadding="0" cellspacing=0>
              <tr>
                <td align="right" valign="center"><A HREF="https://#cgi.SERVER_NAME#/quicksearchhelp.cfm" target="quicksearch" onClick="window.open('','quicksearch','width=320,height=170,status=0,resizable=0,scrollbars=0')"><font size=2 color=red face=arial>Quick Search</font></a> &nbsp;&nbsp;</td>
...
<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
 ...
 <table width=770 border="1" cellpadding="0" cellspacing="0" >
  <TBODY>
	...
	<nobr><cfoutput><A HREF="https://#cgi.SERVER_NAME#/client_acct_mgt.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&ordering_co=#ordering_co#"><FONT FACE=ARIAL SIZE=2 color="red"><b>Back to main</b></font></a></cfoutput></nobr>
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
		...
		<CFIF #count# EQ 0>
				...
				<CFELSE><font size="2">
				<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&confirm_mon=#confirm_mon#&comfirm_day=#comfirm_day#&confirm_year=#confirm_year#&confirm_mon_to=#confirm_mon_to#&comfirm_day_to=#comfirm_day_to#&confirm_year_to=#confirm_year_to#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.title_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&title_id=#title_id#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#">
...
<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
						...
						<cfif url.comp_id eq '1052'>
<CFQUERY datasource="#request.dsn#" NAME="get_ordering_company">
SELECT *
FROM companies
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<FONT FACE=verdana SIZE=1 color="black">
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&confirm_mon=#confirm_mon#&comfirm_day=#comfirm_day#&confirm_year=#confirm_year#&confirm_mon_to=#confirm_mon_to#&comfirm_day_to=#comfirm_day_to#&confirm_year_to=#confirm_year_to#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&ordering_co=#ordering_co#&code=T" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td><!--- &company_id=#company_ID# --->
						<cfif #calc# eq "yes">
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_client_report_nav_calc.cfm?emp=#emp#&confirm_mon=#confirm_mon#&comfirm_day=#comfirm_day#&confirm_year=#confirm_year#&confirm_mon_to=#confirm_mon_to#&comfirm_day_to=#comfirm_day_to#&confirm_year_to=#confirm_year_to#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=T"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
					<cfelse>
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_client_report_nav.cfm?emp=#emp#&confirm_mon=#confirm_mon#&comfirm_day=#comfirm_day#&confirm_year=#confirm_year#&confirm_mon_to=#confirm_mon_to#&comfirm_day_to=#comfirm_day_to#&confirm_year_to=#confirm_year_to#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=T"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
					</cfif>
					</tr>
...
<cfif #titlemail# neq "">
		...
		Loan Number #loan_number# -	<A HREF="https://#cgi.SERVER_NAME#/title_committment_view_amer_pioneer_ins_all.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&company_id=0&ordering_co=#ordering_co#" target="new">American Pioneer Title Insurance Commitment</a> - Order Number #title_id# - #bfirstname1# #blastname1#</B></font><br>
			<cfelseif #read_ins_committments.insurance_co# eq "16">
			Loan Number #loan_number# - <A HREF="https://#cgi.SERVER_NAME#/title_committment_view_stewart_title_ins.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&company_id=0&ordering_co=#ordering_co#" target="new">Stewart Title Insurance Commitment</a> - Order Number #title_id# - #bfirstname1# #blastname1#</B></font><br>
			<cfelseif #read_ins_committments.insurance_co# eq "33">
			Loan Number #loan_number# - <A HREF="https://#cgi.SERVER_NAME#/title_committment_view_wfg.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&company_id=0&ordering_co=#ordering_co#" target="new">WFG Title Insurance Commitment</a> - Order Number #title_id# - #bfirstname1# #blastname1#</B></font><br>
<cfelse>
Loan Number #loan_number# - <A HREF="https://#cgi.SERVER_NAME#/title_committment_view_amer_pioneer_ins_fl.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&company_id=0&ordering_co=#ordering_co#" target="new">Florida Title Insurance Commitment</a> - Order Number #title_id# - #bfirstname1# #blastname1#</B></font><br>
...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			SELECT *
			FROM title a, title_closing_order_request b, eventlist e where
			...
			<cfelseif #comp_id# eq "1017">
			(a.comp_id = 1039 or a.comp_id = 1060 or a.comp_id = 968 or a.comp_id = 1058 or a.comp_id = 631 or a.comp_id = 635 or a.comp_id = 1017 or a.comp_id = 559  or a.comp_id = 859 or a.comp_id = 941 or a.comp_id = 942 or a.comp_id = 919 or a.comp_id = 953 or a.comp_id = 943 or a.comp_id = 944 or a.comp_id = 945 or a.comp_id = 946  or a.comp_id = 947 or a.comp_id = 948 or a.comp_id = 949 or a.comp_id = 950 or a.comp_id = 951 or a.comp_id = 746)


			<cfelse>
			(a.comp_id = '#comp_id#'  or a.comp_id in (#master_co_list#)
			</cfif>
			<cfif read_company.child_ids neq '' and read_company.child_ids neq 'NULL'>
			or a.comp_id IN (#read_company.child_ids#)
			</cfif>)
			<cfif form.oda_month neq 'NONE'>
			 and a.oda_month = '#form.oda_month#'
			</cfif>
             and a.cancelled is null

			 and a.title_id = b.title_id and a.title_id = e.title_id and b.request_date is not null
...
<cfif #appraisal_status# eq "Closing Request">
			and (e.a_filled_out_date between '#DateFormat(YearMon, "m/d/yyyy")#' AND '#DateFormat(YearMonto, "m/d/yyyy")#')
		...
		<cfelse>
		and (b.a_filled_out_date between '#DateFormat(YearMon, "m/d/yyyy")#' AND '#DateFormat(YearMonto, "m/d/yyyy")#')
		</cfif>
...
<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<a href="https://#cgi.SERVER_NAME#/title_closing_report_nav.cfm?emp=#emp#&comp_id=#comp_id#&company_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#">C-#title_id#</a>
						</td>
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_all_notes2">
			...
			<td bgcolor=#a_bgcolor# width=10 align=center valign=top>
							...
							<a href="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&ordering_co=#ordering_co#&code=CL" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!---
							<cfelse>
						...
						<!--
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_closing_report_nav.cfm?emp=#emp#&comp_id=#comp_id#&company_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1"><img src="./images/button_detail.gif" border=0 ALT="view closing"></a>
						</td>-->
	...
	<CFQUERY datasource="#request.dsn#" NAME="read_reportold">
			...
			SELECT *
			FROM title a, title_closing_order_request b, eventlist e where
			(a.comp_id = '#comp_id#' or read_company.master_co_id = '#comp_id#'
			<cfif read_company.child_ids neq '' and read_company.child_ids neq 'NULL'>
			or a.comp_id IN (#read_company.child_ids#)
			</cfif>)
			<cfif form.oda_month neq 'NONE'>
			...
			and a.cancelled is null
			and e.yearmonthold is not null
		...
		and (e.yearmonthold between '#DateFormat(YearMon, "m/d/yyyy")#' AND '#DateFormat(YearMonto, "m/d/yyyy")#')
			...
			and a.title_id = b.title_id and a.title_id = e.title_id
			</CFQUERY>
...
<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
			...
			<td bgcolor=#a_bgcolor# width=10 align=center valign=top>
							...
							<a href="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&ordering_co=#ordering_co#" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!---
							<cfelse>
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
		...
		<CFIF #count# EQ 0>
				...
				<CFELSE><font size="2">
				<CFOUTPUT>
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.prop_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&prop_id=#prop_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=2&ordering_co=#ordering_co#">
				Next Screen</a></CFOUTPUT>
				</CFIF>
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.prop_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&prop_id=#prop_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=2&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.prop_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&prop_id=#prop_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=2&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=100 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<a href="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#prop_id#&ordering_co=#ordering_co#&code=P" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!---
							<cfelse>
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="https://#cgi.SERVER_NAME#/view_the_prop_order.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#prop_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=P"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<table cellpadding="1" cellspacing="1" bgcolor = "000000" border="0" valign="top" width="770" height="25">
		...
		<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		 ...
		 <td valign="middle" align = "center" width="95"  height="20" bgcolor="CCD2D2" nowrap onMouseOver="this.bgColor='FECE62'" onMouseOut="this.bgColor='CCD2D2'" onClick="document.location.href='./contact_team.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&ordering_co=#ordering_co#';return false;"><a class="menu1" href="./contact_team.cfmcomp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&ordering_co=#ordering_co#"><nobr><img src="/client/images/arrowlogin.jpg" border=0>&nbsp;<strong>CONTACT TEAM</strong>&nbsp;</nobr></a></td>
          <td valign="middle" align = "center" width="115" height="20" bgcolor="CCD2D2" nowrap onMouseOver="this.bgColor='E79DF5'" onMouseOut="this.bgColor='CCD2D2'" onClick="document.location.href='./calculator.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&ordering_co=#ordering_co#';return false;"><a class="menu1" href="./calculator.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&ordering_co=#ordering_co#"><nobr><img src="/client/images/arrowcontact.jpg" border=0>&nbsp;<strong>FEE CALCULATOR</strong>&nbsp;</nobr></a></td>
         <td valign="middle"  align = "center" width="115" height="20" bgcolor="CCD2D2" nowrap onMouseOver="this.bgColor='FF0000'" onMouseOut="this.bgColor='CCD2D2'"><a class="menu1" href="./coverage_areas.cfm" target="ft_states" onClick="window.open('','ft_states','width=630,height=530,status=0,resizable=0,scrollbars=0')"><nobr><img src="/client/images/arrowproducts.jpg" border=0>&nbsp;COVERAGE AREAS&nbsp;</nobr></a></td>
<td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onMouseOver="this.bgColor='00FF66'" onMouseOut="this.bgColor='CCD2D2'" onClick="document.location.href='./loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&ordering_co=#ordering_co#';return false;"> <a class="menu1"  href="./loan_offcr_add.emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&ordering_co=#ordering_co#" target="New"><nobr><img src="/client/images/arrowvendor.jpg" border=0>&nbsp;<strong>USER ADMIN</strong>&nbsp;</nobr></a></td>
	<td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onMouseOver="this.bgColor='FF9900'" onMouseOut="this.bgColor='CCD2D2'" onClick="document.location.href='./title_client_rep_view.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=8&company_id=0&ordering_co=#ordering_co#';return false;"><a class="menu1" href="./title_client_rep_view.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=8&company_id=0&ordering_co=#ordering_co#"><nobr><img src="/client/images/arrowcareers.jpg" border=0>&nbsp;<strong>PRODUCT REPORTS</strong>&nbsp;</nobr></a></td>
	<td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onMouseOver="this.bgColor='0066CC'" onMouseOut="this.bgColor='CCD2D2'" onClick="document.location.href='./calendar.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&ordering_co=#ordering_co#';return false;"><a class="menu1" href="./calendar.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#&ordering_co=#ordering_co#"><nobr><img src="/client/images/arrowcompany.jpg" border=0 valign="middel">&nbsp;<strong>CLOSING CALENDAR</strong>&nbsp;</nobr></a></td>
<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	 ---></tr></CFOUTPUT></center>
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
		...
		<CFIF #count# EQ 0>
				...
				<CFELSE><font size="2">
				<CFOUTPUT>
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.app_id#&user_id=#user_id#&company_id=#company_id#&loan_number=#loan_number#&app_id=#app_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=3&ordering_co=#ordering_co#">
				Next Screen</a></CFOUTPUT>
				</CFIF>
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.app_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&app_id=#app_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=3&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.app_id#&user_id=#user_id#&company_id=#company_id#&loan_number=#loan_number#&app_id=#app_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=3&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#app_id#&ordering_co=#ordering_co#&code=A" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td>

					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_report_nav_appraisal.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#app_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=A"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<CFIF IsDefined("form.fdr_id")><cfif #fdr_id# NEQ "NONE">
	<CFSET fdr_id = #fdr_id#>
</cfif></CFIF>
<!--- <CFIF IsDefined("form.company_id")><cfif #company_id# NEQ "NONE">
	<CFSET company_id = #company_id#>
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
			<td width=770 align=left valign=top bgcolor=blue>
				<FONT FACE=ARIAL SIZE=2 color="white">
				<CENTER><B>Final Document Retrieval Report Search</B></CENTER>
			</TD>
		</TR>
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
		...
		<CFIF #count# EQ 0>
				...
				<CFELSE><font size="2">
				<CFOUTPUT>
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.fdr_id#&user_id=#user_id#&company_id=#company_id#&loan_number=#loan_number#&fdr_id=#fdr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=10&ordering_co=#ordering_co#">
				Next Screen</a></CFOUTPUT>
				</CFIF>
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.fdr_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&fdr_id=#fdr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=10&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.fdr_id#&user_id=#user_id#&company_id=#company_id#&loan_number=#loan_number#&fdr_id=#fdr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=10&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
...
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.fdr_id#&user_id=#user_id#&company_id=#company_id#&fdr_id=#fdr_id#&loan_number=#loan_number#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=10&ordering_co=#ordering_co#">
				Next Screen</a></CFOUTPUT>
				</CFIF></td>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#fdr_id#&ordering_co=#ordering_co#&code=FDR" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td>

					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_report_nav_fdr.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#fdr_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=FDR"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<CFIF IsDefined("form.pr_id")><cfif #pr_id# NEQ "NONE">
	<CFSET pr_id = #pr_id#>
</cfif></CFIF>
<!--- <CFIF IsDefined("form.company_id")><cfif #company_id# NEQ "NONE">
	<CFSET company_id = #company_id#>
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
			<td width=770 align=left valign=top bgcolor=blue>
				<FONT FACE=ARIAL SIZE=2 color="white">
				<CENTER><B>Policy Recovery Report Search</B></CENTER>
			</TD>
		</TR>
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
		...
		<CFIF #count# EQ 0>
				...
				<CFELSE><font size="2">
				<CFOUTPUT>
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.pr_id#&user_id=#user_id#&company_id=#company_id#&loan_number=#loan_number#&pr_id=#pr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=11&ordering_co=#ordering_co#">
				Next Screen</a></CFOUTPUT>
				</CFIF>
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.pr_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&pr_id=#pr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=11&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.pr_id#&user_id=#user_id#&company_id=#company_id#&loan_number=#loan_number#&pr_id=#pr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=11&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
...
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.pr_id#&user_id=#user_id#&company_id=#company_id#&pr_id=#pr_id#&loan_number=#loan_number#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=11&ordering_co=#ordering_co#">
				Next Screen</a></CFOUTPUT>
				</CFIF></td>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#pr_id#&ordering_co=#ordering_co#&code=PR" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td>

					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_report_nav_pr.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#pr_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=PR"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
		...
		and	comp_id = '#comp_id#'
			...
			<cfelseif #comp_id# eq "1017">
			and (comp_id = 1039 or comp_id = 1060 or comp_id = 968 or comp_id = 1058 or comp_id = 631 or comp_id = 635 or comp_id = 1017 or comp_id = 559  or comp_id = 859 or comp_id = 941 or comp_id = 942 or comp_id = 919 or comp_id = 953 or comp_id = 943 or comp_id = 944 or comp_id = 945 or comp_id = 946  or comp_id = 947 or comp_id = 948 or comp_id = 949 or comp_id = 950 or comp_id = 951 or comp_id = 746)

			<cfelse>
			and (comp_id = '#comp_id#'  or comp_id in (#master_co_list#)
			</cfif>
			<cfif read_company.child_ids neq '' and read_company.child_ids neq 'NULL'>
			or comp_id IN (#read_company.child_ids#)
			</cfif>)
...
<table width=770 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
		...
		<CFIF #count# EQ 0>
				...
				<CFELSE><font size="2">
				<CFOUTPUT>
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&anc_id=#anc_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=4&ordering_co=#ordering_co#">
				Next Screen</a></CFOUTPUT>
				</CFIF>
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&anc_id=#anc_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=4&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&anc_id=#anc_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=4&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=F" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!---
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=F"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&cr_id=#cr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=5&ordering_co=#ordering_co#">
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&cr_id=#cr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=5&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&cr_id=#cr_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=5&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=CR" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td>

					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=CR"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&avm_id=#avm_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=6&ordering_co=#ordering_co#">
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&avm_id=#avm_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=6&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&avm_id=#avm_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=6&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
		...
		<CFSET count_end = #count# + 9>
			 ...
			 <CFLOOP QUERY="read_report" startrow="#count#" endrow="#count_end#">
				<CFQUERY datasource="#request.dsn#" NAME="read_status">
					SELECT *
							FROM ANCILLARY_detl
							WHERE anc_id = '#anc_id#' and order_type='AVM'
				</cfquery>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=AVM" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td>

					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=AVM"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&sn_id=#sn_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_forward#&a_trigger=7&ordering_co=#ordering_co#">
			...
			<CFELSE><font size="2">
				...
				<CFSET count_back = #count# - 10>
					...
					<CFIF (#count# EQ 0) OR (#count# EQ 1)>
					<CFOUTPUT><A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&loan_number=#loan_number#&user_id=#user_id#&company_id=#company_id#&sn_id=#sn_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&a_trigger=7&ordering_co=#ordering_co#"></CFOUTPUT>
					<CFELSE>
					<CFOUTPUT>

	<A HREF="https://#cgi.SERVER_NAME#/title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_report.anc_id#&user_id=#user_id#&loan_number=#loan_number#&company_id=#company_id#&sn_id=#sn_id#&oda_month=#oda_month#&comments=#comments#&appraisal_status=#appraisal_status#&sortorder=#sortorder#&buyer_fname=#buyer_fname#&buyer_lname=#buyer_lname#&count=#count_back#&a_trigger=7&ordering_co=#ordering_co#"></CFOUTPUT>
					</CFIF>
				Previous Screen</a>
		...
		<CFSET count_end = #count# + 9>
			 ...
			 <CFLOOP QUERY="read_report" startrow="#count#" endrow="#count_end#">
					<CFQUERY datasource="#request.dsn#" NAME="read_status">
						SELECT *
								FROM ANCILLARY_detl
								WHERE anc_id = '#anc_id#' and order_type='SN'
					</cfquery>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=SN" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td>

					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=SN"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							...
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&ordering_co=#ordering_co#&code=T" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>

						</td>

					<cfif #calc# eq "yes">
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_client_report_nav_calc.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=T"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
					<cfelse>
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<A HREF="https://#cgi.SERVER_NAME#/title_client_report_nav.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&oda_month=#oda_month#&code=T"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
					</cfif>
...
WHERE id = '#read_report.comp_id#'
		 ...
		 <CFLOOP QUERY="read_anc">
			<CFQUERY datasource="#request.dsn#" NAME="read_F_status">
				SELECT *
				FROM ANCILLARY_detl
				WHERE anc_id = '#read_anc.anc_id#' and order_type='F'
			</cfquery>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<!--- #appraisal_status# --->#read_F_status.status#
						</td>
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<FONT FACE=verdana SIZE=1 color="black">
		 ...
		 <CFLOOP QUERY="read_cr">
			...
			<CFQUERY datasource="#request.dsn#" NAME="read_CR_status">
				SELECT *
						FROM ANCILLARY_detl
						WHERE anc_id = '#read_cr.anc_id#' and order_type='CR'
			</cfquery>
			<CFOUTPUT>
					<tr>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<!--- #appraisal_status# --->#read_CR_status.status#
						</td>
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<FONT FACE=verdana SIZE=1 color="black">
		 ...
		 <CFLOOP QUERY="read_avm">
			<CFQUERY datasource="#request.dsn#" NAME="read_AVM_status">
				SELECT *
						FROM ANCILLARY_detl
						WHERE anc_id = '#read_avm.anc_id#' and order_type='AVM'
			</cfquery>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<!--- #appraisal_status# --->#read_AVM_status.status#
						</td>
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<FONT FACE=verdana SIZE=1 color="black">
		 ...
		 <CFLOOP QUERY="read_sn">
			<CFQUERY datasource="#request.dsn#" NAME="read_SN_status">
				SELECT *
						FROM ANCILLARY_detl
						WHERE anc_id = '#anc_id#' and order_type='SN'
			</cfquery>
...
WHERE id = '#read_report.comp_id#'
                      ...
                      <td bgcolor=#a_bgcolor# width=110 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<!--- #appraisal_status# --->#read_SN_status.status#
						</td>
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<FONT FACE=verdana SIZE=1 color="black">
...
WHERE id = '#read_report.comp_id#'
				...
				SELECT *
				FROM Title_Notes
				Where Order_Id = #fdr_id# and note_type = 'FDR'  and access = 1
				ORDER BY Note_ID ASC
			</CFQUERY>
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#fdr_id#&ordering_co=#ordering_co#&code=FDR" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
...
WHERE id = '#read_report.comp_id#'
				...
				SELECT *
				FROM Title_Notes
				Where Order_Id = #pr_id# and note_type = 'PR'  and access = 1
				ORDER BY Note_ID ASC
			</CFQUERY>
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<A HREF="https://#cgi.SERVER_NAME#/view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#pr_id#&ordering_co=#ordering_co#&code=PR" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
