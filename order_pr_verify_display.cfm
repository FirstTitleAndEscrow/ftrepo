...
<cfoutput>			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER(S)</B></center><br><p>
					...
					<center>Your Policy Recovery Order Request has been Processed. Order number is <a href="./view_the_pr_order.cfm?emp=#emp#&comp_id=#comp_id#&order_id=#read_title.PR_ID#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>PR-#read_title.PR_ID#</b></a></center><br>
...
<td align="right" width=770>
		...
		<cffileupload align="center" name="MultiFileupload" addbuttonlabel="Add File(s)" uploadbuttonlabel="Upload" url="admin_area/UploadFilePR.cfm?rec_id=#read_title.pr_id#&Files=Multiple" 
