...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/prop_abstractor_add_mortgage_submit.cfm?username=#url.username#&password=#url.password#&rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes" onSubmit="return put();">
