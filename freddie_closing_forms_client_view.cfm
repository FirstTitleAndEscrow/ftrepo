...
<cfoutput>
#DateFormat(mods.foreclosure_date, 'm/d/yyyy')#
</cfoutput>
...
<li>	
	...
	( $<cfoutput>#mods.attorney_fee_charging#</cfoutput>, if you are charging the $25.00 wire fee) . The only title fee the seller will accept is a $25.00(max) wire fee payable to your office for wiring their funds.
...
<li>Total Commission (<cfoutput>#mods.totalcommissionpct#</cfoutput>%): $<cfoutput>#mods.totalcommissionamt#</cfoutput><br>
	Listing Agent (<cfoutput>#mods.listingagentpct#</cfoutput>%): $<cfoutput>#mods.listingagentamt#</cfoutput>
...
IN THE FANNIE MAE CONTRACT ADDENDUM WHICH IS:<br> <cfoutput>#get_titleid.bfirstname1# #get_titleid.blastname1# <cfif Len(get_titleid.blastname2)>and</cfif> #get_titleid.bfirstname2# #get_titleid.blastname2#</cfoutput><o:p></o:p></span></b></p>
...
style='font-size:11.0pt;font-family:"Arial Narrow","sans-serif"'>FINANCE TYPE: #mods.finance_type#<u><span
...
<p align="center"><img src="admin_area/images/sb3.jpg" width="700">
</P>
