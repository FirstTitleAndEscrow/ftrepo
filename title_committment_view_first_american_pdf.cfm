...
codebase="http://www.firsttitleservices.com/smsx.exe">
</object>
...
<div id=idControls align="center" class="noprint">
 ...
 <span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; color:red">If the buttons below are 'grayed-out', please click <a href="http://www.firsttitleservices.com/smsx.exe">HERE</a> to download and install ScriptX, this will allow you to print the HUD-1 and the Title Commitment</span>
...
<cfif read_title.comp_id eq 3182 or read_title.comp_id eq 2368 or read_title.comp_id eq 2430  or ListContainsNoCase(children, read_title.comp_id, ",") and read_title.pstate eq 'VA'>
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
...
<tr>
		...
		<td><B>ADDITIONAL REQUIREMENTS</B><br>
<br>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">First American Title Insurance Company reserves the right to make additional exceptions and/or requirements upon compliance with the requirements set forth herein.
		  </td></tr>
