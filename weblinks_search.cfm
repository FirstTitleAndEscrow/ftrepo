...
<td bgcolor="#a_bgcolor#" width="20%" align=left valign=top>
						...
						<td bgcolor="#a_bgcolor#" width="50%" align=left valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<a href="#weblinks#" target="new">#weblinks#</a>
						</td>
						<cfif #username# NEQ "">
<td bgcolor="#a_bgcolor#" width="10%" align=left valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
...
<td bgcolor="#a_bgcolor#" width="10%" align=left valign=top>
		...
		<td width=21 align=left valign=top bgcolor=#a_bgcolor#>
			 <cfif #url.uid# neq "93" AND #url.uid# neq "167"><a href="https://#cgi.server_name#/admin_area/web_links_modify.cfm?uid=#URL.uid#&al=#URL.al#&web_id=#web_id#&a_state=#a_state#&a_county=#a_county#"></cfif><FONT FACE=verdana SIZE=1 color="blue">modify<!--- <img border=0 src="./images/button_m.gif" ALT="Modify this entry"> ---></a>
		</td>
