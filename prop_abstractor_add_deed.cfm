...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/prop_abstractor_add_deed_submit.cfm?username=#url.username#&password=#url.password#&rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<option value="2005">2005</option>
        ...
        <td width=237 align=left valign=top bgcolor=e6e6e6>
			<select name="consider_type"
				...
				cols="5">
                    ...
                    <option value="Interfamily">Interfamily</option>
                    </select>
		</td>
	</tr>
    <tr>
    ...
    <!---Harry adding this 10/28/04.  New info needed for Legal/Vesting Report--->
	<tr>
		<td width=170 align=right valign=top bgcolor=e6e6e6>
			<font size=2 color=black face=arial>
		    Subdivision
        ...
        <td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="LegalSubdivision" value=""  size=40 maxlength=50
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
        ...
        <td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="LegalBlock" value=""  size=40 maxlength=50
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
        ...
        <td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="LegalLot" value=""  size=40 maxlength=50
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
