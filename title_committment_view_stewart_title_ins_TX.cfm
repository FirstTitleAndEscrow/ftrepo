...
<cfif ListFind("524,529",session.ft_user_id) >
                     <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_TX_nathan.jpg"><br>
<cfelseif ListFind("632",session.ft_user_id) >
                     <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_TX_sarah.jpg"><br>
<cfelseif ListFind("633",session.ft_user_id) >
                     <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_TX_sherry.jpg"><br>
 <cfelse>
	                     <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_TX_blank_sigs.jpg"><br>
...
<td align"left" valign="top" >The members of the Board of Directors of Stewart Title Guaranty Company as of the last day of the year preceding the date hereinabove set forth are as follows: Malcolm Morris, Charles F. Howard, Matthew Morris, Stewart Morris, Stewart Morris, Jr., John Killea, and Allen Berryman.</td></tr>
<tr>
<td width="45" align"left" valign="top" >A-3.</td>
<td align"left" valign="top" >The fifteen designated officers of Stewart Title Guaranty Company as of the date hereinabove set forth are as follows: Matthew Morris, Chief Executive Officer and President; Allen Berryman, Chief Financial Officer and Assistant Secretary -Treasurer; Murshid Khan, Chief Information Officer; Susan McLauchlan, Chief Human Resources Officer; Stewart Morris, Jr., Senior Chairman of the Board; Malcolm S. Morris, Chairman of the Board and Counsel; Glenn Clements, Group President - Direct Operations; George Houghton, Group President - Agency Operations; Jason Nadeau, Group President - Mortgage and Title Services; John Killea, General Counsel and Chief Compliance Officer; Bruce Hawley, Executive Vice President - National Title Services; Mark Winter, Executive Vice President - Public Policy; Richard Black, Senior Vice President - Underwriting Counsel; James Gosdin, Senior Vice President - Chief Underwriting Counsel and Associate General Counsel; John Rothermel, Senior Vice President - Regional Underwriting Counsel.<BR><BR>
</td></tr>
</table><BR>
