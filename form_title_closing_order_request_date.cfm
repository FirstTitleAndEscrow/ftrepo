...
<CFFORM NAME="frm" ACTION="./form_title_closing_order_request_reciept.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=2" METHOD=POST>
<CFOUTPUT>
...
<option value="11:00 pm">11:00 pm
	...
	<table width=699 cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
		...
		<cfif #get_title.pstate# eq "DE" OR #get_title.pstate# eq "GA" OR #get_title.pstate# eq "MA" OR #get_title.pstate# eq "NC" OR #get_title.pstate# eq "SC">
