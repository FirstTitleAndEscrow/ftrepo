...
<cfif arguments.company_id eq 3276 or arguments.company_id eq 3943>
<cfset state_deed_1 = 0>
</cfif>
...
<cfset a_ins_premium = (a_ins_premium * .60)>
<cfset a_1101 = 1000 - 250 - a_ins_premium>
<cfif a_1101 gt 0>
...
<!--- take this out if it doesn't solve the problem --->
<cfif (arguments.property_state eq 'MI' and arguments.transaction_type eq 'Purchase' and arguments.company_id neq 3276 and arguments.company_id neq 3943) or (arguments.property_state eq 'VA' and arguments.transaction_type eq 'Purchase' and check_streamline.streamline_client eq 'True' and arguments.company_id neq 3276 and arguments.company_id neq 3943 and (arguments.company_id eq 2368 or arguments.company_id eq 100 or ListContains(all_shapiro, arguments.company_id, ",")))>
...
<cfelse>
<cfif arguments.property_state eq 'MD' and arguments.company_id neq 3276 and arguments.company_id neq 3943 and (arguments.company_id eq 2368 or arguments.company_id eq 100 or ListContains(all_shapiro, arguments.company_id, ",")) and check_streamline.streamline_client eq 'True'>
   ...
   <cfset temp = AddQueryItem(1109, "Title Insurance Premium", NumberFormat(a_ins_premium-35, '_____.__'), "Seller")>
   <cfset temp = AddQueryItem(1109, "Title Insurance Premium", NumberFormat(35, '_____.__'), "Buyer")>
   <cfelseif arguments.seller_paid_lender_policy eq 'True'>
   <cfset temp = AddQueryItem(1109, "Title Insurance Premium", NumberFormat(a_ins_premium-35, '_____.__'), "Buyer")>
   <cfset temp = AddQueryItem(1109, "Title Insurance Premium", NumberFormat(35, '_____.__'), "Seller")>
   <cfelse>
   <cfset temp = AddQueryItem(1109, "Title Insurance Premium", NumberFormat(a_ins_premium, '_____.__'), "Buyer")>
   </cfif>
<cfelse>
