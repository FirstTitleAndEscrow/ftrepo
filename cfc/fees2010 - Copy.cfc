...
<!--- let's grab the current 1101 --->
<cfloop query="fees_query">
<cfif IsNumeric(fees_query.amount) and fees_query.line_number eq 1101>
<cfset roll_up_1101 = fees_query.amount>
</cfif>
</cfloop>


<!--- if it's a construction loan, throw out all the usual 1101 and use these sets --->
<!--- throw out 1101s and subtract their values from the 1101 total --->

<cfquery dbtype="query" name="fee_detail"> 
SELECT *
FROM fees_query
where (line_number = 0 <cfif arguments.property_state eq 'PA' or arguments.property_state eq 'ND'>and description != 'Optional Detitling Fee'</cfif>)
<cfif arguments.property_state eq 'PA' or arguments.property_state eq 'ND'>
<!--- if it's PA or ND we're also gonna toss out the 1102 --->
or line_number = 1102
</cfif>
or description = 'Closing Protection Letter Fee'
order by line_number
</cfquery>


<!--- now let's loop through these and add them up so e can subtract them from the current 1101 --->
<cfloop query="fee_detail">
<cfif IsNumeric(fee_detail.amount) and fee_detail.amount gt 0>
<cfset roll_up_1101 = roll_up_1101 - #fee_detail.amount#>
</cfif>
</cfloop>

<!--- now let's make a new "fees_query" that doesn't contain the 1101s --->

<cfquery dbtype="query" name="fee_detail"> 
SELECT *
FROM fees_query
where (line_number <> 0 and line_number <> 1101 <cfif arguments.property_state eq 'PA' or arguments.property_state eq 'ND'>and description != 'Optional Detitling Fee'</cfif>)
<cfif arguments.property_state eq 'PA' or arguments.property_state eq 'ND'>
<!--- if it's PA or ND we're also gonna toss out the 1102 --->
and line_number <> 1102
</cfif>
and description != 'Closing Protection Letter Fee'
order by line_number
</cfquery>
...
<cfif arguments.property_state eq 'MD' or arguments.property_state eq 'VA'>
  <cfif arguments.closing_type eq '1' or arguments.closing_type eq '3'>
	<cfset temp = AddQueryItem(0, 'Settlement Fee', NumberFormat(395, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 395>
  <cfelseif arguments.closing_type eq '2'>
	<cfset temp = AddQueryItem(0, 'Settlement Fee', NumberFormat(595, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 595>
  </cfif>
	<cfset temp = AddQueryItem(0, 'Abstract Fee', NumberFormat(100, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 100>
	<cfif arguments.construction_draws gt 0>
	<cfset draw_total = arguments.construction_draws * 100>
	<cfset temp = AddQueryItem(0, 'Update Review and Endorsement Fee', NumberFormat(draw_total, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + draw_total>
	<cfset bring_down_total = arguments.construction_draws * 10>
	<cfset temp = AddQueryItem(0, 'Per Draw/Bring Down', NumberFormat(bring_down_total, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + bring_down_total>
	</cfif>
	<cfset temp = AddQueryItem(0, 'Title Exam Fee', NumberFormat(175, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 175>
	<cfset temp = AddQueryItem(0, 'ICL', NumberFormat(20, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 20>
	<cfset temp = AddQueryItem(0, 'Binder', NumberFormat(75, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 75>
	<cfset temp = AddQueryItem(0, 'Recording Service Fee', NumberFormat(45, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 45>
	<cfset temp = AddQueryItem(0, 'MLA Hazard Fee', NumberFormat(100, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 100>
	<cfif treat_as_refi eq 1>
	<cfif arguments.loan_amount gt arguments.previous_loan_amount>
	<cfset new_money = arguments.loan_amount - arguments.previous_loan_amount>
	<cfset hazard_ins = new_money / 1000>
	<cfset temp = AddQueryItem(0, 'Hazard Risk Premium', NumberFormat(hazard_ins, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + hazard_ins>
	</cfif>
	</cfif>
	<cfif treat_as_purchase eq 1>
...
<cfelseif arguments.property_state eq 'PA'>
  <cfif arguments.closing_type eq '1' or arguments.closing_type eq '3'>
	<cfset temp = AddQueryItem(0, 'Closing Services Fee', NumberFormat(225, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 225>
  <cfelseif arguments.closing_type eq '2'>
	<cfset temp = AddQueryItem(0, 'Closing Services Fee', NumberFormat(280, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 280>
  </cfif>
  	<cfif arguments.construction_draws gt 0>
	<cfset draw_total = arguments.construction_draws * 75>
	<cfset temp = AddQueryItem(0, 'Construction Draws', NumberFormat(draw_total, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + draw_total>
	</cfif>
	<cfset temp = AddQueryItem(1102, 'Signing Fee to TP Agent Signer', NumberFormat(125, '_____.__'), "Buyer", 1)>
	<cfset roll_up_1101 = roll_up_1101 + 125>
	<cfset temp = AddQueryItem(0, 'PA.End', NumberFormat(75, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 75>
<cfelseif arguments.property_state eq 'ND'>
  ...
  <cfelseif arguments.closing_type eq '2'>
	...
	<cfset temp = AddQueryItem(0, 'Construction Draws', NumberFormat(draw_total, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + draw_total>
	<cfset temp = AddQueryItem(1102, 'Signing Fee to TP Agent Signer', NumberFormat(150, '_____.__'), "Buyer", 1)>
	<cfset roll_up_1101 = roll_up_1101 + 150>
	<cfset temp = AddQueryItem(0, 'Exam', NumberFormat(295, '_____.__'), "Buyer", 0)>
	<cfset roll_up_1101 = roll_up_1101 + 295>
</cfif>

<!--- now add in the new 1101 --->
<cfset temp = AddQueryItem(1101, "Title Services and Lender's Title Insurance", NumberFormat(roll_up_1101, '_____.__'), "Buyer", 0)>
...
<!--- <cfoutput>arguments.closing_type = #arguments.closing_type#</cfoutput><br> --->

<!--- if it's a perm loan --->
<cfif arguments.closing_type eq '3'>
<cfloop query="fee_detail">
<cfif IsNumeric(fee_detail.amount) and fee_detail.line_number eq 1104>
<!--- SUBRACTED <cfoutput>#fee_detail.amount#</cfoutput><br> --->
<cfset roll_up_1101 = roll_up_1101 - #fee_detail.amount#>
</cfif>
</cfloop>
...
<cfloop query="fee_detail">
<cfif IsNumeric(fee_detail.amount) and fee_detail.line_number eq 1201>
<!--- SUBRACTED <cfoutput>#fee_detail.amount#</cfoutput><br> --->
<cfset current_1201 = #fee_detail.amount#>
</cfif>
</cfloop>

<!--- now let's get the previous file's loan_amount --->
<cfset old_loan_amount = arguments.end_loan_original_loan_amount>
<!--- let's toss out 1101, 1107, 1108, and 1104, and 999  --->
<cfquery dbtype="query" name="fee_detail"> 
SELECT *
FROM fees_query
where (line_number <> 1101
and line_number <> 1104
and line_number <> 1107
and line_number <> 1108
and line_number <> 999
and line_number <> 0
and line_number <> 1201
and line_number <> 1203
and line_number <> 1204
and line_number <> 1205
and line_number <> 1202
)
or
(line_number = 0 and description like '%ICL%')
or
(line_number = 0 and description like '%Abstract%')
order by line_number
</cfquery>

<cfset fees_query = fee_detail>

<cfif (arguments.loan_amount gte old_loan_amount)>
<cfset temp_arguments_loan_amount = arguments.loan_amount>
<cfset arguments.loan_amount = temp_arguments_loan_amount - old_loan_amount>

<cfset temp = #GetRecFees(arguments.transaction_type,arguments.property_state,arguments.property_county,arguments.property_city,arguments.loan_amount,arguments.purchase_price,arguments.previous_loan_amount,arguments.property_use_type,arguments.company_id,arguments.return_data,arguments.previous_loan_month,arguments.previous_loan_year,arguments.previous_purch_year,arguments.previous_purch_month,arguments.previous_purch_amount,arguments.enhanced_coverage,arguments.same_lender,arguments.reissue_rates,arguments.jlp_policy,arguments.property_report,arguments.appraised_value,arguments.seller_paid_lender_policy,arguments.seller_paid_owner_policy,arguments.buyer_paid_lender_policy,arguments.buyer_paid_owner_policy,arguments.asset_manager,arguments.cema,arguments.transfer_tax_paid_by,arguments.title_id,arguments.first_time_buyer,arguments.encompass,arguments.underwriter_choice,arguments.delinquency,arguments.insured,arguments.assessed_value,arguments.new_deed,arguments.current_deed_num,arguments.spouses_removed,arguments.non_spouses_removed,arguments.spouses_added,arguments.non_spouses_added)#>

<cfset arguments.loan_amount = temp_arguments_loan_amount>

</cfif>

<!--- now let's re-add the 1100s --->
<cfset roll_up_1101 = 0>
<cfloop query="fees_query">
<cfif IsNumeric(fee_detail.amount) and ((fee_detail.line_number gt 1101 and fee_detail.line_number lt 1200 and fee_detail.line_number NEQ 1105 and fee_detail.line_number NEQ 1106) or fee_detail.line_number eq 0) and fee_detail.payer eq 'Buyer'>
<!--- SUBRACTED <cfoutput>#fee_detail.amount#</cfoutput><br> --->
<cfset roll_up_1101 = roll_up_1101 + #fee_detail.amount#>
</cfif>
</cfloop>

<!--- now we gotta figre out the new lender's insurance --->

<cfif (old_loan_amount eq arguments.loan_amount) or (old_loan_amount gt arguments.loan_amount)>
	<cfset mod_rate = #getModRate(arguments.loan_amount,arguments.property_state)#>
	<cfset new_1104 = mod_rate>
<cfelseif old_loan_amount lt arguments.loan_amount>
	<!--- get the mod rate based on the old_loan_amount then use rate_table to get refi column for difference between old and new loan --->
	<cfset mod_rate = #getModRate(old_loan_amount,arguments.property_state)#>
	<cfset loan_diff = arguments.loan_amount - old_loan_amount>
			<CFQUERY datasource="#request.dsn#" NAME="get_new_rate">
			select *
			from #get_table.table_to_use#
			where a_to >= #loan_diff#
			order by a_to
			</CFQUERY>
	<cfif arguments.property_state eq 'VA'>
	<cfset diff_rate = get_new_rate.refinance * .80>
	<cfelse>
	<cfset diff_rate = get_new_rate.refinance>
	</cfif>
	<cfset new_1104 = mod_rate + diff_rate>
...
<cfif arguments.property_state eq 'VA'>
<cfset temp = AddQueryItem(1202, "Release Fee", NumberFormat(41, '_____.__'), "Buyer", 1)>
<cfif (arguments.loan_amount lte old_loan_amount)>
<cfset temp = AddQueryItem(1202, "Mortgage Recording Fee", NumberFormat(56, '_____.__'), "Buyer", 1)>
</cfif>
</cfif>
	


<!--- now let's re-add the 1201 --->
<cfset roll_up_1201 = 0>
<cfloop query="fees_query">
<cfif IsNumeric(fee_detail.amount) and (fee_detail.line_number eq 1202)>
<cfset roll_up_1201 = roll_up_1201 + #fee_detail.amount#>
</cfif>
</cfloop>
...
<!--- now let's re-add the 1203 --->
<cfset roll_up_1203 = 0>
<cfloop query="fees_query">
<cfif IsNumeric(fee_detail.amount) and (fee_detail.line_number gt 1203 and fee_detail.line_number lt 1300)>
<cfset roll_up_1203 = roll_up_1203 + #fee_detail.amount#>
</cfif>
</cfloop>

<!--- now let's pt 1203 back into the query --->
<cfset temp = AddQueryItem(1203, "Transfer Taxes", NumberFormat(roll_up_1203, '_____.__'), "Buyer", 0)>



<!--- now just add the new lenders insurance --->
<cfset temp = AddQueryItem(1104, "Lender's Title Insurance", NumberFormat(new_1104, '_____.__'), "Buyer", 1)>
<cfset temp = AddQueryItem(999, "Lender's Title Insurance Pre-Alta", NumberFormat(new_1104, '_____.__'), "Buyer", 0)>
<cfset new_1101 = new_1104 + roll_up_1101>
<cfset temp = AddQueryItem(1101, "Title Services and Lender's Title Insurance", NumberFormat(new_1101, '_____.__'), "Buyer", 0)>
...
<cfelseif request.which_bulk_rate_used eq 'Stewart' or request.which_bulk_rate_used eq 'Chcago Rates'  or request.which_bulk_rate_used eq 'Chcago Local Rates' >
...
<cfset temp = AddQueryItem(new_line, "Attorney Disbursement Fee to PC Law Associates", NumberFormat(85, '_____.__'), "Buyer", 1)>
<cfset roll_up_1101 = roll_up_1101 + 85>
<cfset temp = AddQueryItem(new_line, "Marketable Title Letter Fee to PC Law Associates", NumberFormat(45, '_____.__'), "Buyer", 1)>
<cfset roll_up_1101 = roll_up_1101 + 45>

<cfelseif arguments.property_state eq 'WV'>
<cfset temp = AddQueryItem(new_line, "Attorney Disbursement Fee to Jeremiah F. McCormick, Atty", NumberFormat(150, '_____.__'), "Buyer", 1)>
<cfset roll_up_1101 = roll_up_1101 + 150>

<cfelseif arguments.property_state eq 'SC'>
<cfset temp = AddQueryItem(new_line, "Attorney Disbursement Review Fee to John A. DeFede Esq", NumberFormat(30, '_____.__'), "Buyer", 1)>
<cfset roll_up_1101 = roll_up_1101 + 30>

<cfelseif arguments.property_state eq 'NC'>
<cfset temp = AddQueryItem(new_line, "Attorney Review Fee to J. Gregory Fagan", NumberFormat(30, '_____.__'), "Buyer", 1)>
<cfset roll_up_1101 = roll_up_1101 + 30>
<cfset new_line = DetermineAltaLine()>
...
<cfset roll_up_1101 = roll_up_1101 + 75>
<cfset new_line = DetermineAltaLine()>
<cfset temp = AddQueryItem(new_line, "Doc Prep Fee to Cottonwood Title", NumberFormat(25, '_____.__'), "Buyer", 1)>
<cfset roll_up_1101 = roll_up_1101 + 25>


<cfelseif arguments.property_state eq 'CA'>
<cfset new_line = DetermineAltaLine()>
<cfset temp = AddQueryItem(new_line, "Escrow Fee to North American Title Company", NumberFormat(450, '_____.__'), "Buyer", 1)>
<cfset roll_up_1101 = roll_up_1101 + 450>
...
<cfset surcharge_payee = ' to North American Title'>
	...
	<cfif arguments.property_state eq 'IL'>
      <cfset temp = AddQueryItem(1110, 'Illinois Fee', NumberFormat(3, '_____.__'), "Buyer", 1)>
...
<cfset temp = AddQueryItem(new_alta_line, "Overnight Fee to First Title", NumberFormat(20, '_____.__'), "Buyer", 1)>
</cfif>
<cfif arguments.underwriter_choice eq 16>
...
<cfif arguments.loan_amount neq '' and arguments.loan_amount GT 0 and arguments.underwriter_choice eq 30>
	...
	<cfif arguments.property_state eq 'TX'>
		<cfset new_alta_line1 = DetermineAltaLine()>	
		<cfset temp = AddQueryItem(new_alta_line1, "E-Recording Service Fee to Title & Escrow of Texas", NumberFormat(4, '_____.__'), "Buyer", 1)>
		<cfset roll_up_1101 = roll_up_1101 + 4>
	</cfif>
