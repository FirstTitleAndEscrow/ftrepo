...
<cfset catch_url = "http://www.firsttitleservices.com/integra2/catch_outgoing.cfm">


<cffunction name="throwError" output="true">
	<cfargument name="message" required="true">
	<cfargument name="condition" required="true">
	<cfargument name="integra_transaction_id" required="no">
...
<cffunction name="SuccessfulOrder" output="false">
	<cfargument name="message" required="true">
	<cfargument name="integra_transaction_id" required="true">
