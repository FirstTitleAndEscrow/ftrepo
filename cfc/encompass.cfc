...
<cffunction name="throwError" output="true">
	...
	<cfargument name="encompass_transaction_id" required="no">
...
<cfif embed_file neq "">
<ATTACHMENT MIMETypeDescription="application/pdf" EncodingTypeDescription="Base64" Type="TitleCommitment">#embed_file#</ATTACHMENT>
</cfif>
<cfif embed_file_2 neq "">
<ATTACHMENT MIMETypeDescription="application/pdf" EncodingTypeDescription="Base64" Type="Closing Disclosure">#embed_file_2#</ATTACHMENT>
</cfif>
...
<cffunction name="SuccessfulOrder" output="false">
	<cfargument name="message" required="true">
	<cfargument name="encompass_transaction_id" required="true">
