...
Dear #read_title.pname#<br><br>          

We are pleased be working with you and #bankerName# on the Title and Closing for your customer, #read_title.bfirstname1# #read_title.blastname1#, LOAN## #read_title.loan_number#.  We will work closely with you both toward a clear to close Title and final closing experience.    
<br><br>
...
Toll-free number with extension:  1-866-484-8537, EXT. 358<br>
...
Loan Processor <BR>
Phone: <BR>
#read_title.pphone#<BR>
Email: <BR>
#read_title.p_email# <BR>
