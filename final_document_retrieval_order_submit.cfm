...
<FONT FACE=ARIAL SIZE=2 color="red">
	<br><br>
<center><B>OUR RECORDS INDICATE THAT YOU HAVE RECENTLY ORDERED FINAL DOCUMENT RETRIEVAL WITH US!
...
FROM="webmaster@firsttitleservices.com"
SERVER="127.0.0.1"
Subject="Copy of Customer Order with 1st Title & Escrow, Inc. FDR-#get_fdrid.fdr_id#-#get_fdrid.bfirstname1# #get_fdrid.blastname1#"
TIMEOUT="600"
type="HTML"
>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Final Document Retrieval Order has been Processed. Order number is <a href="https://#cgi.server_name#/view_the_fdr_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_fdrid.fdr_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>FDR-0232#get_fdrid.fdr_id#</b></a></center><br>
...
<TABLE WIDTH=770 BORDER=1 CELLSPACING=1 align="center" bgcolor=d3d3d3>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
				...
				<p>
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Final Document Retrieval Order has been Processed. Order number is <a href="https://#cgi.server_name#/view_the_fdr_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_fdrid.fdr_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>FDR-#get_fdrid.fdr_id#</b></a></center><br>
...
FROM="webmaster@firsttitleservices.com"
SERVER="127.0.0.1"
Subject="KCopy of Customer Order with 1st Title & Escrow, Inc. FDR-#get_fdrid.fdr_id#-#get_fdrid.bfirstname1# #get_fdrid.blastname1#"
TIMEOUT="600"
type="HTML"
>
