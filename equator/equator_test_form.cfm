...
<cfhttp url="https://servicemartbeta.equator.com/VendorIntegrationInbound-VendorOrderWS/FnmaTitleVendorOrderWS?wsdl" method="post" resolveurl="no">
...
<form action="equator_test_form.cfm" method="post">
