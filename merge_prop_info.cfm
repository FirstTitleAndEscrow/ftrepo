...
<cfcatch type="Any">
	...
	<cfoutput>
			<CFQUERY datasource="#request.dsn#" >
				INSERT INTO title (user_id, comp_id, loan_off_id, oname, ophone, oext, ofax, o_email, pname,
						...
						rptbyemail, a_insert_date, a_insert_time, duedate, order_date_adjusted, oda_day, oda_month, oda_year, oda_day_of_year, appraisal_status, a_day, a_month, a_year, a_day_of_year, polender1, poacctno1, pophone1, polender2, poacctno2, pophone2, order_status)
				VALUES('#get_titleid1.user_id#', '#get_titleid1.comp_id#',	'#get_titleid1.loan_off_id#', '#get_titleid1.oname#', '#get_titleid1.ophone#',
						...
						'#get_titleid1.rptbyemail#', '#a_insert_date#', '#a_insert_time#', '#duedate#','#order_date_adj#', '#a_day_1#', '#a_month_1#', '#a_year_1#', '#oda_day_of_year_1#', 'In Process', '#a_day_1#', '#a_month_1#', '#a_year_1#',	'#a_day_of_year_1#', '#get_titleid1.polender1#', '#poacctno1#', '#get_titleid1.pophone1#', '#get_titleid1.polender2#', '#get_titleid1.poacctno2#', '#get_titleid1.pophone2#', 1)
	...
	<!---			Insert into title_Ins_add(title_id,Type,Seq_Num,Data1,Data2,Data3,Data4,Data5,Data6,Data7,Data8,Data9,Data10,Data11, _
		Data12,Data13,Data14,Data15,Data16,Data17,Data18,Data19,Data20,Data21,Data22,Data23,Data24,Data25,Data26,Data27,Data28, _
		Data29,Data30,Data31,Data32,Data33,Data34,Data35,Notes,status,insert_date,insert_time,Data36,Data37,Data38,complete, _
		Data39,lienintro,addreq,addex)
		Values(#get_titleid.title_ID#,'#Type#',#Seq_Num#,'#Data1#','#Data2#','#Data3#','#Data4#','#Data5#','#Data6#','#Data7#','#Data8#','#Data9#','#Data10#','#Data11#', _
		'#Data12#','#Data13#','#Data14#','#Data15#','#Data16#','#Data17#','#Data18#','#Data19#','#Data20#','#Data21#','#Data22#','#Data23#','#Data24#','#Data25#','#Data26#','#Data27#','#Data28#', _
		'#Data29#','#Data30#','#Data31#','#Data32#','#Data33#','#Data34#','#Data35#','#Notes#','#status#','#insert_date#','#insert_time#','#Data36#','#Data37#','#Data38#','#complete#', _
		'#Data39#','#lienintro#','#addreq#','#addex#') ---->
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_deed_view">
		...
		<cfoutput query = "read_deed_view">

		<cfquery  datasource="#request.dsn#">
			INSERT INTO
				title_ins_view (title_id, type, seq_num, status, insert_date, insert_time, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data37, data38, notes, addreq, addex,selectedorgs,selectedorgs2,selectedorgs3,selectedorgs4,selectedorgs5,selectedorgs6,selectedorgs7)
				VALUES (#get_titleid.title_id#, 'DATA', '#seq_num#', 'O', '#c_date#', '#c_time#', '#data1#', '#data2#', '#data3#', '#data4#', '#data5#', '#data6#', '#data7#', '#data8#', '#data9#', '#data10#', '#data11#', '#data12#', '#data13#', '#data14#', '#data15#', '#data16#', '#data17#', '#data37#', '#data38#', '#notes#', '#addreq#', '#addex#','#selectedorgs#','#selectedorgs2#','#selectedorgs3#','#selectedorgs4#','#selectedorgs5#','#selectedorgs6#','#selectedorgs7#')


			<!---INSERT INTO
				title_ins_view (Type,Seq_Num,Data1,Data2,Data3,Data4,Data5,Data6,Data7,Data8,Data9,Data10,Data11,Data12,Data13,Data14,Data15,Data16,Data17,Data18,Data19,Data20,Data21,Data22,Data23,Data24,Data25,Data26,Data27,Data28, Data29,Data30, Data31,Data32,Data33,Data34,Data35,	Notes, selectedorgs, selectedorgs2, selectedorgs3, selectedorgs4, selectedorgs5, selectedorgs6,selectedorgs7,status, insert_date, insert_time, Data36, Data37,Data38,Data39, lienintro,addreq,addex)
				VALUES (#get_titleid.title_id#,'#Type#',#Seq_Num#,'#Data1#','#Data2#','#Data3#','#Data4#','#Data5#','#Data6#','#Data7#','#Data8#','#Data9#','#Data10#','#Data11#','#Data12#','#Data13#','#Data14#','#Data15#','#Data16#','#Data17#','#Data18#','#Data19#','#Data20#','#Data21#','#Data22#','#Data23#','#Data24#','#Data25#','#Data26#','#Data27#','#Data28#','#Data29#','#Data30#','#Data31#','#Data32#','#Data33#','#Data34#','#Data35#','#Notes#',#selectedorgs#,#selectedorgs2#,#selectedorgs3#,#selectedorgs4#,#selectedorgs5#,#selectedorgs6#,#selectedorgs7#,'#status#', '#insert_date#','#insert_time#','#Data36#','#Data37#','#Data38#','#Data39#','#lienintro#','#addreq#','#addex#')--->
			<!---Insert into title_Ins_add(title_id,Type,Seq_Num,Data1,Data2,Data3,Data4,Data5,Data6,Data7,Data8,Data9,Data10,Data11, _
		Data12,Data13,Data14,Data15,Data16,Data17,Data18,Data19,Data20,Data21,Data22,Data23,Data24,Data25,Data26,Data27,Data28, _
		Data29,Data30,Data31,Data32,Data33,Data34,Data35,Notes,selectedorgs,status,insert_date,insert_time,Data36,Data37,Data38,complete, _
		Data39,lienintro,addreq,addex)
		Values(#get_titleid.title_ID#,'#Type#',#Seq_Num#,'#Data1#','#Data2#','#Data3#','#Data4#','#Data5#','#Data6#','#Data7#','#Data8#','#Data9#','#Data10#','#Data11#', _
		'#Data12#','#Data13#','#Data14#','#Data15#','#Data16#','#Data17#','#Data18#','#Data19#','#Data20#','#Data21#','#Data22#','#Data23#','#Data24#','#Data25#','#Data26#','#Data27#','#Data28#', _
		'#Data29#','#Data30#','#Data31#','#Data32#','#Data33#','#Data34#','#Data35#','#Notes#','#status#','#insert_date#','#insert_time#','#Data36#','#Data37#','#Data38#','#complete#', _
...
FROM="#team_email#" Subject="#get_titleid.bfirstname1# #get_titleid.blastname1# -- Order: #get_titleid.title_id# -- Loan Number: #get_titleid.loan_number# -- Title Insurance Commitment"
TIMEOUT="600"
type="HTML"
	>
...
<CFSET b_emails_to_first_title = "spape@firsttitleservices.com,akumar@firsttitleservices.com,malvarez@firsttitleservices.com,tjustice@firsttitleservices.com,msmith@firsttitleservices.com,pgibb@firsttitleservices.com">
	<CFMAIL
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Title Commitment Request Order has been Processed and Completed. You updated Title Commitment has been emailed to you.  Order number is <a href="https://#cgi.server_name#/view_the_order.cfm?comp_id=#get_titleid.comp_id#&order_id=#get_titleid.title_id#&user_id_1=#get_titleid.USER_ID#&lo_id=#get_titleid.loan_off_id#"><b>T-#get_titleid.title_id#</b></a></center><br>
				<cfif get_titleid.comp_id neq 3889>
...
instantly prepared for you! Click <a href="https://#cgi.server_name#/title_view_hud_pg1.cfm?comp_id=#get_titleid.comp_id#&rec_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center></cfif><br>
...
<td HEIGHT="17" VALIGN="Middle" BGCOLOR="White"><a class="lnk_mhtab" href="./view_the_prop_order_pre.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#"><b><font face="verdana,arial,helvetica" color="003399" size="1">Pre-Closing Data</font></b></a></td>
...
<CFIF (#read_current_Commitment_Clauses.s_status# GT "")><a class="lnk_mhsubnav" href="./property_report.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Property Report</font></a>
<cfif #read_prop_order2.recordcount# GT 0>
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
<a class="lnk_mhsubnav" href="./merge_prop_info.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Merge to Title Commitment</font></a>
...
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
<a class="lnk_mhsubnav" href="./merge_prop_info.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Merge to Title Commitment</font></a>
<font face="arial,helvetica" color="gray" size="2">Property Report</font>
</cfif>
</cfif>

<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
<cfif #read_title_order.hud# eq 1>
...
<cfoutput>			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER(S)</B></center><br><p>
					...
					<center>Your Title Commitment Request Order has been Processed. Order number is <a href="./view_the_order.cfm?comp_id=#comp_id#&order_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>T-#get_titleid.title_id#</b></a></center><br>
					<center>A HUD-1 has been
					instant prepared for you! Click
					<cfif #read_title.hud_type# eq "0">
						<a href="./title_view_hud_pg1.cfm?rec_id=#get_titleid.title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a>
						<cfelse> <a href="./title_view_hud1a.cfm?rec_id=#get_titleid.title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a>
						</cfif>now OR view <a href="https://#cgi.server_name#/fee_sheet.cfm?comp_id=#comp_id#&rec_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>closing fees</b></a>.</center><br>
...
<CFFORM NAME="frm" ACTION="./merge_prop_info.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=10" ENCTYPE="multipart/form-data" METHOD=POST >
