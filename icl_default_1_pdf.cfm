...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="get_email_date">
...
after the date of this letter, provided: <BR>
<BR>
&nbsp;&nbsp;&nbsp;A) the Company issues or is contractually obligated to issue title insurance for your protection in connection with the closing of the Real Estate Transaction;  <BR><BR>

&nbsp;&nbsp;&nbsp;(B) you are to be the (i) lender secured by an Insured Mortgage, as defined in the ALTA Loan Policy (6-17-06), its assignee or a warehouse lender, (ii) purchaser of an interest in land, or (iii) lessee of an interest in land; and<BR><BR>

&nbsp;&nbsp;&nbsp;(C) the aggregate of all funds you transmit to the Issuing Agent or Approved Attorney for the Real Estate
Transaction does not exceed $5 million, and;<BR><BR>
...
require a determination of the validity, enforceability or the effectiveness of the other document, or <BR><BR>
