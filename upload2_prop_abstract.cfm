...
<FORM action="./upload2_prop_abstract_final.cfm?rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#"  ENCTYPE="multipart/form-data" method="post">
...
<tr>
		<td width=455 colspan=2 align=center valign=top>
			<font size=2 align=center color=red face=arial>
		Please enter the new Effective Date: <em>(mm-dd-yyyy)</em> <input type="text" name="effective_date" value=""><br>
		Please enter the new Search Date: <em>(mm-dd-yyyy)</em><input type="text" name="search_date" value=""><br>
		Are there any changes between this new version and the previous search?: <br>
<input type="radio" name="changes" value="0" checked> NO &nbsp;&nbsp;&nbsp;<input type="radio" name="changes" value="1" > YES
		<p>
