...
<CFINCLUDE TEMPLATE="admin_area/admin_property_report.cfm">
...
<b><font face=verdana size=2 color=blue>All selected item(s) were successfully merged to Property Report!</font></b>
	...
	<cfoutput>
Click here to go back to the main page.<a href="./prop_abstract_doc_view_c.cfm?username=#url.username#&password=#url.password#&rec_id=#url.rec_id#&company_id=0"><img src="./images/button_return.gif" border=0 ALT="Click this button to return to main"></a>
		</cfoutput>
