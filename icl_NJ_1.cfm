...
Senior VP/Chief    Underwriting    Counsel<BR>
...
&nbsp;&nbsp;&nbsp;When title insurance of Stewart Title Guaranty Company is specified for your protection in connection with the
closing of the above described real estate transaction in which you are to be a lender secured by a mortgage of an
interest in land, the Company, subject to the Conditions and Exclusions set forth below, hereby agrees to reimburse
you for actual loss incurred by you in connection with that closing when conducted by the above named Issuing Agent
(an agent authorized to issue title insurance for the Company) of Stewart Title Guaranty Company or the above named
Attorney when such loss arises out of:
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. Failure of the Issuing Agent or Attorney to comply with your written closing instructions to the extent that they
relate to (a) the title to said interest in land or the validity, enforceability and priority of the lien of said mortgage on said
interest in land, including the obtaining of documents and the disbursement of funds necessary to establish such of title
or lien, or (b) the collection and payment of funds due you, or
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Fraud or misapplication by the Issuing Agent or Attorney in handling your funds in connection with the matters
set forth in paragraph 1 above.
<br>
<br>
&nbsp;&nbsp;&nbsp;If you are a lender protected under the foregoing paragraph, your borrower in connection with a loan secured by a
mortgage on a one to four family dwelling, which is the principal residence of the borrower, shall be protected, but only
to the extent of the foregoing paragraph 2, as if this letter were addressed to your borrower. If you are a purchaser of a
one to four family dwelling, including a condominium unit, which is your principal residence, and are paying cash for the
purchase, you are protected, but only to the extent of the foregoing paragraph 2.<BR><BR>
<BR>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. Failure of the Issuing Agent or Attorney to comply with your closing instructions which require title insurance
...
failure, insolvency or suspension, except when such shall result from failure of the Issuing Agent or the Attorney to
comply with your written closing instructions to deposit the funds in a bank which you designated by name.
<br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Mechanics' and materialmen's liens in connection with a construction loan transaction, except to the extent
that protection against such liens is afforded by a title insurance binder, commitment or policy of the Company.
 <BR><BR>
