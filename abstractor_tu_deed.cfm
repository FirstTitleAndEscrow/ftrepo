...
<CFOUTPUT>
	<tr>
		<td width=798 align=center valign=top bgcolor=d3d3d3>
			<font size=2 color=green face=arial><b>Add Deed</b><font size=2 color=black face=arial>
			<p>
			<!--- Company - <B>#read_companies.company#</B> --->
			<p>
			Enter the deed info in the form below for order number <font size=2 color=green face=arial><b>#url.rec_id#</b>.
		</td>
	</tr>
</CFOUTPUT>
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/abstractor_tu_deed_submit.cfm?rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes">
...
<!--- ===/ LOAN PROCESSOR INFO \=== --->
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="Yes" Message="You must enter a value in Grantor 1 field" type=text name="grantor1"  size=40 maxlength=600
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="Yes" Message="You must enter a value for Grantee 1 field" type=text name="grantee1"  size=40 maxlength=600
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="Yes" Message="You must enter a value for Document Number field" type=text name="docnum" value=""  size=25 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="Yes" Message="You must enter a value for Book field" type=text name="book" value=""  size=25 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<nobr><cfselect name="inst_mon"
size="1"
 Required="Yes" Message="You must enter a value for the Month in Instrument Date field"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
								color: blue;
...
<cfselect name="inst_day"
size="1"
								Required="Yes" Message="You must enter a value for the Day in Instrument Date field"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
								color: blue;
...
<cfselect name="inst_year"
size="1"
								Required="Yes" Message="You must enter a value for the Month in Instrument Year field"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
								color: blue;
...
<option value="" SELECTED>Year</option>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<nobr><cfselect name="rec_mon"
size="1"
								Required="Yes" Message="You must enter a value for the Month in Recording Date field"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
								color: blue;
...
<cfselect name="rec_day"

Required="Yes"
Message="You must enter a value for the Day in Recording Date field"
								size="1"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
...
<cfselect name="rec_year"
size="1"
Required="Yes" Message="You must enter a value for the Year in Recording Date field"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
								color: blue;
...
<option value="" SELECTED>Year</option>
	...
	<td width=130 align=right valign=top bgcolor=e6e6e6>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="info" value=""  size=40 maxlength=150
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
...
<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="info2" value=""  size=40 maxlength=150
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
