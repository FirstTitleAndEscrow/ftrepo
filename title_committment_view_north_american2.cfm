...
SERVER="127.0.0.1"
Subject="#title_co_name# - North American Title Insurance Commitment for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#, Loan No: #read_title.loan_number#"
TIMEOUT="600"
type="HTML"
>

View/Print <A HREF="https://#cgi.server_name#/title_committment_view_first_american2.cfm?comp_id=115&user_id_1=723&lo_id=1217&rec_id=#rec_id#&a_trigger=1&company_id=0" >North American Title Insurance Commitment</a> for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#</B></font><br><br>
...
.withserifheader {font-family:Verdana, Arial, Helvetica, sans-serif; font:Verdana, Arial, Helvetica, sans-serif; font-size:24px;}
.withserif {font-family:Verdana, Arial, Helvetica, sans-serif; font:Verdana, Arial, Helvetica, sans-serif; font-size:12px;}
.contentstyle
{
  width:5.5in;
  height:8in;
...
<table width="93%" cellpadding=0 cellspacing=0 border=0 >
    <tr>
          <td>
<center><br>
<font size=3><B><span class="withserifheader"><strong>North American Title Insurance Company</strong></span></font><BR>
<span class="withserif"><strong>COMMITMENT FOR TITLE INSURANCE FORM</strong></span></B><br>
<br>
...
<tr>
		  <td align="left" valign="middle" bgcolor="ffffff"><BR><strong>THIS DOCUMENT CONSTITUTES A STATEMENT OF THE TERMS AND CONDITIONS ON WHICH A TITLE INSURER IS WILLING TO ISSUE A POLICY OF TITLE INSURANCE IF THE TITLE INSURER ACCEPTS THE PREMIUM FOR THE POLICY.  IT IS NOT A REPRESENTATION AS TO THE STATE OF TITLE AND IT DOES NOT CONSTITUTE AN ABSTRACT OF TITLE.</strong></td>
	</tr><!---     <tr>
...
<tr><td valign="bottom" colspan="2" style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:1px;">By: &nbsp;&nbsp;&nbsp;<cfif read_FT_company.ID eq 2632 or read_FT_company.master_co_id eq 2632><img src="../images/alan_sig.jpg"><CFELSEIF #read_Title.pstate# eq "CA" or #read_Title.pstate# eq "NV"><img src="../images/steve_sig.jpg"><CFELSE><img src="../images/steve_sig.jpg"></CFIF>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Authorized Signatory</td>
        ...
        <tr>
          <td colspan="4" valign="top"> <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr>
                <td valign="middle" width="60%" align="left" colspan="2"><br>
<br>
<br>
<br>
<br>
...
<br>
<br>
<font color="black" size="1">ALTA Commitment (6-17-06) Schedule A<br>
...
<br>
<br>
SCHEDULE B - SECTION I</strong><br>
REQUIREMENTS
</center>
          </td>
    </tr>
...
<cfif #read_mortgage.data1# NEQ ""> <cfif read_mortgage.lienintro neq "" and read_mortgage.lienintro neq 'NULL' or Len(read_mortgage.lienintro) eq 0>#read_mortgage.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage.data2# <cfif #read_mortgage.data3# neq ""> and #read_mortgage.data3#</cfif> securing #read_mortgage.data1# in the original principal amount of #read_mortgage.data4#, as dated #DateFormat(read_mortgage.data8, "mm")#/#DateFormat(read_mortgage.data8, "dd")#/#DateFormat(read_mortgage.data8, "yyyy")# and recorded on #DateFormat(read_mortgage.data9, "mm")#/#DateFormat(read_mortgage.data9, "dd")#/#DateFormat(read_mortgage.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage.data5# eq ""><cfif #read_mortgage.data6# neq "">
	in Book #read_mortgage.data6# at Page #read_mortgage.data7# </cfif>
	<cfelse> in Document Number #read_mortgage.data5# 
			<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
			...
			<!---(end) -- Added by Synechron Development for ticket# 454 ------->	
</cfif><cfif #read_mortgage.data13# neq ""> Assigned to #read_mortgage.data13# recorded on #DateFormat(read_mortgage.data17, "mm")#/#DateFormat(read_mortgage.data17, "dd")#/#DateFormat(read_mortgage.data17, "yyyy")#, 
in Book <cfif #read_mortgage.data14# eq "">#read_mortgage.data15#, at Page #read_mortgage.data16# 
	<cfelse> in Document #read_mortgage.data14#
		<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
		...
		<cfif #len(read_mortgage.data15)# gt 0 AND #len(read_mortgage.data16)# gt 0 >
		 ...
		 <!---(end) -- Added by Synechron Development for ticket# 454 ------->	
		</cfif> </cfif><cfif #read_mortgage.data18# neq "">Assigned to #read_mortgage.data18# recorded on #DateFormat(read_mortgage.data22, "mm")#/#DateFormat(read_mortgage.data22, "dd")#/#DateFormat(read_mortgage.data22, "yyyy")#, <cfif #read_mortgage.data19# eq "">
			in Book #read_mortgage.data20#, at Page #read_mortgage.data21# 
			<cfelse> in Document #read_mortgage.data19#
					<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
		...
		</cfif> </cfif><cfif #read_mortgage.data23# neq "">Assigned to #read_mortgage.data23# recorded on #DateFormat(read_mortgage.data27, "mm")#/#DateFormat(read_mortgage.data27, "dd")#/#DateFormat(read_mortgage.data27, "yyyy")#, <cfif #read_mortgage.data24# eq "">
			 in Book #read_mortgage.data25#, at Page #read_mortgage.data26# 
			 <cfelse> in Document #read_mortgage.data24#
				<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
				...
				<cfif #len(read_mortgage.data25)# gt 0 AND #len(read_mortgage.data26)# gt 0 >
				 ...
				 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 			 
			</cfif> </cfif><cfif #read_mortgage.data28# neq "">Assigned to #read_mortgage.data28# recorded on #DateFormat(read_mortgage.data32, "mm")#/#DateFormat(read_mortgage.data32, "dd")#/#DateFormat(read_mortgage.data32, "yyyy")#, <cfif #read_mortgage.data29# EQ "">
				 in Book #read_mortgage.data30#, at Page #read_mortgage.data31# 
				 <cfelse> in Document #read_mortgage.data29#
				<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
            ...
            <cfif #read_mortgage2.data1# NEQ ""> <cfif read_mortgage2.lienintro neq "" and read_mortgage2.lienintro neq 'NULL' or Len(read_mortgage2.lienintro) eq 0>#read_mortgage2.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage2.data2# <cfif #read_mortgage2.data3# neq ""> and #read_mortgage2.data3#</cfif> securing #read_mortgage2.data1# in the original principal amount of #read_mortgage2.data4#, as dated #DateFormat(read_mortgage2.data8, "mm")#/#DateFormat(read_mortgage2.data8, "dd")#/#DateFormat(read_mortgage2.data8, "yyyy")# and recorded on #DateFormat(read_mortgage2.data9, "mm")#/#DateFormat(read_mortgage2.data9, "dd")#/#DateFormat(read_mortgage2.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage2.data5# eq ""><cfif #read_mortgage2.data6# neq "">
				...
				<cfelse> in Document Number #read_mortgage2.data5#
					...
					<cfif #len(read_mortgage2.data6)# gt 0 AND #len(read_mortgage2.data7)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				
				</cfif><cfif #read_mortgage2.data13# neq ""> Assigned to #read_mortgage2.data13# recorded on #DateFormat(read_mortgage2.data17, "mm")#/#DateFormat(read_mortgage2.data17, "dd")#/#DateFormat(read_mortgage2.data17, "yyyy")#, 
				in Book <cfif #read_mortgage2.data14# eq "">#read_mortgage2.data15#, at Page #read_mortgage2.data16# 
					<cfelse> in Document #read_mortgage2.data14#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
					...
					</cfif> </cfif><cfif #read_mortgage2.data18# neq "">Assigned to #read_mortgage2.data18# recorded on #DateFormat(read_mortgage2.data22, "mm")#/#DateFormat(read_mortgage2.data22, "dd")#/#DateFormat(read_mortgage2.data22, "yyyy")#, <cfif #read_mortgage2.data19# eq "">
						in Book #read_mortgage2.data20#, at Page #read_mortgage2.data21# 
						<cfelse> in Document #read_mortgage2.data19#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						...
						<cfif #len(read_mortgage2.data20)# gt 0 AND #len(read_mortgage2.data21)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 						
					</cfif> </cfif><cfif #read_mortgage2.data23# neq "">Assigned to #read_mortgage2.data23# recorded on #DateFormat(read_mortgage2.data27, "mm")#/#DateFormat(read_mortgage2.data27, "dd")#/#DateFormat(read_mortgage2.data27, "yyyy")#, <cfif #read_mortgage2.data24# eq ""> 
						in Book #read_mortgage2.data25#, at Page #read_mortgage2.data26# 
						<cfelse> in Document #read_mortgage2.data24#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage2.data25)# gt 0 AND #len(read_mortgage2.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 						
					</cfif> </cfif><cfif #read_mortgage2.data28# neq "">Assigned to #read_mortgage2.data28# recorded on #DateFormat(read_mortgage2.data32, "mm")#/#DateFormat(read_mortgage2.data32, "dd")#/#DateFormat(read_mortgage2.data32, "yyyy")#, <cfif #read_mortgage2.data29# EQ ""> 
						in Book #read_mortgage2.data30#, at Page #read_mortgage2.data31# 
						<cfelse> in Document #read_mortgage2.data29#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage2.data30)# gt 0 AND #len(read_mortgage2.data31)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						
					</cfif> </cfif><cfif #read_mortgage2.data11# neq "">#read_mortgage2.data11#</cfif> <cfif #read_mortgage2.data12# neq "">#read_mortgage2.data12#</cfif></cfif><br><br>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      ...
	      <tr align="left" valign="top">
			...
			#read_lien.lienintro# <cfif read_lien.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien.data7# in favor of #read_lien.data6# in the amount of #read_lien.data5#,
           ...
           <cfif #read_mortgage3.data1# NEQ ""> <cfif read_mortgage3.lienintro neq "" and read_mortgage3.lienintro neq 'NULL' or Len(read_mortgage3.lienintro) eq 0>#read_mortgage3.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage3.data2# <cfif #read_mortgage3.data3# neq ""> and #read_mortgage3.data3#</cfif> securing #read_mortgage3.data1# in the original principal amount of #read_mortgage3.data4#, as dated #DateFormat(read_mortgage3.data8, "mm")#/#DateFormat(read_mortgage3.data8, "dd")#/#DateFormat(read_mortgage3.data8, "yyyy")# and recorded on #DateFormat(read_mortgage3.data9, "mm")#/#DateFormat(read_mortgage3.data9, "dd")#/#DateFormat(read_mortgage3.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage3.data5# eq ""><cfif #read_mortgage3.data6# neq "">
			...
			<cfelse> in Document Number #read_mortgage3.data5# 
				...
				<cfif #len(read_mortgage3.data6)# gt 0 AND #len(read_mortgage3.data7)# gt 0 >
				 ...
				 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 			
			</cfif><cfif #read_mortgage3.data13# neq ""> Assigned to #read_mortgage3.data13# recorded on #DateFormat(read_mortgage3.data17, "mm")#/#DateFormat(read_mortgage3.data17, "dd")#/#DateFormat(read_mortgage3.data17, "yyyy")#, 
			in Book <cfif #read_mortgage3.data14# eq "">#read_mortgage3.data15#, at Page #read_mortgage3.data16# 
				<cfelse> in Document #read_mortgage3.data14#
					<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
					...
					<cfelse>
					 in Document #read_mortgage3.data19#
					<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
					...
					<cfelse> in Document #read_mortgage3.data24#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
					...
					<cfelse> in Document #read_mortgage3.data29#
							...
							<cfif #len(read_mortgage3.data30)# gt 0 AND #len(read_mortgage3.data31)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 					
				</cfif> </cfif><cfif #read_mortgage3.data11# neq "">#read_mortgage3.data11#</cfif> <cfif #read_mortgage3.data12# neq "">#read_mortgage3.data12#</cfif></cfif><br>
<br>
           ...
           <cfif #read_mortgage4.data1# NEQ ""> <cfif read_mortgage4.lienintro neq "" and read_mortgage4.lienintro neq 'NULL' or Len(read_mortgage4.lienintro) eq 0>#read_mortgage4.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage4.data2# <cfif #read_mortgage4.data3# neq ""> and #read_mortgage4.data3#</cfif> securing #read_mortgage4.data1# in the original principal amount of #read_mortgage4.data4#, as dated #DateFormat(read_mortgage4.data8, "mm")#/#DateFormat(read_mortgage4.data8, "dd")#/#DateFormat(read_mortgage4.data8, "yyyy")# and recorded on #DateFormat(read_mortgage4.data9, "mm")#/#DateFormat(read_mortgage4.data9, "dd")#/#DateFormat(read_mortgage4.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage4.data5# eq ""><cfif #read_mortgage4.data6# neq "">
			...
			in Document Number #read_mortgage4.data5# 
			 ...
			 in Book <cfif #read_mortgage4.data14# eq "">#read_mortgage4.data15#, at Page #read_mortgage4.data16# 
				 <cfelse> in Document #read_mortgage4.data14#
					<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
					...
					</cfif> </cfif><cfif #read_mortgage4.data18# neq "">Assigned to #read_mortgage4.data18# recorded on #DateFormat(read_mortgage4.data22, "mm")#/#DateFormat(read_mortgage4.data22, "dd")#/#DateFormat(read_mortgage4.data22, "yyyy")#, <cfif #read_mortgage4.data19# eq "">
						in Book #read_mortgage4.data20#, at Page #read_mortgage4.data21#
						 <cfelse> in Document #read_mortgage4.data19#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage4.data20)# gt 0 AND #len(read_mortgage4.data21)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						 
					</cfif> </cfif><cfif #read_mortgage4.data23# neq "">Assigned to #read_mortgage4.data23# recorded on #DateFormat(read_mortgage4.data27, "mm")#/#DateFormat(read_mortgage4.data27, "dd")#/#DateFormat(read_mortgage4.data27, "yyyy")#, <cfif #read_mortgage4.data24# eq "">
						 in Book #read_mortgage4.data25#, at Page #read_mortgage4.data26# 
						 <cfelse> in Document #read_mortgage4.data24#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage4.data25)# gt 0 AND #len(read_mortgage4.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						 
					</cfif> </cfif><cfif #read_mortgage4.data28# neq "">Assigned to #read_mortgage4.data28# recorded on #DateFormat(read_mortgage4.data32, "mm")#/#DateFormat(read_mortgag4.data32, "dd")#/#DateFormat(read_mortgage4.data32, "yyyy")#, <cfif #read_mortgage4.data29# EQ ""> 
						in Book #read_mortgage4.data30#, at Page #read_mortgage4.data31# 
						<cfelse> in Document #read_mortgage4.data29#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
					...
					</cfif> </cfif><cfif #read_mortgage4.data11# neq "">#read_mortgage4.data11#</cfif> <cfif #read_mortgage4.data12# neq "">#read_mortgage4.data12#</cfif></cfif><br>
<br>
	      ...
	      <tr align="left" valign="top">
		    ...
		    <td>
             <cfif #read_mortgage5.data1# NEQ ""> <cfif read_mortgage5.lienintro neq "" and read_mortgage5.lienintro neq 'NULL' or Len(read_mortgage5.lienintro) eq 0>#read_mortgage5.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage5.data2# <cfif #read_mortgage5.data3# neq ""> and #read_mortgage5.data3#</cfif> securing #read_mortgage5.data1# in the original principal amount of #read_mortgage5.data4#, as dated #DateFormat(read_mortgage5.data8, "mm")#/#DateFormat(read_mortgage5.data8, "dd")#/#DateFormat(read_mortgage5.data8, "yyyy")# and recorded on #DateFormat(read_mortgage5.data9, "mm")#/#DateFormat(read_mortgage5.data9, "dd")#/#DateFormat(read_mortgage5.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage5.data5# eq ""><cfif #read_mortgage5.data6# neq "">
				in Book #read_mortgage5.data6# at Page #read_mortgage5.data7# </cfif>
				<cfelse> in Document Number #read_mortgage5.data5# 
					...
					<cfif #len(read_mortgage5.data6)# gt 0 AND #len(read_mortgage5.data7)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 					
			    </cfif><cfif #read_mortgage5.data13# neq ""> Assigned to #read_mortgage5.data13# recorded on #DateFormat(read_mortgage5.data17, "mm")#/#DateFormat(read_mortgage5.data17, "dd")#/#DateFormat(read_mortgage5.data17, "yyyy")#, 
			    in Book <cfif #read_mortgage5.data14# eq "">#read_mortgage5.data15#, at Page #read_mortgage5.data16# 
				    <cfelse> in Document #read_mortgage5.data14#
						...
						<cfif #len(read_mortgage5.data15)# gt 0 AND #len(read_mortgage5.data16)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->    
					</cfif> </cfif><cfif #read_mortgage5.data18# neq "">Assigned to #read_mortgage5.data18# recorded on #DateFormat(read_mortgage5.data22, "mm")#/#DateFormat(read_mortgage5.data22, "dd")#/#DateFormat(read_mortgage5.data22, "yyyy")#, <cfif #read_mortgage5.data19# eq "">
						in Book #read_mortgage5.data20#, at Page #read_mortgage5.data21# 
						<cfelse> in Document #read_mortgage5.data19#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						...
						<cfif #len(read_mortgage5.data20)# gt 0 AND #len(read_mortgage5.data21)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						
					</cfif> </cfif><cfif #read_mortgage5.data23# neq "">Assigned to #read_mortgage5.data23# recorded on #DateFormat(read_mortgage5.data27, "mm")#/#DateFormat(read_mortgage5.data27, "dd")#/#DateFormat(read_mortgage5.data27, "yyyy")#, <cfif #read_mortgage5.data24# eq "">
						 in Book #read_mortgage5.data25#, at Page #read_mortgage5.data26# 
						 <cfelse> in Document #read_mortgage5.data24#
								<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						...
						<cfif #len(read_mortgage5.data25)# gt 0 AND #len(read_mortgage5.data26)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 				 
					</cfif> </cfif><cfif #read_mortgage5.data28# neq "">Assigned to #read_mortgage5.data28# recorded on #DateFormat(read_mortgage5.data32, "mm")#/#DateFormat(read_mortgage5.data32, "dd")#/#DateFormat(read_mortgage5.data32, "yyyy")#, <cfif #read_mortgage5.data29# EQ ""> 
						in Book #read_mortgage5.data30#, at Page #read_mortgage5.data31# 
						<cfelse> 
						in Document #read_mortgage5.data29#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage5.data30)# gt 0 AND #len(read_mortgage5.data31)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 						
					</cfif> </cfif><cfif #read_mortgage5.data11# neq "">#read_mortgage5.data11#</cfif> <cfif #read_mortgage5.data12# neq "">#read_mortgage5.data12#</cfif></cfif><br>
<br>
          ...
          <cfif #read_mortgage6.data1# NEQ ""> <cfif read_mortgage6.lienintro neq "" and read_mortgage6.lienintro neq 'NULL' or Len(read_mortgage6.lienintro) eq 0>#read_mortgage6.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage6.data2# <cfif #read_mortgage6.data3# neq ""> and #read_mortgage6.data3#</cfif> securing #read_mortgage6.data1# in the original principal amount of #read_mortgage6.data4#, as dated #DateFormat(read_mortgage6.data8, "mm")#/#DateFormat(read_mortgage6.data8, "dd")#/#DateFormat(read_mortgage6.data8, "yyyy")# and recorded on #DateFormat(read_mortgage6.data9, "mm")#/#DateFormat(read_mortgage6.data9, "dd")#/#DateFormat(read_mortgage6.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage6.data5# eq ""><cfif #read_mortgage6.data6# neq "">
			...
			<cfif #len(read_mortgage6.data6)# gt 0 AND #len(read_mortgage6.data7)# gt 0 >
			 ...
			 in Book <cfif #read_mortgage6.data14# eq "">#read_mortgage6.data15#, at Page #read_mortgage6.data16# 
				 <cfelse> in Document #read_mortgage6.data14#
				<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
				...
				<cfif #len(read_mortgage6.data15)# gt 0 AND #len(read_mortgage6.data16)# gt 0 >
				 ...
				 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				 
					</cfif> </cfif><cfif #read_mortgage6.data18# neq "">Assigned to #read_mortgage6.data18# recorded on #DateFormat(read_mortgage6.data22, "mm")#/#DateFormat(read_mortgage6.data22, "dd")#/#DateFormat(read_mortgage6.data22, "yyyy")#, <cfif #read_mortgage6.data19# eq "">
						in Book #read_mortgage6.data20#, at Page #read_mortgage6.data21# 
						<cfelse> in Document #read_mortgage6.data19#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage6.data20)# gt 0 AND #len(read_mortgage6.data21)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 						
					</cfif> </cfif><cfif #read_mortgage6.data23# neq "">Assigned to #read_mortgage6.data23# recorded on #DateFormat(read_mortgage6.data27, "mm")#/#DateFormat(read_mortgage6.data27, "dd")#/#DateFormat(read_mortgage6.data27, "yyyy")#, <cfif #read_mortgage6.data24# eq ""> 
						in Book #read_mortgage6.data25#, at Page #read_mortgage6.data26# 
						<cfelse> in Document #read_mortgage6.data24#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage6.data25)# gt 0 AND #len(read_mortgage6.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 							
					</cfif> </cfif><cfif #read_mortgage6.data28# neq "">Assigned to #read_mortgage6.data28# recorded on #DateFormat(read_mortgage6.data32, "mm")#/#DateFormat(read_mortgage6.data32, "dd")#/#DateFormat(read_mortgage6.data32, "yyyy")#, <cfif #read_mortgage6.data29# EQ ""> 
						in Book #read_mortgage6.data30#, at Page #read_mortgage6.data31# 
						<cfelse> in Document #read_mortgage6.data29#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage6.data30)# gt 0 AND #len(read_mortgage6.data31)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 						
					</cfif> </cfif><cfif #read_mortgage6.data11# neq "">#read_mortgage6.data11#</cfif> <cfif #read_mortgage6.data12# neq "">#read_mortgage6.data12#</cfif></cfif><br>
<br>
			...
			in Book <cfif #read_mortgage7.data14# eq "">#read_mortgage7.data15#, at Page #read_mortgage7.data16# 
				<cfelse> in Document #read_mortgage7.data14#
					...
					<cfif #len(read_mortgage7.data15)# gt 0 AND #len(read_mortgage7.data16)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 	
				</cfif> </cfif><cfif #read_mortgage7.data18# neq "">Assigned to #read_mortgage7.data18# recorded on #DateFormat(read_mortgage7.data22, "mm")#/#DateFormat(read_mortgage7.data22, "dd")#/#DateFormat(read_mortgage7.data22, "yyyy")#, <cfif #read_mortgage7.data19# eq "">
					in Book #read_mortgage7.data20#, at Page #read_mortgage7.data21# 
					<cfelse> in Document #read_mortgage7.data19#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_mortgage7.data19)# gt 0 AND #len(read_mortgage7.data20)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_mortgage7.data20)# gt 0 AND #len(read_mortgage7.data21)# gt 0 >
							in Book #read_mortgage7.data20# at Page #read_mortgage7.data21# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						
				</cfif> </cfif><cfif #read_mortgage7.data23# neq "">Assigned to #read_mortgage7.data23# recorded on #DateFormat(read_mortgage7.data27, "mm")#/#DateFormat(read_mortgage7.data27, "dd")#/#DateFormat(read_mortgage7.data27, "yyyy")#, <cfif #read_mortgage7.data24# eq ""> 
					in Book #read_mortgage7.data25#, at Page #read_mortgage7.data26# 
					<cfelse> in Document #read_mortgage7.data24#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						...
						<cfif #len(read_mortgage7.data25)# gt 0 AND #len(read_mortgage7.data26)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						
				</cfif> </cfif><cfif #read_mortgage7.data28# neq "">Assigned to #read_mortgage7.data28# recorded on #DateFormat(read_mortgage7.data32, "mm")#/#DateFormat(read_mortgage7.data32, "dd")#/#DateFormat(read_mortgage7.data32, "yyyy")#, <cfif #read_mortgage7.data29# EQ ""> 
					in Book #read_mortgage7.data30#, at Page #read_mortgage7.data31# 
					<cfelse> in Document #read_mortgage7.data29#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						...
						<cfif #len(read_mortgage7.data30)# gt 0 AND #len(read_mortgage7.data31)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						
				</cfif> </cfif><cfif #read_mortgage7.data11# neq "">#read_mortgage7.data11#</cfif> <cfif #read_mortgage7.data12# neq "">#read_mortgage7.data12#</cfif></cfif><br>
<br>
			...
			in Book <cfif #read_mortgage8.data14# eq "">#read_mortgage8.data15#, at Page #read_mortgage8.data16# 
				<cfelse> in Document #read_mortgage8.data14#
					...
					<cfif #len(read_mortgage8.data15)# gt 0 AND #len(read_mortgage8.data16)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 ------->	
					</cfif> </cfif><cfif #read_mortgage8.data18# neq "">Assigned to #read_mortgage8.data18# recorded on #DateFormat(read_mortgage8.data22, "mm")#/#DateFormat(read_mortgage8.data22, "dd")#/#DateFormat(read_mortgage8.data22, "yyyy")#, <cfif #read_mortgage8.data19# eq "">
						in Book #read_mortgage8.data20#, at Page #read_mortgage8.data21# 
						<cfelse> in Document #read_mortgage8.data19#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif  #len(read_mortgage8.data19)# gt 0 AND #len(read_mortgage8.data20)# gt 0 > ,</cfif>
								<!-- check for book no. and page no. --->
							<cfif #len(read_mortgage8.data20)# gt 0 AND #len(read_mortgage8.data21)# gt 0 >
								in Book #read_mortgage8.data20# at Page #read_mortgage8.data21# 
							</cfif>	  
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->							
					</cfif> </cfif><cfif #read_mortgage8.data23# neq "">Assigned to #read_mortgage8.data23# recorded on #DateFormat(read_mortgage8.data27, "mm")#/#DateFormat(read_mortgage8.data27, "dd")#/#DateFormat(read_mortgage8.data27, "yyyy")#, <cfif #read_mortgage8.data24# eq ""> 
						in Book #read_mortgage8.data25#, at Page #read_mortgage8.data26# 
						<cfelse> in Document #read_mortgage8.data24#
													<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage8.data25)# gt 0 AND #len(read_mortgage8.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->	
					</cfif> </cfif><cfif #read_mortgage8.data28# neq "">Assigned to #read_mortgage8.data28# recorded on #DateFormat(read_mortgage8.data32, "mm")#/#DateFormat(read_mortgage8.data32, "dd")#/#DateFormat(read_mortgage8.data32, "yyyy")#, <cfif #read_mortgage8.data29# EQ ""> 
						in Book #read_mortgage8.data30#, at Page #read_mortgage8.data31# 
						<cfelse> in Document #read_mortgage8.data29#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage8.data30)# gt 0 AND #len(read_mortgage8.data31)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->							
					</cfif> </cfif><cfif #read_mortgage8.data11# neq "">#read_mortgage8.data11#</cfif> <cfif #read_mortgage8.data12# neq "">#read_mortgage8.data12#</cfif></cfif><br>
<br>
						...
						in Book <cfif #read_mortgage9.data14# eq "">#read_mortgage9.data15#, at Page #read_mortgage9.data16# 
							<cfelse> in Document #read_mortgage9.data14#
								...
								<cfif #len(read_mortgage9.data15)# gt 0 AND #len(read_mortgage9.data16)# gt 0 >
								 ...
								 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 							
							</cfif> </cfif><cfif #read_mortgage9.data18# neq "">Assigned to #read_mortgage9.data18# recorded on #DateFormat(read_mortgage9.data22, "mm")#/#DateFormat(read_mortgage9.data22, "dd")#/#DateFormat(read_mortgage9.data22, "yyyy")#, <cfif #read_mortgage9.data19# eq "">
								...
								<cfelse> in Document #read_mortgage9.data19#
									...
									<cfif #len(read_mortgage9.data20)# gt 0 AND #len(read_mortgage9.data21)# gt 0 >
									 ...
									 <!---(end) -- Added by Synechron Development for ticket# 454 ------->								
							</cfif> </cfif><cfif #read_mortgage9.data23# neq "">Assigned to #read_mortgage9.data23# recorded on #DateFormat(read_mortgage9.data27, "mm")#/#DateFormat(read_mortgage9.data27, "dd")#/#DateFormat(read_mortgage9.data27, "yyyy")#, <cfif #read_mortgage9.data24# eq "">
								 ...
								 <cfelse> in Document #read_mortgage9.data24#
									...
									<cfif #len(read_mortgage9.data25)# gt 0 AND #len(read_mortgage9.data26)# gt 0 >
									 ...
									 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 
							</cfif> </cfif><cfif #read_mortgage9.data28# neq "">Assigned to #read_mortgage9.data28# recorded on #DateFormat(read_mortgage9.data32, "mm")#/#DateFormat(read_mortgage9.data32, "dd")#/#DateFormat(read_mortgage9.data32, "yyyy")#, <cfif #read_mortgage9.data29# EQ ""> 
								...
								<cfelse> in Document #read_mortgage9.data29#
									...
									<cfif #len(read_mortgage9.data30)# gt 0 AND #len(read_mortgage9.data31)# gt 0 >
									 ...
									 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 
							</cfif> </cfif><cfif #read_mortgage9.data11# neq "">#read_mortgage9.data11#</cfif> <cfif #read_mortgage9.data12# neq "">#read_mortgage9.data12#</cfif></cfif><br>
<br>
          ...
          <cfif #read_mortgage10.data1# NEQ ""> <cfif read_mortgage10.lienintro neq "" and read_mortgage10.lienintro neq 'NULL' or Len(read_mortgage10.lienintro) eq 0>#read_mortgage10.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage10.data2# <cfif #read_mortgage10.data3# neq ""> and #read_mortgage10.data3#</cfif> securing #read_mortgage10.data1# in the original principal amount of #read_mortgage10.data4#, as dated #DateFormat(read_mortgage10.data8, "mm")#/#DateFormat(read_mortgage10.data8, "dd")#/#DateFormat(read_mortgage10.data8, "yyyy")# and recorded on #DateFormat(read_mortgage10.data9, "mm")#/#DateFormat(read_mortgage10.data9, "dd")#/#DateFormat(read_mortgage10.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage10.data5# eq ""><cfif #read_mortgage10.data6# neq "">
			...
			in Book <cfif #read_mortgage10.data14# eq "">#read_mortgage10.data15#, at Page #read_mortgage10.data16# 
				...
				<cfif #len(read_mortgage10.data15)# gt 0 AND #len(read_mortgage10.data16)# gt 0 >
				 ...
				 <!---(end) -- Added by Synechron Development for ticket# 454 ------->	
				</cfif> </cfif><cfif #read_mortgage10.data18# neq "">Assigned to #read_mortgage10.data18# recorded on #DateFormat(read_mortgage10.data22, "mm")#/#DateFormat(read_mortgage10.data22, "dd")#/#DateFormat(read_mortgage10.data22, "yyyy")#, <cfif #read_mortgage10.data19# eq "">
					...
					<cfelse> in Document #read_mortgage10.data19#
						...
						<cfif #len(read_mortgage10.data20)# gt 0 AND #len(read_mortgage10.data21)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 -------> 						
				</cfif> </cfif><cfif #read_mortgage10.data23# neq "">Assigned to #read_mortgage10.data23# recorded on #DateFormat(read_mortgage10.data27, "mm")#/#DateFormat(read_mortgage10.data27, "dd")#/#DateFormat(read_mortgage10.data27, "yyyy")#, <cfif #read_mortgage10.data24# eq ""> 
					...
					<cfelse> in Document #read_mortgage10.data24#
						...
						<cfif #len(read_mortgage10.data25)# gt 0 AND #len(read_mortgage10.data26)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					
				</cfif> </cfif><cfif #read_mortgage10.data28# neq "">Assigned to #read_mortgage10.data28# recorded on #DateFormat(read_mortgage10.data32, "mm")#/#DateFormat(read_mortgage10.data32, "dd")#/#DateFormat(read_mortgage10.data32, "yyyy")#, <cfif #read_mortgage10.data29# EQ ""> 
					in Book #read_mortgage10.data30#, at Page #read_mortgage10.data31# 
					<cfelse>
					 in Document #read_mortgage10.data29#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
			...
			in Book <cfif #read_mortgage11.data14# eq "">#read_mortgage11.data15#, at Page #read_mortgage11.data16# 
				<cfelse> in Document #read_mortgage11.data14#
					...
					<cfif #len(read_mortgage11.data15)# gt 0 AND #len(read_mortgage11.data16)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					
					</cfif> </cfif><cfif #read_mortgage11.data18# neq "">Assigned to #read_mortgage11.data18# recorded on #DateFormat(read_mortgage11.data22, "mm")#/#DateFormat(read_mortgage11.data22, "dd")#/#DateFormat(read_mortgage11.data22, "yyyy")#, <cfif #read_mortgage11.data19# eq "">
						...
						<cfif #len(read_mortgage11.data20)# gt 0 AND #len(read_mortgage11.data21)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						
					</cfif> </cfif><cfif #read_mortgage11.data23# neq "">Assigned to #read_mortgage11.data23# recorded on #DateFormat(read_mortgage11.data27, "mm")#/#DateFormat(read_mortgage11.data27, "dd")#/#DateFormat(read_mortgage11.data27, "yyyy")#, <cfif #read_mortgage11.data24# eq "">
						 ...
						 <cfelse> in Document #read_mortgage11.data24#
							...
							<cfif #len(read_mortgage11.data25)# gt 0 AND #len(read_mortgage11.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->							 
					</cfif> </cfif><cfif #read_mortgage11.data28# neq "">Assigned to #read_mortgage11.data28# recorded on #DateFormat(read_mortgage11.data32, "mm")#/#DateFormat(read_mortgage11.data32, "dd")#/#DateFormat(read_mortgage11.data32, "yyyy")#, <cfif #read_mortgage11.data29# EQ "">
          ...
          <cfif #read_mortgage12.data1# NEQ ""> <cfif read_mortgage12.lienintro neq "" and read_mortgage12.lienintro neq 'NULL' or Len(read_mortgage12.lienintro) eq 0>#read_mortgage12.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage12.data2# <cfif #read_mortgage12.data3# neq ""> and #read_mortgage12.data3#</cfif> securing #read_mortgage12.data1# in the original principal amount of #read_mortgage12.data4#, as dated #DateFormat(read_mortgage12.data8, "mm")#/#DateFormat(read_mortgage12.data8, "dd")#/#DateFormat(read_mortgage12.data8, "yyyy")# and recorded on #DateFormat(read_mortgage12.data9, "mm")#/#DateFormat(read_mortgage12.data9, "dd")#/#DateFormat(read_mortgage12.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage12.data5# eq ""><cfif #read_mortgage12.data6# neq "">
			...
			in Book <cfif #read_mortgage12.data14# eq "">#read_mortgage12.data15#, at Page #read_mortgage12.data16# 
				<cfelse> in Document #read_mortgage12.data14#
					...
					</cfif> </cfif><cfif #read_mortgage12.data18# neq "">Assigned to #read_mortgage12.data18# recorded on #DateFormat(read_mortgage12.data22, "mm")#/#DateFormat(read_mortgage12.data22, "dd")#/#DateFormat(read_mortgage12.data22, "yyyy")#, <cfif #read_mortgage12.data19# eq "">
						in Book #read_mortgage12.data20#, at Page #read_mortgage12.data21# 
						<cfelse> in Document #read_mortgage12.data19#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage12.data20)# gt 0 AND #len(read_mortgage12.data21)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->							
					</cfif> </cfif><cfif #read_mortgage12.data23# neq "">Assigned to #read_mortgage12.data23# recorded on #DateFormat(read_mortgage12.data27, "mm")#/#DateFormat(read_mortgage12.data27, "dd")#/#DateFormat(read_mortgage12.data27, "yyyy")#, <cfif #read_mortgage12.data24# eq "">
						 in Book #read_mortgage12.data25#, at Page #read_mortgage12.data26# 
						 <cfelse> in Document #read_mortgage12.data24#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							...
							<cfif #len(read_mortgage12.data25)# gt 0 AND #len(read_mortgage12.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						 
					</cfif> </cfif><cfif #read_mortgage12.data28# neq "">Assigned to #read_mortgage12.data28# recorded on #DateFormat(read_mortgage12.data32, "mm")#/#DateFormat(read_mortgage12.data32, "dd")#/#DateFormat(read_mortgage12.data32, "yyyy")#, <cfif #read_mortgage12.data29# EQ ""> 
			...
			in Book <cfif #read_mortgage13.data14# eq "">#read_mortgage13.data15#, at Page #read_mortgage13.data16# 
				<cfelse> in Document #read_mortgage13.data14#
					...
					<cfif #len(read_mortgage13.data15)# gt 0 AND #len(read_mortgage13.data16)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				
					</cfif> </cfif><cfif #read_mortgage13.data18# neq "">Assigned to #read_mortgage13.data18# recorded on #DateFormat(read_mortgage13.data22, "mm")#/#DateFormat(read_mortgage13.data22, "dd")#/#DateFormat(read_mortgage13.data22, "yyyy")#, <cfif #read_mortgage13.data19# eq "">
						...
						<cfelse> in Document #read_mortgage13.data19#
							...
							<cfif #len(read_mortgage13.data20)# gt 0 AND #len(read_mortgage13.data21)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->							
					</cfif> </cfif><cfif #read_mortgage13.data23# neq "">Assigned to #read_mortgage13.data23# recorded on #DateFormat(read_mortgage13.data27, "mm")#/#DateFormat(read_mortgage13.data27, "dd")#/#DateFormat(read_mortgage13.data27, "yyyy")#, <cfif #read_mortgage13.data24# eq ""> 
						...
						<cfelse> in Document #read_mortgage13.data24#
							...
							<cfif #len(read_mortgage13.data25)# gt 0 AND #len(read_mortgage13.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->						
					</cfif> </cfif><cfif #read_mortgage13.data28# neq "">Assigned to #read_mortgage13.data28# recorded on #DateFormat(read_mortgage13.data32, "mm")#/#DateFormat(read_mortgage13.data32, "dd")#/#DateFormat(read_mortgage13.data32, "yyyy")#, <cfif #read_mortgage13.data29# EQ ""> 
          ...
          <cfif #read_mortgage14.data1# NEQ ""> <cfif read_mortgage14.lienintro neq "" and read_mortgage14.lienintro neq 'NULL' or Len(read_mortgage14.lienintro) eq 0>#read_mortgage14.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage14.data2# <cfif #read_mortgage14.data3# neq ""> and #read_mortgage14.data3#</cfif> securing #read_mortgage14.data1# in the original principal amount of #read_mortgage14.data4#, as dated #DateFormat(read_mortgage14.data8, "mm")#/#DateFormat(read_mortgage14.data8, "dd")#/#DateFormat(read_mortgage14.data8, "yyyy")# and recorded on #DateFormat(read_mortgage14.data9, "mm")#/#DateFormat(read_mortgage14.data9, "dd")#/#DateFormat(read_mortgage14.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage14.data5# eq ""><cfif #read_mortgage14.data6# neq "">
			...
			<cfelse> in Document Number #read_mortgage14.data5# 
				...
				<cfif #len(read_mortgage14.data6)# gt 0 AND #len(read_mortgage14.data7)# gt 0 >
				 ...
				 <!---(end) -- Added by Synechron Development for ticket# 454 ------->			
			</cfif><cfif #read_mortgage14.data13# neq ""> Assigned to #read_mortgage14.data13# recorded on #DateFormat(read_mortgage14.data17, "mm")#/#DateFormat(read_mortgage14.data17, "dd")#/#DateFormat(read_mortgage14.data17, "yyyy")#, 
			in Book <cfif #read_mortgage14.data14# eq "">#read_mortgage14.data15#, at Page #read_mortgage14.data16# 
				<cfelse> in Document #read_mortgage14.data14#
					...
					<cfif #len(read_mortgage14.data15)# gt 0 AND #len(read_mortgage14.data16)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				
				</cfif> </cfif><cfif #read_mortgage14.data18# neq "">Assigned to #read_mortgage14.data18# recorded on #DateFormat(read_mortgage14.data22, "mm")#/#DateFormat(read_mortgage14.data22, "dd")#/#DateFormat(read_mortgage14.data22, "yyyy")#, <cfif #read_mortgage14.data19# eq "">
					...
					<cfelse> in Document #read_mortgage14.data19#
						...
						<cfif #len(read_mortgage14.data20)# gt 0 AND #len(read_mortgage14.data21)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					
				</cfif> </cfif><cfif #read_mortgage14.data23# neq "">Assigned to #read_mortgage14.data23# recorded on #DateFormat(read_mortgage14.data27, "mm")#/#DateFormat(read_mortgage14.data27, "dd")#/#DateFormat(read_mortgage14.data27, "yyyy")#, <cfif #read_mortgage14.data24# eq ""> 
					...
					<cfelse> in Document #read_mortgage14.data24#
						...
						<cfif #len(read_mortgage14.data25)# gt 0 AND #len(read_mortgage14.data26)# gt 0 >
						 ...
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					
				</cfif> </cfif><cfif #read_mortgage14.data28# neq "">Assigned to #read_mortgage14.data28# recorded on #DateFormat(read_mortgage14.data32, "mm")#/#DateFormat(read_mortgage14.data32, "dd")#/#DateFormat(read_mortgage14.data32, "yyyy")#, <cfif #read_mortgage14.data29# EQ ""> 
			...
			in Book <cfif #read_mortgage15.data14# eq "">#read_mortgage15.data15#, at Page #read_mortgage15.data16# 
				<cfelse> in Document #read_mortgage15.data14#
					...
					<cfif #len(read_mortgage15.data15)# gt 0 AND #len(read_mortgage15.data16)# gt 0 >
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				
				</cfif> </cfif><cfif #read_mortgage15.data18# neq "">Assigned to #read_mortgage15.data18# recorded on #DateFormat(read_mortgage15.data22, "mm")#/#DateFormat(read_mortgage15.data22, "dd")#/#DateFormat(read_mortgage15.data22, "yyyy")#, <cfif #read_mortgage15.data19# eq "">
					...
					<cfelse> in Document #read_mortgage15.data19#
							...
							<cfif #len(read_mortgage15.data20)# gt 0 AND #len(read_mortgage15.data21)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					
				</cfif> </cfif><cfif #read_mortgage15.data23# neq "">Assigned to #read_mortgage15.data23# recorded on #DateFormat(read_mortgage15.data27, "mm")#/#DateFormat(read_mortgage15.data27, "dd")#/#DateFormat(read_mortgage15.data27, "yyyy")#, <cfif #read_mortgage15.data24# eq "">
					 ...
					 <cfelse> in Document #read_mortgage15.data24#
							...
							<cfif #len(read_mortgage15.data25)# gt 0 AND #len(read_mortgage15.data26)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					 
				</cfif> </cfif><cfif #read_mortgage15.data28# neq "">Assigned to #read_mortgage15.data28# recorded on #DateFormat(read_mortgage15.data32, "mm")#/#DateFormat(read_mortgage15.data32, "dd")#/#DateFormat(read_mortgage15.data32, "yyyy")#, <cfif #read_mortgage15.data29# EQ "">
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
          ...
          <cfif #read_mortgage16.data1# NEQ ""> <cfif read_mortgage16.lienintro neq "" and read_mortgage16.lienintro neq 'NULL' or Len(read_mortgage16.lienintro) eq 0>#read_mortgage16.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage16.data2# <cfif #read_mortgage16.data3# neq ""> and #read_mortgage16.data3#</cfif> securing #read_mortgage16.data1# in the original principal amount of #read_mortgage16.data4#, as dated #DateFormat(read_mortgage16.data8, "mm")#/#DateFormat(read_mortgage16.data8, "dd")#/#DateFormat(read_mortgage16.data8, "yyyy")# and recorded on #DateFormat(read_mortgage16.data9, "mm")#/#DateFormat(read_mortgage16.data9, "dd")#/#DateFormat(read_mortgage16.data9, "yyyy")# among the Land Records of #Read_temp_comp_b1.pcounty# County, <cfif #read_mortgage16.data5# eq ""><cfif #read_mortgage16.data6# neq "">
			in Book #read_mortgage16.data6# at Page #read_mortgage16.data7# </cfif>
			<cfelse> in Document Number #read_mortgage16.data5#
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->			
			 </cfif><cfif #read_mortgage16.data13# neq ""> Assigned to #read_mortgage16.data13# recorded on #DateFormat(read_mortgage16.data17, "mm")#/#DateFormat(read_mortgage16.data17, "dd")#/#DateFormat(read_mortgage16.data17, "yyyy")#, 
			 in Book <cfif #read_mortgage16.data14# eq "">#read_mortgage16.data15#, at Page #read_mortgage16.data16# 
				 <cfelse> in Document #read_mortgage16.data14#
					 ...
					 <!---(end) -- Added by Synechron Development for ticket# 454 ------->	
					...
					</cfif> </cfif><cfif #read_mortgage16.data18# neq "">Assigned to #read_mortgage16.data18# recorded on #DateFormat(read_mortgage16.data22, "mm")#/#DateFormat(read_mortgage16.data22, "dd")#/#DateFormat(read_mortgage16.data22, "yyyy")#, <cfif #read_mortgage16.data19# eq "">
						...
						<cfelse> in Document #read_mortgage16.data19#
							...
							<cfif #len(read_mortgage16.data20)# gt 0 AND #len(read_mortgage16.data21)# gt 0 >
							 ...
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->							
					</cfif> </cfif><cfif #read_mortgage16.data23# neq "">Assigned to #read_mortgage16.data23# recorded on #DateFormat(read_mortgage16.data27, "mm")#/#DateFormat(read_mortgage16.data27, "dd")#/#DateFormat(read_mortgage16.data27, "yyyy")#, <cfif #read_mortgage16.data24# eq ""> 
					...
					</cfif> </cfif><cfif #read_mortgage16.data28# neq "">Assigned to #read_mortgage16.data28# recorded on #DateFormat(read_mortgage16.data32, "mm")#/#DateFormat(read_mortgage16.data32, "dd")#/#DateFormat(read_mortgage16.data32, "yyyy")#, <cfif #read_mortgage16.data29# EQ ""> 
						in Book #read_mortgage16.data30#, at Page #read_mortgage16.data31# <cfelse>
						 in Document #read_mortgage16.data29#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
...
<cfset mortgages_liens = 1>
		...
		<cfset auto_number = #auto_number# + 1>
	      ...
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien2.data7# NEQ ""> #read_lien2.lienintro# <cfif read_lien2.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien2.data7# in favor of #read_lien2.data6# in the amount of #read_lien2.data5#, dated #DateFormat(read_lien2.data4, "mm")#/#DateFormat(read_lien2.data4, "dd")#/#DateFormat(read_lien2.data4, "yyyy")#
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien4.data7# NEQ ""> #read_lien4.lienintro# <cfif read_lien4.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien4.data7# in favor of #read_lien4.data6# in the amount of #read_lien4.data5#, dated #DateFormat(read_lien4.data4, "mm")#/#DateFormat(read_lien4.data4, "dd")#/#DateFormat(read_lien4.data4, "yyyy")#
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien17.data7# NEQ ""> #read_lien17.lienintro# <cfif read_lien17.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien17.data7# in favor of #read_lien17.data6# in the amount of #read_lien17.data5#, dated #DateFormat(read_lien17.data4, "mm")#/#DateFormat(read_lien17.data4, "dd")#/#DateFormat(read_lien17.data4, "yyyy")# and recorded #DateFormat(read_lien17.data9, "mm")#/#DateFormat(read_lien17.data9, "dd")#/#DateFormat(read_lien17.data9, "yyyy")#
			    <cfif #read_lien17.data1# eq ""> in Book #read_lien17.data2# at Page #read_lien17.data3# 
				    <cfelse> in Document #read_lien17.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien17.data1)# gt 0 AND #len(read_lien17.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien17.data2)# gt 0 AND #len(read_lien17.data3)# gt 0 >
							in Book #read_lien17.data2# at Page #read_lien17.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien17.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien18.data7# NEQ ""> #read_lien18.lienintro# <cfif read_lien18.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien18.data7# in favor of #read_lien18.data6# in the amount of #read_lien18.data5#, dated #DateFormat(read_lien18.data4, "mm")#/#DateFormat(read_lien18.data4, "dd")#/#DateFormat(read_lien18.data4, "yyyy")# and recorded #DateFormat(read_lien18.data9, "mm")#/#DateFormat(read_lien18.data9, "dd")#/#DateFormat(read_lien18.data9, "yyyy")#
			    <cfif #read_lien18.data1# eq ""> in Book #read_lien18.data2# at Page #read_lien18.data3# 
				    <cfelse> in Document #read_lien18.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien18.data1)# gt 0 AND #len(read_lien18.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien18.data2)# gt 0 AND #len(read_lien18.data3)# gt 0 >
							in Book #read_lien18.data2# at Page #read_lien18.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				     </cfif> #read_lien18.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien19.data7# NEQ ""> #read_lien19.lienintro# <cfif read_lien19.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien19.data7# in favor of #read_lien19.data6# in the amount of #read_lien19.data5#, dated #DateFormat(read_lien19.data4, "mm")#/#DateFormat(read_lien19.data4, "dd")#/#DateFormat(read_lien19.data4, "yyyy")# and recorded #DateFormat(read_lien19.data9, "mm")#/#DateFormat(read_lien19.data9, "dd")#/#DateFormat(read_lien19.data9, "yyyy")#
			    <cfif #read_lien19.data1# eq ""> in Book #read_lien19.data2# at Page #read_lien19.data3# 
				    <cfelse> in Document #read_lien19.data1#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif  #len(read_lien19.data1)# gt 0 AND #len(read_lien19.data2)# gt 0 > ,</cfif>
								<!-- check for book no. and page no. --->
							<cfif #len(read_lien19.data2)# gt 0 AND #len(read_lien19.data3)# gt 0 >
								in Book #read_lien19.data2# at Page #read_lien19.data3# 
							</cfif>	  
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				     </cfif> #read_lien19.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien20.data7# NEQ ""> #read_lien20.lienintro# <cfif read_lien20.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien20.data7# in favor of #read_lien20.data6# in the amount of #read_lien20.data5#, dated #DateFormat(read_lien20.data4, "mm")#/#DateFormat(read_lien20.data4, "dd")#/#DateFormat(read_lien20.data4, "yyyy")# and recorded #DateFormat(read_lien20.data9, "mm")#/#DateFormat(read_lien20.data9, "dd")#/#DateFormat(read_lien20.data9, "yyyy")#
			    <cfif #read_lien20.data1# eq ""> in Book #read_lien20.data2# at Page #read_lien20.data3# 
				    <cfelse> in Document #read_lien20.data1# 
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif  #len(read_lien20.data1)# gt 0 AND #len(read_lien20.data2)# gt 0 > ,</cfif>
								<!-- check for book no. and page no. --->
							<cfif #len(read_lien20.data2)# gt 0 AND #len(read_lien20.data3)# gt 0 >
								in Book #read_lien20.data2# at Page #read_lien20.data3# 
							</cfif>	  
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien20.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien21.data7# NEQ ""> #read_lien21.lienintro# <cfif read_lien21.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien21.data7# in favor of #read_lien21.data6# in the amount of #read_lien21.data5#, dated #DateFormat(read_lien21.data4, "mm")#/#DateFormat(read_lien21.data4, "dd")#/#DateFormat(read_lien21.data4, "yyyy")# and recorded #DateFormat(read_lien21.data9, "mm")#/#DateFormat(read_lien21.data9, "dd")#/#DateFormat(read_lien21.data9, "yyyy")#
			    <cfif #read_lien21.data1# eq ""> in Book #read_lien21.data2# at Page #read_lien21.data3# 
				    <cfelse> in Document #read_lien21.data1#
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif  #len(read_lien21.data1)# gt 0 AND #len(read_lien21.data2)# gt 0 > ,</cfif>
								<!-- check for book no. and page no. --->
							<cfif #len(read_lien21.data2)# gt 0 AND #len(read_lien21.data3)# gt 0 >
								in Book #read_lien21.data2# at Page #read_lien21.data3# 
							</cfif>	  
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					    
				     </cfif> #read_lien21.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien22.data7# NEQ ""> #read_lien22.lienintro# <cfif read_lien22.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien22.data7# in favor of #read_lien22.data6# in the amount of #read_lien22.data5#, dated #DateFormat(read_lien22.data4, "mm")#/#DateFormat(read_lien22.data4, "dd")#/#DateFormat(read_lien22.data4, "yyyy")# and recorded #DateFormat(read_lien22.data9, "mm")#/#DateFormat(read_lien22.data9, "dd")#/#DateFormat(read_lien22.data9, "yyyy")#
			    <cfif #read_lien22.data1# eq ""> in Book #read_lien22.data2# at Page #read_lien22.data3# 
				    <cfelse> in Document #read_lien22.data1# 
							<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif  #len(read_lien22.data1)# gt 0 AND #len(read_lien22.data2)# gt 0 > ,</cfif>
								<!-- check for book no. and page no. --->
							<cfif #len(read_lien22.data2)# gt 0 AND #len(read_lien22.data3)# gt 0 >
								in Book #read_lien22.data2# at Page #read_lien22.data3# 
							</cfif>	  
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien22.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien23.data7# NEQ ""> #read_lien23.lienintro# <cfif read_lien23.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien23.data7# in favor of #read_lien23.data6# in the amount of #read_lien23.data5#, dated #DateFormat(read_lien23.data4, "mm")#/#DateFormat(read_lien23.data4, "dd")#/#DateFormat(read_lien23.data4, "yyyy")# and recorded #DateFormat(read_lien23.data9, "mm")#/#DateFormat(read_lien23.data9, "dd")#/#DateFormat(read_lien23.data9, "yyyy")#
			    <cfif #read_lien23.data1# eq ""> in Book #read_lien23.data2# at Page #read_lien23.data3# 
				    <cfelse> in Document #read_lien23.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien23.data1)# gt 0 AND #len(read_lien23.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien23.data2)# gt 0 AND #len(read_lien23.data3)# gt 0 >
							in Book #read_lien23.data2# at Page #read_lien23.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien23.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien24.data7# NEQ ""> #read_lien24.lienintro# <cfif read_lien24.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien24.data7# in favor of #read_lien24.data6# in the amount of #read_lien24.data5#, dated #DateFormat(read_lien24.data4, "mm")#/#DateFormat(read_lien24.data4, "dd")#/#DateFormat(read_lien24.data4, "yyyy")# and recorded #DateFormat(read_lien24.data9, "mm")#/#DateFormat(read_lien24.data9, "dd")#/#DateFormat(read_lien24.data9, "yyyy")#
			    <cfif #read_lien24.data1# eq ""> in Book #read_lien24.data2# at Page #read_lien24.data3# 
				    <cfelse> in Document #read_lien24.data1#
								<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif  #len(read_lien24.data1)# gt 0 AND #len(read_lien24.data2)# gt 0 > ,</cfif>
								<!-- check for book no. and page no. --->
							<cfif #len(read_lien24.data2)# gt 0 AND #len(read_lien24.data3)# gt 0 >
								in Book #read_lien24.data2# at Page #read_lien24.data3# 
							</cfif>	  
							 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				     </cfif> #read_lien24.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien25.data7# NEQ ""> #read_lien25.lienintro# <cfif read_lien25.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien25.data7# in favor of #read_lien25.data6# in the amount of #read_lien25.data5#, dated #DateFormat(read_lien25.data4, "mm")#/#DateFormat(read_lien25.data4, "dd")#/#DateFormat(read_lien25.data4, "yyyy")# and recorded #DateFormat(read_lien25.data9, "mm")#/#DateFormat(read_lien25.data9, "dd")#/#DateFormat(read_lien25.data9, "yyyy")#
			    <cfif #read_lien25.data1# eq ""> in Book #read_lien25.data2# at Page #read_lien25.data3# 
				    <cfelse> in Document #read_lien25.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien25.data1)# gt 0 AND #len(read_lien25.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien25.data2)# gt 0 AND #len(read_lien25.data3)# gt 0 >
							in Book #read_lien25.data2# at Page #read_lien25.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				     </cfif> #read_lien25.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien26.data7# NEQ ""> #read_lien26.lienintro# <cfif read_lien26.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien26.data7# in favor of #read_lien26.data6# in the amount of #read_lien26.data5#, dated #DateFormat(read_lien26.data4, "mm")#/#DateFormat(read_lien26.data4, "dd")#/#DateFormat(read_lien26.data4, "yyyy")# and recorded #DateFormat(read_lien26.data9, "mm")#/#DateFormat(read_lien26.data9, "dd")#/#DateFormat(read_lien26.data9, "yyyy")#
			    <cfif #read_lien26.data1# eq ""> in Book #read_lien26.data2# at Page #read_lien26.data3# 
				    <cfelse> in Document #read_lien26.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien26.data1)# gt 0 AND #len(read_lien26.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien26.data2)# gt 0 AND #len(read_lien26.data3)# gt 0 >
							in Book #read_lien26.data2# at Page #read_lien26.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				     </cfif> #read_lien26.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien27.data7# NEQ ""> #read_lien27.lienintro# <cfif read_lien27.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien27.data7# in favor of #read_lien27.data6# in the amount of #read_lien27.data5#, dated #DateFormat(read_lien27.data4, "mm")#/#DateFormat(read_lien27.data4, "dd")#/#DateFormat(read_lien27.data4, "yyyy")# and recorded #DateFormat(read_lien27.data9, "mm")#/#DateFormat(read_lien27.data9, "dd")#/#DateFormat(read_lien27.data9, "yyyy")#
			    <cfif #read_lien27.data1# eq ""> in Book #read_lien27.data2# at Page #read_lien27.data3# 
				    <cfelse> in Document #read_lien27.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien27.data1)# gt 0 AND #len(read_lien27.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien27.data2)# gt 0 AND #len(read_lien27.data3)# gt 0 >
							in Book #read_lien27.data2# at Page #read_lien27.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien27.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien28.data7# NEQ ""> #read_lien28.lienintro# <cfif read_lien28.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien28.data7# in favor of #read_lien28.data6# in the amount of #read_lien28.data5#, dated #DateFormat(read_lien28.data4, "mm")#/#DateFormat(read_lien28.data4, "dd")#/#DateFormat(read_lien28.data4, "yyyy")# and recorded #DateFormat(read_lien28.data9, "mm")#/#DateFormat(read_lien28.data9, "dd")#/#DateFormat(read_lien28.data9, "yyyy")#
			    <cfif #read_lien28.data1# eq ""> in Book #read_lien28.data2# at Page #read_lien28.data3# 
				    <cfelse> in Document #read_lien28.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien28.data1)# gt 0 AND #len(read_lien28.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien28.data2)# gt 0 AND #len(read_lien28.data3)# gt 0 >
							in Book #read_lien28.data2# at Page #read_lien28.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					    
				</cfif> #read_lien28.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien29.data7# NEQ ""> #read_lien29.lienintro# <cfif read_lien29.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien29.data7# in favor of #read_lien29.data6# in the amount of #read_lien29.data5#, dated #DateFormat(read_lien29.data4, "mm")#/#DateFormat(read_lien29.data4, "dd")#/#DateFormat(read_lien29.data4, "yyyy")# and recorded #DateFormat(read_lien29.data9, "mm")#/#DateFormat(read_lien29.data9, "dd")#/#DateFormat(read_lien29.data9, "yyyy")#
			    <cfif #read_lien29.data1# eq ""> in Book #read_lien29.data2# at Page #read_lien29.data3# 
				    <cfelse> in Document #read_lien29.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien29.data1)# gt 0 AND #len(read_lien29.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien29.data2)# gt 0 AND #len(read_lien29.data3)# gt 0 >
							in Book #read_lien29.data2# at Page #read_lien29.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				     </cfif> #read_lien29.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien30.data7# NEQ ""> #read_lien30.lienintro# <cfif read_lien30.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien30.data7# in favor of #read_lien30.data6# in the amount of #read_lien30.data5#, dated #DateFormat(read_lien30.data4, "mm")#/#DateFormat(read_lien30.data4, "dd")#/#DateFormat(read_lien30.data4, "yyyy")# and recorded #DateFormat(read_lien30.data9, "mm")#/#DateFormat(read_lien30.data9, "dd")#/#DateFormat(read_lien30.data9, "yyyy")#
			    <cfif #read_lien30.data1# eq ""> in Book #read_lien30.data2# at Page #read_lien30.data3# 
				    <cfelse> in Document #read_lien30.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien30.data1)# gt 0 AND #len(read_lien30.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien30.data2)# gt 0 AND #len(read_lien30.data3)# gt 0 >
							in Book #read_lien30.data2# at Page #read_lien30.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					    
				</cfif> #read_lien30.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien31.data7# NEQ ""> #read_lien31.lienintro# <cfif read_lien31.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien31.data7# in favor of #read_lien31.data6# in the amount of #read_lien31.data5#, dated #DateFormat(read_lien31.data4, "mm")#/#DateFormat(read_lien31.data4, "dd")#/#DateFormat(read_lien31.data4, "yyyy")# and recorded #DateFormat(read_lien31.data9, "mm")#/#DateFormat(read_lien31.data9, "dd")#/#DateFormat(read_lien31.data9, "yyyy")#
			    <cfif #read_lien31.data1# eq ""> in Book #read_lien31.data2# at Page #read_lien31.data3# 
				    <cfelse> in Document #read_lien31.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien31.data1)# gt 0 AND #len(read_lien31.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien31.data2)# gt 0 AND #len(read_lien31.data3)# gt 0 >
							in Book #read_lien31.data2# at Page #read_lien31.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					    
				</cfif> #read_lien31.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien32.data7# NEQ ""> #read_lien32.lienintro# <cfif read_lien32.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien32.data7# in favor of #read_lien32.data6# in the amount of #read_lien32.data5#, dated #DateFormat(read_lien32.data4, "mm")#/#DateFormat(read_lien32.data4, "dd")#/#DateFormat(read_lien32.data4, "yyyy")# and recorded #DateFormat(read_lien32.data9, "mm")#/#DateFormat(read_lien32.data9, "dd")#/#DateFormat(read_lien32.data9, "yyyy")#
			    <cfif #read_lien32.data1# eq ""> in Book #read_lien32.data2# at Page #read_lien32.data3# 
				    <cfelse> in Document #read_lien32.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien32.data1)# gt 0 AND #len(read_lien32.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien32.data2)# gt 0 AND #len(read_lien32.data3)# gt 0 >
							in Book #read_lien32.data2# at Page #read_lien32.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien32.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien33.data7# NEQ ""> #read_lien33.lienintro# <cfif read_lien33.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien33.data7# in favor of #read_lien33.data6# in the amount of #read_lien33.data5#, dated #DateFormat(read_lien33.data4, "mm")#/#DateFormat(read_lien33.data4, "dd")#/#DateFormat(read_lien33.data4, "yyyy")# and recorded #DateFormat(read_lien33.data9, "mm")#/#DateFormat(read_lien33.data9, "dd")#/#DateFormat(read_lien33.data9, "yyyy")#
			    <cfif #read_lien33.data1# eq ""> in Book #read_lien33.data2# at Page #read_lien33.data3# 
				    <cfelse> in Document #read_lien33.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien33.data1)# gt 0 AND #len(read_lien33.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien33.data2)# gt 0 AND #len(read_lien33.data3)# gt 0 >
							in Book #read_lien33.data2# at Page #read_lien33.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien33.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien34.data7# NEQ ""> #read_lien34.lienintro# <cfif read_lien34.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien34.data7# in favor of #read_lien34.data6# in the amount of #read_lien34.data5#, dated #DateFormat(read_lien34.data4, "mm")#/#DateFormat(read_lien34.data4, "dd")#/#DateFormat(read_lien34.data4, "yyyy")# and recorded #DateFormat(read_lien34.data9, "mm")#/#DateFormat(read_lien34.data9, "dd")#/#DateFormat(read_lien34.data9, "yyyy")#
			    <cfif #read_lien34.data1# eq ""> in Book #read_lien34.data2# at Page #read_lien34.data3# 
				    <cfelse> in Document #read_lien34.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien34.data1)# gt 0 AND #len(read_lien34.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien34.data2)# gt 0 AND #len(read_lien34.data3)# gt 0 >
							in Book #read_lien34.data2# at Page #read_lien34.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				     </cfif> #read_lien34.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien35.data7# NEQ ""> #read_lien35.lienintro# <cfif read_lien35.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien35.data7# in favor of #read_lien35.data6# in the amount of #read_lien35.data5#, dated #DateFormat(read_lien35.data4, "mm")#/#DateFormat(read_lien35.data4, "dd")#/#DateFormat(read_lien35.data4, "yyyy")# and recorded #DateFormat(read_lien35.data9, "mm")#/#DateFormat(read_lien35.data9, "dd")#/#DateFormat(read_lien35.data9, "yyyy")#
			    <cfif #read_lien35.data1# eq ""> in Book #read_lien35.data2# at Page #read_lien35.data3# 
				    <cfelse> in Document #read_lien35.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien35.data1)# gt 0 AND #len(read_lien35.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien35.data2)# gt 0 AND #len(read_lien35.data3)# gt 0 >
							in Book #read_lien35.data2# at Page #read_lien35.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien35.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien36.data7# NEQ ""> #read_lien36.lienintro# <cfif read_lien36.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien36.data7# in favor of #read_lien36.data6# in the amount of #read_lien36.data5#, dated #DateFormat(read_lien36.data4, "mm")#/#DateFormat(read_lien36.data4, "dd")#/#DateFormat(read_lien36.data4, "yyyy")# and recorded #DateFormat(read_lien36.data9, "mm")#/#DateFormat(read_lien36.data9, "dd")#/#DateFormat(read_lien36.data9, "yyyy")#
			    <cfif #read_lien36.data1# eq ""> in Book #read_lien36.data2# at Page #read_lien36.data3# 
				    <cfelse> in Document #read_lien36.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien36.data1)# gt 0 AND #len(read_lien36.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien36.data2)# gt 0 AND #len(read_lien36.data3)# gt 0 >
							in Book #read_lien36.data2# at Page #read_lien36.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien36.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien37.data7# NEQ ""> #read_lien37.lienintro# <cfif read_lien37.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien37.data7# in favor of #read_lien37.data6# in the amount of #read_lien37.data5#, dated #DateFormat(read_lien37.data4, "mm")#/#DateFormat(read_lien37.data4, "dd")#/#DateFormat(read_lien37.data4, "yyyy")# and recorded #DateFormat(read_lien37.data9, "mm")#/#DateFormat(read_lien37.data9, "dd")#/#DateFormat(read_lien37.data9, "yyyy")#
			    <cfif #read_lien37.data1# eq ""> in Book #read_lien37.data2# at Page #read_lien37.data3# 
				    <cfelse> in Document #read_lien37.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien37.data1)# gt 0 AND #len(read_lien37.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien37.data2)# gt 0 AND #len(read_lien37.data3)# gt 0 >
							in Book #read_lien37.data2# at Page #read_lien37.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien37.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien38.data7# NEQ ""> #read_lien38.lienintro# <cfif read_lien38.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien38.data7# in favor of #read_lien38.data6# in the amount of #read_lien38.data5#, dated #DateFormat(read_lien38.data4, "mm")#/#DateFormat(read_lien38.data4, "dd")#/#DateFormat(read_lien38.data4, "yyyy")# and recorded #DateFormat(read_lien38.data9, "mm")#/#DateFormat(read_lien38.data9, "dd")#/#DateFormat(read_lien38.data9, "yyyy")#
			    <cfif #read_lien38.data1# eq ""> in Book #read_lien38.data2# at Page #read_lien38.data3# 
				    <cfelse> in Document #read_lien38.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien38.data1)# gt 0 AND #len(read_lien38.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien38.data2)# gt 0 AND #len(read_lien38.data3)# gt 0 >
							in Book #read_lien38.data2# at Page #read_lien38.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					     
				</cfif> #read_lien38.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien39.data7# NEQ ""> #read_lien39.lienintro# <cfif read_lien39.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien39.data7# in favor of #read_lien39.data6# in the amount of #read_lien39.data5#, dated #DateFormat(read_lien39.data4, "mm")#/#DateFormat(read_lien39.data4, "dd")#/#DateFormat(read_lien39.data4, "yyyy")# and recorded #DateFormat(read_lien39.data9, "mm")#/#DateFormat(read_lien39.data9, "dd")#/#DateFormat(read_lien39.data9, "yyyy")#
			    <cfif #read_lien39.data1# eq ""> in Book #read_lien39.data2# at Page #read_lien39.data3# 
				<cfelse> in Document #read_lien39.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien39.data1)# gt 0 AND #len(read_lien39.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien39.data2)# gt 0 AND #len(read_lien39.data3)# gt 0 >
							in Book #read_lien39.data2# at Page #read_lien39.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				
				</cfif> #read_lien39.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien40.data7# NEQ ""> #read_lien40.lienintro# <cfif read_lien40.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien40.data7# in favor of #read_lien40.data6# in the amount of #read_lien40.data5#, dated #DateFormat(read_lien40.data4, "mm")#/#DateFormat(read_lien40.data4, "dd")#/#DateFormat(read_lien40.data4, "yyyy")# and recorded #DateFormat(read_lien40.data9, "mm")#/#DateFormat(read_lien40.data9, "dd")#/#DateFormat(read_lien40.data9, "yyyy")#
			    <cfif #read_lien40.data1# eq ""> in Book #read_lien40.data2# at Page #read_lien40.data3# 
				    <cfelse> in Document #read_lien40.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien40.data1)# gt 0 AND #len(read_lien40.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien40.data2)# gt 0 AND #len(read_lien40.data3)# gt 0 >
							in Book #read_lien40.data2# at Page #read_lien40.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				
				</cfif> #read_lien40.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien41.data7# NEQ ""> #read_lien41.lienintro# <cfif read_lien41.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien41.data7# in favor of #read_lien41.data6# in the amount of #read_lien41.data5#, dated #DateFormat(read_lien41.data4, "mm")#/#DateFormat(read_lien41.data4, "dd")#/#DateFormat(read_lien41.data4, "yyyy")# and recorded #DateFormat(read_lien41.data9, "mm")#/#DateFormat(read_lien41.data9, "dd")#/#DateFormat(read_lien41.data9, "yyyy")#
			    <cfif #read_lien41.data1# eq ""> in Book #read_lien41.data2# at Page #read_lien41.data3# 
				    <cfelse> in Document #read_lien41.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien41.data1)# gt 0 AND #len(read_lien41.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien41.data2)# gt 0 AND #len(read_lien41.data3)# gt 0 >
							in Book #read_lien41.data2# at Page #read_lien41.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien41.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien42.data7# NEQ ""> #read_lien42.lienintro# <cfif read_lien42.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien42.data7# in favor of #read_lien42.data6# in the amount of #read_lien42.data5#, dated #DateFormat(read_lien42.data4, "mm")#/#DateFormat(read_lien42.data4, "dd")#/#DateFormat(read_lien42.data4, "yyyy")# and recorded #DateFormat(read_lien42.data9, "mm")#/#DateFormat(read_lien42.data9, "dd")#/#DateFormat(read_lien42.data9, "yyyy")#
			    <cfif #read_lien42.data1# eq ""> in Book #read_lien42.data2# at Page #read_lien42.data3# 
				    <cfelse> in Document #read_lien42.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien42.data1)# gt 0 AND #len(read_lien42.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien42.data2)# gt 0 AND #len(read_lien42.data3)# gt 0 >
							in Book #read_lien42.data2# at Page #read_lien42.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					    
				     </cfif> #read_lien42.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien43.data7# NEQ ""> #read_lien43.lienintro# <cfif read_lien43.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien43.data7# in favor of #read_lien43.data6# in the amount of #read_lien43.data5#, dated #DateFormat(read_lien43.data4, "mm")#/#DateFormat(read_lien43.data4, "dd")#/#DateFormat(read_lien43.data4, "yyyy")# and recorded #DateFormat(read_lien43.data9, "mm")#/#DateFormat(read_lien43.data9, "dd")#/#DateFormat(read_lien43.data9, "yyyy")#
			    <cfif #read_lien43.data1# eq ""> 
			    in Book #read_lien43.data2# at Page #read_lien43.data3#
				     <cfelse> in Document #read_lien43.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien43.data1)# gt 0 AND #len(read_lien43.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien43.data2)# gt 0 AND #len(read_lien43.data3)# gt 0 >
							in Book #read_lien43.data2# at Page #read_lien43.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				     
				      </cfif> #read_lien43.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien44.data7# NEQ ""> #read_lien44.lienintro# <cfif read_lien44.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien44.data7# in favor of #read_lien44.data6# in the amount of #read_lien44.data5#, dated #DateFormat(read_lien44.data4, "mm")#/#DateFormat(read_lien44.data4, "dd")#/#DateFormat(read_lien44.data4, "yyyy")# and recorded #DateFormat(read_lien44.data9, "mm")#/#DateFormat(read_lien44.data9, "dd")#/#DateFormat(read_lien44.data9, "yyyy")#
			    <cfif #read_lien44.data1# eq ""> in Book #read_lien44.data2# at Page #read_lien44.data3# 
				    <cfelse> in Document #read_lien44.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien44.data1)# gt 0 AND #len(read_lien44.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien44.data2)# gt 0 AND #len(read_lien44.data3)# gt 0 >
							in Book #read_lien44.data2# at Page #read_lien44.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien44.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>

<CFQUERY datasource="#request.dsn#" NAME="read_lien45">
			select * from title_ins_view
			WHERE title_id = #url.rec_ID# and selectedOrgs3 = 45
			</cfquery>
<cfif read_lien45.recordcount GT 0>
<cfset mortgages_liens = 1>
</cfif>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien45.data7# NEQ ""> #read_lien45.lienintro# <cfif read_lien45.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien45.data7# in favor of #read_lien45.data6# in the amount of #read_lien45.data5#, dated #DateFormat(read_lien45.data4, "mm")#/#DateFormat(read_lien45.data4, "dd")#/#DateFormat(read_lien45.data4, "yyyy")# and recorded #DateFormat(read_lien45.data9, "mm")#/#DateFormat(read_lien45.data9, "dd")#/#DateFormat(read_lien45.data9, "yyyy")#
			    <cfif #read_lien45.data1# eq ""> in Book #read_lien45.data2# at Page #read_lien45.data3# 
				    <cfelse> in Document #read_lien45.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien45.data1)# gt 0 AND #len(read_lien45.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien45.data2)# gt 0 AND #len(read_lien45.data3)# gt 0 >
							in Book #read_lien45.data2# at Page #read_lien45.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien45.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien46.data7# NEQ ""> #read_lien46.lienintro# <cfif read_lien46.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien46.data7# in favor of #read_lien46.data6# in the amount of #read_lien46.data5#, dated #DateFormat(read_lien46.data4, "mm")#/#DateFormat(read_lien46.data4, "dd")#/#DateFormat(read_lien46.data4, "yyyy")# and recorded #DateFormat(read_lien46.data9, "mm")#/#DateFormat(read_lien46.data9, "dd")#/#DateFormat(read_lien46.data9, "yyyy")#
			    <cfif #read_lien46.data1# eq "">
				     in Book #read_lien46.data2# at Page #read_lien46.data3# 
				     <cfelse> in Document #read_lien46.data1#
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien46.data1)# gt 0 AND #len(read_lien46.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien46.data2)# gt 0 AND #len(read_lien46.data3)# gt 0 >
							in Book #read_lien46.data2# at Page #read_lien46.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				     
				      </cfif> #read_lien46.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien47.data7# NEQ ""> #read_lien47.lienintro# <cfif read_lien47.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien47.data7# in favor of #read_lien47.data6# in the amount of #read_lien47.data5#, dated #DateFormat(read_lien47.data4, "mm")#/#DateFormat(read_lien47.data4, "dd")#/#DateFormat(read_lien47.data4, "yyyy")# and recorded #DateFormat(read_lien47.data9, "mm")#/#DateFormat(read_lien47.data9, "dd")#/#DateFormat(read_lien47.data9, "yyyy")#
			    <cfif #read_lien47.data1# eq ""> in Book #read_lien47.data2# at Page #read_lien47.data3# 
				    <cfelse> in Document #read_lien47.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien47.data1)# gt 0 AND #len(read_lien47.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien47.data2)# gt 0 AND #len(read_lien47.data3)# gt 0 >
							in Book #read_lien47.data2# at Page #read_lien47.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->					    
				</cfif> #read_lien47.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien48.data7# NEQ ""> #read_lien48.lienintro# <cfif read_lien48.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien48.data7# in favor of #read_lien48.data6# in the amount of #read_lien48.data5#, dated #DateFormat(read_lien48.data4, "mm")#/#DateFormat(read_lien48.data4, "dd")#/#DateFormat(read_lien48.data4, "yyyy")# and recorded #DateFormat(read_lien48.data9, "mm")#/#DateFormat(read_lien48.data9, "dd")#/#DateFormat(read_lien48.data9, "yyyy")#
			    <cfif #read_lien48.data1# eq ""> in Book #read_lien48.data2# at Page #read_lien48.data3# 
				    <cfelse> in Document #read_lien48.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien48.data1)# gt 0 AND #len(read_lien48.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien48.data2)# gt 0 AND #len(read_lien48.data3)# gt 0 >
							in Book #read_lien48.data2# at Page #read_lien48.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien48.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien49.data7# NEQ ""> #read_lien49.lienintro# <cfif read_lien49.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien49.data7# in favor of #read_lien49.data6# in the amount of #read_lien49.data5#, dated #DateFormat(read_lien49.data4, "mm")#/#DateFormat(read_lien49.data4, "dd")#/#DateFormat(read_lien49.data4, "yyyy")# and recorded #DateFormat(read_lien49.data9, "mm")#/#DateFormat(read_lien49.data9, "dd")#/#DateFormat(read_lien49.data9, "yyyy")#
			    <cfif #read_lien49.data1# eq ""> in Book #read_lien49.data2# at Page #read_lien49.data3# 
				    <cfelse> in Document #read_lien49.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien49.data1)# gt 0 AND #len(read_lien49.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien49.data2)# gt 0 AND #len(read_lien49.data3)# gt 0 >
							in Book #read_lien49.data2# at Page #read_lien49.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien49.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td>#auto_number#.</td>
		    <td>
              <cfif #read_lien50.data7# NEQ ""> #read_lien50.lienintro# <cfif read_lien50.lienintro neq 'UCC Financing Statement'>Judgment </cfif>against #read_lien50.data7# in favor of #read_lien50.data6# in the amount of #read_lien50.data5#, dated #DateFormat(read_lien50.data4, "mm")#/#DateFormat(read_lien50.data4, "dd")#/#DateFormat(read_lien50.data4, "yyyy")# and recorded #DateFormat(read_lien50.data9, "mm")#/#DateFormat(read_lien50.data9, "dd")#/#DateFormat(read_lien50.data9, "yyyy")#
			    <cfif #read_lien50.data1# eq ""> in Book #read_lien50.data2# at Page #read_lien50.data3# 
				    <cfelse> in Document #read_lien50.data1# 
						<!---(Start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif  #len(read_lien50.data1)# gt 0 AND #len(read_lien50.data2)# gt 0 > ,</cfif>
							<!-- check for book no. and page no. --->
						<cfif #len(read_lien50.data2)# gt 0 AND #len(read_lien50.data3)# gt 0 >
							in Book #read_lien50.data2# at Page #read_lien50.data3# 
						</cfif>	  
						 <!---(end) -- Added by Synechron Development for ticket# 454 ------->				    
				</cfif> #read_lien50.data8#</cfif>
<BR><BR>
		</td>
	</tr>
</cfoutput>
...
<cfset auto_number = #auto_number# + 1>
	<tr>
		  <td valign="top"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">North American Title Insurance Company reserves the right to make additional exceptions and/or requirements upon compliance with the requirements set forth herein.<br>
	</tr>
...
alert("#len(read_Title_Data.addreq)#");
</script>
</cfoutput>
 --->
<cfif auto_number eq 6>
<cfset maxletters = 1000>
<cfelseif auto_number eq 7>
<cfset maxletters = 500>
<cfelseif auto_number eq 8>
<cfset maxletters = 300>
<cfelseif auto_number eq 9>
<cfset maxletters = 0>
<cfelse>
<cfset maxletters = 200000000>
</cfif>
...
<cfif len(read_Title_Data.addreq) GT maxletters>
<cfset extra_text = Mid(read_Title_Data.addreq, maxletters, Len(read_Title_Data.addreq))>
<cfset stop_number = Find(" ", read_Title_Data.addreq, maxletters)>
<cfset text_1 = Mid(read_Title_Data.addreq, 1, stop_number)>
<cfset text_2 = Mid(read_Title_Data.addreq, stop_number + 1, Len(read_Title_Data.addreq))>
</cfif>
...
<cfif read_title.comp_id neq 8417> <!--- removed for Doc Solution, Inc. - DIL.  There will be no new mortgage put on for these deals --->
	      <tr align="left" valign="top">
            <td><cfoutput>#auto_number#</cfoutput>.</td>
		    <td>
              <cfoutput>Recordation of (mortgage/deed of trust) from <cfif #read_title.purchase# neq "" and  #read_title.purchase# neq 0 and  #read_title.purchase# neq "NULL">#Buyer_1#, &nbsp;&nbsp;#Buyer_2#<cfif Len(read_title.blastname3)>, #read_title.bfirstname3# #read_title.blastname3# </cfif><cfif Len(read_title.blastname4)>, #read_title.bfirstname4# #read_title.blastname4# </cfif><cfelse>TBD</cfif> securing #read_title.insured# in the amount of $<cfif #read_title.loanamt_float# neq "" and #read_title.loanamt_float# neq 0 and #read_title.loanamt_float# neq 'NULL'>#NumberFormat(read_title.loanamt_float, "999,999,999.00")#<cfelse>TBD</cfif> </cfoutput>
		</td>
	</tr>
</cfif>
	<tr>
...
<cfif mortgages_liens eq 0 and (#read_title_data.addreq# eq '' or #read_title_data.addreq# eq "NULL")>
	<tr>
...
<cfif len(read_Title_Data.addreq) LTE maxletters>
	<tr>
...
<!--- extra additiona requirements page --->
<cfif len(read_Title_Data.addreq) GT maxletters>
<P>
...
<br>
	...
	<tr>
		<td colspan="3">Additional Requirements:</td>
	</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
	</tr>
      ...
      <table width="93%" cellpadding=0 cellspacing=0 border=0 >
        <tr>
		  <td width="5%" valign="top">&nbsp;</td>
		<td><cfoutput>#text_2#</cfoutput></td>
	</tr>
<cfset auto_number = #auto_number# + 1>
		<tr>
		  <td colspan="2">&nbsp;</td>
...
<cfif read_title.comp_id neq 8417> <!--- removed for Doc Solution, Inc. - DIL.  There will be no new mortgage put on for these deals --->
	...
	<tr>
        ...
        <tr>
		  <td width="5%" valign="top"><cfset auto_number = #auto_number# + 1><cfoutput>#auto_number#</cfoutput></td>
...
<br>
<br>
SCHEDULE B - SECTION II</strong><br>
EXCEPTIONS
</center>
          </td>
    </tr>
...
<br>
          ...
          <td colspan = 3 align = "center"><p>
<cfinclude template="title_committment_tax_box_north_american.cfm">
		  </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
