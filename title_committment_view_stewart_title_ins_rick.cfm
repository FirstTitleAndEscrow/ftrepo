...
<CFQUERY DATASOURCE="#dynamic_datasource#" name="check_shapiro">
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_tax">
			SELECT *
			FROM tax_cert_title
			where title_id = #rec_id#
		</CFQUERY>
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_title_update">
			SELECT *
			FROM doc_abstract_title
			where title_id = #rec_id# and title_update = 'True'
		</CFQUERY>
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_Title">
    SELECT *
	FROM Title
	WHERE Title_ID = #rec_ID#
</CFQUERY>
<cfparam name="company_id" default="#read_title.comp_id#">
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_title_data">
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_rosicki">
    SELECT *
	FROM Rosicki
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_keystone">
    SELECT *
	FROM Keystone
	WHERE Order_ID = #rec_ID#
</CFQUERY>
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_FT_company">
    SELECT *
	FROM Companies
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="Read_Committment_Doc">
    SELECT *
	FROM Doc_Title_Insurance_Title
	WHERE Title_ID = #rec_ID# and Insurance_co = 16
</CFQUERY>

<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_ins_committments">
    SELECT *
	FROM Doc_Title_Insurance_Title
	WHERE Title_ID = #rec_ID#
</CFQUERY>

<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="get_billing_states">
    SELECT *
...
<cfif #get_billing_states.recordcount# GT "0">
    <CFQUERY DATASOURCE="#dynamic_datasource#" NAME="get_line_costs">
		SELECT *
		FROM Company_Billing_Values
		WHERE company_id = #read_title.comp_id# AND billing_id = #get_billing_states.billing_id#
	</CFQUERY>

    <CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_age">
		SELECT *
...
<cfif #read_age.recordcount# gt "0">
      ...
      <CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_Title_FT_Agency_company">
          SELECT *
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_Title_FT_Agency_company">
	...
	<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="Read_Doc">
			SELECT *
			FROM Doc_Amer_Pioneer_Ins_ALL_Title
			WHERE Title_ID = #rec_ID#
		</CFQUERY>

		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_company">
			SELECT *
...
#this_company# staff
				...
				<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_tax_info">

			SELECT *
			FROM tax_cert_title
			where title_id = #rec_id#
		</CFQUERY>
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_deed_info">
		SELECT     *
FROM         title_ins_view
WHERE     (title_id = #rec_id#) AND (type = 'DATA')
ORDER BY insert_date, insert_time DESC
</CFQUERY>
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_data_info">
		SELECT     *
FROM        doc_title_insurance_title
WHERE     (title_id = #rec_id#)
</CFQUERY>
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="get_all" maxrows=10>
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_title">
		...
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_comp">
	...
	<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_hud">

			SELECT a_1108_a
			FROM hud_form_title_pg2
			where title_id = #rec_id#

		</CFQUERY>					<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_rec_fees">
					SELECT *
					FROM recording_fees
...
<Cfset rel_fee = "0">
	...
	<CFSET intang_tax = #round(read_title.loanamt_float)# * #read_rec_fees.intangible_tax#>
		...
		<CFSET rel_fee = "0">
			...
			<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_this_sets_billing_states">
...
<cfoutput query="read_this_sets_billing_states">
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_this_sets_billing_values">
...
<p>
      <table width="93%" cellpadding=1 cellspacing=1 border=0 valign="top" >
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_title_data">
            select * from title_ins_view WHERE title_id = #url.rec_ID# and selectedOrgs
...
<cfset auto_number = #auto_number# + 1>
        <tr>
         <td width="5%" valign="top">#auto_number# - tx</td>
<td><b>Real Estate Tax Information: </b>
	...
	<cfset auto_number = #auto_number# + 1>
	<tr>
		  <td width="5%" valign="top"><cfoutput>#auto_number#</cfoutput> - x</td>
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage">
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage2">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage3">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage4">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage5">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage6">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage7">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage8">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage9">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage10">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage11">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage12">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage13">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage14">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage15">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_mortgage16">
			select * from title_ins_view
...
<br>
	 	...
	 	<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien2">
			select * from title_ins_view
...
<br>
		...
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien3">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien4">
			select * from title_ins_view
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien5">
			select * from title_ins_view
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien6">
			select * from title_ins_view
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien7">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien8">
			select * from title_ins_view
...
<cfset mortgages_liens = 1>
	...
	<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien9">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien10">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien11">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien12">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien13">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien14">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien15">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_lien16">
			select * from title_ins_view
...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="check_states">
SELECT     title_co_id
FROM         Title_Companies_States
WHERE     (st_abbrev = '#read_title.pstate#')
</CFQUERY>

<cfif (read_FT_Company.company contains "Chase Home Mortgage" or read_FT_Company.company contains "First Michigan"  or read_FT_Company.company contains "Flagstar Bank"  or read_FT_Company.company contains "1st Continental Mortgage - Corp - FHA"  or read_FT_Company.company contains "1st Continental Mortgage - Corp - Conv/VA" or read_FT_Company.company contains "Chase -")   and check_states.title_co_id neq "19">
...
<cfif (read_FT_Company.company contains "Chase Home Mortgage" or read_FT_Company.company contains "Chase -")>
Addressee:<BR>
...
(Covered Party) <BR><BR>
<cfelseif (read_FT_Company.company contains "Flagstar bank")>
Addressee:<BR>
Flagstar Bank, FSB<BR>
5151 Corporate Drive <BR>
Troy, MI 48098 <BR>
(Covered Party) <BR><BR>
<cfelseif (read_FT_Company.company contains "1st Continental Mortgage - Corp - FHA"  or read_FT_Company.company contains "1st Continental Mortgage - Corp - Conv/VA")>
Addressee:<BR>
1st Continental Mortgage<BR>
2619 E. Oakland Drive<BR>
Fort Lauderdale, FL 33306<BR>
(Covered Party) <BR><BR>
<cfelse>
First Michigan Bank<br>
2301 West Big Beaver Road<br>
Ste. 525<br>
Troy, MI 48084<br>
(Covered Party)
<br>
...
<cfoutput>Property: #read_title.paddress#, #read_title.pstate# #read_title.pzip#</cfoutput><BR></cfif><BR>
...
<cfif (read_FT_Company.company contains "Chase Home Mortgage" or read_FT_Company.company contains "First Michigan"  or read_FT_Company.company contains "Flagstar Bank"  or read_FT_Company.company contains "1st Continental Mortgage - Corp - FHA"  or read_FT_Company.company contains "1st Continental Mortgage - Corp - Conv/VA") and check_states.title_co_id neq "19">
