<!---<cfif #getcustomerinfo.RecordCount# NEQ 1>--->
...
Name<br>
<INPUT NAME="oname" size=15 maxlength=25>
</td>

<td bgcolor="a2a3fe" width=""><FONT FACE=ARIAL SIZE=2 color="black">
Phone No.<br>
<CFINPUT NAME="ophone" message="Please enter the office's phone no. in the format of xxx-xxx-xxxx." validate="telephone"  size=10 maxlength=15> 
</td>
...
<CFINPUT NAME="bssn1" message="Please enter the borrower's social security no. in the format of xxx-xx-xxxx." required="Yes"  validate="social_security_number" size=10 maxlength=15> 
...
<td><CFINPUT NAME="pcounty" size=40 maxlength=50 message="Property county is required." required="yes">
...
<td><CFinput type="text" name="plegaldesc" size=50 maxlength=150 message="Legal Description is a required field" required="yes">
