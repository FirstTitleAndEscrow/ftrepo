...
<CFQUERY datasource="#request.dsn#" NAME="insert_line_costs">
		update Company_Billing_Values
		set A_1113_text = '#A_1113_text#', A_1304_text = '#A_1304_text#', A_1305_text = '#A_1305_text#', A_1303_text = '#A_1303_text#', a_1111_text = '#a_1111_text#', a_1112_text = '#a_1112_text#', A_1205_text = '#A_1205_text#'
		WHERE company_id = #get_titleid.comp_id# AND billing_id = #get_billing_states.billing_id#
	</CFQUERY>
...
<cfif #read_data2.a_1101_b# EQ "">
<Cfset a_1101_b = "0">
<cfelse>
<Cfset a_1101_b = #round(read_data2.a_1101_b)#>
</cfif>
<cfif #read_data2.a_1102_b# EQ "">
<Cfset a_1102_b = "0">
<cfelse>
<Cfset a_1102_b = #round(read_data2.a_1102_b)#>
</cfif>

<cfif #read_data2.a_1103_b# EQ "">
<Cfset a_1103_b = "0">

<cfelse>
<Cfset a_1103_b = #round(read_data2.a_1103_b)#>
</cfif>

<cfif #read_data2.a_1104_b# EQ "">
<Cfset a_1104_b = "0">

<cfelse>
<Cfset a_1104_b = #round(read_data2.a_1104_b)#>
</cfif>

<cfif #read_data2.a_1105_b# EQ "">
<Cfset a_1105_b = "0">

<cfelse>
<Cfset a_1105_b = #round(read_data2.a_1105_b)#>
</cfif>

<cfif #read_data2.a_1106_b# EQ "">
<Cfset a_1106_b = "0">

<cfelse>
<Cfset a_1106_b = #round(read_data2.a_1106_b)#>
</cfif>

<cfif #read_data2.a_1107_b# EQ "">
<Cfset a_1107_b = "0">

<cfelse>
<Cfset a_1107_b = #round(read_data2.a_1107_b)#>
</cfif>

<cfif #read_data2.a_1111_b# EQ "">
<Cfset a_1111_b = "0">
<cfelse>
<Cfset a_1111_b = #round(read_data2.a_1111_b)#>

</cfif>
<cfif #read_data2.a_1112_b# EQ "">
<Cfset a_1112_b = "0">
<cfelse>
<Cfset a_1112_b = #round(read_data2.a_1112_b)#>

</cfif>

<cfif #read_data2.a_1113_b# EQ "">
<Cfset a_1113_b = "0">
<cfelse>
<Cfset a_1113_b = #round(read_data2.a_1113_b)#>

</cfif>

<cfif #read_data2.a_1205_b# EQ "">
<Cfset a_1205_b = "0">
<cfelse>
<Cfset a_1205_b = #round(read_data2.a_1205_b)#>
</cfif>

<cfif #read_data2.a_1303_b# EQ "">
<Cfset a_1303_b = "0">
<cfelse>
<Cfset a_1303_b = #round(read_data2.a_1303_b)#>
</cfif>

<cfif #read_data2.a_1304_b# EQ "">
<Cfset a_1304_b = "0">
<cfelse>
<Cfset a_1304_b = #round(read_data2.a_1304_b)#>
</cfif>

<cfif #read_data2.a_1305_b# EQ "">
<Cfset a_1305_b = "0">
<cfelse>
<Cfset a_1305_b = #round(read_data2.a_1305_b)#>

</cfif>


					<CFSET a_total_charges = #a_1101_b#
													+ #a_1102_b#
													+ #a_1103_b#
													+ #a_1104_b#
													+ #a_1105_b#
...
FROM="webmaster@firsttitleservices.com" Subject="Title Insurance modified"
TIMEOUT="600"
>
Below is the link for the modified Title Insurance form for order #rec_id#
https://www.firsttitleservices.com/admin_area/title_view_hud_pg1.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#
	...
	<tr>
		<td bgcolor=white colspan=4 width=790 align=left valign=top>
			<font size=1 color=black face=arial>
				...
				<nobr><font size=1 color=black face=arial>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Place of Settlement:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cfif NOT DateDiff("d", Now(), "1/30/2012")><font size=1 color=blue face=verdana><b>30 W. Gude Dr. Rockville, MD. 20850 - Montgomery County</b></NOBR><cfelse><font size=1 color=blue face=verdana><b>7361 Calhoun Place, Suite 200, Rockville, MD. 20855 - Montgomery County</b></NOBR></cfif><br>
...
<!--- </table>
	...
	<tr>
		<td bgcolor=white width=790 align=right colspan = 3 valign=top>
