...
<CFQUERY datasource="#request.dsn#" NAME="read_current_Commitment_Clauses">
		...
		<CFQUERY datasource="#request.dsn#" NAME="Read_Title_Order_Req">
			...
			<CFQUERY datasource="#request.dsn#" NAME="Read_Title_Order_shipping">
				SELECT *
				FROM title_notes
				Where (order_Id = #URL.rec_id#) and (access = 1) and (N_note = 'Package Received' or N_note = 'Package Due/Unrec.' or N_note = 'FT Shipped Pack' or N_note like '%UPS%' or N_note like '%FEDEX%' or N_note like '%FUND%')
