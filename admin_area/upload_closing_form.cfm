...
SERVER="127.0.0.1"
Subject="First Title - Closing Package 1 for order #rec_id# - #get_id.bfirstname1# #get_id.blastname1#, Loan No. - #get_id.loan_number#"
TIMEOUT="600"
type="HTML"
>
...
<CFLOCATION URL="https://#cgi.server_name#/admin_area/closing_form_upload.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=21&company_id=0">
...
<table width=455 cellpadding=1 cellspacing=1 border=0>
		...
		<B>1st Title & Escrow, Inc. -Closing Form File Upload for Order <CFOUTPUT query="get_id">#title_id#</CFOUTPUT></B>
		<p>
...
<FORM action="./upload_closing_form_final.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#"  ENCTYPE="multipart/form-data" method="post">
