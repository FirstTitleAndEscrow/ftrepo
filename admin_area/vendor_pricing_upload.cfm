...
<cfmail to="rjermain@firsttitleservices.com" from="webmaster@firsttitleservices.com" subject="New Vendor Pricing Uploaded - #get_vendor.company#" type="html" server="127.0.0.1">
<cfmailparam file="#fileSys.FindFilePath('#new_file_name#', 'file')#">
