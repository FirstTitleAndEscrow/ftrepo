...
<CFSET b_emails_to_first_title = "webmaster@firsttitleservices.com,spape@firsttitleservices.com,akumar@firsttitleservices.com">
<CFELSE>
<CFSET b_emails_to_first_title = "webmaster@firsttitleservices.com,akumar@firsttitleservices.com">
</CFIF>
				<CFMAIL
...
FROM="webmaster@firsttitleservices.com"
SERVER="127.0.0.1"
Subject="Copy of Customer Order with 1st Title & Escrow, Inc. #get_titleid.app_id#-#get_titleid.bfirstname1# #get_titleid.blastname1#"
TIMEOUT="600"
type="HTML"
>
...
instantly prepared for you! Click <a href="https://#cgi.server_name#/title_view_hud_pg1.cfm?comp_id=#comp_id#&rec_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center></cfif><br>
				 --->
...
<CFLOCATION URL="https://#cgi.server_name#/order_verify_display_title.cfm?comp_id=#comp_id#&title_id=#title_id#&prop_id=#prop_id#&app_id=#get_titleid.app_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#">
