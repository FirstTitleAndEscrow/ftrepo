...
<CFIF #a_flag# EQ "2">
	...
	<CFSET a_agency_list = #ListToArray(FORM.New_agency_id, ",")#>
	...
	<CFLOOP FROM="1" TO="#ArrayLen(a_agency_list)#" INDEX="DDD">
		...
		<CFQUERY datasource="#request.dsn#" >		
			INSERT INTO company_agency_assoc(title_FT_Agency_ID, title_FT_Agency_Name, title_FT_Agency_State, Company_ID)
			VALUES(#read_agency_1.title_FT_Agency_ID#, '#read_agency_1.company#',  '#read_agency_1.state#', #company_id#)		
		</CFQUERY>	
...
<CFELSEIF #a_flag# EQ "1">
	...
	<CFSET a_agency_list = #ListToArray(FORM.Current_agencies_id, ",")#>
	
	<CFLOOP FROM="1" TO="#ArrayLen(a_agency_list)#" INDEX="EEE">
		<CFQUERY datasource="#request.dsn#" >		
			DELETE
			FROM company_agency_assoc
			WHERE title_FT_Agency_ID = #a_agency_list[EEE]# AND company_id = #company_id#
		</CFQUERY>	
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_current_agency_assoc">
			...
			ORDER BY title_FT_Agency_State ASC, title_FT_Agency_Name ASC
