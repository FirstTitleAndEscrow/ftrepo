...
message = message + "In order to add a new Closer you need to choose county(ies)/state(s) Closer serves\n"
valid = false;
}
if (valid == false) {
alert(message);
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="Closer_add_submit.cfm?uid=#URL.uid#&al=#URL.al#" name="frm">
</CFOUTPUT>
	...
	<tr>		
		...
		<td width=368 align=left valign=top bgcolor=e6e6e6>	
			<input type=text name="user_name" VALUE="" size=20 maxlength=90
	...
	<tr>		
		...
		<td width=368 align=left valign=top bgcolor=e6e6e6>	
			<input type=text name="pass" VALUE="" size=20 maxlength=90
...
<tr>		
		<td width=468 colspan=2 align=center valign=top bgcolor=e6e6e6>	
			...
			Select County and State Closer is going to serve
