...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			...
			set recording_fee = '#form.recording_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="recording_fee" VALUE="#read_entry.recording_fee#" size=6 maxlength=22
