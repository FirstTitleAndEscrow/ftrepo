...
<CFPARAM NAME="transfer_tax" DEFAULT="">
	...
	<CFQUERY datasource="#request.dsn#">
		INSERT INTO recording_fees(state, county, mort_rec_fee, release_rec_fee, mort_stamps, stamps_diff, intangible_tax, transfer_tax)
		VALUES('#state#', '#county#', '#mort_rec_fee#', '#release_rec_fee#', '#mort_stamps#', '#stamps_diff#', '#intangible_tax#', '#transfer_tax#')
