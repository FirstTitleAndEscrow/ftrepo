...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			...
			set taxprep_fee = '#form.taxprep_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="taxprep_fee" VALUE="#read_entry.taxprep_fee#" size=6 maxlength=22
