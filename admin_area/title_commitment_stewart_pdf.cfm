...
<cfdocumentitem type="header">
<style>
.small_header {font-family:Arial, Helvetica, sans-serif; font-size:11px;}
</style>
...
<style>
TD {font-family:Arial, Helvetica, sans-serif; font-size:10pt;}
.headerstyle {font-family:Arial, Helvetica, sans-serif; font-size:14px;}
</style>
<table width="100%" cellpadding=5 cellspacing=0 border=0 >
	  <tr>
		<td align="center" class="headerstyle">TAX INFO</font></td>
	</tr>
	<tr>
		<td  >&nbsp;</td>
	</tr>
...
<table >
<tr>
<td align="left" valign="top">Borrower(s) Name(s):<br>
...
<cfoutput>
<tr bgcolor="FFFFFF">
<td align="left" valign="top">#read_report.payto#<BR>
...
#read_report.web#</td>
<td align="left" valign="top">#read_report.collects_for#</td>
<td align="left" valign="top">#read_report.acctnum#</td>
<td align="left" valign="top" >#read_report.taxfreq#</td>
<td align="left" valign="top">#read_report.tax_dueDate#
...
<td align="left" valign="top">#read_report.tax_lateDate#
<cfif read_report.taxfreq eq 'Semi Annually'><br>
...
<td align="left" valign="top">#read_report.lastamt#</td>
<td align="left" valign="top">#read_report.paidDate#</td>
<td align="left" valign="top">#read_report.paidTo#</td>
<td align="left" valign="top">#read_report.dueDate#</td>
</tr>
...
<table>
<tr>
<td align="left" valign="top">Closing Agent/Attorney Name:<br>
