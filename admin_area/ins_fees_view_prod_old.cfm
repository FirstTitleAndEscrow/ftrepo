...
<CFOUTPUT QUERY="read_records">
	...
	<tr>
		...
		<td width=50 align=center valign=top bgcolor=f1f1f1>
		<cfif #url.al# eq 1>	<a href="./ins_fees_modify.cfm?a_item_id=#ID#&a_table=#a_info[1]#&a_state_display=#a_info[2]#&uid=#URL.uid#&al=#URL.al#"><img border=0 src="./images/button_m.gif" ALT="Modify this entry"></a>		<cfelse> <img border=0 src="./images/button_m.gif" ALT="Modify this entry"></cfif>
		</td>
		<td width=50 align=center valign=top bgcolor=f1f1f1>
