...
<CFQUERY datasource="#request.dsn#" NAME="get_tx_ids">
	SELECT  c.ID
	FROM	companies c, First_Admin f 
	where f.tx_employee = 'True'
	and f.ID = c.intSales
</CFQUERY>
<cfset tx_ids = ValueList(get_tx_ids.ID)>
...
<CFIF #state# eq "none" and #company_id# eq "none">
		...
		<cfif #comments# neq "none">
			<cfif #comments# is "Cancelled per client">
				and a.cancelled = 1 
			<cfelseif #comments# is "SR Closing Paid">
				and a.sr_closing_paid = 'True' 
			<cfelse> 
...
<!--- ======================================================================== --->
	...
	<CFLOOP QUERY="read_report"> 
		<CFOUTPUT>
			...
			<cfset actual_record_count = actual_record_count +1>
			<tr>
...
<cfif (#confirm_mon# NEQ "Month" and #comfirm_day# NEQ "Day" and #confirm_year# NEQ "Year") and (#confirm_mon_to# NEQ "Month" and #comfirm_day_to# NEQ "Day" and #confirm_year_to# NEQ "Year")>
			...
			and (e.cl_dateandtime between '#DateFormat(YearMon, "yyyy-mm-dd")# 00:00:00' AND '#DateFormat(YearMonto, "yyyy-mm-dd")# 23:59:59')
			
			<cfelseif (#loancloseorfun# NEQ "NONE") and (#loancloseorfun# is "Loan Closed OR Funded")>
			and ((e.cl_dateandtime between '#DateFormat(YearMon, "yyyy-mm-dd")# 00:00:00' AND '#DateFormat(YearMonto, "yyyy-mm-dd")# 23:59:59') OR (e.fl_dateandtime between '#DateFormat(YearMon, "yyyy-mm-dd")# #TimeFormat(YearMon, "HH:mm:ss")#' AND '#DateFormat(YearMonto, "yyyy-mm-dd")# #TimeFormat(YearMonto, "HH:mm:ss")#'))
			
			
			<cfelseif (#sellerreploanclosed# NEQ "NONE") and (#sellerreploanclosed# is "Seller Rep - Loan Closed")>
			and (e.cl_dateandtime between '#DateFormat(YearMon, "yyyy-mm-dd")# 00:00:00' AND '#DateFormat(YearMonto, "yyyy-mm-dd")# 23:59:59') and (a.appraisal_status = 'Loan Closed-Seller Rep')
...
<!--- 		<cfif (#subordination_needed# NEQ "NONE") and (#subordination_needed# is "Subordination Needed")>
 ...
 --->		<cfif (#prefunding# NEQ "NONE") and (#prefunding# is "Pre-Funding Completed")>
	 ...
	 <cfif (#event6# NEQ "NONE") and (#event6# is "Closer Not Assigned")>
		...
		AND (a.sr_closing_paid is null or a.sr_closing_paid = 'False')
		</cfif>
...
<cfif ListContainsNoCase(richmond_ids, comp_id, ",") and ListGetAt(richmond_ids, ListContainsNoCase(richmond_ids, comp_id, ",") , ",") eq comp_id and read_report.pstate neq 'TX'>
				<cfif ListFind(list_of_ids, #title_id#, ",") eq 0>
			<cfset actual_record_count = actual_record_count +1>
				<tr>
...
<tr><td colspan=10>FIRST TITLE - TEXAS</td></tr>

<!--- <cfif cgi.REMOTE_ADDR eq '98.233.235.105'>
<cfmail to="rjermain@firsttitleservices.com" from="rjermain@firsttitleservices.com" subject="test" type="html">
...
<cfif ListContainsNoCase(tx_ids, comp_id, ",") and ListGetAt(tx_ids, ListContainsNoCase(tx_ids, comp_id, ",") , ",") eq comp_id or read_report.pstate eq 'TX'>
				<cfif ListFind(list_of_ids, #title_id#, ",") eq 0>
			<cfset actual_record_count = actual_record_count +1>
				<tr>
...
<cfif (NOT ListContainsNoCase(richmond_ids, comp_id, ",") or (ListContainsNoCase(richmond_ids, comp_id, ",") and ListGetAt(richmond_ids, ListContainsNoCase(richmond_ids, comp_id, ",") , ",") neq comp_id)) and (NOT ListContainsNoCase(tx_ids, comp_id, ",") or (ListContainsNoCase(tx_ids, comp_id, ",") and ListGetAt(tx_ids, ListContainsNoCase(tx_ids, comp_id, ",") , ",") neq comp_id))>
<cfif ListFind(list_of_ids, #title_id#, ",") eq 0 and read_report.pstate neq 'TX'>
			<cfset actual_record_count = actual_record_count +1>
...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			FROM Title a, title_closing_order_request f, doc_closer_title g, eventlist e, tax_cert_title b, companies c
			WHERE a.oda_year > 2005 and   a.title_id = b.title_id and a.title_id = f.title_id and a.title_id = e.title_id and a.title_id = g.title_id
			and c.ID = a.comp_id AND f.a_Req_closing_month IS NOT NULL
...
<cfif (#confirm_mon# NEQ "Month" and #comfirm_day# NEQ "Day" and #confirm_year# NEQ "Year") and (#confirm_mon_to# NEQ "Month" and #comfirm_day_to# NEQ "Day" and #confirm_year_to# NEQ "Year")>
			...
			<CFIF #comments# NEQ "none">
			<cfif #comments# is "SR Closing Paid">
		       and a.sr_closing_paid = 'True' 
             <cfelse>
				AND a.comments = '#comments#'
				</cfif>
...
<div align="left">
<cfoutput><font size=1>Actual records: #actual_record_count#</font></cfoutput><br>
</div>
<br>
