...
By  <cfif ListFind("524,529,248",session.ft_user_id) ><img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/nathan_sig2.jpg" width="200"><cfelse>______________________________________________</cfif><BR>
