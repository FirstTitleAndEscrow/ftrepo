...
<cfset company_id = url.cid>
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_current_lender_assoc">
			...
			ORDER BY Lender_Name ASC, Lender_State ASC
		...
		<CFSET a_lender_addr = ArrayNew(1)>
		<CFSET a_count = "1">
		...
		<CFOUTPUT QUERY="read_lenders">
				...
				<CFSET a_lender_addr[a_count] = "" & #addr1# & ", " & #city# & ", " & #state# & " " & #zip_code# & "">
		...
		<td width=497 align=left valign=top bgcolor=e6e6e6>	
					...
					<CFIF #read_current_lender_assoc.recordcount# EQ "0">
						<CFLOOP FROM="1" TO="#ArrayLen(a_lender_id)#" INDEX="PPP">
							...
							<CFOUTPUT>
								<OPTION VALUE="#a_Lender_ID[PPP]#">#a_lender_state[PPP]#&nbsp;&nbsp;--&nbsp;#a_lender_name[PPP]#&nbsp;&nbsp;--&nbsp;#a_lender_addr[PPP]# </OPTION>
							</CFOUTPUT>
						</CFLOOP>
