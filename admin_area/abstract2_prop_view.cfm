...
select abstract_upload2 from doc_abstract_prop where prop_id = #url.rec_id#
</cfquery>
...
<cfoutput>
<A HREF="#fileSys.FindFilePath('#get_file.abstract_upload2#', 'url')#" target="new">Click to View/PrintAbstractor upload-2</a><BR>
