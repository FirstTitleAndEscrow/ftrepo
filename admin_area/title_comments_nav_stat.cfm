...
where order_ID = #rec_id# and N_Note like 'Postponed%'
		...
		<CFQUERY datasource="#request.dsn#">		
				Update Title_Notes
				set status = 1 
				where note_id = #read_notes.note_id# and N_Note != 'Clear to Close'
			</CFQUERY>
			<CFQUERY datasource="#request.dsn#">		
				Update doc_title_insurance_title
				set clear_close = 1 
...
<CFFORM NAME="frm" ACTION="./Title_comments_nav_stat.cfm?uid=#session.ft_user_id#&al=#URL.al#&rec_id=#url.rec_id#&a_trigger=1&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=1" METHOD=POST>
