...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="./prop_abstractor_admin_add_deed_submit.cfm?uid=#URL.uid#&al=#URL.al#&&rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes" onSubmit="return put();">
