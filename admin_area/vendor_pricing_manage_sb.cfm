...
<lh:MS_TableColumn
		...
		Search="Yes"
		required="yes"
		SelectQuery="select distinct(vendor_id) as selectValue, company as selectText from vendors_stacie_sb where company <> '' order by company"
		/>
