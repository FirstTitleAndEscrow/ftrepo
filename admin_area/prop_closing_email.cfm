<cfset is_VA = 0>
	<cfif #date# eq "">
<CFLOCATION URL="https://#cgi.server_name#/admin_area/prop_closing_doc_view.cfm?uid=#uid#&al=#al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#&a_flag=1">
...
<cfif check_VA.ft_fairfax_employee eq 'True'>
<cfset is_FX = 1>
</cfif>
...
<CFMAIL
TO="1#read_assigned_closer.fax#@efaxsend.com,#read_ft_user.email#"
FROM="#from_email#"
SERVER="127.0.0.1"
