...
<CFSET c_date = #DateFormat(Now(), "mm/dd/yyyy")#>
		...
		<CFQUERY datasource="#request.dsn#" >
			...
			INSERT INTO Title_FT_Agencies(company, phone, fax, addr1, addr2, city, state, zip_code, email, insert_time, insert_date)
	...
	<CFLOOP FROM="1" TO="#ArrayLen(st_list)#" INDEX="AAA">
		...
		<CFQUERY datasource="#request.dsn#" >
			...
			INSERT INTO Title_FT_Agencies_States(Title_FT_Agency_ID, St_Abbrev)
			VALUES(#Read_ID.Title_FT_Agency_ID#, '#st_list[AAA]#')
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>The First Title Agency was added</B>
		</td>
	</tr>
</CFOUTPUT>	
