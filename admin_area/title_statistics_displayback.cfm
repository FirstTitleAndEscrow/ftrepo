...
<cfif #a_trigger# eq "1">
	<CFIF #state# eq "none" and #company_id# eq "none">
		<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			WHERE (a.order_date > '#forty_five_days_ago#') and a.title_id = d.title_id and a.title_id = e.title_id and a.title_id = f.title_id and a.title_id = g.title_id 
...
<cfset comp_id_count = comp_id_count + 1>
		...
		<cfif IsDefined("session.is_logged_in") and (session.mi_employee eq 1 or session.mo_employee eq 1 or session.mi_flushing_employee eq 1 or session.tx_employee eq 1)>
and a.order_date > '07/14/2008'
</cfif>
...
<CFLOOP FROM="1" TO="#ArrayLen(cty_name_1)#" INDEX="TTT">
	...
	<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			SELECT *
			FROM Title a, doc_title_insurance_title d, tax_cert_title e, doc_abstract_title f, pay_off_lender_1_title g
			WHERE (a.order_date > '#forty_five_days_ago#') and a.title_id = d.title_id and a.title_id = e.title_id and a.title_id = f.title_id and a.title_id = g.title_id 	<cfif #comments# neq "none">
			<cfif #comments# is "Cancelled per client">
		and a.cancelled = 1 
		<cfelse> 
		and a.cancelled is null
...
<td bgcolor=#a_bgcolor# width=201 align=center valign=top>
	...
	<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			WHERE (a.order_date > '#forty_five_days_ago#') and a.prop_id = d.prop_id and a.prop_id = e.prop_id and a.prop_id = f.prop_id
...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			WHERE (a.order_date > '#ninety_days_ago#') and a.title_id = b.title_id and a.title_id = f.title_id and a.title_id = e.title_id and a.title_id = g.title_id AND f.a_Req_closing_month IS NOT NULL
...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			SELECT *
			FROM Title a
			WHERE (a.order_date > '#forty_five_days_ago#') and a.cancelled is null
...
and a.order_date > '10/01/2010'
 	...
 	<CFELSE>
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_prop">
			...
			SELECT *
			FROM property a
			WHERE (a.order_date > '#forty_five_days_ago#') 
...
and a.order_date  > '10/01/2010'
 	...
 	<CFELSE>
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_closing">
			...
			WHERE (a.order_date > '#ninety_days_ago#') and a.title_id = f.title_id AND f.a_Req_closing_month IS NOT NULL and a.cancelled is null
