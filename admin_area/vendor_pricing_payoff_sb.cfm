...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing_sb (vendor_id, service_type, state, county, payoff_fee)
			values
			( #url.vendor_id#, 'payoff', '#form.state#', '#form.county#', '#form.payoff_fee#')
</CFQUERY>
...
<td align=left valign=top width="80"><input type=text name="payoff_fee" VALUE="" size=6 maxlength=22
