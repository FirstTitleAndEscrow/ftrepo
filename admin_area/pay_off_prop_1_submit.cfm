...
Insert Into Pay_Off_Lender_1_Prop
(prop_id)
Values
(#rec_ID#)
</cfquery>
		...
		<CFQUERY datasource="#request.dsn#">		
			...
			SET fax_to_send_to = '#fax_to_send_to#',
				...
				<CFIF #read_prop.sfirstname2# GT "">
					...
					<tr>
						<td width=519 colspan=2 align=left valign=top bgcolor=white>
							...
							<br>
							<p>
							Please fax us a payoff statement regarding the above-referenced loan, with interest calculated through <FONT SIZE=2 color=black face=arial><b>#read_payoff_info_1.int_calc_thru#</b>, and including a per diem interest rate.
					...
					<tr>
						<td width=519 colspan=2 align=left valign=top bgcolor=white>
							<FONT FACE=ARIAL SIZE=2 color="black">
							Our Fax Number is <FONT SIZE=2 color=black face=arial>#read_title_co.fax#</b>.
