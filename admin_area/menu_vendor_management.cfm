...
<script src="jquery-1.11.3.min.js">
 ...
 alert("Internet Explorer Compatibility Mode Detected. Please switch your compatibility mode off before proceeding.") 
 </script>
<body>
...
<!---<cfif session.ft_user_id eq 417 or session.ft_user_id eq 248 or  session.ft_user_id eq 434>
		<td align="center" colspan="2"><b>New System<br>
Vendors</b></td>
</cfif>--->	<cfif session.ft_user_id NEQ 462 AND session.ft_user_id NEQ 458 AND session.ft_user_id NEQ 506>
	...
	<TR>
		...
		<cfif session.ft_user_id NEQ 462 AND session.ft_user_id NEQ 458 AND session.ft_user_id NEQ 506><a href="./client_add.cfm?uid=#URL.uid#&al=#URL.al#&a_trigger=1" target="_blank"><font size=2 color=blue face=verdana>A</font></a></cfif>&nbsp;&nbsp;&nbsp;<a href="./client_modify.cfm?uid=#URL.uid#&al=#URL.al#&a_trigger=1" target="_blank"><font size=2 color=red face=verdana>M</font></a>&nbsp;&nbsp;&nbsp;<A HREF="https://#cgi.server_name#/admin_area/login_as_client.cfm?uid=#URL.uid#&al=#URL.al#" target="client_window"><font size=2 color=red face=verdana>L</font></a></td>
		...
		--->
		<!---<cfif session.ft_user_id eq 417 or session.ft_user_id eq 248>---><td width="45"align="center"><a href="./vendor_add2.cfm?uid=#URL.uid#&al=#URL.al#&a_trigger=1" target="_blank"><font size=2 color=blue face=verdana>A</font></a></td>
		...
		<cfif session.ft_user_id NEQ 462 AND session.ft_user_id NEQ 458 AND session.ft_user_id NEQ 506>
...
<table>
	...
	<cfif session.ft_user_id NEQ 462 AND session.ft_user_id NEQ 458 AND session.ft_user_id NEQ 506>
		...
		<cfif session.ft_user_id eq 1>
		<a href="calendar_choose.cfm?uid=#URL.uid#&al=#URL.al#&trigger=1" target="_blank"><font size=2 color=yellow face=verdana>Calendar</font></a>
		<cfelse>
...
<ul class="new_menu"> 
		<!--- New Reports Menu --->
       <cfinclude template="/admin_area/met/ricks_page2.cfm">
	</ul>
<table>
	<tr>
		<TD align="center" >
...
<cfif session.ft_user_id EQ 524>
<li><a href="https://<cfoutput>#cgi.server_name#</cfoutput>/admin_area/met/fee_generator_hits_by_company.cfm" target="new">Calculator Hits by Client</a></li>
</cfif>


<cfif session.ft_user_id EQ 472 or session.ft_user_id EQ 618 or session.ft_user_id EQ 390 or session.ft_user_id EQ 548 or session.ft_user_id EQ 555 or session.ft_user_id EQ 495 or session.ft_user_id EQ 549 or session.ft_user_id EQ 542 or session.ft_user_id EQ 611>
<li><a href="team_stats.cfm" target="_new">Team Stats</a>
</li>
</cfif>


<cfif session.ft_user_id EQ 472 or session.ft_user_id EQ 618 or session.ft_user_id EQ 390 or session.ft_user_id EQ 548 or session.ft_user_id EQ 555>
VRM REPORTS<br>
...
<cfif session.ft_user_id EQ 472 or session.ft_user_id EQ 618>
...
<cfif session.ft_user_id neq 563>
<cfif ListLen(session.all_team_ids, ",")>

<li><a href="reports_team_stats.cfm" target="_new">Detailed Team Stats</a>
</li>
</cfif>
<li><a href="./met/team_editor/" target="_new">Team Editor</a>
</li>
</cfif>
...
<cfif get_current_user.streamline_employee eq 1>
<li><a href="reo_reports.cfm?" target="reo_reports">REO Reports</a></li>
</cfif>
<cfif (get_current_user.role_id neq 24 and get_current_user.role_id neq 17) or get_current_user.id eq 322 or get_current_user.id eq 339 or get_current_user.id eq 359>
<li><a href="./met/projects" target="projects">Projects</a></li>
</cfif>
...
<cfif read_user.streamline_employee eq 'True' or session.ft_user_id eq 472 or session.ft_user_id EQ 618>
...
<li><a href="vendor_routing_manage.cfm" target="new">Vendors Routing Table</a></li>
<!---<li><a href="vendor_routing_table.cfm" target="new">Master Routing Table Upload</a></li>--->
<li><a href="vendor_manage_services.cfm" target="new">Vendors Manage Services</a></li>

<li><a href="reports_ICL.cfm" target="new">ICL Assignments</a></li>
<li><a href="https://#cgi.server_name#/admin_area/Contract_Assignment_and_Sales_Report_Date.cfm?uid=#url.uid#&al=1" target="new">Contract Assignment Report</a></li>
<li><a href="https://machine1.firsttitleservices.com/reports_vendor_eando.cfm" target="new">E & O Report</a></li>
<li><a href="https://#cgi.server_name#/admin_area/FT_Policies/ft_policies.cfm" target="New" onClick="window.open('','New','left=0,top=0,width=400,height=400,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">Company Policies</a></li>
<li><a href="http://firsttitle.sysaidit.com" target="new">Help Desk</a></li>

<cfif get_current_user.ID eq 318 or get_current_user.ID eq 472 or session.ft_user_id EQ 618 or get_current_user.ID eq 9 or get_current_user.ID eq 362 or get_current_user.ID eq 449 or get_current_user.ID eq 417 or get_current_user.ID eq 469 or get_current_user.ID eq 407 or get_current_user.ID eq 468 or get_current_user.ID eq 384 or get_current_user.ID eq 374 or get_current_user.ID eq 555>
<li><a href="reports_tracking_new.cfm" target="new">Chase/RealEC Turntime Report</a></li>
<li><a href="reports_simple_complex.cfm" target="new">Simple/Complex Not Clear to Close Issues</a></li>
<li><a href="reports_tracking_flagstar.cfm" target="new">Flagstar Turntime Report</a></li>
<li><a href="reports_tracking_shore.cfm" target="new">Shore Mortgage Turntime Report</a></li>
<li><a href="report_chase_contacts.cfm" target="new">Chase Contacts Report</a></li>
</cfif>


<cfif get_current_user.ID eq 318>
<li><a href="reports_assigned_to_DIL.cfm" target="new">Assigned to DIL Report</a></li>
</cfif>


<cfif get_current_user.id eq 9>
<li><a href="./met/team_editor" target="projects">Teams Editor</a></li>
</cfif>
<cfif get_current_user.id eq 9 or get_current_user.id eq 479 or get_current_user.id eq 472 or session.ft_user_id EQ 618>
<li><a href="reports_subordination_needed.cfm?uid=#URL.uid#&al=#URL.al#" target="subordinations">Subordination Needed</a></li>
</cfif>
<cfif get_current_user.id eq 9 or get_current_user.id eq 472 or session.ft_user_id EQ 618 or get_current_user.id eq 555 or get_current_user.id eq 563>
<li><a href="reports_sales_stats.cfm?uid=#URL.uid#&al=#URL.al#" target="stats">Sales Stats by Client</a></li>
<li><a href="Sales_Commission_Report_Date_New.cfm?uid=#url.uid#" target="commissions">Sales Commission Report</a></li>
</cfif>
</cfif>
...
<li><a href="reports_days_to_clear_to_close.cfm?uid=<cfoutput>#url.uid#&al=0</cfoutput>" target="new">Time to Clear to Close - Simple Problem Alert</a></li>
<cfif get_current_user.ID eq 478 or get_current_user.ID eq 536>
<li><a href="calendar_choose.cfm?uid=#URL.uid#&al=#URL.al#&trigger=1" target="_blank">Scheduling Calendar</a></li>
</cfif>


<cfif get_current_user.ID eq 472 or get_current_user.ID eq 555 or session.ft_user_id EQ 618>
...
<li><a href="https://#cgi.server_name#/admin_area/toggle_richmond_access.cfm?enable=1" target="New" onClick="window.open('','New','left=0,top=0,width=400,height=400,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">Turn ON Richmond Emergency Access</a></li>
<cfelse>
<li><a href="https://#cgi.server_name#/admin_area/toggle_richmond_access.cfm?enable=0" target="New" onClick="window.open('','New','left=0,top=0,width=400,height=400,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">Turn OFF Richmond Emergency Access</a></li>
</cfif>
</cfif>
<li><a href="https://#cgi.server_name#/admin_area/prop_reports_typed.cfm" target="blank">Prop Reports - TYPED</a></li>
<li><a href="https://#cgi.server_name#/admin_area/apr_files.cfm" target="blank">APR Firsttitle Report</a></li>
<li><a href="https://#cgi.server_name#/admin_area/apr_files.cfm?paid=1" target="blank">APR Firsttitle Paid In Full Report</a></li>
<li><a href="https://#cgi.server_name#/admin_area/apr_files.cfm?view=streamline" target="blank">APR Streamline Report</a></li>
<li><a href="https://#cgi.server_name#/admin_area/apr_files.cfm?view=streamline&paid=1" target="blank">APR Streamline Paid In Full Report</a></li>
<li><a href="https://#cgi.server_name#/admin_area/reports_secretary_veteran_affairs.cfm?uid=#url.uid#&al=0" target="blank">Secretary Veteran Affairs Report</a></li>
<li><a href="https://#cgi.server_name#/admin_area/reports_purchases_last_60_days.cfm" target="blank">Purchases - Last 60 Days</a></li>
<cfif session.ft_user_id eq 472 or session.ft_user_id EQ 618 or  session.ft_user_id eq 367 or  session.ft_user_id eq 322>
<li><a href="reports_internal_processor.cfm" target="_new">Internal Processor Report</a></li> 
</cfif>
<cfif session.ft_user_id eq 472 or session.ft_user_id EQ 618 or  session.ft_user_id eq 577 or  session.ft_user_id eq 536>
<li><a href="reports_internal_processor_melanie.cfm" target="_new">Internal Processor Report (Melanie)</a></li> 
</cfif>
</ul>
