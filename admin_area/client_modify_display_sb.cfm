...
<cfoutput><a href="client_custom_fees.cfm?modify_client_id=#read_company.ID#&uid=#URL.uid#&al=#URL.al#">Custom Fees</a></cfoutput><br>
...
<option value="#this_ID#" <cfif read_company.master_co_id eq this_ID>selected</cfif>>#Left(Company, 25)#<cfif Len(Company) gt 25>...</cfif></option>
</cfloop>
								</select>
		</td>
	</tr>
...
<cfif #read_user.role_id# eq "15" or #read_user.role_id# eq "20"
	...
	or #read_user.role_id# eq "32" or #read_user.va_admin# eq 'True'>
