...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="vendor_modify_submit.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
	 ...
	 <tr>	<td width="50%" align=right valign=top bgcolor=e6e6e6>	Deed Preparation vendor -  </td><td width="50%"  align=left valign=top bgcolor=e6e6e6>	<input type=radio name="vd" VALUE="7"> </td></tr>
