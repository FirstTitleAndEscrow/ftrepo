...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			SELECT *
			FROM Title a
			WHERE a.oda_year > 2005 and   a.cancelled is null
...
and a.order_date > '10/01/2010'
 	...
 	<CFELSE>
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_closing">
			...
			WHERE a.oda_year > 2005 and   a.title_id = f.title_id AND f.a_Req_closing_month IS NOT NULL and a.cancelled is null
