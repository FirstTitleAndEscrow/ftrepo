		...
		<CFQUERY datasource="#request.dsn#">
			...
			VALUES(#user_id#, '#DateFormat(Now(), "mm/dd/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', #URL.uid#, 1, '#FORM.lo_fname#', '#FORM.lo_lname#', '#FORM.lo_email#', '#FORM.lo_phone#', '#FORM.lo_ext#', '#FORM.lo_fax#')
			...
			<CFOUTPUT>
				<tr>
					<td width=498 align=left valign=top bgcolor=white>
						 <NOBR><a href="./user_add.cfm?uid=#URL.uid#&al=#URL.al#"><img src="./images/button_home.gif" border=0></a><img src="./images/clear.gif" height=10 width=85><font size=2 color=blue face=arial>Loan Officer was Added</CENTER></NOBR><font size=2 color=black face=arial>
						<p>
