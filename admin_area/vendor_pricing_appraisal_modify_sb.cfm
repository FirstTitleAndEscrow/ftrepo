...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			...
			set appraisal_fee = '#form.appraisal_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="appraisal_fee" VALUE="#read_entry.appraisal_fee#" size=6 maxlength=22
