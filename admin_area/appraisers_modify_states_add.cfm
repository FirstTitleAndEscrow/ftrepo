	...
	<CFSET zip_id_1 = #ListToArray(zip_id, ",")#>
		...
		<CFLOOP FROM="1" TO="#ArrayLen(zip_id_1)#" INDEX="SSS">
			<CFQUERY datasource="#request.dsn#">
				INSERT INTO Appraisers_states(Appraiser_ID, st_abbrev)
				VALUES(#Appraiser_ID#, '#zip_id_1[SSS]#')
			</CFQUERY>
		</CFLOOP>
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>States were added to Appraisers States List</B>
		</td>
	</tr>
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<tr>
		...
		<font size=2 color=black face=arial>
		This is the current List of States Serviced by this Appraiser.
