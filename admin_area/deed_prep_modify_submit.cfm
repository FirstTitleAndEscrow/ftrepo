...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>The Deed Prep Vendor's record was successfully  Modified</B>
		</td>
	</tr>
...
</cfif> <!--- END if the Vendor Admin that changed this vendor is not Pam, send Pam an email  --->


<cfelse> <!--- this person is not a vendor admin --->
