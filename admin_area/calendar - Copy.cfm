...
select a.*, b.*, t.order_date From EventList a,  Title_Closing_Order_Request b, Title t where a.title_id = b.title_id and b.request_date = '#f#' and a.yearmonth is null AND t.ip_id = '#session.ft_user_id#' 
</cfquery>
