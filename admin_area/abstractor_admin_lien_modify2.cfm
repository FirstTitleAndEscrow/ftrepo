...
Click here to go back to the main page.<a href="title_Committment.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=0"><img src="./images/button_return.gif" border=0 ALT="Click this button to return to main"></a>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractor_admin_lien_modify.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#url.rec_id#&seq_num=#read_report.seq_num#&company_id=0&a_trigger=1" name="frm" ENABLECAB="Yes">
