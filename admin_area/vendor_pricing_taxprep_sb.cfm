...
window.opener.location.hash = 'closer_pricing';
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing_sb (vendor_id, service_type, state, county, taxprep_fee)
			values
			( #url.vendor_id#, 'TaxPrep', '#form.state#', '#form.county#', '#form.taxprep_fee#')
</CFQUERY>
...
<td align=left valign=top width="80"><input type=text name="TaxPrep_fee" VALUE="" size=6 maxlength=22
