...
<CFFORM NAME="frm" ACTION="./pay_off_title_1_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#" METHOD=POST>
				...
				<TR>
					...
					<TD width=300 align=left valign=top bgcolor=white>
						<CFINPUT type="text" NAME="person_to_send_to" SIZE=35 MAXLENGTH=90 
							VALUE="#read_payoff_info_1.person_to_send_to#"
							style="font-size: 9; 
							font-family: verdana; 
							font-style: normal; 
							color: 003F1E; 
					...
					<tr>
						<td width=519 colspan=2 align=left valign=top bgcolor=white>
							...
							Please fax us a payoff statement regarding the above-referenced loan, with interest calculated through <CFINPUT type="text" NAME="int_calc_thru" SIZE=40 MAXLENGTH=200 
									VALUE="#read_payoff_info_1.int_calc_thru#"
									style="font-size: 9; 
									font-family: verdana; 
									font-style: normal; 
									color: 003F1E; 
...
<cfFORM ACTION="./file_uploadp.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#" METHOD=POST>
<cfoutput query="get_file">
	...
	<input type="submit" value="Upload File"></td>
		...
		<CFELSE>
<tr align="right"><td width=519 colspan=2  align=right valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#payoff1_upload#). To upload a new file click to delete this one first. &nbsp;<br>
	<a href="./delete-uploaded-filep.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#" target="New" onClick="window.open('','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">delete</a></TD></tr></NOBR>	  
