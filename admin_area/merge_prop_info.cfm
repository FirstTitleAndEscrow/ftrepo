...
<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=bfbfbf>
	<tr>
			...
			<TD width=519 align=left valign=top bgcolor=blue>
				...
				Order Number is...<b>P-232#read_title.prop_id#</b></FONT>
			</TD>
		</TR>
...
<table width="770" height="110" border=0 cellpadding=0 cellspacing=0 background="/client/images/banner_black_wout_logo.jpg" valign=top>
  <tr>
    ...
    <td valign="top" align="right"><br>
	<!---
	<cfFORM NAME="Search" METHOD="post" ACTION="title_client_single_display.cfm?comp_id=#read_title.comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#">
