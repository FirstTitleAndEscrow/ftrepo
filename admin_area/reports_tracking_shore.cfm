...
.large_header {font-family:Arial, Helvetica, sans-serif; font-size: 16px;}
	...
	<CFQUERY datasource="#request.dsn#" NAME="get_recs">
		select t.title_id, t.paddress, t.pcity, t.pstate, t.on_hold, t.a_insert_date, t.a_insert_time, t.loan_number, l.closing_date,l.l_date,
		min(t1.n_date) as n_date, min(t1.n_time) as n_time
		 from title t
		...
		where (c.company LIKE '%Shore Mortgage%' or c.company LIKE '%Shore Team%' or c.company LIKE '%Shore Master%')
		...
		group by  t.title_id, t.paddress, t.pcity, t.pstate, t.on_hold, t.a_insert_date, t.a_insert_time, t.loan_number, l.closing_date,l.l_date
		order by t.title_id
    </CFQUERY>
...
<cfif DateDiff("d",pstart,pbinder_sent) GT 0>#dayscol1#<cfset totaldays = totaldays + dayscol1><cfelse>0</cfif> : #hourscol1# : #mincol1#
	...
	<CFQUERY datasource="#request.dsn#" NAME="get_dates">
		select cl_dateandtime, fl_dateandtime
		 from eventlist
		 where title_id = #title_id#
    </CFQUERY>


<td><cfif get_dates.cl_dateandtime neq ''>#DateFormat(get_dates.cl_dateandtime,"mm/dd/yyyy")#<cfelse>&nbsp;</cfif></td>
<td><cfif get_dates.fl_dateandtime neq ''>#DateFormat(get_dates.fl_dateandtime,"mm/dd/yyyy")#<cfelse>&nbsp;</cfif></td>
