...
<CFFORM NAME="frm" ACTION="./form_title_closing_request_reciept_admin_cal.cfm?rec_id=#rec_id#&a_trigger=1&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=2" METHOD=POST>
<CFOUTPUT>
...
<cfINPUT TYPE="Text" NAME="input_date" size=12 maxlength=20
								...
								style="font-size: 9;
									...
									border-style: bar;
									clear: none;" >
							 <font face=verdana size=2 color=black>To change date click <cfoutput><A href="javascript:ShowCalendar(document.all('calpic'),document.all('input_date'),document.all('null'),'01/1/2002', '12/31/2009')" onclick="event.cancelBubble=true;"><img src="https://#cgi.server_name#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic" style="POSITION: relative"></A></cfoutput>
