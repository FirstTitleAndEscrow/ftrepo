...
To modify this Closing Information click <a href="./form_title_closing_order_requesta.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#read_title.title_id#"><img src="./images/button_modify.gif" border=0 ALT="Modify Closing info"></a> 
          </center>   <br>           
</cfoutput>
			</TD>
		</TR>
...
<CFOUTPUT QUERY="aaaa">
	...
	<table width=699 cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
		<tr>
			...
			<td width=200 align=left valign=top bgcolor=e1e1e1>
				<font face=verdana size=2 color=blue>
				<B>#DateFormat(aaaa.contract_busted_date, "m/d/yyyy")#</B>
			</td>					
	...
	<table width=699 cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
		<tr>
			<td width=699 align=center valign=top bgcolor=e1e1e1>
				...
				Your First Choice in Settlement Companies<br>
