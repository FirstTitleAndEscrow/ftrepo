...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				prop_ins_add (title_id, type, seq_num, status, insert_date, insert_time, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data37, data38, notes, addreq, addex)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				prop_ins_view (title_id, type, seq_num, status, insert_date, insert_time, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data37, data38, notes, addreq, addex)
				VALUES (#rec_id#, 'DATA', '#seq_num#', 'O', '#c_date#', '#c_time#', '#grantor1#', '#grantor2#', '#grantee1#', '#grantee2#', '#deedtype#', '#mannertitle#', '#docnum#', '#book#', '#page#', '#DateFormat(instdate, "mm/dd/yyyy")#', '#DateFormat(recdate, "mm/dd/yyyy")#', '#trustee#', '#vest#', '#info#', '#info2#', '#consider#', '#township#', '#DateFormat(effective, "mm/dd/yyyy")#', '#select1#', '#a_comments#', '#addreq#', '#addex#')
