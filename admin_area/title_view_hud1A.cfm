...
<!--
    function Locate(){
		 ...
		 window.location= "https://<cfoutput>#cgi.server_name#</cfoutput>/admin_area/title_view_hud_A_modify.cfm?uid=<cfoutput>#uid#</cfoutput>&al=<cfoutput>#al#</cfoutput>&rec_id=<cfoutput>#rec_id#</cfoutput>&a_trigger=2";
...
<div id=idControls align="center" class="noprint">
 ...
 <p>
 <cfoutput>
 <FORM METHOD=POST ACTION="./title_view_hudA.cfm?uid=#uid#&al=#al#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#" name="frm" ENABLECAB="Yes">
</cfoutput>
...
<cfelse>
  ...
  <tr>
    <td width="46%" valign="top"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;1102.
      Abstract to <cfif get_titleid.comp_ID eq 202><b>ESS Solutions, LLC</b><cfelse><b>Abstracts USA, LLC</b></cfif> </font></td>
