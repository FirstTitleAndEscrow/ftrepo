...
<CFSWITCH EXPRESSION="#read_current_sales.role_id#">
				...
				<CFCASE VALUE = 25>
			     ...
			     <CFCASE VALUE = 24>
					   <CFSET sales = "OutsideSales"><!--- InHouse --->
          </CFCASE>
				<CFDEFAULTCASE>
...
<CFOUTPUT>
<!--- Commented 07/14/05 N<input type="hidden" name="intSales" value="#intSales#"> --->
																										<tr>
...
<cfoutput>
	...
	<tr>
		<td width=367 colspan=2 align=right valign=top bgcolor=e6e6e6>
			...
			<input type=image src="./images/button_submit.gif" border=0><img src="./images/clear.gif" height=10 width=40></NOBR>
