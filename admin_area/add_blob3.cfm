...
<td style="margin:100px" align="center">
		...
		<cffileupload align="center" name="MultiFileupload" addbuttonlabel="Add File" uploadbuttonlabel="Upload the files" url="UploadFile.cfm?rec_id=#url.rec_id#&Files=Multiple" 
