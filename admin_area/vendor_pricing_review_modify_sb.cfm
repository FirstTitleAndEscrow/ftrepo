...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			...
			set review_fee = '#form.review_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="review_fee" VALUE="#read_entry.review_fee#" size=6 maxlength=22
