...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Abstractors States List</B>
		</td>
	</tr>
	...
	<tr>
		...
		<NOBR><a href="https://#cgi.server_name#/admin_area/abstractors_modify_choose.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#"><img src="./images/button_return.gif" border=0></a><img src="./images/clear.gif" height=10 width=85></NOBR>
...
<CFIF #read_abstractors_states_list.recordcount# EQ "0">
	...
	<tr>
		...
		<bR>
		<font size=2 color=blue face=arial>
		This Abstractor does not have any "States Serviced" in their list.
		<p>
		</td>
	</tr>
...
<CFELSE>
	<tr>
		...
		<font size=2 color=black face=arial>
		This is the current List of States for this Abstractor.	To
		...
		State from this Abstractors Counties List
		</td>

		<td width=50 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_states_delete.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					...
					rows="5"
					cols="45"
					><CFOUTPUT QUERY="read_abstractors_states_list"><OPTION VALUE="#st_abbrev#">#st_abbrev#</OPTION></CFOUTPUT>
			</SELECT>
		</td>
	</tr>
	...
	<tr>
		...
		<font size=2 color=black face=arial>
		Click on any of the
		States in the list to add them to this Abstractors <br>"States
		...
		<td width=50 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_states_add.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
