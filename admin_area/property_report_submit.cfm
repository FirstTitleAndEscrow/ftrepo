...
SERVER="127.0.0.1"
Subject="First Title - Property Report for Property Order 0232#rec_id# - #read_title.bfirstname1# #read_title.blastname1#"
TIMEOUT="600"
type="HTML"
>
<cfmailparam file="#fileSys.FindFilePath('P-#rec_id#_REPORT.pdf', 'file')#">
...
<cfoutput>
<FORM action="./Prop_report_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#company_ID#&a_trigger=7"  ENCTYPE="multipart/form-data" method="post">
</cfoutput>
<tr>
...
<cfFORM NAME="Search" METHOD="Post" ACTION="./property_report_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=21&company_ID=#read_Title.comp_id#">
...
View/Print <A HREF="https://#cgi.server_name#/admin_area/property_report.cfm?rec_id=#rec_id#" target="new">Property Report</a> for order 0232#rec_id# - #read_title.bfirstname1# #read_title.blastname1#</B></font><br><br>
...
<cfelse>
    ...
    <TR>
    <td valign="top" colspan="2">
    Type of Deed:  <B><font size="2" color = "blue" face="Arial, Helvetica, sans-serif">#read_title_update.data5#</font>
    </td>
    </TR>
  	<tr>
    	<td  valign="top">
	...
	<tr>
    	<td colspan="2" valign="top">Holder: <b><font size="2" color = "blue" face="Arial, Helvetica, sans-serif">#read_mortgage.data1#</font></b></td>
  	</tr>
    <tr>
