...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify ICL Vendors </B>
			<p>
			Select an ICL Vendor to modify</CENTER></NOBR><font size=2 color=black face=arial>
		</td>
	</tr>
</CFOUTPUT>	
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="abstractors_modify_view.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
