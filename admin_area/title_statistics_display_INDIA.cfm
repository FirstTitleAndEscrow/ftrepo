...
<cfswitch expression="#FORM.productChoiceCbx#" >	
	<cfcase value="2">     <!---Title Product --->
		<cfset selectedEventsIds   =  FORM.TitleEventsHdn>
	</cfcase>
	
	<cfcase value="3">	<!---Property Product --->
		<cfset selectedEventsIds   =  FORM.PropertyEventsHdn>
	</cfcase>
	
	<cfcase value="4"> <!---Appraisal Product --->	
		<cfset selectedEventsIds   =  FORM.AppraisalEventsHdn>
	</cfcase>
	
	<cfcase value="5"> <!---Flood Product --->
		<cfset selectedEventsIds   =  FORM.FloodEventsHdn>
	</cfcase>
	
	<cfcase value="6"> <!---Credit Product --->
		<cfset selectedEventsIds   =  FORM.CreditEventsHdn>
	</cfcase>	
	
	<cfcase value="7">  <!---AVM Product --->
		<cfset selectedEventsIds   =  FORM.AVMEventsHdn>
	</cfcase>
	
	<cfcase value="8"> <!---Signing Product --->
		   <cfset selectedEventsIds   =  FORM.SigningEventsHdn>
	</cfcase>
	
	<cfcase value="9"> <!---Closing Product --->
		  <cfset selectedEventsIds   =  FORM.ClosingEventsHdn> 
	</cfcase>
	
</cfswitch>

<cfif #FORM.productChoiceCbx# NEQ 1>
<cfloop from="1" to="21" index="i">   
 <cfset formOrder = "FORM.Event" & i>      
   <cfif ListFindNoCase(selectedEventsIds,listLast(formOrder,'.')) >          
	      <cfset eventValueIs = replaceNoCase(evaluate(formOrder),'NONE',",","ALL")>	      
	      <cfset uniqueList = listChangeDelims(eventValueIs,",")>      
    
          <cfif len(uniqueList)>
			  <cfset "#formOrder#" =   uniqueList>
		  <cfelse>		     
			  <cfset "#formOrder#" =   'NONE'>  
		  </cfif>
...
<cfset formSortOrder = replaceNoCase(FORM.sortOrder,'NONE',",","ALL")>
<cfset formSortOrder = listChangeDelims(formSortOrder,",")>  

<cfif len(formSortOrder) GT 0 >
	<cfset FORM.sortOrder = formSortOrder>
<cfelse>
	<cfset FORM.sortOrder = 'NONE'>
</cfif>
...
<CFIF IsDefined("form.title_id")><cfif #title_id# NEQ "">
	<CFSET title_id = #title_id#>
</cfif></CFIF>
<CFIF IsDefined("form.order_id")><cfif #order_id# NEQ "NONE">
	<CFSET order_id = #order_id#>
</cfif></CFIF>
<CFIF IsDefined("form.prop_id")><cfif #prop_id# NEQ "">
	<CFSET prop_id = #prop_id#>
</cfif></CFIF>
<CFIF IsDefined("form.Clos_id")><cfif #Clos_id# NEQ "">
	<CFSET Clos_id = #Clos_id#></cfif>
</CFIF>	
...
<cfif IsDefined("FORM.productChoiceCbx")>	
	<cfif #FORM.productChoiceCbx# neq "1">
		<CFIF IsDefined("form.event1")><cfif #event1# NEQ "NONE" AND #event1# NEQ ""> 
			#event1#,
		</cfif></CFIF>
<CFIF IsDefined("form.event2")><cfif #event2# NEQ "NONE" AND #event2# NEQ "">
	#event2#,
</cfif></CFIF>
<CFIF IsDefined("form.event3")><cfif #event3# NEQ "NONE" AND #event3# NEQ "">
	#event3#,
</cfif></CFIF>
<CFIF IsDefined("form.event4")><cfif #event4# NEQ "NONE" AND #event4# NEQ "">
	#event4#,
</cfif></CFIF>
<CFIF IsDefined("form.event5")><cfif #event5# NEQ "NONE" AND #event5# NEQ "">
	#event5#,
</cfif></CFIF>

<CFIF IsDefined("form.datamerged")><cfif #datamerged# NEQ "NONE" AND #datamerged# NEQ "">
	#datamerged#,
</cfif></CFIF>
<CFIF IsDefined("form.datanotmerged")><cfif #datanotmerged# NEQ "NONE" AND #datanotmerged# NEQ "">
	#datanotmerged#,
</cfif></CFIF>
<CFIF IsDefined("form.loanfun")><cfif #loanfun# NEQ "NONE" AND #loanfun# NEQ "">
	#loanfun#,
</cfif></CFIF>
<CFIF IsDefined("form.mortrec")><cfif #mortrec# NEQ "NONE" AND #mortrec# NEQ "">
	#mortrec#,
</cfif></CFIF>
<CFIF IsDefined("form.loannotfun")><cfif #loannotfun# NEQ "NONE" AND #loannotfun# NEQ "">
	#loannotfun#,
</cfif></CFIF>
<CFIF IsDefined("form.mortnotrec")><cfif #mortnotrec# NEQ "NONE" AND #mortnotrec# NEQ "">
	#mortnotrec#,
</cfif></CFIF>
<CFIF IsDefined("form.titlepol")><cfif #titlepol# NEQ "NONE" AND #titlepol# NEQ "">
	#titlepol#,
</cfif></CFIF>
<CFIF IsDefined("form.titlenotpol")><cfif #titlenotpol# NEQ "NONE" AND #titlenotpol# NEQ "">
	#titlenotpol#,
</cfif></CFIF>
<CFIF IsDefined("form.abstractor")><cfif #abstractor# NEQ "NONE" AND #abstractor# NEQ "">
	#abstractor#,
</cfif></CFIF>
<CFIF IsDefined("form.event7")><cfif #event7# NEQ "NONE" AND #event7# NEQ "">
	#event7#,
</cfif></CFIF>
<CFIF IsDefined("form.event8")><cfif #event8# NEQ "NONE" AND #event8# NEQ "">
	#event8#,
</cfif></CFIF>
<CFIF IsDefined("form.event9")><cfif #event9# NEQ "NONE" AND #event9# NEQ "">
	#event9#,
</cfif></CFIF>
<CFIF IsDefined("form.event10")><cfif #event10# NEQ "NONE" AND #event10# NEQ "">
	#event10#,
</cfif></CFIF>
<CFIF IsDefined("form.event11")><cfif #event11# NEQ "NONE" AND #event11# NEQ "">
	#event11#,
</cfif></CFIF>
<CFIF IsDefined("form.event12")><cfif #event12# NEQ "NONE" AND #event12# NEQ "">
	#event12#,
</cfif></CFIF>
<CFIF IsDefined("form.event13")><cfif #event13# NEQ "NONE" AND #event13# NEQ "">
	#event13#,
</cfif></CFIF>
<CFIF IsDefined("form.event14")><cfif #event14# NEQ "NONE" AND #event14# NEQ "">
	#event14#,
</cfif></CFIF>
<CFIF IsDefined("form.event16")><cfif #event16# NEQ "NONE" AND #event16# NEQ "">
	#event16#,
</cfif></CFIF>
<CFIF IsDefined("form.event17")><cfif #event17# NEQ "NONE" AND #event17# NEQ "">
	#event17#,
</cfif></CFIF>
<CFIF IsDefined("form.event18")><cfif #event18# NEQ "NONE" AND #event18# NEQ "">
	#event18#,
</cfif></CFIF>
<CFIF IsDefined("form.event19")><cfif #event19# NEQ "NONE" AND #event19# NEQ "">
	 #event19#,
</cfif></CFIF>
<CFIF IsDefined("form.event20")><cfif #event20# NEQ "NONE" AND #event20# NEQ "">
	#event20#,
</cfif></CFIF>
<CFIF IsDefined("form.event21")><cfif #event21# NEQ "NONE" AND #event21# NEQ "">
	#event21#,
</cfif></CFIF>
</cfif></CFIF>
<CFIF IsDefined("form.subordination_needed")><cfif #subordination_needed# NEQ "NONE">
...
<CFIF IsDefined("form.anc_id")><cfif #anc_id# NEQ "">
	#anc_id#,
</cfif></CFIF>
<CFIF IsDefined("form.app_id")><cfif #app_id# NEQ "">
	#app_id#,
</cfif></CFIF>
<CFIF IsDefined("form.avm_id")><cfif #avm_id# NEQ "">
	#avm_id#,
</cfif></CFIF>
<CFIF IsDefined("form.cr_id")><cfif #cr_id# NEQ "">
	#cr_id#,
</cfif></CFIF>
<CFIF IsDefined("form.sn_id")><cfif #sn_id# NEQ "">
	#sn_id#,
</cfif></CFIF>
<CFIF IsDefined("form.clos_id")><cfif #clos_id# NEQ "">
	#clos_id#,
...
<CFIF IsDefined("form.packagenotreceived")><cfif #Trim(packagenotreceived)# is not "NONE">
	#packagenotreceived#,
</cfif></CFIF>
<CFIF IsDefined("form.closingnotinvoiced")><cfif #Trim(closingnotinvoiced)# is not "NONE">
	#closingnotinvoiced#,
</cfif></CFIF>
<CFIF IsDefined("form.srclosingnotpaid")><cfif #Trim(srclosingnotpaid)# is not "NONE">
	#srclosingnotpaid#,
</cfif></CFIF>
<CFIF IsDefined("form.mortgagerecordingissue")><cfif #Trim(mortgagerecordingissue)# is not "NONE">
...
<cfif IsDefined("FORM.productChoiceCbx")>		
	<cfswitch expression="#FORM.productChoiceCbx#">
		<cfcase value="1"> <cfset a_trigger=6> </cfcase> <!---This is for ALL product --->
		<cfcase value="2"> <cfset a_trigger=1> </cfcase> <!---This is for Title product --->
		<cfcase value="3"> <cfset a_trigger=2> </cfcase> <!---This is for Property product --->
		<cfcase value="4"> <cfset a_trigger=3> </cfcase> <!---This is for Appraisal product --->
		<cfcase value="5"> <cfset a_trigger=4> </cfcase> <!---This is for Flood product --->
		<cfcase value="6"> <cfset a_trigger=8> </cfcase> <!---This is for Credit product --->
		<cfcase value="7"> <cfset a_trigger=9> </cfcase> <!---This is for AVM product --->
		<cfcase value="8"> <cfset a_trigger=7> </cfcase> <!---This is for Signing product --->
		<cfcase value="9"> <cfset a_trigger=5> </cfcase> <!---This is for Closing product --->
	</cfswitch> 		
</cfif>

 <!---This is for Title product --->

<cfif #a_trigger# eq "1">
	<CFIF #state# eq "none" and #company_id# eq "none">
		<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *
			FROM---> SELECT a.Title_Id,a.check_date,a.bfirstname1,a.blastname1,a.pstate, d.merge_date, d.merge_time, f.Company, f.a_date_completed, f.a_time_completed, a.appraisal_status
			...
			<CFIF #read_user.role_id# eq 24 or read_user.va_admin eq 'True'>
				,companies comp, First_Admin FA
				WHERE   a.comp_id=comp.id and   comp.intsales=FA.ID and
			<cfelse>	
				WHERE
			<!---<CFINCLUDE TEMPLATE="./includes/companies_list.cfm">
			and a.comp_id IN(#companylist#)--->
			</cfif>			
			 a.oda_year > 2005 and  a.title_id = d.title_id and a.title_id = e.title_id and a.title_id = f.title_id and a.title_id = g.title_id
		...
		<CFIF #state# NEQ "none">
				<!---AND a.pstate = '#state#'--->
					AND a.pstate in ('#cty_name_1[TTT]#')
		</CFIF>
	...
	<CFLOOP QUERY="read_report">
		<CFOUTPUT>
			<CFQUERY DATASOURCE="#request.dsn#" NAME="read_time">
				<!---SELECT *---> SELECT a.Title_Id,a.check_date,a.bfirstname1,a.blastname1,a.pstate, d.merge_date, d.merge_time,a.appraisal_status,SearchType,a.comp_id
...
<CFLOOP FROM="1" TO="#ArrayLen(cty_name_1)#" INDEX="TTT">
	...
	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *---> SELECT a.Title_Id,a.check_date,a.bfirstname1,a.blastname1,a.pstate, d.merge_date, d.merge_time, f.Company, f.a_date_completed, f.a_time_completed, a.appraisal_status
			FROM Title a, doc_title_insurance_title d, tax_cert_title e, doc_abstract_title f, pay_off_lender_1_title g
...
<cfif #sortorder# NEQ "NONE">
	...
	<CFLOOP QUERY="read_report">
			...
			<!---SELECT *---> SELECT a.Title_Id,a.check_date,a.bfirstname1,a.blastname1,a.pstate, d.merge_date, d.merge_time, a.appraisal_status, a.SearchType ,a.COMP_ID
			FROM Title a, doc_title_insurance_title d
			WHERE a.title_id = #title_id# and a.title_id = d.title_id and check_date is not null and check_time is not null and a_recieved_time is not null and a_recieved_date is not null and (a.cancelled is null or a.cancelled = 0)
</cfquery>
			<cfif read_time.SearchType eq 'Purchase'>
	...
	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			...
			FROM Title a, doc_title_insurance_title d, tax_cert_title e, doc_abstract_title f, pay_off_lender_1_title g
				...
				<cfelse>	
					...
					a.oda_year > 2005 and   a.title_id = d.title_id and a.title_id = e.title_id and a.title_id = f.title_id and a.title_id = g.title_id 	<cfif #comments# neq "none">
			<cfif #comments# is "Cancelled per client">
				and a.cancelled = 1
				<cfelse>
				and (a.cancelled is null or a.cancelled = 0)
...
<td bgcolor=#a_bgcolor# width=201 align=center valign=top>
	...
	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			...
			<!---SELECT *---> Select SearchType, appraisal_status, a.prop_id, check_date,a.Bfirstname1,a.Blastname1,a.pstate,sfirstname1,slastname1,duedate
			...
			a.oda_year > 2005 and  a.prop_id = d.prop_id and a.prop_id = e.prop_id and a.prop_id = f.prop_id
...
<cfif (#confirm_mon# NEQ "Month" and #comfirm_day# NEQ "Day" and #confirm_year# NEQ "Year") and (#confirm_mon_to# NEQ "Month" and #comfirm_day_to# NEQ "Day" and #confirm_year_to# NEQ "Year")>
			...
			<CFIF #state# NEQ "none">
				...
				AND a.pstate in (#ListQualify(state,"'")#)
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *--->
			SELECT a.title_id,SEARCHTYPE , CLOSER_ID, a.COMP_ID,REQUEST_DATE, BFIRSTNAME1, BLASTNAME1, appraisal_status,pstate,
			paddress,pcity,pzip
			...
			a.oda_year > 2005 and   a.title_id = b.title_id and a.title_id = f.title_id and a.title_id = e.title_id and a.title_id = g.title_id
			and c.ID = a.comp_id
...
<cfif ListContainsNoCase(richmond_ids, comp_id, ",") and ListGetAt(richmond_ids, ListContainsNoCase(richmond_ids, comp_id, ",") , ",") eq comp_id>
				<tr>
                       ...
                       <td bgcolor=#a_bgcolor# width=58 align=center valign=top>
							...
							#DateFormat(read_report.request_date, "m/d/yyyy")#</cfif>
						</td>
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							C-#title_id#
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			...
			<cfelse>	
				...
				a.oda_year > 2005 and   a.title_id = b.title_id and a.title_id = f.title_id and a.title_id = e.title_id and a.title_id = g.title_id AND f.a_Req_closing_month IS NOT NULL
...
and a.order_date > '10/01/2010'
	...
	<!---This is for Appraisal product --->
	<cfelseif #a_trigger# eq "3">
	<cfif #state# eq "none">

	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *--->
			SELECT App_id,CHECK_DATE, BFIRSTNAME1 , BLASTNAME1 , SFIRSTNAME1 , SLASTNAME1 , DUEDATE , APPRAISAL_STATUS, PSTATE 
			FROM appraisal a
			WHERE 0=0
...
<CFLOOP FROM="1" TO="#ArrayLen(cty_name_1)#" INDEX="TTT">
		...
		<CFIF #read_user.role_id# eq 24 or read_user.va_admin eq 'True'>
			<!---<CFINCLUDE TEMPLATE="./includes/companies_list.cfm">
			and a.comp_id IN(#companylist#)--->
			 inner join companies comp on a.comp_id=comp.id
			 inner join First_Admin FA on comp.intsales=FA.ID and va_employee='True'
		<CFELSEIF #read_user.role_id# eq 24 or read_user.ft_fairfax_admin eq 'True'>
			<!---<CFINCLUDE TEMPLATE="./includes/companies_list.cfm">
			and a.comp_id IN(#companylist#)--->
			 inner join companies comp on a.comp_id=comp.id
			 inner join First_Admin FA on comp.intsales=FA.ID and ft_fairfax_employee='True'
		</cfif>
			WHERE 0=0
...
and a.order_date_adjusted > '10/01/2010'
	...
	<cfif #state# eq "none">
		...
		<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *--->
			SELECT Anc_id, CHECK_DATE, CODEFLOOD , BFIRSTNAME1 , BLASTNAME1 , SFIRSTNAME1 , SLASTNAME1 , DUEDATE , APPRAISAL_STATUS, PSTATE
			FROM ancillary a
...
and a.order_date_adjusted > '10/01/2010'
	...
	<cfif #state# eq "none">
		...
		<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *--->
			SELECT Anc_id, CHECK_DATE,codeAVM , BFIRSTNAME1 , BLASTNAME1 , SFIRSTNAME1 , SLASTNAME1 , DUEDATE , APPRAISAL_STATUS, PSTATE
			FROM ancillary a
...
<!---This is for Credit product --->
	...
	<cfif #state# eq "none">
		...
		<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *--->
			SELECT Anc_id, CHECK_DATE, CODEFLOOD , BFIRSTNAME1 , BLASTNAME1 , SFIRSTNAME1 , SLASTNAME1 , DUEDATE , APPRAISAL_STATUS, PSTATE,CODECR 
			FROM ancillary a
...
and a.order_date_adjusted > '10/01/2010'
	...
	<cfif #state# eq "none">
		...
		<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			<!---SELECT *--->
			SELECT Anc_id,CODESIGNING , CHECK_DATE, CODEFLOOD , BFIRSTNAME1 , BLASTNAME1 , SFIRSTNAME1 , SLASTNAME1 , DUEDATE , APPRAISAL_STATUS, PSTATE,CODECR
			FROM ancillary a
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">	
			...
			SELECT a.title_id,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate
			FROM Title a
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_prop">
			...
			SELECT a.prop_id,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate,a.SearchType   <!---SELECT *--->
			FROM property a
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_closing">
			...
			SELECT a.title_id,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate       <!---SELECT *--->
			...
			a.oda_year > 2005 and   a.title_id = f.title_id AND f.a_Req_closing_month IS NOT NULL and (a.cancelled is null or a.cancelled = 0)
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_app">
			...
			SELECT a.App_ID,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate		<!---SELECT *--->
			FROM appraisal a
			<CFIF #read_user.role_id# eq 24 or read_user.va_admin eq 'True'>
				<!---<CFINCLUDE TEMPLATE="./includes/companies_list.cfm">
				and a.comp_id IN(#companylist#)--->		
...
and a.order_date_adjusted > '10/01/2010'
	...
	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_anc">
			...
			SELECT a.Anc_ID,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate  	<!---SELECT *--->
			FROM ancillary a
...
and a.order_date_adjusted > '10/01/2010'
	...
	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_avm">
			...
			SELECT a.anc_id,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate,a.codeAVM	<!---SELECT *--->
			FROM ancillary a
...
and a.order_date_adjusted > '10/01/2010'
	...
	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_cr">
			...
			SELECT a.anc_id,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate,a.codeCR 	<!---SELECT *--->
			FROM ancillary a
...
and a.order_date_adjusted > '10/01/2010'
	...
	<CFQUERY DATASOURCE="#request.dsn#" NAME="read_sn">
			...
			SELECT a.anc_id,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate, a.codeSigning <!---SELECT *--->
			FROM ancillary a
...
<!--- ======================================================================== --->
	...
	<CFLOOP QUERY="read_report">
			...
			<CFQUERY DATASOURCE="#request.dsn#" NAME="read_time">
				...
				SELECT check_date,check_time,a_recieved_time,a_recieved_date   <!---SELECT *--->
				FROM Title a, doc_title_insurance_title d
				WHERE a.title_id = #title_id# and a.title_id = d.title_id and check_date is not null and check_time is not null and a_recieved_time is not null and a_recieved_date is not null and (a.cancelled is null or a.cancelled = 0)
			</cfquery>
	...
	<CFLOOP QUERY="read_closing">
		...
		<CFOUTPUT>
			...
			SELECT check_date,check_time,a_recieved_time,a_recieved_date,SearchType,COMP_ID	<!---SELECT *--->
			FROM Title a, doc_title_insurance_title d
			WHERE a.title_id = #title_id# and a.title_id = d.title_id and check_date is not null and check_time is not null and a_recieved_time is not null and a_recieved_date is not null and (a.cancelled is null or a.cancelled = 0)
</cfquery>
			<cfif read_time.SearchType eq 'Purchase'>
...
<CFLOOP FROM="1" TO="#ArrayLen(cty_name_1)#" INDEX="TTT">
 ...
 <CFQUERY DATASOURCE="#request.dsn#" NAME="read_report">
			...
			<cfelse>	
			 ...
			 a.oda_year > 2005 and   (a.cancelled is null or a.cancelled = 0)
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_anc">
			...
			SELECT a.Anc_ID,a.duedate,a.check_date,a.bfirstname1,a.blastname1,a.appraisal_status,a.pstate,a.codeFlood   <!---SELECT *--->
			FROM ancillary a
