		...
		<CFQUERY datasource="#request.dsn#" NAME="read_prop_tax_cert">
...
<CFIF #read_prop_tax_cert.User_ID_started# GT "">
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_user_starting">
			...
			SELECT *
			FROM first_admin
			WHERE ID = #read_prop_tax_cert.User_ID_started#
...
<CFIF #read_prop_tax_cert.User_ID_finished# GT "">
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_user_finished">
			...
			SELECT *
			FROM first_admin
			WHERE ID = #read_prop_tax_cert.User_ID_finished#
...
<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=red face=verdana>
				<B>#read_prop_tax_cert.a_date_started#</B>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=red face=verdana>
				<B>#read_prop_tax_cert.a_time_started#</B>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=red face=verdana>
				<B>#read_prop_tax_cert.a_date_finished#</B>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=red face=verdana>
				<B>#read_prop_tax_cert.a_time_finished#</B>
			</td>
		</tr>
<!--- =========================================================== --->
		<tr>
				...
				<table width=518 cellpadding=1 cellspacing=1 border=0>
					<tr>
						...
						<td width=120 align=right valign=top>
							<font size=2 color=blue face=arial>
							<B>#read_property.pcity#</B>
						</td>				

						<td width=20 align=right valign=top>
							<font size=2 color=blue face=arial>
							<B>#read_property.pstate#</B>
						</td>

						<td width=60 align=right valign=top>
							<font size=2 color=blue face=arial>
							<B>#read_property.pzip#</B>
						</td>				
					...
					<tr>
						<td width=517 colspan=5 align=right valign=top>
							<font size=2 color=blue face=arial>
							Property Estimated Value is.... <font size=2 color=blue face=arial>
							<B>$ #NumberFormat(read_property.estimate_value, "999,999,999.99")#</B>
...
<!--- =========================================================== --->		
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				...
				<B>#read_prop_tax_cert.payable_to#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.taxing_state#</b>
			</td>
		</tr>		
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.taxing_state_phone#</b>
			</td>
		</tr>		
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.taxing_state_ext#</b>
			</td>
		</tr>	
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.taxing_state_fax#</b>
			</td>
		</tr>			
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.taxing_state_person#</b>
			</td>
		</tr>
		...
		<tr>
			<td width=519 colspan=2  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.taxing_state_comments#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_payer_id#</b>
			</td>
		</tr>		
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_period_covered_from#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_period_covered_to#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_year_pymnt_covers#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				...
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.taxing_state_pay_increments#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_due_dates_1#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_due_dates_2#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_due_dates_3#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.tax_due_dates_4#</b>
			</td>
		</tr>
		...
		<tr>
			<td width=519 colspan=2  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.dilinquent_taxes#</b>
			</td>
		</tr>
	...
	<!---===============================================================--->
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.other_tax_township_rate#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.other_tax_township_desc#</b>
			</td>
		</tr>
	<!---===============================================================--->
		<tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.other_tax_city_rate#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.other_tax_city_desc#</b>
			</td>
		</tr>
	...
	<!---===============================================================--->
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.other_tax_county_rate#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.other_tax_county_desc#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.amt_last_paid#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.amt_last_period_from#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.amt_last_period_to#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.amt_next_due#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.amt_next_due_from#</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_prop_tax_cert.amt_next_due_to#</b>
			</td>
		</tr>
