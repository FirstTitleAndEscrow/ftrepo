...
<cfoutput QUERY="read_report">					
											...
											<td bgcolor="#a_bgcolor#" width=10 align=left valign=top>
												<FONT FACE=verdana SIZE=1 color="black">
						 						<cfif #url.uid# neq "93" AND #url.uid# neq "167">
													<a href="abstractors_modify_view.cfm?abstractor_id=#abstractor_ID#&uid=#URL.uid#&al=#URL.al#&a_state=#a_state#&vendor=#vendor#">
												</cfif>
												<img border=0 src="./images/button_m.gif" ALT="Modify this entry"></a>	
											</td>	
										</tr>
	<cfelse>
										<tr>
											...
											<td bgcolor="#a_bgcolor#" width=10 align=left valign=top>
												<FONT FACE=verdana SIZE=1 color="black">
						 						<cfif #url.uid# neq "93" AND #url.uid# neq "167">
													<a href="abstractors_modify_view.cfm?abstractor_id=#abstractor_ID#&uid=#URL.uid#&al=#URL.al#&a_state=#a_state#&vendor=#vendor#"></cfif><img border=0 src="./images/button_m.gif" ALT="Modify this entry"></a>	
											</td>	
										</tr>
	</cfif>
	...
	<CFQUERY datasource="#request.dsn#" NAME="read_report">
		...
		WHERE b.closer_id = a.closer_id and a.st_abbrev = '#A_state#' and b.status = 1
		order by ct_name ASC
	</cfquery>	
...
<cfelse>
												<table width="98%" cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
													<tr>
														<td width="98%" align=center valign=top bgcolor=d3d3d3>
															<FONT FACE=ARIAL SIZE=2 color="black">
															<CENTER><B>A p p r a i s e r s&nbsp;&nbsp;&nbsp;&nbsp;S e a r c h &nbsp;&nbsp;&nbsp;&nbsp;R e s u l t s </B></CENTER>
														</TD>
													</TR>
													<tr>
														<td width="98%" align=center valign=top bgcolor=d3d3d3>
