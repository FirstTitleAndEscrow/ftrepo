...
<CFQUERY name="get_ins_co" datasource="#request.dsn#">
SELECT insurance_co
...
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already a Mortgage Recording file <A HREF="#fileSys.FindFilePath('#get_file.mortrec#', 'url')#" target="new">#get_file.mortrec#</a> uploaded. To upload new Mortgage Recording file click to delete this one first. &nbsp;<br>
	<a  onClick="javascript: if (confirm('Sure you want to delete this file?')) { window.open('./delete_mort_rec.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1'); }"><u>delete</u></a></TD></tr></NOBR>	  
...
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already a Title Policy file <A HREF="#fileSys.FindFilePath('#get_file.titlepol#', 'url')#" target="new">#get_file.titlepol#</a> uploaded. To upload new Title Policy file click to delete this one first. &nbsp;<br>
	<a  onClick="javascript: if (confirm('Sure you want to delete this file?')) { window.open('./delete_title_policy.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1'); }"><u>delete</u></a></TD></tr></NOBR>	  
 ...
 <input type="text" name = "email" size = "15"> and click <input type="submit" value="Email"><input type="hidden" name="a_flag" value="3"></b><p></td></tr>
		...
		<tr>			
	<cfif get_ins_co.insurance_co eq 25>
	<td align=left>
	<FONT SIZE=2 color = blue FACE=ARIAL>Click <a href="<cfoutput>../first_american_owners_policy.cfm?#cgi.QUERY_STRING#</cfoutput>" target="_new">here</a> to fill out Owner's Policy
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</td>
	<cfelse>
    <td align=left>
	<FONT SIZE=2 color = blue FACE=ARIAL>Click <a href="<cfoutput>../stewart_owners_policy.cfm?#cgi.QUERY_STRING#</cfoutput>" target="_new">here</a> to fill out Owner's Policy
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</td>	
