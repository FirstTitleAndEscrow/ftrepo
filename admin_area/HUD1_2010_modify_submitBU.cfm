...
VALUES (#rec_id#, '#i#', '#ReplaceNoCase(Evaluate("check_for_hud.#i#"), "'", "", "ALL")#', '#ReplaceNoCase(Evaluate("form.#i#"), "'", "", "ALL")#', '#c_date#', '#c_time#', '#session.ft_user_id#')
</cfquery>
</cfif>
</cfloop>
</cfif>
...
INSERT INTO 
HUD2010_TITLE_MODS (title_id, field_num, previous_value, current_value, c_date, c_time, user_id)
VALUES (#rec_id#, '#i#', '#Evaluate("check_for_hud_b.#i#")#', '#Evaluate("form.#i#")#', '#c_date#', '#c_time#', '#session.ft_user_id#')
</cfquery>
</cfif>
</cfloop>
</cfif>
