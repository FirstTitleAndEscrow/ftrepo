...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Abstractors County List</B>
		</td>
	</tr>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_countys_delete_sb.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#">
</CFOUTPUT>
	...
	<tr>
		...
		<td width=150 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_countys_add_sb.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
