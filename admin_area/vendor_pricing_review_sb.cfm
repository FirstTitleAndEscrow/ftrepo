...
window.opener.location.hash = 'review_pricing';
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing_sb (vendor_id, service_type, state, county, review_fee)
			values
			( #url.vendor_id#, 'Review', '#form.state#', '#form.county#', '#form.review_fee#')
</CFQUERY>
...
<td align=left valign=top width="80"><input type=text name="review_fee" VALUE="" size=6 maxlength=22
