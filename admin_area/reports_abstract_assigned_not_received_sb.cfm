...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_Abstract_Assigned_Not_Received">
			...
			SELECT DISTINCT
                      ...
                      First_Admin_1.fname AS Abstractor, First_Admin_3.fname AS AbstractorIH, dbo.Title.SearchType, dbo.Title.pstate
...
WHERE     (dbo.Title.cancelled IS NULL) AND (dbo.Companies.company <> 'test - ABC Mortgage') AND (dbo.Companies.company NOT LIKE 'Vanderbilt M%') AND (CAST(dbo.Title.a_insert_date AS smalldatetime)
                      >= '#sixty_days_old#') AND (dbo.Doc_Abstract_Title.a_Date_Assigned IS NOT NULL) AND
                      (dbo.Doc_Abstract_Title.a_Date_Completed IS NULL) AND (dbo.Doc_Abstract_Title.Report_Flag IS NULL) AND
                      (dbo.Title.appraisal_status <> 'Report E-mailed') AND (dbo.Title.appraisal_status <> 'Loan Closed') AND (dbo.Title.appraisal_status <> 'Loan Funded')
...
SELECT DISTINCT
                      ...
                      First_Admin_1.fname AS Abstractor, First_Admin_3.fname AS AbstractorIH, dbo.Property.SearchType, dbo.Property.pstate
...
WHERE     (dbo.Doc_Abstract_Prop.a_Date_Assigned IS NOT NULL) AND (dbo.Companies.company <> 'test - ABC Mortgage')  AND (dbo.Companies.company NOT LIKE 'Vanderbilt M%') AND
                      (dbo.Doc_Abstract_Prop.a_Date_Completed IS NULL) AND (CAST(dbo.Property.a_insert_date AS smalldatetime) >= '#sixty_days_old#') AND (dbo.Property.cancelled IS NULL) AND (dbo.Doc_Abstract_Prop.Report_Flag IS NULL) AND
                      (dbo.Property.appraisal_status <> 'Report E-mailed') AND (dbo.Property.appraisal_status <> 'Loan Closed') AND
                      (dbo.Property.appraisal_status <> 'Loan Funded') AND (dbo.Property.appraisal_status <> 'Loan Closed-Seller Rep') AND
...
select  a.abstractor_id, a.company as abstractor_name from Abstractors_sb a, Doc_Abstract_title t where
t.title_id = #id# and a.abstractor_id = t.abstractor_id
</CFQUERY>
<cfelse>
<CFQUERY DATASOURCE="#request.dsn#" NAME="get_ab_info">
select a.abstractor_id, a.company as abstractor_name from Abstractors_sb a, Doc_Abstract_Prop t where
...
<cfset status_color = "FF3333">
   ...
   <cfif get_ab_info.abstractor_name does not contain 'Test Vendor'>     
        <tr  >
			...
			<CFIF #Letter# eq "T"><td  bgcolor="#a_bgcolor#" align="center"><a href="title_report_modify.cfm?&company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#id#&a_trigger=1" target="_order_window"><font size=1 color=blue face=verdana>T-#id#</font></a></td>
			<CFELSE><td bgcolor="#a_bgcolor#" align="center"><a href="prop_report_modify.cfm?&company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#id#&a_trigger=1" target="_order_window"><font size=1 color=blue face=verdana>P-0232#id#</font></a></td>
			</CFIF>
			...
			<td width=150 bgcolor="#a_bgcolor#" align="center"><a href="client_modify_display.cfm?company_id=#read_Abstract_Assigned_Not_Received.company_ID#&uid=#URL.uid#&al=#URL.al#" target="_company_window"><font size=1 color=blue face=verdana>#company#</font></a></td>
			...
			<CFIF #Letter# eq "T">
					...
					<CFIF #read_taxes.recordcount# gte 1><td bgcolor="#a_bgcolor#" align="center"><b><a href="./update_vendor_management_taxes_title.cfm?company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#id#&a_trigger=1" target="_parent"><font size=1 color=Green face=verdana>#taxes#</font></a></b></td>
					</CFIF>
				<CFELSE>
					<CFQUERY DATASOURCE="#request.dsn#" NAME="read_taxes">
						SELECT     payoff_ID, payoff_Start_Datetime, payoff_Finish_Datetime, Title_ID
					...
					<CFIF #read_taxes.recordcount# gte 1><td bgcolor="#a_bgcolor#" align="center"><b><a href="./update_vendor_management_taxes_prop.cfm?company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#id#&a_trigger=1" target="_parent"><font size=1 color=Green face=verdana>#taxes#</font></a></b></td>
					</CFIF>
				</CFIF>
		</tr>
