...
<table width=780 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
			<td width=780 align=left valign=top bgcolor=green>
				...
				<CENTER><B>Title Closing Request Search</B></CENTER>
			</TD>
		</TR>
<CFFORM METHOD=POST ACTION="./title_rep_displaya.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=1">
...
<!--- ====================================================================== --->
			...
			</TD><td width=780 align=left valign=top bgcolor=green>
				<FONT FACE=ARIAL SIZE=2 color="white">
				<CENTER><B>Title Closing Request Search</B></CENTER>
			</TD>
		</TR>
