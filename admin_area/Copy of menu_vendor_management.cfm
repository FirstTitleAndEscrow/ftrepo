...
<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_Abstract_Not_Assigned">
			Select * from sqlAbstract_Not_Assigned order by a_insert_date 
</CFQUERY>

<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_Abstract_Assigned_Not_Received">
			Select * from sqlAbstract_Assigned_Not_Received order by a_insert_date
</CFQUERY>



<cfset date_range = CreateODBCDate('9/15/2005')>
<!--- BEGIN --->
...
<cfset a_bgcolor = a_color_temp>
    ...
    <tr>
		...
		<CFIF #Letter# eq "T">
                <CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_IH">
						    SELECT     abstract_ID
						    FROM         tblUser_Roles
			...
			<CFELSE>
                <CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_IH2">
						    SELECT     abstract_ID
						    FROM         tblUser_Roles
		...
		<td bgcolor="#a_bgcolor#" align="center">
		<CFIF #Letter# eq "T">
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_taxes">
