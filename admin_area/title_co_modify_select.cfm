...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Title Companies </B>
		</td>
	</tr>
</CFOUTPUT>
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<tr>
		...
		<td width=498 align=left valign=top bgcolor=e1e1e1>
			...
			From the pulldown below, pick the Title Company that you want to
			modify
			<p>
		</td>
	</tr>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Title_Co_modify_view.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
	<tr>
