...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Deed Prep Vendor</B>
		</td>
	</tr>
</CFOUTPUT>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="deed_prep_modify_submit.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#&a_state=#a_state#&vendor=#vendor#" name="frm">


	<tr>

		<td width=498 colspan=2 align=left valign=top bgcolor=e1e1e1>
			<NOBR><a href="blank.cfm?uid=#URL.uid#&al=#URL.al#&a_trigger=1"><img src="./images/button_return.gif" border=0></a><img src="./images/clear.gif" height=10 width=85></NOBR>
...
<CFOUTPUT>
<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/deed_prep_modify_countys_delete.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#&a_state=#a_state#&vendor=#vendor#">
</CFOUTPUT>
	...
	<tr>
		...
		<td width=150 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/deed_prep_modify_countys_add.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#&a_state=#a_state#&vendor=#vendor#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
