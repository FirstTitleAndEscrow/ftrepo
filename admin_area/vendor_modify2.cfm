...
<cfif read_closer.recordcount neq 0>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/vendor_modify2.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=e3e3e3>
	...
	<cfFORM name = "frm" ACTION="vendor_modify_submit2.cfm?vendor_id=#url.vendor_id#" ENCTYPE="multipart/form-data" METHOD=POST>
	...
	<tr>
		...
		<td width=368 align=left valign=top bgcolor=e6e6e6>
			<cfinput  Required="Yes" Message="You must enter a Password" type=password name="password" VALUE="#read_vendor.password#" size=20 maxlength=90
...
<tr>
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<cfquery DATASOURCE="#request.dsn#" name="getPrivacy">
				select * from vendor_privacyPolicies
				where vendor_id = #url.vendor_id#
			</cfquery>
			
			<input type="file" name="privacy_policy" size=25 style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
				background-color: e6e6e6;
				...
				border-style: bar;
				clear: none;">
				<input type="hidden" name="upload_pp" value="0">
				<input type="hidden" name="delete_pp" value="0">
			<br>
			<cfoutput query="getPrivacy"> 
				<cfset FileSys = createObject('component','cfc.FileManagement')>
				<cfset fileurl = fileSys.FindFilePath(privacypolicy, 'url')>
			
			<FONT SIZE=1 FACE=ARIAL>
<FONT SIZE=2 FACE=ARIAL><A HREF="#fileurl#" target="new">#Mid(privacypolicy, 1, 20)#<cfif Len(privacypolicy) GT 20>...</cfif></a> <a href="vendor_modify_submit2.cfm?delete_pp=1&vendor_id=#url.vendor_id#&vendorpolicyid=#vendorpolicyid#&filename=#privacypolicy#">delete</a></font>
			<br>
			</cfoutput>
...
<tr bgcolor=e1e1e1>
<td bgcolor="cccccc" colspan=11 style="border-top-style:solid; border-top-width:thin; border-top-color:e6e6e6; border-bottom-style:solid; border-bottom-width:thin; border-bottom-color:e6e6e6;"><font size=3 color=black face=arial>Abstract Pricing</td>
</tr>
<cfif read_abstract_prices.recordcount eq 0>
<tr>
<td bgcolor=e6e6e6 colspan=11><font size=1 color=black face=arial>No Pricing Found</td>
</tr>
<cfelse>
	<tr bgcolor=000000>
...
<cfoutput query="read_abstract_prices">
	<tr>
		...
		<td align=right valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			#read_abstract_prices.TEN_YEAR#
		</td>
		<td align=right valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			#read_abstract_prices.bankruptcy#
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_abstractor_modify.cfm?billing_id=#read_abstract_prices.billing_id#','mywindow','width=700,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=11 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Abstract Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_abstractor.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=700,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_appraisal_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_appraisal_modify.cfm?billing_id=#read_appraisal_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Appraisal Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_appraisal.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_closer_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_closer_modify.cfm?billing_id=#read_closer_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Closer Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_closer.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_taxprep_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_taxprep_modify.cfm?billing_id=#read_taxprep_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Tax Prep Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_taxprep.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_ICL_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_ICL_modify.cfm?billing_id=#read_ICL_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onclick="question = confirm('Are you sure you want to delete this entry?'); if (question==true) {document.location.href='https://#cgi.SERVER_NAME#/admin_area/vendor_pricing_delete.cfm?vendor_id=#read_ICL_prices.vendor_id#&billing_id=#read_ICL_prices.billing_id#'}; "><img src="images/button_d.gif" length=14 width=14 border=0></a>
		</td>
	</tr>
</cfoutput>
</cfif>
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add ICL Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_ICL.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_PAYOFF_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_PAYOFF_modify.cfm?billing_id=#read_PAYOFF_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Payoff Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_PAYOFF.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_deedprep_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_deedprep_modify.cfm?billing_id=#read_deedprep_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Deed Prep Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_deedprep.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_Typing_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_Typing_modify.cfm?billing_id=#read_Typing_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Typing Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_Typing.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_Review_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_Review_modify.cfm?billing_id=#read_Review_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Commitment Review Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_Review.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_REO_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_REO_modify.cfm?billing_id=#read_REO_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add REO Document Retrieval Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_REO.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_Recording_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_Recording_modify.cfm?billing_id=#read_Recording_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Recording Services Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_Recording.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<cfoutput query="read_orderentry_prices">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_orderentry_modify.cfm?billing_id=#read_orderentry_prices.billing_id#','mywindow','width=500,height=125')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
	...
	<tr>
	<td colspan=9 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add Order Entry/Opening Pricing Tier" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/vendor_pricing_orderentry.cfm?vendor_id=<cfoutput>#read_vendor.vendor_id#</cfoutput>','mywindow','width=500,height=125')"></td>
	</tr>
</table>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_countys_delete.cfm?uid=#session.ft_user_id#&al=1&Abstractor_ID=#read_abstractor.Abstractor_ID#&a_state=#a_state#&vendor=#vendor#">
</CFOUTPUT>
	...
	<tr>
		...
		<td width=150 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_countys_add.cfm?uid=#session.ft_user_id#&al=1&Abstractor_ID=#read_abstractor.Abstractor_ID#&a_state=#a_state#&vendor=#vendor#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
...
<CFIF read_closer.recordcount neq 0 and #read_Closers_county_list.recordcount# EQ "0">
		<tr>
			<td width=498 colspan=2 align=left valign=top bgcolor=f1f1f1>
				<p>
				<bR>
...
<CFELSE>
		<tr>
			...
			<td width=150 align=left valign=top bgcolor=f1f1f1>
	<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_countys_delete.cfm?uid=#session.ft_user_id#&al=1&Closer_ID=#read_closer.Closer_ID#&a_state=#a_state#&vendor=#vendor#">
	</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
		...
		<tr>
			...
			<td width=150 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_countys_add.cfm?uid=#session.ft_user_id#&al=1&Closer_ID=#read_closer.Closer_ID#&a_state=#a_state#&vendor=#vendor#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
