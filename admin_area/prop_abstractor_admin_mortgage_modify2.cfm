...
<CFQUERY datasource="#request.dsn#" NAME="read_deed">
			...
			SELECT *
			FROM prop_ins_add
			where prop_id = #rec_id# and type = 'MORTGAGE' AND seq_num = #URL.seq_num#
		</CFQUERY>
...
WHERE  prop_id = #rec_id# AND type = 'MORTGAGE' AND seq_num = #seq_num#
		</CFQUERY>
<CFQUERY datasource="#request.dsn#" NAME="read">
...
Click here to go back to the main page.<a href="admin_property_report.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=0"><img src="./images/button_return.gif" border=0 ALT="Click this button to return to main"></a>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/prop_abstractor_admin_MORTGAGE_modify2.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#url.rec_id#&seq_num=#read_report.seq_num#&company_id=0&a_trigger=1" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<cfoutput query = "read_report">
	...
	<tr>
		...
		<TEXTAREA name="mort1"  COLS=80 ROWS=5
					style="font-size: 9;
					font-family: verdana;
					font-style: normal;
					color: blue;
...
<option value="2005">2005</option>
	...
	<tr>
		...
		<td width=600 align=left valign=top bgcolor=e6e6e6>
			...
			cols="45"
			>
			<OPTION VALUE="1" <cfif #read_report.subject_trust# eq 1>selected</cfif>>Yes</OPTION>
			<OPTION VALUE="0" <cfif #read_report.subject_trust# neq 1>selected</cfif>>No</OPTION>
