...
FROM="#from_email#"
SERVER="127.0.0.1"
Subject="#new_loan_number##get_file.paddress#, #get_file.pcity#, #get_file.pstate# #get_file.pzip#, #DateFormat(date_to_use, 'm/d/yyyy')#, REO HUD for Approval for order #rec_id#"
TIMEOUT="600"
type="HTML"
>
...
View/Print REO HUD for Approval <A HREF="#fileSys.FindFilePath('#get_file.reo_hud_for_approval#', 'url')#" target="new">#get_file.reo_hud_for_approval#</a> for order #rec_id#  - #get_id.bfirstname1# #get_id.blastname1#</B></font><br><br>
Thank You,<br>
Streamline Title Staff
</cfmail>
<CFQUERY datasource="#request.dsn#">
		    INSERT INTO Title_Notes(FName, LName, Order_ID, N_Note, N_Date, N_Time, note_type, access, access2)
			VALUES('#read_user.FName#', '#read_user.LName#', #URL.rec_id#, 'REO HUD for Approval emailed to #email#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T', '1', '1')
</CFQUERY>
...
<table width=455 cellpadding=1 cellspacing=1 border=0>
		...
		<B>1st Title & Escrow, Inc. -REO HUD for Approval File Upload for Order <CFOUTPUT query="get_id">#title_id#</CFOUTPUT></B>
		<p>
...
<FORM action="./upload_reo_hud_for_approval_final.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#"  ENCTYPE="multipart/form-data" method="post">

<input type="hidden" name="title_id" value="#title_id#">
Insert REO HUD for Approval to upload <input type="file" size = 15 name="file_upload"><br>
