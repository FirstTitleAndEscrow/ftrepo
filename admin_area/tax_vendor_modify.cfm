...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Tax Vendors </B>
			<p>
			Select a Tax Vendor to modify</CENTER></NOBR><font size=2 color=black face=arial>
		</td>
	</tr>
</CFOUTPUT>
...
<CFOUTPUT>
	...
	<tr>
		...
		<SELECT NAME="Abstractor_ID"
			...
			rows="5"
			cols="45"
			><CFOUTPUT QUERY="read_tax_vendors"><OPTION VALUE="#Abstractor_ID#">#Company# -  #lname#, #fname#</OPTION></CFOUTPUT>
			</SELECT>
