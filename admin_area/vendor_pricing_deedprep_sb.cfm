...
window.opener.location.hash = 'payoff_pricing';
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing_sb (vendor_id, service_type, state, county, deedprep_fee)
			values
			( #url.vendor_id#, 'deedprep', '#form.state#', '#form.county#', '#form.deedprep_fee#')
</CFQUERY>
...
<td align=left valign=top width="80"><input type=text name="deedprep_fee" VALUE="" size=6 maxlength=22
