...
<CFPARAM NAME="code" DEFAULT=""> 
			<!--- <CFFILE 			
				...
				<CFFILE 			
				DESTINATION="C:\Inetpub\wwwroot\clients\firsttitleservices.com\www\admin_area\uploaded_files\"
				ACTION="UPLOAD"
				NAMECONFLICT="MAKEUNIQUE"
				FILEFIELD="file_upload"> 
...
<cfset new_file_name = #fileSys.MoveFromUploads('#FILE.ServerFile#')#>
			...
			update ancillary set ancillary_upload = '#FILE.ServerFile#'
			WHERE anc_id = #rec_ID#
			</cfquery>  --->
			
			<CFQUERY datasource="#request.dsn#" NAME="insert_filename">
				update ancillary_detl
					set file_uploaded='#new_file_name#',
						status='Report Emailed/Delivered'
