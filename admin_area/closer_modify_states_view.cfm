...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Closer States List</B>
		</td>
	</tr>
...
<CFIF #read_Closers_states_list.recordcount# EQ "0">
	...
	<tr>
		...
		<bR>
		<font size=2 color=blue face=arial>
		This Closer does not have any "States Serviced" in their list.
		<p>
		</td>
	</tr>
...
<CFELSE>
	<tr>
		...
		<font size=2 color=black face=arial>
		This is the current List of States for this Closer.	To
		...
		State from this Closer Counties List
		</td>

		<td width=50 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_states_delete.cfm?uid=#URL.uid#&al=#URL.al#&Closer_ID=#Closer_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					...
					rows="5"
					cols="45"
					><CFOUTPUT QUERY="read_Closers_states_list"><OPTION VALUE="#st_abbrev#">#st_abbrev#</OPTION></CFOUTPUT>
			</SELECT>
		</td>
	</tr>
	...
	<tr>
		...
		<font size=2 color=black face=arial>
		Click on any of the
		States in the list to add them to this Closer <br>"States
		...
		<td width=50 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_states_add.cfm?uid=#URL.uid#&al=#URL.al#&Closer_ID=#Closer_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
