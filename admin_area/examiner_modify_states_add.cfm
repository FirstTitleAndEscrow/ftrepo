	...
	<CFSET zip_id_1 = #ListToArray(zip_id, ",")#>
		...
		<CFLOOP FROM="1" TO="#ArrayLen(zip_id_1)#" INDEX="SSS">
			<CFQUERY datasource="#request.dsn#">
				INSERT INTO Examiner_states(Examiner_ID, st_abbrev)
				VALUES(#Examiner_ID#, '#zip_id_1[SSS]#')
			</CFQUERY>
		</CFLOOP>
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>States were added to Examiner States List</B>
		</td>
	</tr>
