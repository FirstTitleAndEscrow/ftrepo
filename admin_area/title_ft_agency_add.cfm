...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Add First Title Agencies </B>
		</td>
	</tr>
</CFOUTPUT>
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<tr>
		...
		<td width=498 colspan=2 align=left valign=top bgcolor=e1e1e1>
			...
			Review the list below to ensure the First Title Agency isn't already in the Database
		</td>
	</tr>
...
<CFOUTPUT>
	...
	<tr>
		<td width=498 colspan=2 align=left valign=top bgcolor=e6e6e6>
			...
			Use the list below to select all of the States that this First Title Agency
	...
	<tr>
		<td width=130 align=right valign=top bgcolor=e6e6e6>
			<font size=2 color=black face=arial>
			Select the States this First Title Agency is going to Serve
		</td>
