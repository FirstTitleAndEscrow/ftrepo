...
<cfset new_file_name = #fileSys.MoveFromUploads('#FILE.ServerFile#')#>
			...
			<cfmail to="#get_title.p_email#; #get_title.o_email#" from="webmaster@firsttitleservices.com" subject="2nd Payoff for Order ###rec_id# has been received" mimeattach="#fileSys.FindFilePath('#new_file_name#', 'file')#">
2nd Payoff for Order ###rec_id# has been received.<br>
<br>
