...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Update Vendor_Pricing_sb
			set orderentry_fee = '#form.orderentry_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="orderentry_fee" VALUE="#read_entry.orderentry_fee#" size=6 maxlength=22
