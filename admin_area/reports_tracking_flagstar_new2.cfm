...
.large_header {font-family:Arial, Helvetica, sans-serif; font-size: 16px;}
	...
	<CFQUERY datasource="#request.dsn#" NAME="get_recs">
		select t.title_id, t.paddress, t.pcity, t.pcounty, t.pstate, t.a_insert_date, t.a_insert_time, t.loan_number, t.docs_recorded_date, t.sec_inst_date, t.pname, t.flagstar_hud_req, t.flagstar_hud_completed, t.flagstar_policy_issued, l.closing_date,l.l_date,
		...
		group by  t.title_id, t.paddress, t.pcity, t.pcounty, t.pstate, t.a_insert_date, t.a_insert_time, t.loan_number, t.docs_recorded_date, t.sec_inst_date, t.pname, t.flagstar_hud_req, t.flagstar_hud_completed, t.flagstar_policy_issued, l.closing_date,l.l_date
		order by t.title_id
    </CFQUERY>
...
<td align="left" valign="bottom"><strong>Commit Comp</strong></td>
<td align="left" valign="bottom"><strong>Order to Commit</strong></td>
<td align="left" valign="bottom"><strong>Title Clear</strong></td>
<td align="left" valign="bottom"><strong>Commitment to Clear</strong></td>
<td align="left" valign="bottom"><strong>Sched Req</strong></td>
<td align="left" valign="bottom"><strong>Sched Comp</strong></td>
<td align="left" valign="bottom"><strong>Sched Req to Sched Comp</strong></td>
<td align="left" valign="bottom"><strong>HUD Req</strong></td>
<td align="left" valign="bottom"><strong>HUD Comp</strong></td>
<td align="left" valign="bottom"><strong>HUD Req to Sched Comp</strong></td>
...
<td><!--- Commt Comp --->
#DateFormat(pbinder_sent,"mm/dd/yyyy")#<br>
#TimeFormat(pbinder_sent,"short")#</td>
...
<td><!--- title Clear --->#DateFormat(get_userRoles.cleartoclose_End_Datetime,"mm/dd/yyyy")#<br>
#TimeFormat(get_userRoles.cleartoclose_End_Datetime,"short")#</td>
...
<td><!--- Sched Req --->#DateFormat(get_closing_req.a_filled_out_date,"mm/dd/yyyy")#<br>
#TimeFormat(get_closing_req.a_filled_out_time,"short")#</td>
<CFSET sched_req = '#DateFormat(get_closing_req.a_filled_out_date, "mm/dd/yyyy")# #TimeFormat(get_closing_req.a_filled_out_time, "HH:mm:ss")#'>
...
<td><!--- Sched Comp --->#DateFormat(get_eventlist.sc_dateandtime,"mm/dd/yyyy")#<br>
#TimeFormat(get_eventlist.sc_dateandtime,"short")#</td>
...
<td style="color:#col1color#">
#DateFormat(get_recs.flagstar_hud_req, "mm/dd/yyyy")#
</td>
<td style="color:#col1color#">
#DateFormat(get_recs.flagstar_hud_completed, "mm/dd/yyyy")#
</td>
