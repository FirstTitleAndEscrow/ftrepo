...
<title>FT Notes Test Page</title>
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_id">
	SELECT title_id, comp_id, equator_title_transactionID, equator_closing_transactionID, realec_transactionid from title where title_id = #rec_id#
</CFQUERY>
...
<cfif url.code eq 'A'>
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_id">
	SELECT app_id, comp_id from appraisal where app_id = #rec_id#
</CFQUERY>
<cfelseif url.code eq 'P'>
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_id">
	SELECT prop_id, prop_id as title_id, comp_id, equator_title_transactionID, realec_transactionid from Property where prop_id = #rec_id#
</CFQUERY>
<cfelse>
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_id">
	SELECT title_id, comp_id, equator_title_transactionID, equator_closing_transactionID, realec_transactionid from title where title_id = #rec_id#
		...
		<CFQUERY DATASOURCE="#request.dsn#">
			...
			<!---   <CFIF #read_title.comp_id# eq "559"><!---Change to Weichert after testing--->
             ...
             --->
					...
					<CFIF #read_title.comp_id# eq "559">
...
<cfset to_email = to_email & ';' & 'MGMT@FirstTitleServices.com'>
</cfif>
<CFMAIL
TO="#to_email#"
FROM="#team_email#"
...
<cfset to_email = team_email & ';' & 'pgibb@firsttitleservices.com; hkelly@firsttitleservices.com; jmoore@firsttitleservices.com; ssacks@firsttitleservices.com; jmajor@firsttitleservices.com; nashley@firsttitleservices.com; aoakes@firsttitleservices.com; nwood@firsttitleservices.com'>
</cfif>
...
<cfif #form.otherpro# eq "Problem Alert - Customer Service" OR #form.otherpro# eq "Problem Solved - Customer Service" >
<cfset subject_prefix = '#form.otherpro#' & ' - '>
<cfset to_email = team_email & ';' & 'pgibb@firsttitleservices.com; sflickinger@firsttitleservices.com; jmoore@firsttitleservices.com'>
</cfif>
<cfif Len(email)>
<cfset to_email = to_email & ';' & email>
<cfset email = to_email>
...
<select name="ctcReview" id="ctcReview" style="font-size: 9;
									...
									border-bottom-width: thin;
									border-width: thin;
									border-style: bar;"><option value=""></option>
							...
							<option value="542">Alyssa Robinson</option>
