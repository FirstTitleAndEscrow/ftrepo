...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			...
			set closer_fee = '#form.closer_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="closer_fee" VALUE="#read_entry.closer_fee#" size=6 maxlength=22
