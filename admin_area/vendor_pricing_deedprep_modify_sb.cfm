...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			...
			set deedprep_fee = '#form.deedprep_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="deedprep_fee" VALUE="#read_entry.deedprep_fee#" size=6 maxlength=22
