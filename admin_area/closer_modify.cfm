...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			...
			<p>
			Select an Closer to modify</CENTER></NOBR><font size=2 color=black face=arial>
		</td>
	</tr>
</CFOUTPUT>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_view.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
	...
	<tr>
		...
		<SELECT NAME="Closer_ID"
			...
			rows="5"
			cols="45"
			><CFOUTPUT QUERY="read_Closers"><OPTION VALUE="#Closer_ID#">#Company# -  #lname#, #fname#</OPTION></CFOUTPUT>
			</SELECT>
