...
<CFELSEIF #a_flag# EQ "2">
	...
	<CFLOOP FROM="1" TO="#ArrayLen(st_list)#" INDEX="AAA">
		...
		<CFQUERY datasource="#request.dsn#" >
			...
			WHERE Title_FT_Agency_ID = #Title_FT_Agency_ID# AND st_abbrev = '#st_list[AAA]#'
...
<CFELSE>
	...
	<CFLOOP FROM="1" TO="#ArrayLen(st_list)#" INDEX="AAA">
		...
		<CFQUERY datasource="#request.dsn#" >
			...
			VALUES(#Title_FT_Agency_ID#, '#st_list[AAA]#')
...
<CFOUTPUT>
	...
	<tr>
		<td width=499 align=center valign=top bgcolor=white>
			...
			to make to this First Title Agencys' record.
			<p>
