...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing_sb (vendor_id, service_type, state, county, ICL_fee)
			values
			( #url.vendor_id#, 'ICL', '#form.state#', '#form.county#', '#form.ICL_fee#')
</CFQUERY>
...
<td align=left valign=top width="80"><input type=text name="ICL_fee" VALUE="" size=6 maxlength=22
