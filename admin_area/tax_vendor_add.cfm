		...
		<CFQUERY datasource="#request.dsn#" NAME="read_tax_vendors">
...
message = message + "In order to add a new Tax Vendor you need to choose county(ies)/state(s) the Tax Vendor serves\n"
valid = false;
}
if (valid == false) {
alert(message);
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Add Tax Vendor </B>
		</td>
	</tr>
</CFOUTPUT>	
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<CFFORM METHOD=POST ACTION="tax_vendor_add_submit.cfm?uid=#URL.uid#&al=#URL.al#" name="frm">
...
<tr>		
	...
	<tr>		
		<td width=468 colspan=2 align=center valign=top bgcolor=e6e6e6>	
			...
			Select County and State Tax Vendor is going to serve
	...
	<tr>		
		<td width=468 colspan=2 align=center valign=top bgcolor=e6e6e6>	
			<font size=2 color=gray face=arial>
			Preferences for recieving Tax Form Notice
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	<tr>		
		...
		<td width=497 align=center valign=top bgcolor=e1e1e1>	
			...
			Review the list below to ensure the Tax Vendor isn't already in the Database
	...
	<tr>		
		...
		<td width=497  align=right valign=top bgcolor=e1e1e1>	
			...
			rows="5" 
			cols="45" 
			><CFOUTPUT QUERY="read_tax_vendors"><OPTION VALUE="#company#">#Company# ---  #lname#, #fname#</OPTION></CFOUTPUT>			
			</SELECT></FORM>		
		</td>
	</tr>
