...
<td style="margin:100px" align="center">
		...
		<cffileupload align="center" name="MultiFileupload" addbuttonlabel="Add File" uploadbuttonlabel="Upload the files" url="UploadFilePR.cfm?rec_id=#url.rec_id#&Files=Multiple" 
...
<table<tr><td>&nbsp;&nbsp;<a href="./blob_list_pr.cfm?rec_id=<cfoutput>#url.rec_id#</cfoutput>">[View existing files]</a>
</td>
</table>
</center>
</body>
