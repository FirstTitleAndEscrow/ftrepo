		...
		<CFQUERY datasource="#request.dsn#" NAME="read_Examiner_county_list">
		...
		<CFOUTPUT QUERY="read_Examiner_county_list">
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Examiner County List</B>
		</td>
	</tr>
...
<CFIF #read_Examiner_county_list.recordcount# EQ "0">
	...
	<tr>
		...
		<bR>
		<font size=2 color=blue face=arial>
		This Examiner does not have any "Counties Serviced" in their list.
		<p>
		</td>
	</tr>
...
<CFELSE>
	<tr>
		...
		<font size=2 color=black face=arial>
		This is the current List of States and Counties for this Examiner.
		<p>
		To
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Examiner_modify_countys_delete.cfm?uid=#URL.uid#&al=#URL.al#&Examiner_ID=#Examiner_ID#">
</CFOUTPUT>
	...
	<tr>
		<td width=348 align=left valign=top bgcolor=f1f1f1>
		<font size=2 color=black face=arial>
		Click on any of the items in the list to add them to this Examiner "Countys
		Serviced" List.
		...
		<td width=150 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Examiner_modify_countys_add.cfm?uid=#URL.uid#&al=#URL.al#&Examiner_ID=#Examiner_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
