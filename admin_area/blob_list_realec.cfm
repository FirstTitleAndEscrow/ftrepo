...
<cfoutput query="view">
<cfset i = i + 1>
<form method="POST" action="./blob_list_realec.cfm?rec_id=#rec_id#&ID=#ID#&a_trigger=4" enctype="multipart/form-data">
<tr>
<td>#i#.</td>
...
<tr>
<td><cfoutput>
<a href="./add_blob_realec.cfm?rec_id=#rec_id#">[Add a new file]</a>&nbsp;&nbsp;
</td>
<td>


&nbsp;&nbsp;<a href="./blob_list_realec.cfm?rec_id=#rec_id#">[View existing files]</a>
</td></cfoutput>
</tr>
</table>
</div>
