...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			...
			set typing_fee = '#form.typing_fee#'
			where billing_id = #url.billing_id#
</CFQUERY>
...
<cfoutput><td align=left valign=top width="80"><input type=text name="typing_fee" VALUE="#read_entry.typing_fee#" size=6 maxlength=22
