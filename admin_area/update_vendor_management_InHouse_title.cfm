...
<CFFORM ACTION="update2_vendor_management_InHouse_title.cfm?company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#preprocessor.title_id#&a_trigger=1"><!--- Embed primary key as a hidden field --->
<CFOUTPUT>
