...
and title_package_upload IS NULL and title_package_upload_date IS NULL
</CFQUERY>

<center>
<span class="large_header"><strong>Secretary of Veteran Affairs<br>
Title Opened - Title Package not received</strong></span><br>

<b>Files in RED are past due (due in 5 business days)</b>
...
<td align="left" valign="bottom" width=150><strong>Due Date</strong></td>
</tr>
...
<cfset past_due = 0>
<cfset ord_date = get_recs.order_date>
<cfset due_date = DateAdd("w", 5, ord_date)>
<cfif DateDiff("d",ord_date,due_date) gt 0>
<cfset past_due = 1>
</cfif>
