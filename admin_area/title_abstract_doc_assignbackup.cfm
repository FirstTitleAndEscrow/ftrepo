...
<CFMAIL
				...
				FROM="#company_email#" Subject="New Title Commitment/Prelim Report of Title Request from First Ttile - Order #prefix#-#read_title.title_id#"  bcc="akumar@firsttitleservices.com"
				TIMEOUT="600">
<cfoutput>
...
<CFMAIL
				TO="#read_abs.email#" server="127.0.0.1"
				FROM="#company_email#" Subject="New Abstract report request from Abstracts, USA - Order #prefix#-#read_title.title_id#" bcc="akumar@firsttitleservices.com"
				TIMEOUT="600">
<cfoutput>
#company_name#
Account #account#
