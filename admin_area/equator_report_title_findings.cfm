...
document.getElementById('title_findings_block').style.display = 'block';
} else {
document.getElementById('title_findings_block').style.display = 'none';
}


if (document.getElementById('title_findings_type_cure').options[1].selected) {
document.getElementById('reason_for_delay_type_block').style.display = 'block';
document.getElementById('cause_type_block').style.display = 'block';
} else {
document.getElementById('reason_for_delay_type_block').style.display = 'none';
document.getElementById('cause_type_block').style.display = 'none';
}

if (document.getElementById('title_findings_type_cure').options[2].selected) {
document.getElementById('current_owner_block').style.display = 'block';
} else {
document.getElementById('current_owner_block').style.display = 'none';
}

if (document.getElementById('title_findings_type_cure').options[3].selected) {
document.getElementById('taxes_block').style.display = 'block';
} else {
document.getElementById('taxes_block').style.display = 'none';
}


if (document.getElementById('title_findings_type_cure').options[4].selected) {
document.getElementById('hoa_block').style.display = 'block';
} else {
document.getElementById('hoa_block').style.display = 'none';
}

if (document.getElementById('title_findings_type_cure').options[5].selected) {
document.getElementById('legal_block').style.display = 'block';
document.getElementById('status_block').style.display = 'block';
} else {
document.getElementById('legal_block').style.display = 'none';
document.getElementById('status_block').style.display = 'none';
}

if (document.getElementById('title_findings_type_cure').options[6].selected) {
document.getElementById('irs_block').style.display = 'block';
document.getElementById('irs2_block').style.display = 'block';
} else {
document.getElementById('irs_block').style.display = 'none';
document.getElementById('irs2_block').style.display = 'none';
}

if (document.getElementById('title_findings_type_cure').options[7].selected) {
document.getElementById('liens_block').style.display = 'block';
} else {
document.getElementById('liens_block').style.display = 'none';
}



if (document.getElementById('title_findings_type_cure').options[8].selected) {
document.getElementById('mortgage_block').style.display = 'block';
} else {
document.getElementById('mortgage_block').style.display = 'none';
}
...
Click the "Submit to Equator" button <font color="red"><b>ONLY</b></font> once ALL information has been filled out and saved.<br>
...
<!--- TITLE FINDINGS BLOCK --->
<tr  name="title_findings_block" id="title_findings_block" style="display:none;">
<td align="right" valign="top" width="250">Title Findings</td>
<td align="left" valign="top" width="350"><select name="title_findings_type_cure" id="title_findings_type_cure" style="font-size: 9; 
									font-family: verdana; 
									font-style: normal; 
									color: 003F1E; 
									background-color: E4E3E3; 
...
<!--- END TITLE FINDINGS BLOCK --->


<!--- REASON FOR DELAY TYPE BLOCK --->
<tr name="reason_for_delay_type_block" id="reason_for_delay_type_block" style="display:none;">
...
<!--- END REASON FOR DELAY TYPE BLOCK --->


<!--- CAUSE TYPE BLOCK --->
<tr name="cause_type_block" id="cause_type_block" style="display:none;">
...
<!--- END CAUSE TYPE BLOCK --->


<!--- CURRENT OWNER BLOCK --->
<tr name="current_owner_block" id="current_owner_block" style="display:none;">
<td align="right" valign="top" width="250">Current Owner</td>
<td align="left" valign="top" width="350"><input type="text" name="current_owner"  value="<cfoutput>#read_findings.current_owner#</cfoutput>" style="font-size: 9; 
									font-family: verdana; 
									font-style: normal; 
									color: 003F1E; 
									background-color: E4E3E3; 
...
<!--- END CURRENT OWNER BLOCK --->


<!--- TAXES BLOCK --->
<cfoutput>
<tr name="taxes_block" id="taxes_block" style="display:none;">
<td colspan=3>
<table cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
<tr>
...
<tr>
<td align="right" valign="top" width="250">Tax Penalty/Interest Amount (1)</td>
...
<tr>
<td align="right" valign="top" width="250">Tax Penalty/Interest Amount (2)</td>
...
<tr>
<td align="right" valign="top" width="250">Tax Penalty/Interest Amount (3)</td>
...
<tr>
<td align="right" valign="top" width="250">Tax Penalty/Interest Amount (4)</td>
...
<!--- HOA BLOCK --->
<cfoutput>
<tr name="hoa_block" id="hoa_block" style="display:none;">
<td colspan=3>
<table cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
<tr>
...
<!--- LEGAL BLOCK --->
<cfoutput>
<tr bgcolor=e1e1e1 name="legal_block" id="legal_block" style="display:none;">
...
<!--- STATUS BLOCK --->
<cfoutput>
<tr bgcolor=e1e1e1 name="status_block" id="status_block" style="display:none;">
<td align="right" valign="top" width="250">Survey Status</td>
<td align="left" valign="top" width="350"><select name="survey_status" multiple style="font-size: 9; 
									font-family: verdana; 
									font-style: normal; 
									color: 003F1E; 
									background-color: E4E3E3; 
...
<!--- IRS BLOCK --->
<cfoutput>
<tr bgcolor=e1e1e1 name="irs_block" id="irs_block" style="display:none;">
...
<!--- IRS 2 BLOCK --->
<cfoutput>
<tr bgcolor=e1e1e1 name="irs2_block" id="irs2_block" style="display:none;">
...
<!--- LIENS BLOCK --->
<cfoutput>
<tr name="liens_block" id="liens_block" style="display:none;">
<td colspan=3>
<table cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
<tr>
...
<!--- MORTGAGE/JUDGMENT BLOCK --->
<cfoutput>
<tr name="mortgage_block" id="mortgage_block" style="display:none;">
<td colspan=3>
<table cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
<tr>
