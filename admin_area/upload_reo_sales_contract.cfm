...
<CFQUERY name="comp_info" datasource="#request.dsn#">
SELECT *
FROM companies
WHERE id = #get.comp_id#
</CFQUERY>

<cfquery name="check_eventlist" datasource="#request.dsn#">
SELECT * from eventlist
WHERE title_id = #URL.rec_id#
</cfquery>
<cfif check_eventlist.recordcount eq 0>
<cfquery name="insert_eventlist" datasource="#request.dsn#">
...
<cfif comp_info.streamline_client eq 'True'>
...
FROM="#from_email#"
SERVER="127.0.0.1"
Subject="#new_loan_number##get_file.paddress#, #get_file.pcity#, #get_file.pstate# #get_file.pzip#, #DateFormat(date_to_use, 'm/d/yyyy')#, REO Sales Contract for order #rec_id#"
TIMEOUT="600"
type="HTML"
>
...
View/Print REO Sales Contract <A HREF="#fileSys.FindFilePath('#get_file.reo_sales_contract#', 'url')#" target="new">#get_file.reo_sales_contract#</a> for order #rec_id#  - #get_id.bfirstname1# #get_id.blastname1#</B></font><br><br>
Thank you,<BR>
<cfif comp_info.streamline_client eq 'True'>
...
<CFQUERY datasource="#request.dsn#">
			...
			VALUES('#read_user.FName#', '#read_user.LName#', #URL.rec_id#, 'REO Sales Contract emailed to #email#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T', '1', '1')
</CFQUERY>
...
<table width=455 cellpadding=1 cellspacing=1 border=0>
		...
		<B>1st Title & Escrow, Inc. -REO Sales Contract File Upload for Order <CFOUTPUT query="get_id">#title_id#</CFOUTPUT></B>
		<p>
...
<FORM action="./upload_reo_sales_contract_final.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#"  ENCTYPE="multipart/form-data" method="post">

<input type="hidden" name="title_id" value="#title_id#">
Insert REO Sales Contract to upload <input type="file" size = 15 name="file_upload"><br>
