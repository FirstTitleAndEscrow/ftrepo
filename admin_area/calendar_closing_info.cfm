...
<TR><br>
<TD ALIGN=middle>
<FONT FACE=ARIAL COLOR="red" SIZE=4>Admin - Individual Closing</FONT><br><br>
<HR><CFOUTPUT>
...
<!--- <form action="./update_title_closing.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#" method="post">
...
<font color="Black" size="2"><b>Submitted: #DateFormat(aaaa.closing_date, "m/d/yyyy")# at #aaaa.s_time#</b></font>
		...
		<tr>
			...
			<td width="30%" align=center valign=top bgcolor=e1e1e1>
			 ...
			 <td width="70%" align=left valign=top bgcolor=e1e1e1>
<font color="Black" size="2"><b>Scheduled: #aaaa.c_month#/#aaaa.c_day#/#aaaa.c_year#</b></font>
<!--- <select name="confirm_mon">
	 	<Cfif #aaaa.recordcount# GT "0">
<option value="#aaaa.month#" selected>
...
<Cfif #aaaa.recordcount# GT "0">
<option value="#aaaa.day#" selected>
<cfelse>
...
<!--- <select name="confirm_year">
		<Cfif #aaaa.recordcount# GT "0">
<option value="#aaaa.year#" selected>#aaaa.year#
<cfelse>
...
<font color="Black" size="2"><b>Assigned: #TimeFormat(aaaa.c_time, "HH:mm:ss")#</b></font>

<!--- <SELECT name="confirm_time">
<Cfif #aaaa.recordcount# GT "0">
<option value="#aaaa.c_Time#" selected>
<cfelse>
