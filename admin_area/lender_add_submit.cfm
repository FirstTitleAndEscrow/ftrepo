...
<CFSET c_date = #DateFormat(Now(), "mm/dd/yyyy")#>
		...
		<CFQUERY datasource="#request.dsn#" >
			...
			INSERT INTO Lenders(tss_id, company, phone, fax, addr1, addr2, city, state, zip_code, email, insert_time, insert_date, a_note_1, a_comment)
			VALUES('#tss_id#', '#company#', '#phone#', '#fax#', '#addr1#', '#addr2#', '#city#', '#state#', '#zip#', '#email#', '#c_time#', '#c_date#', '#a_note_1#', '#a_comment#')
	...
	<CFLOOP FROM="1" TO="#ArrayLen(st_list)#" INDEX="AAA">
		...
		<CFQUERY datasource="#request.dsn#" >
			...
			VALUES(#Read_ID.Lender_ID#, '#st_list[AAA]#')
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>The Lender was added</B>
		</td>
	</tr>
</CFOUTPUT>	
