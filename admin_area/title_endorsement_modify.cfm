...
<CFFORM NAME="frm" ACTION="./title_endorsement_modify_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#&Endorse_id=#URL.Endorse_id#" METHOD=POST>
		<tr>
			<td width=408  align=left valign=top bgcolor=green>
				<font size=1 color=white face=verdana>
				The Endorsement shown below is the one you have chosen to modify. Make any changes you need to and then click on the submit button below.
			</td>
		</tr>
		<tr>
			<td width=408 align=left valign=top bgcolor=white>
				<TEXTAREA name="a_endorse_item"  COLS=76 ROWS=6
					style="font-size: 9; 
					font-family: verdana; 
					font-style: normal; 
					color: blue; 
					...
					border-width: thin; 
					border-style: bar; 
					clear: none;">#read_current_endorsements.endorse_item#</TEXTAREA>
