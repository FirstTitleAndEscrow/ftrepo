...
<table width=450 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
							<tr>
								...
								<td width=450 colspan=2  align=left valign=top bgcolor=f3f3f3>
								<INPUT TYPE="Text" NAME="Instructions"  MAXLENGTH=200  VALUE=""
									REQUIRED="No"
									style="font-size: 9;
									font-family: verdana;
									font-style: normal;
...
<A HREF="https://#cgi.server_name#/admin_area/uploads/#get_file.abstractor_doc_upload#" target="new">#Mid(get_file.abstractor_doc_upload, 1, 20)#<cfif Len(get_file.abstractor_doc_upload) GT 20>...</cfif></a><br>
...
<br>
	...
	<tr>
	<td align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>Uploaded file:<br>
<A HREF="https://#cgi.server_name#/admin_area/uploads/#get_file2.abstractor_doc_upload2#" target="new">#Mid(get_file2.abstractor_doc_upload2, 1, 20)#<cfif Len(get_file2.abstractor_doc_upload2) GT 20>...</cfif></a><br>
...
<br>
	...
	<tr>
	<td align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>Uploaded file:<br>
<A HREF="https://#cgi.server_name#/admin_area/uploads/#get_file3.abstractor_doc_upload3#" target="new">#Mid(get_file3.abstractor_doc_upload3, 1, 20)#<cfif Len(get_file3.abstractor_doc_upload3) GT 20>...</cfif></a><br>
