...
<table width=455 cellpadding=1 cellspacing=1 border=0>
		...
		<B>1st Title & Escrow, Inc. - File Upload for Order #<CFOUTPUT query="get_id">#anc_id#</CFOUTPUT></B>
		<p>
...
<FORM action="./upload_ancillary_final.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#&code=#URL.code#"  ENCTYPE="multipart/form-data" method="post">

<input type="hidden" name="anc_id" value="#anc_id#">
