...
SELECT seller_executed_deed_package
...
<table width=455 cellpadding=1 cellspacing=1 border=0>
		...
		<B>1st Title & Escrow, Inc. - Seller Executed Deed Package File Upload for Order <CFOUTPUT query="get_id">#title_id#</CFOUTPUT></B>
		<p>
...
<FORM action="./upload_seller_executed_deed_package_final.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#"  ENCTYPE="multipart/form-data" method="post">

<input type="hidden" name="title_id" value="#title_id#">
Insert Seller Executed Deed Package to upload <input type="file" size = 15 name="file_upload"><br>
