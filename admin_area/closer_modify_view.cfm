...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="Closer_modify_submit.cfm?uid=#URL.uid#&al=#URL.al#&Closer_ID=#Closer_ID#&a_state=#a_state#&vendor=#vendor#" name="frm">
	<tr>
		<td width=498 colspan=2 align=left valign=top bgcolor=e1e1e1>
			<NOBR><a href="vendor_coverage.cfm?uid=#URL.uid#&al=#URL.al#&a_trigger=1&a_state=#a_state#&vendors=#vendor#"><img src="./images/button_return.gif" border=0></a><img src="./images/clear.gif" height=10 width=85></NOBR>
		</td>
	</tr>
	<tr>
...
<CFIF #URL.UID# eq 19><!---Toronica Woods --->
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_delete.cfm?uid=#URL.uid#&al=#URL.al#&Closer_ID=#Closer_ID#&a_state=#a_state#&vendor=#vendor#">
		<tr>
			<td width=367 colspan=2 align=right valign=top bgcolor=e6e6e6>
				<NOBR><input type=image src="./images/button_delete.gif" border=0><img src="./images/clear.gif" height=10 width=40></NOBR>
			</td>
		</tr>
	</FORM>
</CFIF>
...
<CFELSE>
	...
	<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_countys_delete.cfm?uid=#URL.uid#&al=#URL.al#&Closer_ID=#Closer_ID#&a_state=#a_state#&vendor=#vendor#">
	</CFOUTPUT>
		...
		<tr>
			...
			<td width=150 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Closer_modify_countys_add.cfm?uid=#URL.uid#&al=#URL.al#&Closer_ID=#Closer_ID#&a_state=#a_state#&vendor=#vendor#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
