				...
				<table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
					<tr>
						<td width=200 bgcolor="f1f1f1" align=right valign=top>
							<FONT FACE=ARIAL SIZE=2 color=gray>Share Loan Payoff:</FONT>&nbsp;&nbsp;
					...
					<tr>
						...
						<td bgcolor="f1f1f1" align=left valign=top>
							<FONT FACE=verdana SIZE=1 color="blue"><select NAME="senior" style="font-size: 9;
									font-family: verdana;
									font-style: normal;
									color: 003F1E;
									background-color: E4E3E3;
									...
									border-style: bar;
									clear: none;">
<option value="Yes" <cfif read_title.senior eq 'Yes'>selected</cfif>>Yes</option>
<option value="No" <cfif read_title.senior eq 'No'>selected</cfif>>No</option>
							</select>
						</td>
					</tr>
				</table>
