...
<CFPARAM NAME="city_transfer_exempt" DEFAULT="">
	...
	<CFQUERY datasource="#request.dsn#">
		INSERT INTO recording_fees(state, county, city, mort_rec_fee, release_rec_fee, mort_stamps, stamps_diff, intangible_tax, transfer_tax, deedrecfees, state_transfer_tax, county_transfer_tax, city_transfer_tax, state_transfer_paidby, county_transfer_paidby, city_transfer_paidby, state_transfer_buyer_split, state_transfer_seller_split, state_transfer_exempt, county_transfer_buyer_split, county_transfer_seller_split, county_transfer_exempt, city_transfer_buyer_split, city_transfer_seller_split, city_transfer_exempt)
		VALUES('#state#', '#county#', '#city#', '#mort_rec_fee#', '#release_rec_fee#', '#mort_stamps#', '#stamps_diff#', '#intangible_tax#', '#transfer_tax#', '#deedrecfees#', '#state_transfer_tax#', '#county_transfer_tax#', '#city_transfer_tax#', '#state_transfer_paidby#', '#county_transfer_paidby#', '#city_transfer_paidby#', '#state_transfer_buyer_split#', '#state_transfer_seller_split#', '#state_transfer_exempt#', '#county_transfer_buyer_split#', '#county_transfer_seller_split#', '#county_transfer_exempt#', '#city_transfer_buyer_split#', '#city_transfer_seller_split#', '#city_transfer_exempt#')
...
<CENTER>
<table width=652 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	<tr>
