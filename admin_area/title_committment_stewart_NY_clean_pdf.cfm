...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left"><font color="black" size="1">NY-465  Rev. 8/92</font></td>
  </tr>
</table>
</cfdocumentitem >
...
.big_header {font-family:"Times New Roman", Times, serif; font-size:20pt}
.small_header {font-family:"Times New Roman", Times, serif; font-size:14pt}
.medium_header {font-family:"Times New Roman", Times, serif; font-size:18pt}
</style>
<center>
...
<br>
<br>
				<img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/stewart_NY_sigs.jpg">
			</td>		
		</tr>		
	</table>
	<center>
...
<style type="text/css">
td {font-family:"Times New Roman", Times, serif; font-size:10pt}
.big_header {font-family:"Times New Roman", Times, serif; font-size:28pt}
.small_header {font-family:"Times New Roman", Times, serif; font-size:18pt}
.medium_header {font-family:"Times New Roman", Times, serif; font-size:24pt}
</style>
...
.big_header {font-family:"Times New Roman", Times, serif; font-size:38pt}
.small_header {font-family:"Times New Roman", Times, serif; font-size:28pt}
.medium_header {font-family:"Times New Roman", Times, serif; font-size:34pt}
</style>
<cfoutput>
		...
		<table width="93%" cellpadding=1 cellspacing=1 border=0 >
			...
			<tr>
				...
				<td width="13%">#DateFormat(read_deed.data37, "mm/dd/yyyy")#</td>
			</tr>
			<tr>
				<td width="2%">&nbsp;</td>
...
<cfif read_title.title_id eq 52901>Elizabeth Warren<cfelseif read_title.title_id eq 52914>Julie Konik<cfelseif read_title.title_id eq 44863>Emilio R. Limchoa and Imelda T. Limchoa<cfelseif read_title.title_id eq 52794>The Village Cooperative Homes<cfelseif read_title.title_id eq 44894>Kindra McLeroy Pack, Barbara A. McLeroy and Wayne McLeroy by Barbara A. McLeroy, his heir.<cfelseif read_title.title_id eq 59179>Chang-Tai Hsieh and Sally Jo Hsieh<cfelseif read_title.title_id eq 57411>ALEXANDER MAKRIS<cfelseif read_title.comp_id eq 3943 or read_title.comp_id eq 4043 or read_title.comp_id eq 4042>#read_title.full_vesting#<cfelse>#read_title_data.data3#<cfif #read_title_data.data4# neq "">&nbsp;AND&nbsp;#read_title_data.data4#</cfif><cfif #read_title_data.data6# neq "">,&nbsp;#read_title_data.DATA6#</b></font></cfif></cfif>
			...
			<tr>
				<td width="2%">&nbsp;</td>
				<td width="25%">District: #read_deed.district#</td>
				<td width="60%">&nbsp;</td>
				<td width="13%">&nbsp;</td>
			</tr>
			...
			<tr>
				<td width="2%">&nbsp;</td>
				<td width="25%">Section: #read_deed.section#</td>
				<td width="60%">&nbsp;</td>
				<td width="13%">&nbsp;</td>
			</tr>
			<tr>
				<td width="2%">&nbsp;</td>
				<td width="25%">Block: #read_deed.block#</td>
				<td width="60%">&nbsp;</td>
				<td width="13%">&nbsp;</td>
			</tr>
			...
			<tr>
				<td width="2%">&nbsp;</td>
				<td width="25%">Lot: #read_deed.lot#</td>
				<td width="60%">&nbsp;</td>
				<td width="13%">&nbsp;</td>
			</tr>
