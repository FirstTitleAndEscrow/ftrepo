...
<cfset from_address = read_user.email>
	...
	<CFMAIL
TO="#email#"
FROM="#from_address#" Subject="First Title - Stewart Endorsement for order #rec_id#"
TIMEOUT="600"
type="HTML"
>

View/Print <A HREF="https://#cgi.server_name#/stend_client_view4.cfm?rec_id=#rec_id#" target="new">Stewart Endorsement</a> for order #rec_id#</B></font><br><br>
...
<CFLOCATION URL="https://#cgi.server_name#/admin_area/stend_view4.cfm?rec_id=#rec_id#&a_trigger=2">
