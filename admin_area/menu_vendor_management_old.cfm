...
<cfif session.ft_user_id EQ 472 or session.ft_user_id EQ 390 or session.ft_user_id EQ 548 or session.ft_user_id EQ 555 or session.ft_user_id EQ 495 or session.ft_user_id EQ 549 or session.ft_user_id EQ 542 or session.ft_user_id EQ 611>
<li><a href="team_stats.cfm" target="_new">Team Stats</a>
</li>
</cfif>


<cfif session.ft_user_id EQ 472 or session.ft_user_id EQ 390 or session.ft_user_id EQ 548 or session.ft_user_id EQ 555>
VRM REPORTS<br>
...
<cfif session.ft_user_id EQ 472>
...
<cfif read_user.streamline_employee eq 'True' or session.ft_user_id eq 472>
...
<cfif get_current_user.ID eq 318 or get_current_user.ID eq 472 or get_current_user.ID eq 9 or get_current_user.ID eq 362 or get_current_user.ID eq 449 or get_current_user.ID eq 417 or get_current_user.ID eq 469 or get_current_user.ID eq 407 or get_current_user.ID eq 468 or get_current_user.ID eq 384 or get_current_user.ID eq 374 or get_current_user.ID eq 555>
...
<cfif get_current_user.id eq 9 or get_current_user.id eq 479 or get_current_user.id eq 472>
<li><a href="reports_subordination_needed.cfm?uid=#URL.uid#&al=#URL.al#" target="subordinations">Subordination Needed</a></li>
</cfif>
<cfif get_current_user.id eq 9 or get_current_user.id eq 472 or get_current_user.id eq 555 or get_current_user.id eq 563>
...
<cfif get_current_user.ID eq 472 or get_current_user.ID eq 555>
...
<cfif session.ft_user_id eq 472 or  session.ft_user_id eq 367 or  session.ft_user_id eq 322>
<li><a href="reports_internal_processor.cfm" target="_new">Internal Processor Report</a></li> 
</cfif>
<cfif session.ft_user_id eq 472 or  session.ft_user_id eq 577 or  session.ft_user_id eq 536>
