...
select abstract_upload1 from doc_abstract_prop where prop_id = #url.rec_id#
</cfquery>
...
<cfoutput>
<A HREF="#fileSys.FindFilePath('#get_file.abstract_upload1#', 'url')#" target="new">Click to View/PrintAbstractor upload-1</a><BR>
