...
<style>
.latest_Notes { table-layout: fixed;  word-wrap: keep-all; text-wrap:unrestricted; white-space:pre-wrap; }
</style>
</head>
...
<CFOUTPUT QUERY="Read_all_notes">
									<table class="latest_Notes" width=650 cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
										<tr>
											...
											<td class="latest_Notes" width=444 align=left valign=top bgcolor=e1e1e1>
						...
						<td  width=300 align=left valign=top bgcolor=f1f1f1>
							...
							<input type="text"  NAME="on_hold_removed_reason" ID="on_hold_removed_reason" style="font-size: 9;
									...
									clear: none; width:200px;">
												...
												<TEXTAREA id="NotesBox" name="N_Note_1" onClick="insertAtCaret('NotesBox','<br>');" onFocus=cant_edit(this)  COLS=80 ROWS=5
												style="font-size: 9; 
												font-family: verdana; 
												font-style: normal; 
												color: blue; 
