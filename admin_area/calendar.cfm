...
<cfquery datasource="#request.dsn#" name="getEventList" maxrows="1">
...
<cfquery datasource="#request.dsn#" name="getEventList_IntProcessor" maxrows="1">
select e.*, c.master_co_id, t.order_date, c.id 
From EventList e, Companies c, Title t 
where yearmonth = '#f#' 
AND 
...
<cfquery datasource="#request.dsn#" name="getEventList2" maxrows="1">
...
<cfquery datasource="#request.dsn#" name="getEventList2_IntProcessor" maxrows="1">
