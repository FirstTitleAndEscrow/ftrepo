...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<tr>
		...
		<td width=498 align=left valign=top bgcolor=e1e1e1>
			...
			From the pulldown below, pick the First Title Agency that you want to
			modify
			<p>
		</td>
	</tr>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Title_FT_Agency_modify_view.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
	<tr>

		<td width=498 colspan=2 align=left valign=top bgcolor=e1e1e1>
			<FORM><SELECT NAME="Title_FT_Agency_ID"
			size="1"
			style="font-size: 9;
			font-family: verdana;
			font-style: normal;
			...
			rows="5"
			cols="45"
			><CFOUTPUT QUERY="read_title_co"><OPTION VALUE="#Title_FT_Agency_ID#">#Company# </OPTION></CFOUTPUT>
			</SELECT>
