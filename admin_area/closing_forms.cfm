...
<p>RESPONSIBILITY FOR PAYMENT OF FEES.  As part of the obligation of the Borrower(s) to pay expenses of the Lender in connection with the preparation of the legal documentation, the Borrower(s) agree(s) to pay, directly to First Title & Escrow, Inc., at Loan closing, the amount indicated on the Settlement Statement (HUD-1).</p>

<p>BASIS FOR FEES.  The Borrower(s) acknowledge that of the fee collected for the closing on line 1101 of the HUD Settlement Statement, a portion of it may be shared with an attorney who may have attended your settlement (that was licensed to practice law in the state in which your property is located).   The document preparation fee charged by First Title & Escrow, Inc., is based a per transaction charge rather than an hourly fee.  This fee is intended to provide fair compensation for the above-described services taking into consideration the time and labor required, the complexities of the questions involved, and the skill required to perform said services.  Other considerations include the expertise of First Title & Escrow, Inc., in the complexities of the real estate practice, the necessary overhead associated with the rendering of the said services and the assumption of risk by First Title & Escrow, Inc., in the rendering of said services.  There has been no charge made for any disclosures required by the Real Estate Settlement and Procedures Act and/or Truth-In-Lending Act.</p>
