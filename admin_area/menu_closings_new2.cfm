...
<CFQUERY NAME="get_all_titles" datasource="#request.dsn#" maxrows="5000">
			Select t.title_id, c.company, t.order_date, t.cancelled, t.appraisal_status, d.clear_close, t.check_date, t.check_time, d.a_recieved_time, d.a_recieved_date, e.title_id, f.title_id, g.title_id
			from Title t, Companies c, doc_title_insurance_title d, tax_cert_title e, doc_abstract_title f, pay_off_lender_1_title g
			<CFINCLUDE TEMPLATE="./includes/companies_list.cfm">
			where t.comp_id IN(#companylist#)
			and c.ID = t.comp_ID
			and d.title_ID = t.title_ID
			and e.title_ID = t.title_ID
			and f.title_ID = t.title_ID
			...
			and (t.order_date between '2007-08-01 00:00:00'  AND '#DateFormat(Now(), "yyyy-mm-dd")# 00:00:00')
			order by t.order_date
</CFQUERY>

<cfdump var="#get_all_titles#">
<cfabort>



<CFQUERY NAME="read_Closer_Not_Assigned" datasource="#request.dsn#" cachedwithin="#CreateTimeSpan(0, 0, 0, cache_reset)#">
			Select *
...
<CFQUERY datasource="#request.dsn#" NAME="read_Closer_Assigned_Not_Received" cachedwithin="#CreateTimeSpan(0, 0, 0, cache_reset)#">
...
<CFQUERY datasource="#request.dsn#" NAME="read_Todays_Closings" cachedwithin="#CreateTimeSpan(0, 0, 0, cache_reset)#">
...
<CFQUERY datasource="#request.dsn#" NAME="payoffs_read_report" cachedwithin="#CreateTimeSpan(0, 0, 0, cache_reset)#">
			SELECT *
...
<CFQUERY datasource="#request.dsn#" NAME="icls_read_report" cachedwithin="#CreateTimeSpan(0, 0, 0, cache_reset)#">
SELECT *
			FROM Title a, doc_title_insurance_title d, tax_cert_title e, doc_abstract_title f, pay_off_lender_1_title g
			WHERE a.title_id = d.title_id and a.title_id = e.title_id and a.title_id = f.title_id and a.title_id = g.title_id
...
<CFQUERY datasource="#request.dsn#" NAME="not_clear_to_close_read_report" cachedwithin="#CreateTimeSpan(0, 0, 0, cache_reset)#">
SELECT *
			FROM Title a, doc_title_insurance_title d, tax_cert_title e, doc_abstract_title f, pay_off_lender_1_title g
			WHERE a.title_id = d.title_id and a.title_id = e.title_id and a.title_id = f.title_id and a.title_id = g.title_id
...
<CFQUERY datasource="#request.dsn#" NAME="loan_funded_not_closed_read_report" cachedwithin="#CreateTimeSpan(0, 0, 0, cache_reset)#">
SELECT *
