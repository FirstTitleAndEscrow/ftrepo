...
<cfoutput>
<FORM action="./Title_committment_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#company_ID#&a_trigger=7&Im_A_Vendor=#Im_A_Vendor#"  ENCTYPE="multipart/form-data" method="post">
</cfoutput>
<tr>
...
<CFINCLUDE TEMPLATE="../title_committment_view_north_american.cfm">
