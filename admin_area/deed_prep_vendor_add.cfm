...
message = message + "In order to add a new Deed Prep Vendor you need to choose county(ies)/state(s) the Deed Prep Vendor serves\n"
valid = false;
}
if (valid == false) {
alert(message);
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Add Deed Preparation Vendor </B>
		</td>
	</tr>
</CFOUTPUT>	
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<CFFORM METHOD=POST ACTION="deed_prep_vendor_add_submit.cfm?uid=#URL.uid#&al=#URL.al#" name="frm">
...
<tr>		
	...
	<tr>		
		<td width=468 colspan=2 align=center valign=top bgcolor=e6e6e6>	
			...
			Select County and State Deed Prep Vendor is going to serve
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	<tr>		
		...
		<td width=497 align=center valign=top bgcolor=e1e1e1>	
			...
			Review the list below to ensure the Deed Prep Vendor isn't already in the Database
