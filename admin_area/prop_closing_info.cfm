...
select *
from Property
where prop_id = #getorderinfo.prop_id#
</cfquery>
...
<cfform name = "frm" action="./update_prop_closing.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&comp_id=#read_title.comp_ID#" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
...
<input type="hidden" name="prop_id" value="#getorderinfo.prop_id#">
