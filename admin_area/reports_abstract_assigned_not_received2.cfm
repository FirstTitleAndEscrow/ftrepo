...
<CFQUERY datasource="#request.dsn#" NAME="read_Abstract_Assigned_Not_Received">
			...
			SELECT DISTINCT
                      ...
                      First_Admin_1.fname AS Abstractor, First_Admin_3.fname AS AbstractorIH, dbo.Title.SearchType, dbo.Title.pstate, dbo.Companies.fairfax_client, dbo.Companies.streamline_client
...
WHERE     (dbo.Title.cancelled IS NULL) AND (dbo.Companies.company <> 'test - ABC Mortgage') AND (CAST(dbo.Title.a_insert_date AS smalldatetime)
                      ...
                      (dbo.Title.appraisal_status <> 'Report E-mailed') AND (dbo.Title.appraisal_status <> 'Loan Closed') AND (dbo.Title.appraisal_status <> 'Loan Funded') AND (dbo.Title.appraisal_status <> 'Awaiting Contract')
...
SELECT DISTINCT
                      ...
                      First_Admin_1.fname AS Abstractor, First_Admin_3.fname AS AbstractorIH, dbo.Property.SearchType, dbo.Property.pstate, dbo.Companies.fairfax_client, dbo.Companies.streamline_client
...
WHERE     (dbo.Doc_Abstract_Prop.a_Date_Assigned IS NOT NULL) AND (dbo.Companies.company <> 'test - ABC Mortgage') AND
...
<cfdump var="#read_Abstract_Assigned_Not_Received#">
<cfabort>
</cfif>
 --->
...
<cfif read_Abstract_Assigned_Not_Received.letter eq "T">
	...
	<cfset prefix = 'ST'>
	<cfelseif read_Abstract_Assigned_Not_Received.fairfax_client eq 1>
	<cfset prefix = 'T(R)'>
	<cfelseif read_Abstract_Assigned_Not_Received.tx_client eq 1 or read_Abstract_Assigned_Not_Received.state eq 'TX'>
	<cfset prefix = 'T(TX)'>
	<cfelse>
	<cfset prefix = 'T'>
	</cfif>
...
<cfif get_tc_sent_info.s_status neq 1 and (get_ab_info.abstractor_doc_upload3 eq '' or get_ab_info.abstractor_doc_upload3 eq 'NULL')>
		<tr  >
			...
			<CFIF #Letter# eq "T">
					...
					<CFIF #read_taxes.recordcount# gte 1><td bgcolor="#a_bgcolor#" align="center"><b><a href="./update_vendor_management_taxes_title.cfm?company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#id#&a_trigger=1" target="_parent"><font size=1 color=Green face=verdana>#taxes#</font></a></b></td><cfelse><td>&nbsp;</td>
					</CFIF>
				<CFELSE>
					<CFQUERY datasource="#request.dsn#" NAME="read_taxes">
						SELECT     payoff_ID, payoff_Start_Datetime, payoff_Finish_Datetime, Title_ID
					...
					<CFIF #read_taxes.recordcount# gte 1><td bgcolor="#a_bgcolor#" align="center"><b><a href="./update_vendor_management_taxes_prop.cfm?company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#id#&a_trigger=1" target="_parent"><font size=1 color=Green face=verdana>#taxes#</font></a></b></td><cfelse><td>&nbsp;</td>
					</CFIF>
				</CFIF>
