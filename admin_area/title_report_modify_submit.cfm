...
<CFPARAM NAME="read_title.closingInsight_transactionID" DEFAULT="">
<CFPARAM NAME="read_title.loanamt_float" DEFAULT="0">
<CFPARAM NAME="form.title_grade" DEFAULT="">
<CFPARAM NAME="form.title_grade_document" DEFAULT="">
<CFPARAM NAME="form.parcel" DEFAULT="">
<CFPARAM NAME="form.lot" DEFAULT="">
<CFPARAM NAME="form.file_upload" DEFAULT="">
<CFPARAM NAME="form.cema" DEFAULT="0">
<CFPARAM NAME="form.loan_off" DEFAULT="">
<CFPARAM NAME="form.assessed_value" DEFAULT="">
<CFPARAM NAME="form.loan_procs" DEFAULT="">
<CFPARAM NAME="form.change_loan_officer" DEFAULT="0">
<CFPARAM NAME="form.change_loan_processor" DEFAULT="0">
<CFPARAM NAME="form.change_seller_rep" DEFAULT="0">
<CFPARAM NAME="form.seller_rep" DEFAULT="3">
...
<cfparam name="form.vesting_override" default="">
...
<cfparam name="form.subordination" default="">
...
<cfparam name="form.opt_tx_2" default="0">
<cfparam name="form.opt_tx_3" default="0">
<cfparam name="form.opt_tx_4" default="0">
<cfparam name="form.opt_tx_5" default="0">
...
<cfparam name="form.disposition_type" default="">
<cfparam name="form.responsibleparty_rollover" default="">
<cfparam name="form.rolloverexplanation_rollover" default="">
<cfparam name="form.responsibleparty_exception" default="">
<cfparam name="form.rolloverexplanation_exception" default="">
...
<cfparam name="form.mortgage_insurance" default="">
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="find_rec">
			insert into Doc_Title_Insurance_Title (title_id) values (#rec_id#)
</CFQUERY>
</cfif>
...
<CFLOCATION URL="https://#cgi.server_name#/admin_area/title_report_modify.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#">
</cfif>
...
<cfif form.change_seller_rep eq 1>


<CFQUERY DATASOURCE="#request.dsn#" NAME="update_seller_rep">
			UPDATE Title
			set
			seller_rep = '#form.seller_rep#'
			WHERE title_ID = #rec_id#
...
<CFPARAM NAME="form.closingInsight_transactionID" DEFAULT="">
<CFPARAM NAME="form.title_grade" DEFAULT="">
<CFPARAM NAME="form.title_grade_document" DEFAULT="">
<CFPARAM NAME="form.parcel" DEFAULT="">
<CFPARAM NAME="form.lot" DEFAULT="">
...
<CFPARAM NAME="form.title_committment" DEFAULT="16">
...
<CFPARAM NAME="revenue" DEFAULT="">
<CFPARAM NAME="run_loan_funded" DEFAULT="0">
...
<cfparam name="form.same_lender" default=1>
<cfparam name="form.reo_number" default="">
...
<cfif IsDefined("form.pstate") and (read_comp.alta_8_1 eq 1)>
<cfset form.opt_alta_8_1 = 1>
</cfif>
<cfif IsDefined("form.pstate") and (read_comp.alta_9 eq 1)>
<cfset form.opt_alta_9 = 1>
</cfif>

<cfif IsDefined("pstate") and (read_comp.alta_8_1 eq 1)>
<cfset opt_alta_8_1 = 1>
</cfif>
<cfif IsDefined("pstate") and (read_comp.alta_9 eq 1)>
<cfset opt_alta_9 = 1>
</cfif>
...
update Title set title_grade_document = '#FILE.ServerFile#'
WHERE title_id = #rec_ID#
</cfquery>
		...
		<cfif lookup_transaction.recordcount and Len(lookup_transaction.equator_title_transactionID)>
		<cfinvoke	component = "cfc.equator"	method = "sendTitleGrade" transactionID="#lookup_transaction.equator_title_transactionID#">
		</cfif>
...
<CFPARAM NAME="read_title1.loanamt_float" DEFAULT="0">

<cfparam name="client_id" default="#read_title1.comp_id#">

<cfif Len(form.oda_month) and Len(form.oda_day) and Len(form.oda_year)>
<CFSET duedate = #oda_month# & "/" & #oda_day# & "/" & #oda_year# >
<cfelse>
<CFSET duedate = #read_title1.duedate# >
</cfif>
...
<cfif #read_title1.loanamt_float# EQ #loanamt_float#>
	...
	<cfquery  DATASOURCE="#request.dsn#">
		...
		pzip = '#pzip#',
			...
			loanType = '#loanType#',
			loanamt_float = '#ReplaceNoCase(loanamt_float, ",", "", "ALL")#',
			Purchase = '#Purchase#',
			...
			disposition_type = '#form.disposition_type#',
			responsibleparty_rollover = '#form.responsibleparty_rollover#',
			rolloverexplanation_rollover = '#form.rolloverexplanation_rollover#',
			responsibleparty_exception = '#form.responsibleparty_exception#',
			rolloverexplanation_exception = '#form.rolloverexplanation_exception#',
			...
			prev_purch_month = '#form.previous_purch_month#',
			prev_purch_year = '#form.previous_purch_year#',
...
share_loan_payoff = '#share_loan_payoff#',
...
prop_tax = '#prop_tax#',
same_lender = '#form.same_lender#',
seller_paid_owner_policy = '#form.seller_paid_owner_policy#',
seller_paid_lender_policy = '#form.seller_paid_lender_policy#',
full_vesting = '#form.full_vesting#',
vesting_override = '#form.vesting_override#',
...
transfer_tax_paid_by = '#form.transfer_tax_paid_by#',
opt_alta_4 = '#form.opt_alta_4#',
opt_alta_4_1 = '#form.opt_alta_4_1#',
opt_alta_5 = '#form.opt_alta_5#',
opt_alta_5_1 = '#form.opt_alta_5_1#',
opt_alta_6 = '#form.opt_alta_6#',
opt_alta_6_1 = '#form.opt_alta_6_1#',
opt_alta_6_2 = '#form.opt_alta_6_2#',
opt_alta_7 = '#form.opt_alta_7#',
opt_alta_8_1 = '#form.opt_alta_8_1#',
opt_alta_9 = '#form.opt_alta_9#',
opt_tx_1 = '#form.opt_tx_1#',
opt_tx_2 = '#form.opt_tx_2#',
opt_tx_3 = '#form.opt_tx_3#',
opt_tx_4 = '#form.opt_tx_4#',
opt_tx_5 = '#form.opt_tx_5#',
opt_tx_6 = '#form.opt_tx_6#',
opt_tx_7 = '#form.opt_tx_7#',
opt_tx_8 = '#form.opt_tx_8#',
opt_tx_9 = '#form.opt_tx_9#',
opt_tx_10 = '#form.opt_tx_10#',
opt_tx_11 = '#form.opt_tx_11#',
opt_tx_12 = '#form.opt_tx_12#',
opt_tx_13 = '#form.opt_tx_13#',
opt_tx_14 = '#form.opt_tx_14#',
opt_ut_4 = '#form.opt_ut_4#',
opt_ut_41 = '#form.opt_ut_41#',
opt_ut_5 = '#form.opt_ut_5#',
opt_ut_51 = '#form.opt_ut_51#',
opt_ut_6 = '#form.opt_ut_6#',
opt_ut_61 = '#form.opt_ut_61#',
opt_ut_62 = '#form.opt_ut_62#',
opt_ut_81 = '#form.opt_ut_81#',
opt_ut_9 = '#form.opt_ut_9#',
opt_sd_comp = '#form.opt_sd_comp#',
opt_sd_balloon = '#form.opt_sd_balloon#',
opt_sd_credit = '#form.opt_sd_credit#',
opt_sd_7 = '#form.opt_sd_7#',
opt_sd_6 = '#form.opt_sd_6#',
opt_sd_4 = '#form.opt_sd_4#',
opt_sd_5 = '#form.opt_sd_5#',
opt_sd_9 = '#form.opt_sd_9#',
opt_sd_8 = '#form.opt_sd_8#',
cema = #form.cema#,
...
closingInsight_TransactionID = '#form.closingInsight_TransactionID#'
WHERE title_id = #rec_id#
			</cfquery>
...
<!--- <CFIF #read_title.SearchType# EQ "Refinance">
 ...
 --->
		...
		<CFELSE>
				<CFIF #read_rec_fees.recordcount# gt "0">
					<CFIF #read_rec_fees.mort_stamps# NEQ "0" and #read_rec_fees.mort_stamps# NEQ "">
							<CFSET state_mort_stamps = "0">
							<CFSET city_mort_stamps = #round(read_title.loanamt_float)# * #read_rec_fees.mort_stamps#>
...
<cfif read_title1.comp_id neq 3889>
<cfmailparam
		file = "c:\huds\HUD_#read_title1.title_id#.pdf"
		disposition="attachment; filename=""c:\huds\HUD_#read_title1.title_id#.pdf""">  
</cfif>   
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>YOU HAVE BEEN INVITED TO VIEW TITLE INFORMATION AS ORDERED ON THE FIRST TITLE WEB SYSTEM</B></center><br><p>
				...
				<cfif read_title1.comp_id neq 3889>
<center>A HUD-1 has been instantly prepared for you and is attached to this email! OR view<a href="https://#cgi.server_name#/fee_sheet.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#read_title1.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>closing fees</b></a>.</center></cfif><br>
...
<cfset same_lender_change = 0>
<cfset update_this_title_id = rec_id>
<cfif read_title1.same_lender neq form.same_lender>
<cfset same_lender_change = 1>
<cfelse>
<cfset same_lender_change = 0>
</cfif>
...
<cfif run_loan_funded eq 1>
<cfinclude template="loan_funded_code.cfm">
<cfinclude template="send_loan_funded_emails.cfm">
</cfif>

<cfif read_title1.comp_id neq client_id>
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_uder_info">
		SELECT *
		FROM First_Admin
		WHERE ID = #session.ft_user_id#
	</CFQUERY>
<CFQUERY DATASOURCE="#request.dsn#" NAME="get_old_company">
		SELECT *
		FROM companies
		WHERE ID = #read_title1.comp_id#
	</CFQUERY>
<CFQUERY DATASOURCE="#request.dsn#" NAME="get_new_company">
		SELECT *
		FROM companies
		WHERE ID = #client_id#
	</CFQUERY>
<CFQUERY DATASOURCE="#request.dsn#" NAME="reassigned_data">
		update title
		set reassigned_date = #CreateODBCDateTime(Now())#,
		reassigned_to = #client_id#,
		reassigned_from = #read_title1.comp_id#
		WHERE title_ID = #rec_id#
	</CFQUERY>
<CFQUERY DATASOURCE="#request.dsn#">
						INSERT INTO Title_Notes(FName, LName, Order_ID, N_Note, N_Date, N_Time, note_type)
						VALUES('#read_uder_info.FName#', '#read_uder_info.LName#', #rec_id#, 'File was reassigned from client: #get_old_Company.company# (#get_old_Company.ID#) to client: #get_new_company.company# (#get_new_company.ID#)', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T')
					</CFQUERY>
<cfinclude template="send_file_reassigned_emails.cfm">
</cfif>
