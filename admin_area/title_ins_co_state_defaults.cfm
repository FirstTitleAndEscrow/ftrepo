...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<tr>
		...
		<td width=498 align=left valign=top bgcolor=e1e1e1>
			...
			From the pulldown below, pick the Title Insurance Company that you want to
			modify
			<p>
		</td>
	</tr>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Title_Ins_Co_modify_view.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
	<tr>

		<td width=498 colspan=2 align=left valign=top bgcolor=e1e1e1>
			<FORM><SELECT NAME="title_co_id"
			size="1"
			style="font-size: 9;
			font-family: verdana;
			font-style: normal;
			...
			rows="5"
			cols="45"
			><CFOUTPUT QUERY="read_title_co"><OPTION VALUE="#title_co_id#">#Company# </OPTION></CFOUTPUT>
			</SELECT>
