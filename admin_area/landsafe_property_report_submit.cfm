...
<cfinclude template="../includes/landsafe_prop_report_create_pdf.cfm">
...
type="HTML"
>
<cfmailparam file="c:\uploads\P-#rec_id#_REPORT.pdf">
...
<cfFORM NAME="Search" METHOD="Post" ACTION="./landsafe_property_report_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=21&company_ID=#read_Title.comp_id#">
...
<cfif Len(Mortgage_count.notes)>
    <tr>
        <td width="20%"><u><strong>COMMENTS</strong></u>:</td>
        <td colspan="3">#Mortgage_count.notes#</td>
    </tr>
</cfif>
...
<tr>
<td>
<cfinclude template="../title_committment_tax_box_landsafe_prop.cfm">
</td>
       </tr>
</table>             
</cfoutput>
...
<tr><td><hr></td></tr>
			...
			<cfif #read_title_update.addex# neq "">
			<tr>
		  <td width="5%" valign="top">&nbsp;</td>

		</tr><tr>
          <td ALIGN = "left"><p><B><u>NOTES</u></p></B><br></td>
        </tr>
        <tr>
          <td align = "left"><p><B><cfoutput>
			#read_title_update.addex#
		</cfoutput>
		 </b></td>
        </tr></cfif>
