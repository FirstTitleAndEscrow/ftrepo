...
<CFIF #a_trigger# EQ "1">
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_Prop_Appraisal">
			...
			UPDATE Appraisal_Doc_Prop
			SET Appraiser_ID = #Appraiser_ID_new#,
			a_Assigned_by = #uid#,
...
<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
		...
		<tr>
			<td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3>
				...
				use the pulldown below to select another Appraiser to assign to this Appraisal.
			</td>
		</tr>		
</CFOUTPUT>

<CFFORM NAME="frm" ACTION="./Prop_Appraisal_doc_assign.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#" METHOD=POST>
...
<CFFORM NAME="frm" ACTION="./Prop_Appraisal_doc_assign.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#" METHOD=POST>
		<tr>
			<td width=519 colspan=2  align=right valign=top bgcolor=f3f3f3>
...
<CFOUTPUT>
	...
	<tr>		
		...
		<td width=368 align=left valign=top bgcolor=e6e6e6>	
			<font size=2 color=blue face=arial>
				<B>#read_Prop.bfirstname1# #read_Prop.bminame1# #read_Prop.blastname1#</B><br>
				<B>#read_Prop.bfirstname2# #read_Prop.bminame2# #read_Prop.blastname2#</B>
		</td>
	</tr>
				...
				<table width=518 cellpadding=1 cellspacing=1 border=0>
					...
					<tr>
						<td width=517 colspan=5 align=right valign=top>
							<font size=2 color=blue face=arial>
							<CFIF #read_Prop.estimate_value# GT "">
							Estimated Property Value is.... <font size=2 color=blue face=arial>
							<B>$ #NumberFormat(read_Prop.estimate_value, "999,999,999.99")#</B></CFIF>
						</td>
					</tr>
