		...
		<!--- <cfquery  datasource="#request.dsn#">
			INSERT INTO
				PROPERTY (type,dateandtime, hud_type, loanamt_float, hud, loan_number, check_date, check_time, user_id, comp_id, loan_off_id, oname, ophone, oext, ofax, o_email, pname,
						...
						rptbyemail, a_insert_date, a_insert_time, duedate,  order_date_adjusted, oda_day, oda_month, oda_year, oda_day_of_year, appraisal_status, a_day, a_month, a_year, a_day_of_year, polender1, poacctno1, pophone1, polender2, poacctno2, pophone2, order_status, prop_use_type, codeP,company1,company2,taxID1,taxID2,search_type)
				VALUES ('P','#order_date#', '#hud_type#', '#loanamt_float#', '#hud#', '#loan_number#', '#DateFormat(Now(), "mm-dd-yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', #user_id_1#, #RU.comp_id#,	#lo_id#, '#rlo_name#', '#RLO.lo_phone#',
						...
						'#order_date_adj#', #a_day_1#, #a_month_1#, #a_year_1#, #oda_day_of_year_1#, '#app_stat#', #a_day_1#, #a_month_1#, #a_year_1#,	#a_day_of_year_1#, '#polender1#', '#poacctno1#', '#pophone1#', '#polender2#', '#poacctno2#', '#pophone2#', 1, '#prop_use_type#', 'P','#trim(company1)#','#trim(company2)#','#trim(taxID1)#','#trim(taxID2)#','#trim(search_type)#')
						</cfquery> --->
			<cfquery  datasource="#request.dsn#">
	INSERT INTO
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				...
				<cfif #get_propid.hud# eq 1><cfif get_propid.comp_id neq 3889>
<center>A HUD-1 has been
instantly prepared for you! Click <a href="./prop_view_hud_pg1.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="/images/button_est_hud_1.gif"></a> now.</center><br></cfif></CFIF>
...
<CFLOCATION URL="https://#cgi.server_name#/admin_area/order_verify_display_title.cfm?emp=#emp#&comp_id=#comp_id#&prop_id=#prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#">
</cfif>
