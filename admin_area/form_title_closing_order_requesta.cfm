...
<CFQUERY datasource="#request.dsn#">		
	INSERT INTO Title_Notes(FName, LName, Order_ID, N_Note, N_Date, N_Time, note_type, access, access2)
				VALUES('#get_user.fname#', '#get_user.lname#', #rec_id#, 'Closing request received by client', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T', '1', '1')		
</CFQUERY>
...
<cfif getorderinfo.a_req_closing_year eq 'NULL' or getorderinfo.a_req_closing_year eq ''>
<cfset getorderinfo.a_req_closing_year = DateFormat(Now(), 'yyyy')>
</cfif>
...
<P><cfif url.cancelled eq 1><font color="red">This request has been cancelled<br>
<br>
</font></cfif>
...
<CFFORM NAME="frm" ACTION="./form_title_closing_request_reciept_admin.cfm?uid=#url.uid#&rec_id=#rec_id#&a_trigger=1&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=2" METHOD=POST>
<CFOUTPUT>
...
size="1" 
								...
								rows="5" 
								cols="45">
	 	<cfif #getorderinfo.contract_busted_date# NEQ "" and  #getorderinfo.contract_busted_date# NEQ "NULL">
...
size="1" 
		...
		<cfelse>
		<option value="#DateFormat(Now(), 'yyyy')#">#DateFormat(Now(), 'yyyy')#</option>
		</cfif>
	   	<option value="2000">2000</option>
		<option value="2001">2001</option>
		<option value="2002">2002</option>
...
<option value="2020">2020</option>
	...
	<table width=699 cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
		...
		<option value="#getorderinfo.A_How_Will_Be_Shipped#">#getorderinfo.A_How_Will_Be_Shipped#</option>
		</cfif>
		<option value="email">Email</option>
		<option value="internet">Website Delivery</option>
		...
		<option value="other">Other</option>
			...
			<tr>
	<td width="268" align="right">Are you the lender?</td>
	<td width="410"><input type="radio" name="is_lender" id="is_lender" value="1" <cfif getorderinfo.is_lender eq 1>checked</cfif>> Yes&nbsp;&nbsp;&nbsp;<input type="radio" name="is_lender" id="is_lender" value="0" <cfif getorderinfo.is_lender eq 0>checked</cfif>>No</td>
	</tr>
	<tr>
	<td colspan="2">If you are the Broker on this loan, please provide the following:</td>
	</tr>
	<tr>
	<td align="right">Lender Name - </td>
	<td><input type="text" name="lender_name" id="lender_name" size="15" value="#getorderinfo.lender_name#"></td>
	</tr>
	<tr>
	<td align="right">Lender Contact Name - </td>
	<td><input type="text" name="lender_contact_name" id="lender_contact_name" size="15" value="#getorderinfo.lender_contact_name#"></td>
	</tr>
	<tr>
	<td align="right">Phone Number - </td>
	<td><input type="text" name="lender_phone" id="lender_phone" size="15" value="#getorderinfo.lender_phone#"></td>
	</tr>
	<tr>
	<td align="right">Loan Number or Reference Number - </td>
	<td><input type="text" name="ref_number" id="ref_number" size="15" value="#getorderinfo.ref_number#"></td>
	</tr>
	...
	<table width=699 cellpadding=1 cellspacing=1 border=0 bgcolor=e1e1e1>
		<tr>
			<td width=699 align=right valign=top bgcolor=e1e1e1>
			<input type="hidden" name="cancel_it" value=0>
				<cfif getorderinfo.recordcount><input type="submit" name="cancel_closing" value="Cancel This Closing Request" style="background-color:##FF9966;" onClick="cancel_it=1;"></cfif> &nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=image src="./images/button_submit.gif" border=0>
			</td>
		</tr>
	</table>
</CFOUTPUT>
