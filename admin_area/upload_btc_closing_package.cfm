...
SELECT btc_closing_package_upload
FROM title
...
SERVER="127.0.0.1"
Subject="First Title - BTC Closing Package received for order #rec_id# - #get_id.bfirstname1# #get_id.blastname1#<cfif #get.loan_number# neq "">, Loan No. - #get.loan_number#</cfif>"
TIMEOUT="600"
type="HTML"
>

View/Print BTC Closing Package <A HREF="#fileSys.FindFilePath('#get_file.btc_closing_package_upload#', 'url')#" target="new">#get_file.btc_closing_package_upload#</a> for order #rec_id#  - #get_id.bfirstname1# #get_id.blastname1#</B></font><br><br>
...
<table width=455 cellpadding=1 cellspacing=1 border=0>
		...
		<B>1st Title & Escrow, Inc. -BTC Closing Package File Upload for Order <CFOUTPUT query="get_id">#title_id#</CFOUTPUT></B>
		<p>
...
<FORM action="upload_btc_closing_package_final.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#"  ENCTYPE="multipart/form-data" method="post">

<input type="hidden" name="title_id" value="#title_id#">
Insert BTC Closing Package to upload <input type="file" size = 15 name="file_upload"><br>
