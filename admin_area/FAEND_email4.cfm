...
<cfset from_address = read_user.email>
	...
	<CFMAIL
TO="#email#"
FROM="#from_address#" Subject="First Title - First American Endorsement for order #rec_id#"
TIMEOUT="600"
type="HTML"
>

View/Print <A HREF="https://#cgi.server_name#/faend_client_view4.cfm?rec_id=#rec_id#" target="new">First American Endorsement</a> for order #rec_id#</B></font><br><br>
...
SERVER="127.0.0.1"
Subject="First Title - First American Endorsement for order #rec_id#"
TIMEOUT="600"
type="HTML"
>
...
<CFLOCATION URL="https://#cgi.server_name#/admin_area/faend_view4.cfm?rec_id=#rec_id#&a_trigger=2">
