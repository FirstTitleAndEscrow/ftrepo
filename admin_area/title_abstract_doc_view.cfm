...
<cfquery DATASOURCE="#request.dsn#" name="get_file7" >
	SELECT abstractor_invoice, abstractor_invoice2, abstractor_invoice3
	FROM  Doc_Abstract_Title
	WHERE title_id = #read_title.title_ID#
</CFQUERY>
...
<cfquery name="get_file17" DATASOURCE="#request.dsn#">
	SELECT abstractor_doc_upload7
	FROM  Doc_Abstract_Title
	WHERE title_id = #read_title.title_ID#
</CFQUERY>
...
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_all_abstractors">
	SELECT *
	FROM Abstractors where type = 1
	and username IN (select username from vendors_stacie where status =1)
...
<cfif exceptions.recordcount eq 1 and exceptions.title_co_id eq 25 and read_title.pstate eq 'MI'>
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_all_abstractors">
	SELECT *
	FROM abstractors
	where abstractor_ID = 2516
</CFQUERY>
<cfelse>
<CFQUERY DATASOURCE="#request.dsn#" NAME="read_all_abstractors">
	SELECT *
	...
	and b.username IN (select username from vendors_stacie where status =1)
</CFQUERY>
</cfif>
...
<CFFORM NAME="frm" ACTION="./title_abstract_invoice.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=10&company_id=#url.company_id#" METHOD=POST>
								...
								<cfif get_line_items.recordcount>
								<tr><td colspan="2"><b>Please Enter The Amount Paid For Each Item</b></td></tr>
								</cfif>
								<cfloop query="get_line_items">
									<tr>
									<td width=200  align=right valign=top bgcolor=d3d3d3>
										<font size=2 color=black face=arial>
										#Replace(product_ordered,"_"," ","ALL")#<br>
										#company#
									</td>
									<td width=319  align=left valign=top bgcolor=e1e1e1>
										<CFINPUT TYPE="Text" NAME="amt_paid_#id#" SIZE=11 MAXLENGTH=15  VALUE="#DollarFormat(amt_paid)#"
											REQUIRED="No"
											style="font-size: 9;
											font-family: verdana;
											font-style: normal;
								...
								<tr>
									...
									<td width=319  align=left valign=top bgcolor=e1e1e1>
										<CFINPUT TYPE="Text" NAME="invoice_amt_paid" SIZE=11 MAXLENGTH=15  VALUE="#DollarFormat(read_title_abstract.invoice_amt_paid)#"
											REQUIRED="No"
											style="font-size: 9;
											font-family: verdana;
											font-style: normal;
								...
								<input type=image name = "invoice_Submit" src="./images/button_submit.gif" border=0></td>
								</td>
...
<cfflush>
<CFFORM NAME="frm" ACTION="./title_abstract_doc_assign.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=10&company_id=#url.company_id#&order_type=T" METHOD=POST>
							<tr>
...
<!--- 						<CFFORM NAME="frm" ACTION="https://#cgi.server_name#/admin_area/title_abstract_price_assign.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=10&company_id=#url.company_id#" METHOD=POST>
						...
						<table width=520 cellpadding=1 cellspacing=1 border=1 bgcolor=BFBFBF>
							<tr>
								<td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
									...
									<CFELSE>
							<tr>
								<td width=520 align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload#', 'url')#" target="_new">#abstractor_doc_upload#</A>.<br>
			...
			<CFELSE>
							<tr>
								<td width=520   align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload2#', 'url')#" target="_new">#abstractor_doc_upload2#</A>.<br>
...
<cfoutput query="get_file4">
			...
			<CFELSE>
							<tr>
								<td width=520   align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload4#', 'url')#" target="_new">#abstractor_doc_upload4#</A>.<br>
...
<cfoutput query="get_file5">
			...
			<CFELSE>
							<tr>
								<td width=520   align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload5#', 'url')#" target="_new">#abstractor_doc_upload5#</A>.<br>
...
<cfoutput query="get_file6">
			...
			<CFELSE>
							<tr>
								<td width=520   align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload6#', 'url')#" target="_new">#abstractor_doc_upload6#</A>.<br>
...
<cfoutput query="get_file7">
			<FORM ACTION="./file_upload7.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=0&a_trigger=3" METHOD=POST>
				<input type="hidden" name="title_id" value="#read_title.title_id#">
								<td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
									<CFIF #abstractor_invoice# EQ "">
										Abstractor Invoice
										
										<input type="submit" value="Upload File" name="submit1"></td>
							</tr>
			<CFELSE>
							<tr>
								<td width=520   align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file for abstractor invoice 1 named: <A href="#fileSys.FindFilePath('#abstractor_invoice#', 'url')#" target="_new">#abstractor_invoice#</A>.<br>
									<a href="./delete-uploaded-file7.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#url.company_id#" target="New" onClick="window.open('','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">delete</a></TD></tr></NOBR>
			</CFIF>
			<CFIF #abstractor_invoice2# EQ "">
				<tr><td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
										Abstractor Invoice ##2
										
										<input type="submit" value="Upload File" name="submit2"></td>
							</tr>
			<CFELSE>
							<tr>
								<td width=520   align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file for abstractor invoice 2 named: <A href="#fileSys.FindFilePath('#abstractor_invoice2#', 'url')#" target="_new">#abstractor_invoice2#</A>.<br>
									<a href="./delete-uploaded-file7.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#url.company_id#&invoicenum=2" target="New" onClick="window.open('','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">delete</a></TD></tr></NOBR>
			</CFIF>
			<CFIF #abstractor_invoice3# EQ "">
				<tr><td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
										Abstractor Invoice ##3
										
										<input type="submit" value="Upload File" name="submit3"></td>
							</tr>
			<CFELSE>
							<tr>
								<td width=520   align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is an uploaded file for abstractor invoice 3 named: <A href="#fileSys.FindFilePath('#abstractor_invoice3#', 'url')#" target="_new">#abstractor_invoice3#</A>.<br>
									<a href="./delete-uploaded-file7.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#url.company_id#&invoicenum=3" target="New" onClick="window.open('','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">delete</a></TD></tr></NOBR>
			</CFIF>
			</FORM>
			</cfoutput>
<cfflush>
...
<cfif read_title.pstate eq 'NM' and (read_title.comp_id eq 8260 or read_title.comp_id eq 8487 or read_title.comp_id eq 8490 or read_title.comp_id eq 8489 or read_title.comp_id eq 8488)>
<cfset inhouse_count = 0>
</cfif>
...
<cfset doj = 0>
<cfif (read_title.pstate eq 'CA') and (read_title.comp_id eq 8260 or read_title.comp_id eq 8487 or read_title.comp_id eq 8490 or read_title.comp_id eq 8489 or read_title.comp_id eq 8488)>
<cfset doj = 1>
</cfif>


			<!---
			<cfif (read_title.comp_id eq 9711) or (inhouse_count GTE 1 or (#read_title.pstate# eq "CA" and date_diff lte 0) or (#read_title.pstate# eq "TX") and doj eq 0)>
			--->
			...
			<FORM ACTION="./file_upload3.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=4&company_id=#url.company_id#" METHOD=POST>
								<td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
									...
									<CFELSE>
							<tr>
								<td width=520 align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded Committment file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload3#', 'url')#" target="_new">#abstractor_doc_upload3#</A>.<br>
			...
			<cfoutput query="get_file17">

			<FORM ACTION="./file_upload17.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=4&company_id=#url.company_id#" METHOD=POST>
								<td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
									<CFIF #abstractor_doc_upload7# EQ "">
										Updated Commitment Upload
										<input type="hidden" name="title_id" value="#read_title.title_id#">
									...
									<CFELSE>
							<tr>
								<td width=520 align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded Updated Committment file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload7#', 'url')#" target="_new">#abstractor_doc_upload7#</A>.<br>
									<a href="./delete-uploaded-file3.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#url.company_id#&updated=1" target="New" onClick="window.open('','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">delete</a></TD></tr></NOBR>
									</CFIF>
			</FORM>
			</cfoutput>  
