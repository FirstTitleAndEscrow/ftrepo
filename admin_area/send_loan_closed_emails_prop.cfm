		...
		<hr>
            ...
            <CFSWITCH EXPRESSION="#get_order.comp_id#">
                ...
                <CFCASE VALUE = 559><!---Weichert--->
		            ...
		            <Cfset strDear = "#get_order.pname#" >
                    <Cfset strSubject = "Your Loan Closed with First Title - Order: #get_order.prop_id# - #get_order.bfirstname1# #get_order.blastname1# ">
	            </CFCASE>
                <CFCASE VALUE = 154>
...
<cfif NOT strEmailTo contains 'rosicki'>
...
Dear #strDear#:
Loan has been closed for order #get_order.prop_id#. 
