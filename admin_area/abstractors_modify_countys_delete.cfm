...
<CFOUTPUT>
	<tr>
		<td width=498 align=left valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Counties were Deleted from Abstractors County List</B>
		</td>
	</tr>
...
FROM="#user.email#" Subject="Abstractor info has been changed"
TIMEOUT="600"
type="HTML"
>
<table width=500 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
...
<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Click <NOBR><a href="https://#CGI.SERVER_NAME#/admin_area/abstractors_modify_countys_delete.cfm?uid=59&al=1&abstractor_ID=#abstractor_ID#&zip_id=#zip_id#">HERE</a></NOBR>
