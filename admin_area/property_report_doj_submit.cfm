...
<cfinclude template="../includes/prop_report_doj_create_pdf.cfm">
...
<cfoutput>
<FORM action="./Prop_report_doj_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#company_ID#&a_trigger=7"  ENCTYPE="multipart/form-data" method="post">
</cfoutput>
<tr>
...
<cfFORM NAME="Search" METHOD="Post" ACTION="./property_report_doj_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=21&company_ID=#read_Title.comp_id#">
