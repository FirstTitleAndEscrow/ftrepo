...
<CFSET zip_id_2 = #ListToArray(zip_id, ",")#>
	...
	<CFSET cty_name_1 = ArrayNew(1)>
		...
		<CFQUERY datasource="#request.dsn#" >
			...
			VALUES(1, '#tss_id#', '#company#', '#username#', '#password#', '#fname#',  '#lname#', '#phone#', '#cell#', '#pager#', '#fax#', '#addr1#', '#addr2#', '#city#', '#state#', '#zip_code#', '#email#', '#a_cost#',  '#pref_for_send#',  '#a_note_1#', '#a_comments#', '#c_time#', '#c_date#', '#oe#', '#deedonly#', '#oe1#', '#oe2#', '#mort#', '#rec#', '#judg#', '#rec_update#', '#refphone1#', '#refphone2#', '#refCo1#', '#refCo2#', '#city2#', '#state2#', '#zip_code2#', '#SSN#', '#TAXID#', '#homephone#', '#otherphone#', '#eocompany#', '#eoamount#', '#eoexpiredate#')
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>The Abstractor was added</B>
		</td>
	</tr>
</CFOUTPUT>	
