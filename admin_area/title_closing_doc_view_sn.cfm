...
<CFQUERY datasource="#request.dsn#" NAME="read_title">
     ...
     <CFQUERY datasource="#request.dsn#" NAME="aaaa">		
				...
				Where anc_Id = #read_title.anc_id#
			</CFQUERY>
	...
	<CFQUERY datasource="#request.dsn#" NAME="read_state">
		   ...
		   <CFQUERY datasource="#request.dsn#" NAME="read_all_closers">
			...
			where b.status is null and st_abbrev = '#read_state.st_abbrev#' AND UPPER(ct_name) = UPPER('#read_state.ct_name#') and a.closer_id = b.closer_id
...
<cfelse>
	   ...
	   <tr>
			<td width=790 align=left valign=top bgcolor=green>
				...
				<CENTER><B>Closing Assign Form for Anc-#rec_id#</B></CENTER>
			</TD>
		</TR>
</cfoutput>
	<tr>
...
<CFFORM NAME="frm" ACTION="./title_closing_doc_assign_anc.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=10&company_id=#company_ID#" METHOD=POST>
...
<cfoutput>
<form action="title_closing_email_anc.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#">
