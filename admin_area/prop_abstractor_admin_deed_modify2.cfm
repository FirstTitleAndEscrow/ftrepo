...
<CFQUERY datasource="#request.dsn#" NAME="read_deed">
			...
			SELECT *
			FROM prop_ins_add
			where prop_id = #rec_id# and type = 'DATA' AND seq_num = #URL.seq_num#
		</CFQUERY>
...
<CFQUERY datasource="#request.dsn#" >
            ...
            notes = '#a_comments#',
            comments = '#comments#',
            search_date = '#search_mon#/#search_day#/#search_year#'
...
Click here to go back to the main page.<a href="admin_property_report.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=0"><img src="./images/button_return.gif" border=0 ALT="Click this button to return to main"></a>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/prop_abstractor_admin_deed_modify2.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#url.rec_id#&seq_num=#read_report.seq_num#&company_id=0&a_trigger=1" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<option value="#DateFormat(search_date, "mm")#">#DateFormat(search_date, "mm")#</option>
...
size="1"
								...
								rows="5"
								cols="45">
<option value="#DateFormat(search_date, "dd")#">#DateFormat(search_date, "dd")#</option>
...
<option value="#DateFormat(search_date, "yyyy")#">#DateFormat(search_date, "yyyy")#</option>
<option value="2020">2020</option>
<option value="2019">2019</option>
<option value="2018">2018</option>
<option value="2017">2017</option>
