...
<CFQUERY datasource="#request.dsn#" NAME="insert_entry">
			Insert into Client_Bulk_Rates (comp_id, state, tier_100000, tier_175000, tier_250000, tier_500000, tier_750000, tier_1000000, tier_1250000, tier_1500000)
			values
...
<title>Add State to Bulk Rates</title>
...
<td align=center valign=top width="75"><input type="checkbox" name="tier_750000" value=1 disabled>
</td>
<td align=center valign=top width="75"><input type="checkbox" name="tier_1000000" value=1 disabled>
</td>
<td align=center valign=top width="75"><input type="checkbox" name="tier_1250000" value=1 disabled>
</td>
<td align=center valign=top width="75"><input type="checkbox" name="tier_1500000" value=1 disabled>
</td>
</tr>
