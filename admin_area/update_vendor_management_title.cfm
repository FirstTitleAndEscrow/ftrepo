...
<CFFORM ACTION="update2_vendor_management_title.cfm?company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#preprocessor.title_id#&a_trigger=1"><!--- Embed primary key as a hidden field --->
<CFOUTPUT>
...
<TABLE ALIGN="center" BGCOLOR="white">
   <TR>
        <TH colspan="2" Align="center">
            <FONT SIZE="+1"><Center>Reassign Vendor Management</CENTER></FONT>
        </TH>
    </TR>
    <TR>
        <TD>
	...
	<tr>
		...
		<TD><!--- Ratings list --->
			<CFSELECT Name="NewName"
				...
				Value="ID"
				Display="Name"
				Selected="#preprocessor.abstract_ID#">
			</CFSELECT>
		</TD>
    </TR>
	<tr>
