...
<CFIF #state# eq "none" and #company_id# eq "none">
		...
		<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_report">
			...
			WHERE a.title_id = d.title_id and a.title_id = e.title_id and a.title_id = f.title_id and a.title_id = g.title_id and a.cancelled is null
...
<td bgcolor=#a_bgcolor# width=201 align=center valign=top>
	...
	<CFQUERY DATASOURCE="#dynamic_datasource#" NAME="read_report">
			...
			SELECT *
			FROM property a, doc_title_insurance_prop d, tax_Data_prop e, doc_abstract_prop f
