...
<CFQUERY datasource="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing (vendor_id, service_type, STATE, COUNTY, FULL_SEARCH, CURRENT_OWNER, doc_retrieval, TWO_OWNER, BRING_TO_DATE, ten_year, Bankruptcy)
			values
			( #url.vendor_id#, 'Abstract', '#form.STATE#', '#form.COUNTY#', '#form.FULL_SEARCH#', '#form.CURRENT_OWNER#', '#form.doc_retrieval#', '#form.TWO_OWNER#', '#form.BRING_TO_DATE#', '#form.ten_year#', '#form.bankruptcy#')
</CFQUERY>
...
<td align=left valign=top width="80"><input type=text name="ten_year" VALUE="" size=6 maxlength=22
