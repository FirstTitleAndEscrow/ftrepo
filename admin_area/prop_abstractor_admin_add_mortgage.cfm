...
<table width=600 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/prop_abstractor_admin_add_mortgage_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<tr>
		...
		<td width=600 align=left valign=top bgcolor=e6e6e6>
		<textarea name="info" cols="40" rows="20"></textarea>
			<!--- <CFINPUT  type=text name="info"  size=40 maxlength=2500
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
...
<option value="2005">2005</option>
	...
	<tr>
		<td width=300 align=right valign=top bgcolor=e6e6e6>
			...
			<NOBR><textarea name="Comments"style="font-size: 9;
								font-family: verdana;
								font-style: normal;
								color: blue;
								background-color: e1e1e1;
