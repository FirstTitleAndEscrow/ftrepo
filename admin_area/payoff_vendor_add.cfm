		...
		<CFQUERY datasource="#request.dsn#" NAME="read_payoff_vendors">
		
			SELECT *
			FROM Abstractors where type = 6
...
message = message + "In order to add a new Payoff Vendor you need to choose county(ies)/state(s) the Payoff Vendor serves\n"
valid = false;
}
if (valid == false) {
alert(message);
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Add Payoff Vendor </B>
		</td>
	</tr>
</CFOUTPUT>	
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<CFFORM METHOD=POST ACTION="payoff_vendor_add_submit.cfm?uid=#URL.uid#&al=#URL.al#" name="frm">
	...
	<tr>		
		...
		<td width=368 align=left valign=top bgcolor=e6e6e6>	
			<input type=text name="username" VALUE="" size=20 maxlength=90
	...
	<tr>		
		...
		<td width=368 align=left valign=top bgcolor=e6e6e6>	
			<input type=text name="password" VALUE="" size=20 maxlength=90
...
<tr>		
	...
	<tr>		
		<td width=468 colspan=2 align=center valign=top bgcolor=e6e6e6>	
			...
			Select County and State Payoff Vendor is going to serve
	...
	<tr>		
		<td width=468 colspan=2 align=center valign=top bgcolor=e6e6e6>	
			<font size=2 color=gray face=arial>
			Preferences for recieving Payoff Form Notice
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	<tr>		
		...
		<td width=497 align=center valign=top bgcolor=e1e1e1>	
			...
			Review the list below to ensure the Payoff Vendor isn't already in the Database
	...
	<tr>		
		...
		<td width=497  align=right valign=top bgcolor=e1e1e1>	
			...
			rows="5" 
			cols="45" 
			><CFOUTPUT QUERY="read_payoff_vendors"><OPTION VALUE="#company#">#Company# ---  #lname#, #fname#</OPTION></CFOUTPUT>			
			</SELECT></FORM>		
		</td>
	</tr>
