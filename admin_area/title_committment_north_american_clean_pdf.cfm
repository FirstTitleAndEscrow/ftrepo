...
<!--- MAIN START PAGE BEGINS HERE --->
   ...
   <CFQUERY datasource="#request.dsn#" name="Read_company">
	SELECT COUNT(*) FROM COMPANIES COMP INNER JOIN TITLE T ON
	COMP.ID=T.COMP_ID WHERE T.TITLE_ID=<CFQUERYPARAM cfsqltype="cf_sql_integer" Value="#rec_id#"> AND (COMP.COMPANY LIKE 'FLAGSTAR%' or COMP.COMPANY LIKE 'MB FINANCIAL%')
	</CFQUERY>


   <CFQUERY datasource="#request.dsn#" name="read_richmond">
	SELECT f.va_employee, c.intsales
	 from companies c , first_admin f
	 where c.id = #read_title.comp_id#
	 and f.id = c.intsales
	</CFQUERY>

<CFIF #Read_company.recordCount# GT 0 and read_richmond.va_employee neq 'True'>
...
<tr><td valign="bottom" colspan="2" style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:1px;">By: &nbsp;&nbsp;&nbsp;<img src="http://machine1.firsttitleservices.com/images/seth_sig.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Authorized Signatory</td>
</tr></cfIF>
</table></cfoutput>
</td></tr>
</table>
...
</cfif><cfif #read_mortgage.data11# neq "">#read_mortgage.data11#</cfif> <cfif #read_mortgage.data12# neq "">#read_mortgage.data12#</cfif></cfif>
<br>
<br>
...
<br>
 ...
 <cfelse>
	...
	<tr>
		  <td width="5%" valign="top">6.</td>
		<td>State, County and Municipal real estate taxes subsequent to the original levy for the year ending <cfif read_title.pstate eq 'AL'>October 31, 2014<cfelse><cfoutput>June 30, #DateFormat(Now(), "yyyy")#</cfoutput></cfif>, not yet due and payable, plus possible supplemental taxes.
</td>
	</tr>
