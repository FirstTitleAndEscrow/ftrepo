...
select *
from title 
where title_id = #getorderinfo.title_id#
</cfquery>
...
<form action="./update_title_closing.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&comp_id=#read_title.comp_ID#" method="post">
...
size="1" 
								...
								rows="5" 
								cols="45">
	 	<Cfif (#aaaa.recordcount# GT "0") AND (#Read_Title.appraisal_status# EQ 'Closing Complete')>
...
size="1" 
								...
								cols="45">
<Cfif (#aaaa.recordcount# GT "0") AND (#Read_Title.appraisal_status# EQ 'Closing Complete')>
<option value="#aaaa.c_Time#"selected>#aaaa.C_Time#</OPTION>
<cfelse>
