...
<cfhttp url="http://www.firsttitleservices.com/HUD1_2010_PDF.cfm?rec_id=#rec_id#" method="get" resolveURL="true">
</cfhttp>
        <cfdocument format="PDF" pagetype="custom" pageheight="14" pagewidth="8.5" margintop=".25" marginbottom=".25" marginleft=".25" marginright=".25" filename="c:\inetpub\wwwroot\clients\firsttitleservices.com\www\admin_area\saved_huds\HUD_#rec_id#.pdf" overwrite="yes"> <cfoutput>#cfhttp.filecontent#</cfoutput> </cfdocument>
<cfif url.viewprint eq 1>
<script language="javascript">
open('saved_huds/HUD_<cfoutput>#rec_id#</cfoutput>.pdf');
</script>
</cfif>
...
<cfmailparam file="c:\inetpub\wwwroot\clients\firsttitleservices.com\www\admin_area\saved_huds\HUD_#rec_id#.pdf">
...
<tr>
<td class="bsilver">804. Appraisal fee to<input type="text" class="text" name="A_0804_APPRAISALFEEPAYTO" value="#get_hud_data.A_0804_APPRAISALFEEPAYTO#" />&nbsp;&nbsp;$<input type="text" class="text" name="A_0804_APPRAISALFEEPAYTO" value="#get_hud_data.A_0804_APPRAISALFEE_OUTSIDE_AMOUNT#" /></td>
