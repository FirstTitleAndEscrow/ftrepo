...
<cfif session.ft_user_id eq 417 or session.ft_user_id eq 248>
...
<li><a href="vendor_routing_table.cfm" target="new">Vendors Routing Table</a></li>
</cfif>
</ul>
