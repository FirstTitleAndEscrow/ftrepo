...
select * from Title_Closing_Order_Request_anc
...
<CFQUERY datasource="#request.dsn#" NAME="read_user">
		...
		<CFQUERY datasource="#request.dsn#">		
				...
				VALUES('#read_user.FName#', '#read_user.LName#', #URL.rec_id#, 'Closing confirmed and information submitted to client', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'S', '1', '1')		
		</CFQUERY>
...
FROM="#team_email#"
Subject="#get_order.blastname1#, #get_order.bfirstname1#: Closing Infomation for order #get_order.anc_id# -- Loan Number-#get_order.loan_number#"
TIMEOUT="600"
type="html"
><center>
