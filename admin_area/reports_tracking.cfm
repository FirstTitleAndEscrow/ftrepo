...
<cfoutput query="get_recs">
	<CFQUERY datasource="#request.dsn#" NAME="title_info" maxrows=1>
	select title_id,paddress,pcity,pstate from title
	WHERE title_id = #get_recs.title_id#
    </CFQUERY>
<tr bgcolor="#bgcolor#">
<td><strong>#title_info.title_id#</strong></td>
<td>#title_info.paddress#</td>
<td>#title_info.pcity#</td>
<td>#title_info.pstate#</td>
<td align="center"><cfif turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'start', 'binder_sent')) LT 2160 or turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'start', 'binder_sent')) EQ 0><font color="green"><cfset within_range_count1 = within_range_count1 + 1><cfelseif turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'start', 'binder_sent')) LT 4320><font color="orange"><cfelse><font color="red"></cfif>#turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'start', 'binder_sent')#</font>
...
<td align="center"><cfif turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'binder_sent', 'cleared')) LT 7200 or turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'binder_sent', 'cleared')) EQ 0><cfset within_range_count2 = within_range_count2 + 1><font color="green"><cfelseif turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'binder_sent', 'cleared')) LT 14400><font color="orange"><cfelse><font color="red"></cfif>#turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'binder_sent', 'cleared')#</font>
<cfif turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'binder_sent', 'cleared')) neq 0>
<cfset col2_total = col2_total + turnTimes.HoursToMinutes(turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'binder_sent', 'cleared'))>
...
<td align="center">#turnTimes.calculateCurrentTurnTime(get_recs.title_id, 'marker', 'start', 'stop')#</td>
