				...
				<table width=519 cellpadding=1 cellspacing=1 border=0 bgcolor=f1f1f1>
					...
					<tr>
						...
						<!--- <td rowspan=2 bgcolor=f1f1f1 width="275" align="left" valign="top">
				    		...
				    		<a href="https://#cgi.server_name#/endorse_modify.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#title_id#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_endorse.gif" border=0></a>
		            	</td> --->
