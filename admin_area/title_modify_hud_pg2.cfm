...
<CFFORM METHOD=POST ACTION="./title_modify_hud_pg2_submit.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#">
...
<!--- ===/ NOTE \=== --->
	...
	<tr>
		<td bgcolor=white width=790 align=right valign=top>
