...
<cfelseif session.role_id eq 34 or session.ft_user_id eq 248 or session.ft_user_id eq 90>
<CFQUERY datasource="#request.dsn#" NAME="read_Loans_Funded">
...
<cfif session.ft_user_id eq 294 or session.ft_user_id eq 56 or session.ft_user_id eq 59 or session.ft_user_id eq 90 or session.ft_user_id eq 424 or session.role_id eq 34>
    <tr>
        <TD colspan="10">
            <FONT FACE=verdana SIZE=3 color="black">
...
<form action="Sales_Commission_Report_Revenue_Commit.cfm" method="post"   name="form_#read_Loans_Funded_Person.currentrow#" target="update_window" onSubmit="window.open('','update_window','width=10,height=10');">
 <TR>
                ...
                <td>
					...
					<input type="hidden" name="file_id" value="#read_Loans_Funded_Person.title_id#" size="4">
					<input type="text" name="revenue_amount" value="#dollarformat(new_rev)#" size="4">
                    </font>
                </td>
...
<cfif session.ft_user_id eq 294 or session.ft_user_id eq 56 or session.ft_user_id eq 59 or session.ft_user_id eq 90 or session.ft_user_id eq 248 or session.ft_user_id eq 424>
    <tr>
        <TD colspan="10">
            <FONT FACE=verdana SIZE=3 color="black">
