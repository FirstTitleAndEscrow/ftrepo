...
<CFOUTPUT>
	<tr>
		<td width=748 align=center valign=top bgcolor=e3e3e3>
			<font size=2 color=green face=arial><B>Client Bulk Rates - NATIC</B><br>
...
<cfoutput query="read_bulk_rates">
	<tr>
		...
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onClick="window.open('https://machine1.firsttitleservices.com/admin_area/client_bulk_rates_Natic_modify.cfm?id=#read_bulk_rates.ID#','mywindow','width=700,height=150')"><img src="images/button_m.gif" length=14 width=14 border=0></a>
		</td>
		<td align=right width=16 valign=top bgcolor=e6e6e6>
			<font size=1 color=black face=arial>
			<a onclick="question = confirm('Are you sure you want to delete this entry?'); if (question==true) {document.location.href='https://machine1.firsttitleservices.com/admin_area/client_bulk_rates_Natic_delete.cfm?id=#read_bulk_rates.ID#&comp_id=#read_bulk_rates.comp_id#'}; "><img src="images/button_d.gif" length=14 width=14 border=0></a>
		</td>
	</tr>
</cfoutput>
</cfif>
	<tr>
	<td colspan=10 align=right valign=top bgcolor=e6e6e6><input type="button" value="Add State for Bulk Rates" onClick="window.open('https://machine1.firsttitleservices.com/admin_area/client_bulk_rates_Natic_add.cfm?comp_id=<cfoutput>#url.MODIFY_CLIENT_ID#</cfoutput>','mywindow','width=700,height=150')"></td>
	</tr>
</table>
