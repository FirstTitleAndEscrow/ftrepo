...
<cfset new_file_name = #fileSys.MoveFromUploads('#FILE.ServerFile#')#>
			...
			update doc_closer_title set closing_form_upload2 = '#new_file_name#'
...
<CFQUERY datasource="#request.dsn#" NAME="get_file">
			select closing_form_upload2 from doc_closer_title
			WHERE title_id = #rec_ID#
</cfquery> 
<CFMAIL
TO="#email#"
...
SERVER="127.0.0.1"
Subject="First Title Closing Package 2 file for order #rec_id#<cfif #get_id.loan_number# neq "">, Loan No. - #get_id.loan_number#</cfif>"
type="HTML"
TIMEOUT="600"
>
