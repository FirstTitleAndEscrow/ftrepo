...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing_sb (vendor_id, service_type, STATE, COUNTY, FULL_SEARCH, CURRENT_OWNER, doc_retrieval, TWO_OWNER, BRING_TO_DATE)
			values
			( #url.vendor_id#, 'Abstract', '#form.STATE#', '#form.COUNTY#', '#form.FULL_SEARCH#', '#form.CURRENT_OWNER#', '#form.doc_retrieval#', '#form.TWO_OWNER#', '#form.BRING_TO_DATE#')
</CFQUERY>
