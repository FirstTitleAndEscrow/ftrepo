	...
	<CFSET zip_id_1 = #ListToArray(zip_id, ",")#>
		...
		<CFLOOP FROM="1" TO="#ArrayLen(zip_id_1)#" INDEX="SSS">
			<CFQUERY datasource="#request.dsn#">
				INSERT INTO first_title_states(st_abbrev)
				VALUES('#zip_id_1[SSS]#')
			</CFQUERY>
		</CFLOOP>
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<NOBR><font size=2 color=green face=arial><B>The States were ADDED to First Titles List of States Served</B></CENTER></NOBR><font size=2 color=black face=arial>
		</td>
	</tr>
