...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Add Title Companies </B>
		</td>
	</tr>
</CFOUTPUT>
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<tr>
		...
		<td width=498 colspan=2 align=left valign=top bgcolor=e1e1e1>
			...
			Review the list below to ensure the Title Company isn't already in the Database
		</td>
	</tr>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Title_Co_add_submit.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
	...
	<tr>
		<td width=498 colspan=2 align=left valign=top bgcolor=e6e6e6>
			...
			Use the list below to select all of the States that this Title Company
	...
	<tr>
		<td width=130 align=right valign=top bgcolor=e6e6e6>
			<font size=2 color=black face=arial>
			Select the States this Title Company is going to Serve
		</td>
