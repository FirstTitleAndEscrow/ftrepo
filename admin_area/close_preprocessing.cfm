...
<html>
<head>
	<title>1st Title & Escrow, Inc. - Preprocessing</title>
</head>
...
<tr>
	<td width="50%" align=left valign=bottom>
		<br><br><br><br><br><br>	
<cfoutput>
	<NOBR><a href="./menu_processing_all.cfm?&company_id=0&uid=#URL.uid#&al=#URL.al#&rec_id=#get_order.title_id#&a_trigger=1"><img src="./images/button_return.gif" border=0 ALT="Return to main menu"></a> 
...
<!--- Heidi told me that they are not going to do processing automation any longer
...
<CFQUERY datasource="#request.dsn#">
	...
	set preprocessor_end_datetime = #Now()#<!---, 
    processor_start_datetime = #now()#,
    processor_ID = #processing#--->
...
<CFQUERY datasource="#request.dsn#" name="read_user_name"> 
    ...
    FROM         tblUser_Roles LEFT OUTER JOIN
                      First_Admin ON tblUser_Roles.Preprocessor_ID = First_Admin.ID
...
<cfquery  datasource="#request.dsn#">
	INSERT INTO 
				...
				Values ('System','Web','#DateFormat(Now(), "m/d/yyyy")#','#TimeFormat(Now(), "HH:mm:ss")#','#rec_id#','Preprocessing was completed by #trim(read_user_name.username)#','T','1')
</CFQUERY>		
</cfform>
