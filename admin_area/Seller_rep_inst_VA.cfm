...
<CFFORM NAME="frm" ACTION="./Seller_rep_inst_VA_email.cfm?rec_id=#rec_id#" METHOD="POST">
...
<CFFORM NAME="modform" ACTION="./seller_rep_inst_VA_final.cfm?rec_id=#rec_id#" METHOD="POST">
...
To:  Sarah Spiers-Legacy Law Group - <cfoutput><cfif mods.recordcount and Len(mods.title_co)>
