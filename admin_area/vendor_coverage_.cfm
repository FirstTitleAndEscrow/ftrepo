				...
				<cfelse>
					<tr>
						...
						<td bgcolor="green" width=10 align=right valign=top>
							...
							<a href="vendor_view_abstractor_.cfm?abstractor_id=#abstractor_ID#&uid=#URL.uid#&al=#URL.al#&a_state=#a_state#&vendor=#vendor#">43204#abstractor_id#</a>
						</b>
						</td>
...
<td bgcolor="green" width=80 align=left valign=top>
				...
				<a href="mailto:#email#">#email#</a>	</b>	
						...
						<td bgcolor="#a_bgcolor#" width=10 align=left valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
						<a href="abstractors_modify_view_.cfm?abstractor_id=#abstractor_ID#&uid=#URL.uid#&al=#URL.al#&a_state=#a_state#&vendor=#vendor#"><img border=0 src="./images/button_m.gif" ALT="Modify this entry"></a>	
	...
	<CFSET a_color_trigger = "1">
			...
			<CFOUTPUT QUERY="read_report">
					...
					<tr>
						...
						<td bgcolor="#a_bgcolor#" width=10 align=right valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<a href="vendor_view_closer_.cfm?closer_id=#closer_ID#&uid=#URL.uid#&al=#URL.al#&a_state=#a_state#&vendor=#vendor#">24043#closer_id#</a>
