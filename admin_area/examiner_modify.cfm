...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			...
			<p>
			Select an Examiner to modify</CENTER></NOBR><font size=2 color=black face=arial>
		</td>
	</tr>
</CFOUTPUT>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Examiner_modify_choose.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
	...
	<tr>
		...
		<SELECT NAME="Examiner_ID"
			...
			rows="5"
			cols="45"
			><CFOUTPUT QUERY="read_Examiners"><OPTION VALUE="#Examiner_ID#">#Company# -  #lname#, #fname#</OPTION></CFOUTPUT>
			</SELECT>
