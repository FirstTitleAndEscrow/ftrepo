...
<cfoutput>
<form name="excel_form" action="https://#cgi.server_name#/admin_area/title_rep_display2.cfm" method="post">
...
<cfif form.product eq "title" or form.product eq "all">
	...
	<CFIF #form.company_id# NEQ "none">
	    AND comp_id IN (#form.company_id#)
	<cfelse>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
	...
	<a href="./title_comments_nav.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#prop_id#&a_trigger=0&company_id=#company_ID#&code=P" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=500,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
	...
	<td bgcolor=#a_bgcolor# width=60 align=center valign=top><FONT FACE=verdana SIZE=1 color="black">
	<a href="./title_comments_nav.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#app_id#&a_trigger=0&company_id=#company_ID#&code=A" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=500,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
...
<cfif form.product eq "closing" or form.product eq "all">
<CFQUERY datasource="#request.dsn#" NAME="read_report">
SELECT *
