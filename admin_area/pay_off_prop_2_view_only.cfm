		...
		<!--- =================================================================== --->			
			<table width=400 cellpadding=2 cellspacing=1 border=0 bgcolor=white>
				...
				<TR>
					...
					<TD width=300 align=left valign=top bgcolor=white>
						<FONT FACE=ARIAL SIZE=2 color="black">
							 <b>#read_payoff_info_2.fax_to_send_to#</b>
					</td>
				</tr>
				...
				<TR>
					...
					<TD width=300 align=left valign=top bgcolor=white>
						<FONT FACE=ARIAL SIZE=2 color="black">
							 <b>#read_payoff_info_2.person_to_send_to#</b>
					</td>
				</tr>
				<TR>
					<TD width=100 align=right valign=top bgcolor=white>
				...
				<CFIF #read_prop.sfirstname2# GT "">
					...
					<tr>
						<td width=519 colspan=2 align=left valign=top bgcolor=white>
							...
							<br>
							<p>
							Please fax us a payoff statement regarding the above-referenced loan, with interest calculated through <FONT FACE=ARIAL SIZE=2 color="black">
							 <b>#read_payoff_info_2.int_calc_thru#</b>, and including a per diem interest rate.
					...
					<tr>
						<td width=519 colspan=2 align=left valign=top bgcolor=white>
							<FONT FACE=ARIAL SIZE=2 color="black">
							Our Fax Number is <FONT FACE=ARIAL SIZE=2 color="black">
