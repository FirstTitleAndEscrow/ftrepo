...
<CFSET instdate = #CreateDate(#ListFirst(inst_year)#, #inst_mon#, #inst_day#)#>
<CFSET recdate = #CreateDate(#ListFirst(rec_year)#, #rec_mon#, #rec_day#)#>
...
Click here to go back to the main page.<a href="title_Committment.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=1&company_id=0"><img src="./images/button_return.gif" border=0 ALT="Click this button to return to main"></a>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractor_admin_MORTGAGE_modify.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#url.rec_id#&seq_num=#read_report.seq_num#&company_id=0&a_trigger=1" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<option value="Subordination of">Subordination of</option>
<option value="Assignment to and Assumption of">Assignment to and Assumption of</option>
	...
	<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT value = "#data1#" Required="Yes" Message="You must enter a Mortgagee" type=text name="mort1"  size=40 maxlength=100
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
...
<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT value = "#data2#" Required="Yes" Message="You must enter a Mortgagor 1" type=text name="mort2"  size=40 maxlength=100
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
...
<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT value = "#data3#" type=text name="mort3"  size=40 maxlength=100
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
...
<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="docnum" value = "#data5#" size=40 maxlength=50
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="book" value = "#data6#" size=25 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
	...
	<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="page" value = "#data7#" size=25 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
