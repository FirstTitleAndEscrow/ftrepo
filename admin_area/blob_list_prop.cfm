...
where prop_id = #url.rec_id# AND ID = #URL.ID#
</cfquery>
<cfquery name="view" datasource="#request.dsn#">
DELETE FROM upload_many_prop 
where prop_id = #url.rec_id# AND ID = #URL.ID#
</cfquery>
...
<cfoutput query="view">
<cfset i = i + 1>
<form method="POST" action="./blob_list_prop.cfm?rec_id=#rec_id#&ID=#ID#&a_trigger=4" enctype="multipart/form-data">		
<tr>
<td>#i#.</td>
...
<tr>
<td><cfoutput>
<a href="./add_blob_prop.cfm?rec_id=#rec_id#">[Add a new file]</a>&nbsp;&nbsp;
</td>
<td>


&nbsp;&nbsp;<a href="./blob_list_prop.cfm?rec_id=#rec_id#">[View existing files]</a>
</td></cfoutput>
</tr>
</table>
</div>
