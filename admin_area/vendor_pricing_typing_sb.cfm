...
<CFQUERY DATASOURCE="#request.dsn#" NAME="insert_entry">
			Insert into Vendor_Pricing_sb (vendor_id, service_type, state, county, typing_fee)
			values
			( #url.vendor_id#, 'Typing', '#form.state#', '#form.county#', '#form.typing_fee#')
</CFQUERY>
...
<td align=left valign=top width="80"><input type=text name="typing_fee" VALUE="" size=6 maxlength=22
