...
<cfif #get_file.recordcount# GT "0" and get_file.client_upload4 neq 'NULL'>
<cfoutput>
<A HREF="#fileSys.FindFilePath('#get_file.client_upload4#', 'url')#" target="new">Click to View/Print Client upload-4</a><BR>
