	...
	<CFSET cty_name_1 = ArrayNew(1)>
		...
		<CFLOOP FROM="1" TO="#ArrayLen(st_abbrv_1)#" INDEX="SSS">
			<CFQUERY datasource="#request.dsn#">
				INSERT INTO Appraisers_county(Appraiser_ID, st_abbrev, ct_name)
				VALUES(#Appraiser_ID#, '#st_abbrv_1[SSS]#', '#cty_name_1[SSS]#')
			</CFQUERY>
		</CFLOOP>
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>The Counties were added to the Appraisers Countys List</B>
		</td>
	</tr>
