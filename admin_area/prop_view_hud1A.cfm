...
<!--
    function Locate(){
		 ...
		 window.location= "https://<cfoutput>#cgi.server_name#</cfoutput>/admin_area/prop_view_hud_A_modify.cfm?uid=<cfoutput>#uid#</cfoutput>&al=<cfoutput>#al#</cfoutput>&rec_id=<cfoutput>#rec_id#</cfoutput>&a_trigger=2";
...
View/Print <A HREF="https://#cgi.server_name#/prop_view_hud1a.cfm?comp_id=115&user_id_1=723&lo_id=1217&rec_id=#rec_id#&a_trigger=1&company_id=0" target="new">HUD1</a> for order #rec_id#  - #get_titleid.bfirstname1# #get_titleid.blastname1#</B></font><br><br>
...
<div id=idControls align="center" class="noprint">
 ...
 <p>
 <cfoutput>
 <FORM METHOD=POST ACTION="./prop_view_hudA.cfm?uid=#uid#&al=#al#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#" name="frm" ENABLECAB="Yes">
</cfoutput>
 ...
 onclick="factory.printing.Preview()">
   <a href="./prop_view_hud_A_modify.cfm?uid=#uid#&al=#al#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#"><input class=ie55 disabled type="button" value="Modify..." onclick="Locate();"></a>
</form>
<cfoutput>
<FORM NAME="Search" METHOD="post" ACTION="./prop_view_hud1A.cfm">
 <input type="Hidden" name="al" value="#al#">
  <input type="Hidden" name="a_trigger" value="23">
  <input type="Hidden" name="uid" value="#uid#">
 <input type="Hidden" name="rec_id" value="#rec_id#">
 </cfoutput> <FONT FACE=ARIAL SIZE=2 color="black">Enter email to send </font>
 <input disabled type=text name="email" size=20 maxlength=100
								size="1"
								style="font-size: 9;
								font-family: verdana;
								font-style: normal;
