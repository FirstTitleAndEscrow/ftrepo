...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_countys_delete.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#">
</CFOUTPUT>
	...
	<tr>
		...
		<td width=150 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/abstractors_modify_countys_add.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
