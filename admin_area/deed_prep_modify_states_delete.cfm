	...
	<CFSET zip_id_1 = #ListToArray(zip_id, ",")#>
		...
		<CFLOOP FROM="1" TO="#ArrayLen(zip_id_1)#" INDEX="SSS">
			<CFQUERY datasource="#request.dsn#">
				...
				WHERE Abstractor_ID = #Abstractor_ID# and st_abbrev =  '#zip_id_1[SSS]#'
			</CFQUERY>
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=red face=arial><B>States were Deleted from Deed Prep Vendor's States List</B>
		</td>
	</tr>
	...
	<tr>
		...
		<NOBR><a href="https://#cgi.server_name#/admin_area/deed_prep_modify_choose.cfm?uid=#URL.uid#&al=#URL.al#&Abstractor_ID=#Abstractor_ID#"><img src="./images/button_return.gif" border=0></a><img src="./images/clear.gif" height=10 width=85></NOBR>
