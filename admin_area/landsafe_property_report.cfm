...
<CFQUERY datasource="#request.dsn#" NAME="Mortgage_Count">
	SELECT     *, title_id AS Expr1
	FROM         dbo.title_ins_view
	WHERE     (title_id = #rec_ID#) AND (selectedOrgs4 IS NOT NULL)
</CFQUERY>
...
<CFQUERY datasource="#request.dsn#" NAME="Judgment_Count">
	SELECT     *, title_id AS Expr1
	FROM         dbo.title_ins_view
	WHERE     (title_id = #rec_ID#) AND (selectedOrgs3 IS NOT NULL)
</CFQUERY>
...
<table width="800">
    ...
    <td colspan="75%">#read_title.title_id#</td>
    </tr>
    <tr>
...
<tr>
<td>
<cfinclude template="../title_committment_tax_box_landsafe.cfm">
</td>
       </tr>
</table>             
</cfoutput>
