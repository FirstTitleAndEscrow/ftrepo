...
WHERE     (t.reo_sales_contract <> '') AND (t.reo_sales_contract IS NOT NULL) AND (t.appraisal_status <> 'Loan Closed')  AND (t.appraisal_status <> 'Loan Funded')  AND (t.appraisal_status <> 'Loan Closed-Seller Rep') AND (t.cancelled IS NULL) and t.order_date > '8/31/2009'
</CFQUERY>
<!--- <CFQUERY datasource="#request.dsn#" NAME="all_reos">
...
<cfset temp = QuerySetCell(the_big_query, "closing_date", '')>
<cfset temp = QuerySetCell(the_big_query, "busted_date", '')>
...
<cfset temp = QuerySetCell(the_big_query, "reo_num", "REO Number: #all_reos.loan_number#")>
<cfelse>
<cfset temp = QuerySetCell(the_big_query, "reo_num", "REO Number:")>
		</cfif>
	...
	<cfelse>
	<cfset temp = QuerySetCell(the_big_query, "closing_date", CreateODBCDate('1-1-1900'))>
	</cfif>
...
<cfelse>
<cfset temp = QuerySetCell(the_big_query, "busted_date", CreateODBCDate('1-1-1900'))>
	</cfif>
...
<cfset temp = QuerySetCell(the_big_query, "datediff", '#DateDiff("d", Now(), get_closing_date.closing_date)#')>
...
<!--- <CFIF CGI.REMOTE_ADDR EQ '98.233.53.112'>
...
<tr>
 ...
 <td bgcolor="#a_bgcolor2#"><font size=1 color=black face=verdana><b><cfif a_bgcolor2 eq 'green'><font color="white">#datediff2#</font><cfelse>&nbsp;</cfif></b></font></td>
		...
		<td align="left"><font size=1 color=black face=verdana>#ReplaceNoCase(report1.reo_num, "REO Number: ", "")#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
			#report1.prop_addr#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report1.closing_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report1.closing_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report1.busted_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report1.busted_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
...
<tr>
 ...
 <td bgcolor="#a_bgcolor2#"><font size=1 color=black face=verdana><b><cfif a_bgcolor2 eq 'green' or a_bgcolor2 eq 'gray'><font color="white">#ReplaceNoCase(datediff2, "-", "", "ALL")#</font><cfelse>&nbsp;</cfif></b></font></td>
		...
		<td align="left"><font size=1 color=black face=verdana>#ReplaceNoCase(report2.reo_num, "REO Number: ", "")#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
			#report2.prop_addr#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report2.closing_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report2.closing_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report2.busted_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report2.busted_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
...
<tr>
 ...
 <td bgcolor="#a_bgcolor2#"><font size=1 color=black face=verdana><b><cfif a_bgcolor2 eq 'gray'><font color="white">#ReplaceNoCase(datediff2, "-", "", "ALL")#</font><cfelse>&nbsp;</cfif></b></font></td>
		...
		<td align="left"><font size=1 color=black face=verdana>#ReplaceNoCase(report3.reo_num, "REO Number: ", "")#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
			#report3.prop_addr#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report3.closing_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report3.closing_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report3.busted_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report3.busted_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
...
<tr>
 ...
 <td bgcolor="#a_bgcolor2#"><font size=1 color=black face=verdana><b><cfif a_bgcolor2 eq 'gray'><font color="white">#datediff2#</font><cfelse>&nbsp;</cfif></b></font></td>
		...
		<td align="left"><font size=1 color=black face=verdana>#ReplaceNoCase(report4.reo_num, "REO Number: ", "")#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
			#report4.prop_addr#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report4.closing_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report4.closing_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report4.busted_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report4.busted_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
...
<tr>
 ...
 <td bgcolor="#a_bgcolor2#"><font size=1 color=black face=verdana><b>&nbsp;</b></font></td>
		...
		<td align="left"><font size=1 color=black face=verdana>#ReplaceNoCase(report5.reo_num, "REO Number: ", "")#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
			#report5.prop_addr#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report5.closing_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report5.closing_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report5.busted_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report5.busted_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
...
<tr>
 ...
 <td bgcolor="#a_bgcolor2#"><font size=1 color=black face=verdana><b>&nbsp;</b></font></td>
		...
		<td align="left"><font size=1 color=black face=verdana>#ReplaceNoCase(report6.reo_num, "REO Number: ", "")#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
			#report6.prop_addr#</font></td>
		<td align="left"><font size=1 color=black face=verdana>
		   <cfif DateFormat(report6.closing_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report6.closing_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
		    <cfif DateFormat(report6.busted_date, "m/d/yyyy") neq '1/1/1900'>#DateFormat(report6.busted_date, "m/d/yyyy")#</cfif></font></td>
		<td align="left"><font size=1 color=black face=verdana>
