...
To modify this Closing Information click <a href="./form_title_closing_order_requesta_sn.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#read_title.anc_id#"><img src="./images/button_modify.gif" border=0 ALT="Modify Closing info"></a> 
          </center>   <br>           
</cfoutput>
			</TD>
		</TR>
