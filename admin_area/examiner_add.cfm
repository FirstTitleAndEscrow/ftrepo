...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Add Examiner </B>
		</td>
	</tr>
</CFOUTPUT>
...
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Examiner_add_submit.cfm?uid=#URL.uid#&al=#URL.al#">
</CFOUTPUT>
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	<tr>
		...
		<td width=497 align=center valign=top bgcolor=e1e1e1>
			...
			Review the list below to ensure the Examiner isn't already in the Database
	...
	<tr>
		...
		<td width=497  align=right valign=top bgcolor=e1e1e1>
			...
			rows="5"
			cols="45"
			><CFOUTPUT QUERY="read_Examiners"><OPTION VALUE="#company#">#Company# ---  #lname#, #fname#</OPTION></CFOUTPUT>
			</SELECT></FORM>
		</td>
	</tr>
