...
<cfparam name="url.delete_update" default="">
<cfparam name="url.delete_id" default="">


<cfif url.delete_update eq 1>
<cfquery name="get_this_update" datasource="#request.dsn#">
SELECT *
FROM  Abstractor_Uploads
WHERE ID = #url.delete_id#
</CFQUERY> 
<cfquery name="delete_record" datasource="#request.dsn#">
delete
FROM  Abstractor_Uploads
WHERE ID = #url.delete_id#
</CFQUERY> 
<CFFILE ACTION="delete" file="#fileSys.FindFilePath('#get_this_update.filename#', 'file')#">
<cfset url.delete_update = "">
<cfset url.delete_id ="">
</cfif>
...
<B>Abstracts USA<br>30 W. Gude Dr.<br>Rockville, MD. 20850<br><cfelse><B>Abstracts USA<br>7361 Calhoun Place, Suite 200<br>Rockville, MD. 20855<br></cfif>
				...
				<CFOUTPUT>
							...
							<CFFORM NAME="frm" ACTION="./prop_abstract_invoice.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=10&company_id=#url.company_id#" METHOD=POST>
...
<FORM ACTION="./prop_file_upload2.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=0&a_trigger=3" METHOD=POST>
							...
							<NOBR><font size=2 color=blue face=arial>There is an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload2#', 'url')#" target="_new">#abstractor_doc_upload2#</a>.<br>
...
<FORM ACTION="./prop_file_upload3.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=4&company_id=#url.company_id#" METHOD=POST>
									<td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
										...
										<CFELSE>
								<tr>
									<td width=520 align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_doc_upload3#', 'url')#" target="_new">#abstractor_doc_upload3#</a>.<br>
...
<table width=520 cellpadding=1 cellspacing=1 border=1 bgcolor=d3d3d3>
...
<A HREF="#fileSys.FindFilePath('#get_updates.filename#', 'url')#" target="new">#get_updates.filename#</a> <cfif get_updates.changes eq 1>(contains changes)</cfif>&nbsp;&nbsp;<a href="#cgi.SCRIPT_NAME#?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#url.company_id#&delete_update=1&delete_id=#get_updates.ID#">delete</a><br>
</cfoutput>
<br>
</CFIF>
...
<FORM ACTION="./prop_file_upload4.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=4&company_id=#url.company_id#" METHOD=POST>
									<td width=520 valign=top align=center bgcolor="d3d3d3" ><FONT SIZE=2 FACE=ARIAL>
										...
										<CFELSE>
								<tr>
									<td width=520 align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file named: <A href="#fileSys.FindFilePath('#abstractor_invoice#', 'url')#" target="_new">#abstractor_invoice#</A>.<br>
										<a href="./prop_delete-uploaded-invoice.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&company_id=#url.company_id#" target="New" onClick="window.open('','New','width=450,height=220,left=40,top=40,status=1,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')">delete</a></TD></tr></NOBR>	  
										</CFIF>		
</FORM>
</cfoutput>  
