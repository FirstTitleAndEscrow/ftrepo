...
<cfif #email# neq "">
<cfquery name="updeed" datasource="#request.dsn#">
update doc_closer_title
SET deed_package_date = getDate()
where title_id = #get.title_ID#
</CFQUERY>
...
View/Print Deed Package <A HREF="#fileSys.FindFilePath('#get_file.deed_package#', 'url')#" target="new">#get_file.deed_package#</a> for order #rec_id#  - #get_id.bfirstname1# #get_id.blastname1#</B></font><br><br>
...
<table width=455 cellpadding=1 cellspacing=1 border=0>
		...
		<B>1st Title & Escrow, Inc. - Deed Package File Upload for Order <CFOUTPUT query="get_id">#title_id#</CFOUTPUT></B>
		<p>
...
<FORM action="./upload_deed_package_final.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=2&company_id=#company_ID#"  ENCTYPE="multipart/form-data" method="post">

<input type="hidden" name="title_id" value="#title_id#">
Insert Deed Package to upload <input type="file" size = 15 name="file_upload"><br>
