...
message = message + "In order to add a new abstractor you need to choose county(ies)/state(s) abstractor serves\n"
valid = false;
}
if (valid == false) {
alert(message);
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Add Abstractors </B>
		</td>
	</tr>
</CFOUTPUT>	
...
<table width=498 cellpadding=0 cellspacing=0 border=0 bgcolor=white>
	...
	<cfFORM name = "frm" ACTION="abstractors_add_submit.cfm?uid=#URL.uid#&al=#URL.al#" ENCTYPE="multipart/form-data" METHOD=POST>
	...
	<tr>		
		...
		<td width=368 align=left valign=top bgcolor=e6e6e6>	
			<cfinput  Required="Yes" Message="You must enter a Company Name (or the Abstractor's Name)" type=text name="company" VALUE="" size=25 maxlength=90 style="font-size: 9; 
				font-family: verdana; 
				font-style: normal; 
				color: blue; 
				background-color: e6e6e6; 
...
<!--- <tr>		
	...
	<tr>		
		<td width=468 colspan=2 align=center valign=top bgcolor=e6e6e6>	
			...
			Select County and State Abstractor is going to serve
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	<tr>		
		...
		<td width=497 align=center valign=top bgcolor=e1e1e1>	
			...
			Review the list below to ensure the Abstractors isn't already in the Database
	...
	<tr>		
		...
		<td width=497  align=right valign=top bgcolor=e1e1e1>	
			...
			rows="5" 
			cols="45" 
			><CFOUTPUT QUERY="read_abstractors"><OPTION VALUE="#company#">#Company# ---  #lname#, #fname#</OPTION></CFOUTPUT>			
			</SELECT></FORM>		
		</td>
	</tr>
