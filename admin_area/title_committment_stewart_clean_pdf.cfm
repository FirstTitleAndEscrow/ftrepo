...
<cfif #read_title.comp_id# eq 5026 or #read_title.comp_id# eq 4177 or #read_title.comp_id# eq 1754>
...
<cfif #read_title.comp_id# eq "254" or #read_title.comp_id# eq 1754>
<cfdocumentsection>
<cfdocumentitem type="header">
<style type="text/css">
td {font-family:Arial, Helvetica, sans-serif; font-size:10px}
...
<CFIF #read_Title.pstate# eq "CA"  or #read_title.comp_id# eq 1754>
<cfdocumentsection>
<cfdocumentitem type="header">
<style type="text/css">
td {font-family:Arial, Helvetica, sans-serif; font-size:10px}
...
<CFIF #Read_company.recordCount# GT 0 or #read_title.comp_id# eq 1754>

<!--- Vesting Page BEGINS HERE --->
<cfdocumentsection>
...
Issued by<br>
<cfif read_title.comp_id eq 2818 or #read_title.comp_id# eq 1754>

<table>
<tr>
<td align="right" width="405"><img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/stewart_logo.jpg" width="288" height="74"></td>
<td width="40">&nbsp;</td>
...
<cfif read_FT_company.ID eq 2632 or read_FT_company.master_co_id eq 2632>
					<img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/stewart_sigs_alan.jpg"><br>
<cfelseif read_FT_company.ID eq 9999999>
					<img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/community_sigs.jpg"><br>

				    <CFELSEIF #read_Title.pstate# eq "CA" or #read_Title.pstate# eq "NV">
                     <img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/stewart_sigs_onfile.jpg"><br>
				    <CFELSEIF #read_Title.pstate# eq "AL">
                     <img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/stewart_AL_sigs.jpg"><br>
                    <CFELSE>
                        <img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/stewart_sigs.jpg"><br>
                    </CFIF>
          </td>
    </tr>
</table>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			...
			<cfif read_title.pstate eq 'DC'>
				<tr>
                <td valign="middle" width="60%" align="left" colspan=2><font size="-1">THE EXCEPTIONS ARE MEANT TO PROVIDE YOU WITH NOTICE OF MATTERS WHICH ARE NOT COVERED UNDER THE TERMS OF THE TITLE INSURANCE POLICY AND SHOULD BE CAREFULLY CONSIDERED.
				<br><br>
...
<table width="100%" cellpadding=0 cellspacing=0 border=0 >
        <tr>
		  <td align="left" valign="middle" bgcolor="ffffff" height="30"><strong>THIS DOCUMENT CONSTITUTES A STATEMENT OF THE TERMS AND CONDITIONS ON WHICH A TITLE INSURER IS WILLING TO ISSUE A POLICY OF TITLE INSURANCE IF THE TITLE INSURER ACCEPTS THE PREMIUM FOR THE POLICY.  IT IS NOT A REPRESENTATION AS TO THE STATE OF TITLE AND IT DOES NOT CONSTITUTE AN ABSTRACT OF TITLE.</strong><br>
<br>
</td>
	</tr>
</table><br>
...
IT IS IMPORTANT TO NOTE THAT THIS FORM IS NOT A WRITTEN REPRESENTATION AS TO THE CONDITION OF TITLE AND MAY NOT LIST ALL LIENS, DEFECTS, AND ENCUMBRANCES AFFECTING TITLE TO THE LAND.
	    ...
	    <tr align="right" valign="top">
          <td colspan="2"><img src="http://<cfoutput>machine1.firsttitleservices.com</cfoutput>/images/stewart_logo.jpg" width="288" height="74"><BR><BR><BR></td>
	</tr>
</table>
</cfdocumentitem >
...
Possible right, title and interest of the State of New Jersey in and to so much of the premises in question as is now or was formerly flowed by the ebb and tide.<BR></td>
	</tr>
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
...
<tr>
	...
	<cfif #read_title.pstate# eq 'SC'>
          <tr>
             <td width="5%" valign="top"><cfoutput>8</cfoutput>.</td>
...
#read_title_data.addex#
	...
	<!--- Edit (Start) Added by Synechron Development for ticket# 761 --->
		<cfif read_title.pstate eq 'GA'>
			<tr>
					<td align = "left" colspan="3" valign="top"><B>Retroactive or additional taxes or assessments, and interest and penalties, which may be imposed by adjustment, reappraisal, reassessment, appeal, amendment to the tax records, or otherwise.<B></td>
			</tr>
		</cfif>
	<!--- Edit (End) Added by Synechron Development for ticket# 761 --->
	<!--- Edit (Start) Added by Synechron Development for ticket# 761 --->
		...
		<tr>
			<td align = "left" colspan="3" valign="top">
					<B>Retroactive or additional taxes or assessments, and interest and penalties, which may be imposed by adjustment, reappraisal, reassessment, appeal, amendment to the tax records, or otherwise.</B></td>
			</tr>
		</cfif>
	<!--- Edit (End) Added by Synechron Development for ticket# 761 --->
		<!--- <cfif read_title.pstate eq 'MD'>
...
Streamline Title
<cfelseif read_title.pstate eq 'AL'>
Alabama First Settlement & Escrow, Inc.
<cfelse>
First Title & Escrow, Inc.
</cfif></td>
