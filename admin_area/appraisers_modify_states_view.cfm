		...
		<CFQUERY datasource="#request.dsn#" NAME="read_Appraisers_states_list">

			SELECT st_id, Appraiser_ID, st_abbrev
			FROM Appraisers_states
			WHERE Appraiser_ID = #Appraiser_ID#
			ORDER BY st_abbrev ASC
		...
		<CFOUTPUT QUERY="read_Appraisers_states_list">
...
<CFOUTPUT>
	<tr>
		<td width=498 align=center valign=top bgcolor=white>
			<font size=2 color=green face=arial><B>Modify Appraisers States List</B>
		</td>
	</tr>
	...
	<tr>
		...
		<NOBR><a href="https://#cgi.server_name#/admin_area/Appraisers_modify_choose.cfm?uid=#URL.uid#&al=#URL.al#&Appraiser_ID=#Appraiser_ID#"><img src="./images/button_return.gif" border=0></a><img src="./images/clear.gif" height=10 width=85></NOBR>
...
<CFIF #read_Appraisers_states_list.recordcount# EQ "0">
	...
	<tr>
		...
		<bR>
		<font size=2 color=blue face=arial>
		This Appraiser does not have any "States Serviced" in their list.
		<p>
		</td>
	</tr>
...
<CFELSE>
	<tr>
		...
		<font size=2 color=black face=arial>
		This is the current List of States for this Appraiser.	To
		...
		State from this Appraisers Counties List
		</td>

		<td width=50 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Appraisers_modify_states_delete.cfm?uid=#URL.uid#&al=#URL.al#&Appraiser_ID=#Appraiser_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					...
					rows="5"
					cols="45"
					><CFOUTPUT QUERY="read_Appraisers_states_list"><OPTION VALUE="#st_abbrev#">#st_abbrev#</OPTION></CFOUTPUT>
			</SELECT>
		</td>
	</tr>
	...
	<tr>
		...
		<font size=2 color=black face=arial>
		Click on any of the
		States in the list to add them to this Appraisers <br>"States
		...
		<td width=50 align=left valign=top bgcolor=f1f1f1>
<CFOUTPUT>
	<FORM METHOD=POST ACTION="https://#cgi.server_name#/admin_area/Appraisers_modify_states_add.cfm?uid=#URL.uid#&al=#URL.al#&Appraiser_ID=#Appraiser_ID#">
</CFOUTPUT>
				<SELECT NAME="zip_id" MULTIPLE
					size="6"
					style="font-size: 9;
