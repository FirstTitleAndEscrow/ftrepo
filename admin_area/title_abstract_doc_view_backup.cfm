...
<!--- took UTAH out --->
			<cfif #read_title.pstate# eq "AK" or #read_title.pstate# eq "OR" or #read_title.pstate# eq "CT" or #read_title.pstate# eq "WA" or #read_title.pstate# eq "ID" or #read_title.pstate# eq "WY" or #read_title.pstate# eq "UT" or #read_title.pstate# eq "OK" or #read_title.pstate# eq "SD" or #read_title.pstate# eq "NM" or #read_title.pstate# eq "TX" or #read_title.pstate# eq "HI" or #read_title.pstate# eq "CA" or (#read_title.pstate# eq "CA" and date_diff lte 0)>
...
<!--- =========================================================== --->
			...
			<cfflush>
			<cfoutput>
			<cfform action="title_abstract_email.cfm?uid=#URL.uid#&al=#URL.al#&rec_id=#rec_id#&a_trigger=5&company_id=#url.company_id#">
			<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
							<tr>
