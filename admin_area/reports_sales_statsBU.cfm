...
<cfset admin_ids = "56,59,294,450,9,477,595">
...
<cfif session.ft_user_id eq 59 or session.ft_user_id eq 56 or session.role_id eq 34 or session.ft_user_id eq 248 or session.ft_user_id eq 9 or session.ft_user_id eq 472 or session.ft_user_id eq 477 or session.ft_user_id eq 547 or session.ft_user_id eq 285 or session.ft_user_id eq 595>
...
<cfif session.ft_user_id neq 59 and session.ft_user_id neq 56 and session.ft_user_id neq 450 and session.ft_user_id neq 460 and session.ft_user_id neq 248 and session.ft_user_id neq 9 and session.ft_user_id neq 472 and session.ft_user_id neq 477 and session.ft_user_id neq 547 and session.ft_user_id neq 285 and session.ft_user_id neq 595>
and c.intsales = #session.ft_user_id#
</cfif>
<cfif session.role_id eq 34>
and c.streamline_client <> 1
...
<td align="top" valign="left"><span class="table_header"><strong><cfif session.ft_user_id eq 59 or session.ft_user_id eq 56 or session.role_id eq 34 or session.ft_user_id eq 248 or session.ft_user_id eq 472 or session.ft_user_id eq 547 or session.ft_user_id eq 9 or session.ft_user_id eq 595>Salesperson</cfif></strong></span></td>
<td align="top" valign="left"><span class="table_header"><strong><cfif session.ft_user_id eq 59 or session.ft_user_id eq 56 or session.role_id eq 34 or session.ft_user_id eq 248 or session.ft_user_id eq 472 or session.ft_user_id eq 547 or session.ft_user_id eq 9 or session.ft_user_id eq 595>Client</cfif></strong></span></td>
</tr>
<tr>
...
<cfif session.ft_user_id eq 59 or session.ft_user_id eq 56 or session.role_id eq 34 or session.ft_user_id eq 248 or session.ft_user_id eq 9 or session.ft_user_id eq 472 or session.ft_user_id eq 547 or session.ft_user_id eq 285 or session.ft_user_id eq 595>
...
<td rowspan=3 align="top" valign="left"><cfif session.ft_user_id eq 59 or session.ft_user_id eq 56 or session.role_id eq 34 or session.ft_user_id eq 248 or session.ft_user_id eq 285 or session.ft_user_id eq 472 or session.ft_user_id eq 547 or session.ft_user_id eq 9 or session.ft_user_id eq 595>
