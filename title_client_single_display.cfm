...
<cfif get_comp_info.child_ids neq '' and get_comp_info.child_ids neq 'NULL'>
<CFQUERY datasource="#request.dsn#" NAME="read_branches">
SELECT *
    FROM companies
    WHERE id IN (#get_comp_info.child_ids#)
...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
	...
	<cfif #url.comp_id# eq "154">
			...
			<cfif get_comp_info.child_ids neq '' and get_comp_info.child_ids neq 'NULL'>
			or comp_id IN (#get_comp_info.id#,#get_comp_info.child_ids#)
			</cfif>
			)
