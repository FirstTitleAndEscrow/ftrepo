...
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#abstractor_doc_upload#). <br>
	...
	<A HREF="#fileSys.FindFilePath('#get_file1.abstractor_doc_upload#', 'url')#" target="_blank"><img src="./images/button_view.gif" border=0 ALT="View Upload file for this order"></a><BR>
...
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#abstractor_doc_upload2#). <br>
	...
	<A HREF="#fileSys.FindFilePath('#get_file2.abstractor_doc_upload2#', 'url')#" target="_blank"><img src="./images/button_view.gif" border=0 ALT="View Upload file for this order"></a><BR>
<font size=2 color=red face=arial>Adobe Acrobat Reader Required</font></TD></tr></NOBR>
...
<FORM ACTION="./upload4_abstract.cfm?rec_id=#rec_id#&company_id=#company_ID#" METHOD=POST>
	...
	<input type="submit" value="Upload File"></td>
		...
		<CFELSE>
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#abstractor_doc_upload4#). <br>
	Click this button to view it

	<A HREF="#fileSys.FindFilePath('#get_file4.abstractor_doc_upload4#', 'url')#" target="_blank"><img src="./images/button_view.gif" border=0 ALT="View Upload file for this order"></a><BR>
<font size=2 color=red face=arial>Adobe Acrobat Reader Required</font></TD></tr></NOBR>
...
<FORM ACTION="./upload5_abstract.cfm?rec_id=#rec_id#&company_id=#company_ID#" METHOD=POST>
	...
	<input type="submit" value="Upload File"></td>
		...
		<CFELSE>
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#abstractor_doc_upload5#). <br>
	Click this button to view it

	<A HREF="#fileSys.FindFilePath('#get_file4.abstractor_doc_upload5#', 'url')#" target="_blank"><img src="./images/button_view.gif" border=0 ALT="View Upload file for this order"></a><BR>
<font size=2 color=red face=arial>Adobe Acrobat Reader Required</font></TD></tr></NOBR>
...
<FORM ACTION="./upload6_abstract.cfm?rec_id=#rec_id#&company_id=#company_ID#" METHOD=POST>
	...
	<input type="submit" value="Upload File"></td>
		...
		<CFELSE>
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#abstractor_doc_upload6#). <br>
	Click this button to view it

	<A HREF="#fileSys.FindFilePath('#get_file6.abstractor_doc_upload6#', 'url')#" target="_blank"><img src="./images/button_view.gif" border=0 ALT="View Upload file for this order"></a><BR>
<font size=2 color=red face=arial>Adobe Acrobat Reader Required</font></TD></tr></NOBR>
...
<tr><td width=519 colspan=2  align=center valign=top bgcolor=f3f3f3><NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#abstractor_doc_upload3#). <br>
	...
	<A HREF="#fileSys.FindFilePath('#get_file3.abstractor_doc_upload3#', 'url')#" target="_blank"><img src="./images/button_view.gif" border=0 ALT="View Upload file for this order"></a><BR>
<font size=2 color=red face=arial>Adobe Acrobat Reader Required</font></TD></tr></NOBR>
</CFIF>		  </FORM>
