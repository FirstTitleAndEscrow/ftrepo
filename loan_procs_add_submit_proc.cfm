...
<cfif #read_processor.recordcount# GT 0>
    <CFLOCATION URL="https://#cgi.server_name#/loan_offcr_add.cfm?comp_id=#comp_id#&user_id_1=#user_id_1#&lo_id=#lo_id#&a_trigger=11&emp=#emp#">
<cfelse>
    <CFQUERY datasource="#request.dsn#" NAME="read_company">
	    SELECT *
		FROM companies
    ...
    <CFIF #read_company.companies_switch# eq "1">
	    ...
	    INSERT INTO companies_user(comp_id, user_ID, job_title, fname, lname, username, password, administrator, dateadded,status)
			VALUES(#URL.comp_ID#, #read_proc.id#, 'Processor','#FORM.lp_fname#','#FORM.lp_lname#', #username#, #password#, #form.administrator#,getdate(),1)
	    </CFQUERY>
    </CFIF>
...
<table width=430 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	...
	<cfoutput><font face="arial" size="2" color="black">To go back click here > </font> <a href="./loan_offcr_add.cfm?comp_id=#comp_id#&user_id_1=#user_id_1#&lo_id=#lo_id#&emp=#emp#" ><img src="./images/button_return.gif" border=0></a></td>	</td></tr>
</cfoutput>	</td>	</td></tr>
	</table>
...
<table width=430 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
  ...
  <font face="arial" size="2" color="black">To modify this entry click here > </font> <a href="https://#cgi.server_name#/admin_area/user_modify_view.cfm?uid=60&al=1&comp_id=#comp_id#&user_id=#read_proc.id#&emp=#emp#"><img src="https://#cgi.server_name#/admin_area/images/button_modify.gif" border=0></a></td>	</td></tr>
</td>	</td></tr>
	</table>
