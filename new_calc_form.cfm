...
<cfelse>
  ...
  <tr><td colspan="4" >&nbsp;</td><td colspan="2" bgcolor="#e9e9e9" align="center">Do you know the number of mortgage pages?
  ...
  <tr class="pagenum" <cfif form.knowpages EQ 0>style="display:none"</cfif>>
	<td colspan="4">&nbsp;</td>
	<td bgcolor="#e9e9e9" colspan="2" align="center">Mortgage Pages</td>
  ...
  <tr class="pagenum" <cfif form.knowpages EQ 0>style="display:none"</cfif>> 
	...
	<td bgcolor="#e9e9e9" colspan="2" align="center"><select name="mortgage_pages" style="font-size: 9;
										font-family: verdana;
										font-style: normal;
										color: blue;
										background-color: e6e6e6;
