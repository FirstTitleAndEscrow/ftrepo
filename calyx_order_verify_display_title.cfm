	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<cfoutput>	<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER(S)</B></center><br><p>
				<cfif #title# eq 1><center>Your Title Commitment Request Order has been Processed. Order number is <a href="./view_the_order.cfm?emp=#emp#&comp_id=#comp_id#&order_id=#read_title.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#"><b>T-#read_title.title_id#</b></a></center><br>
				<center>A HUD-1 has been
instant prepared for you! Click <cfif #read_title.hud_type# eq "0"> <a href="./title_view_hud_pg1.cfm?emp=#emp#&rec_id=#title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a><cfelse> <a href="./title_view_hud1a.cfm?emp=#emp#&rec_id=#title_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a></cfif>now.</center><br>
</cfif>
				<cfif #property# eq 1><center>Your Property Request Order has been Processed. Order number is <a href="./view_the_prop_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#read_prop.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_flag=7&emp=#emp#"><b>P-#read_prop.prop_id#</b></a></center><br>
				<cfif #read_prop.hud# eq 1><center>A HUD-1 has been
instant prepared for you! Click <cfif #read_prop.hud_type# eq "0"> <a href="./prop_view_hud_pg1.cfm?emp=#emp#&rec_id=#prop_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a><cfelse> <a href="./prop_view_hud1a.cfm?emp=#emp#&rec_id=#prop_id#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=800,height=550,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="./images/button_est_hud_1.gif"></a></cfif>now.</center><br>
</cfif>
				</cfif>
			<cfif #appraisal# eq 1><center>Your Appraisal Request Order has been Processed. Order number is <a href="./title_report_nav_appraisal.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#read_app.app_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_flag=7&emp=#emp#"><b>A-#read_app.app_id#</b></a></center><br></cfif>
			<cfif #other# eq 1><center>Your Ancillary Request Order has been Processed. <br>You have ordered -- <cfif #read_anc.codeflood# eq "F">Flood: <a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#read_anc.anc_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_flag=7&emp=#emp#"><b>F-#read_anc.anc_id#</b></a></cfif><cfif #read_anc.codeAVM# eq "AVM">&nbsp;&nbsp;AVM: <a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#read_anc.anc_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_flag=7"><b>AVM-#read_anc.anc_id#</b></a></cfif> <cfif #read_anc.codeCR# eq "CR">&nbsp;&nbsp;Credit: <a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#read_anc.anc_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_flag=7"><b>CR-#read_anc.anc_id#</b></a></cfif><cfif #read_anc.codeSigning# eq "SN">&nbsp;&nbsp;Signing: <a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#read_anc.anc_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_flag=7"><b>SN-#read_anc.anc_id#</b></a></cfif></center><br></cfif>
...
<cfif #get_user.recordcount# GT "0">
	...
	<tr><td width=770 colspan = 5 align=center valign=bottom>
				<cfoutput>
				<a href="./client_acct_mgt.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#">Return Home</a> to place another <strong>Order</strong> or access <strong>Quick Search</strong> to get to a file
				</cfoutput><p></td></tr>
		</table>
