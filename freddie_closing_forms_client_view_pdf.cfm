...
<strong>Date: <cfoutput>#DateFormat(mods.doc_date, 'm/d/yyyy')#</cfoutput><br>
...
Attention:   <cfoutput>#mods.attention#</cfoutput></strong><br>
<br>
...
<ol type="a">
<li>	
	Attorney Fee payable to Shapiro, Brown & Alt, LLP in the 1100 or 1300 section of the HUD in the amount of  $<cfoutput>#mods.attorney_fee#</cfoutput>
	
	( <span style="color:red">$<cfoutput>#mods.attorney_fee_charging#</cfoutput>, if you are charging the $25.00 wire fee</span>) . The only title fee the seller will accept is a $25.00(max) wire fee payable to your office for wiring their funds.
...
<li>Total Commission (<cfoutput>#mods.totalcommissionpct#</cfoutput>%): $<cfoutput>#mods.totalcommissionamt#</cfoutput><br>
	Listing Agent (<cfoutput>#mods.listingagentpct#</cfoutput>%): $<cfoutput>#mods.listingagentamt#</cfoutput><br>
	Selling Agent (<cfoutput>#mods.sellingagentpct#</cfoutput>%): $<cfoutput>#mods.sellingagentamt#</cfoutput><br>

</li> 
<li>	Seller Closing Cost Credit: $<cfoutput>#mods.sellingcostcredit#</cfoutput> (MAX)</li> 
<li>
	Home Warranty: $<cfoutput>#mods.homewarranty#</cfoutput> (MAX) (HOME WARRANTY MUST BE LISTED IN THE 1300 OF THE HUD on the Seller Side. Invoice to be provided by Buyer and/or agents and MUST be submitted together with the HUD. )
	<br><br>
	Other Fee: <cfoutput>#mods.otherfee1#</cfoutput>
	<br><br>
	Other Fee: <cfoutput>#mods.otherfee2#</cfoutput>
</li>
</ol>
...
href="mailto:freddiemae@streamline-title.com">FreddieMac@streamline-title.com</a><o:p></o:p></span></p>
...
href="mailto:freddiemac@streamline-title.com">freddiemac@streamline-title.com</a>
...
disbursement of proceeds to Freddie Mac, please contact your Streamline Closer
...
<p class=MsoNormal style='line-height:115%'><span style='font-size:11.0pt;
line-height:115%;font-family:TimesNewRomanPSMT;mso-fareast-font-family:"Arial Unicode MS";
mso-bidi-font-weight:bold'><a href="mailto:freddiemac@streamline-title.com">freddiemac@streamline-title.com</a>
or fax to 301-315-8197<o:p></o:p></span></p>
