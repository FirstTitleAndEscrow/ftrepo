...
<!--- <td HEIGHT="17" VALIGN="Middle" BGCOLOR="CCDAF0"><a class="lnk_mhtab" href="./title_client_report_nav.cfm?emp=#emp#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#"><b><font face="verdana,arial,helvetica" color="003399" size="1">Contact Us</font></b></a></td>
 ---></tr></cfoutput>
...
<cfoutput>
<td><cfif #read_payoff_info_1.payoff1_upload# NEQ ""><a class="lnk_mhsubnavsel" href="./pay_off_title_1_view_only.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">Pay Off-1</font></a>
...
<a class="lnk_mhsubnav" href="./pay_off_title_2_view_only.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">Pay Off-2</font></a>
<cfelse>
...
<cfif #read_current_Commitment_Clauses.insurance_co# EQ "19">
	...
	<a class="lnk_mhsubnav" href="#fileSys.FindFilePath('#inserted_commit.abstractor_doc_upload3#', 'url')#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Title Insurance</font></a>
</cfif><cfelse>
<a class="lnk_mhsubnav" href="./title_Committment.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target = "new"><font face="arial,helvetica" color="0033CC" size="2">Title Insurance</font></a>
</cfif>
...
<cfelse>
<a class="lnk_mhsubnav" href="./title_view_hud1a.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><font face="arial,helvetica" color="0033CC" size="2">PRE HUD-1A</font></a>
</cfif>
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" /><a class="lnk_mhsubnav" href="./merge_endorsements.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">HUD-Endorse</font></a>
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
<cfif #read_current_Commitment_Clauses.insurance_co# EQ "15">
...
<img src="https://#cgi.server_name#/images/masthead_subnav_sep.gif" align="AbsMiddle" border="0" height="15" width="15" />
				...
				<a class="lnk_mhsubnav" href="./ICL_view.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><font face="arial,helvetica" color="0033CC" size="2">ICL</font></a>
