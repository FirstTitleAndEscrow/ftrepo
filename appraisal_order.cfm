...
You may check the <a href="./apraisal_status.cfm?loginid=1&acct_num=#acct_num#&password=#password#">appraisal order status</a> in Account Menu.<p>
...
<CFFORM Name="frm"  ACTION="https://www.firsttitleservices.com/appraisal_verify.cfm?loginid=#loginid#&acct_num=#acct_num#&password=#password#" METHOD=POST>
...
<INPUT TYPE="hidden"  NAME="do_appraisal" VALUE="Yes">
</CFFORM>
