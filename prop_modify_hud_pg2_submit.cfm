...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_103, a103, c_date, c_time, lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_104_a, a104_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_104_b, a104_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_105_a, a105_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_105_b, a105_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_301, a301, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_302, a302, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_303, a303, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_504, a504, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_505, a505, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_801_a, a801_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_801_b, a801_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_801_d, a801_d, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_802_a, a802_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_802_b, a802_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_802_d, a802_d, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_803_a, a803_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_803_b, a803_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_804_a, a804_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_804_b, a804_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_805_a, a805_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_805_b, a805_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_806_a, a806_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_806_b, a806_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_807_a, a807_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_807_b, a807_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_808_a, a808_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_808_b, a808_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_809_a, a809_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_809_b, a809_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_810_a, a810_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_810_b, a810_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_811_a, a811_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_811_b, a811_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_901_a, a901_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_901_b, a901_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_901_c, a901_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_901_d, a901_d, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_902_a, a902_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_902_b, a902_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_902_c, a902_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_903_a, a903_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_903_b, a903_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_903_c, a903_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_904_a, a904_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_904_b, a904_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_905_a, a905_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1001_a, a1001_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1001_b, a1001_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1001_c, a1001_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1002_a, a1002_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1002_b, a1002_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1002_c, a1002_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1003_a, a1003_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1003_b, a1003_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1003_c, a1003_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1004_a, a1004_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1004_b, a1004_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1004_c, a1004_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1005_a, a1005_a, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1005_b, a1005_b, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1005_c, a1005_c, c_date, c_time,  lname)
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (prop_id, a_1400_a, a1400_a, c_date, c_time,  lname)
...
<CFIF IsDefined("URL.lo_id")>
	<CFLOCATION URL="https://#cgi.server_name#/prop_view_hud_pg1.cfm?user_id_1=#user_id_1#&lo_id=#URL.lo_id#&rec_id=#rec_id#">
<CFELSE>
	<CFLOCATION URL="https://#cgi.server_name#/prop_view_hud_pg1.cfm?user_id_1=#user_id_1#&rec_id=#rec_id#">
</CFIF>
