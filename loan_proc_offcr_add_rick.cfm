...
<CFFORM name = "frm" ACTION="./form_title_request_addr_rick.cfm?emp=#emp#&comp_id=#comp_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&zip_trigger=0&ordering_co=#ordering_co#" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
        ...
        <CFIF #emp# neq "0">
            <CFIF isdefined("read_company_user.Administrator") and #read_company_user.Administrator# eq "1">
                <tr>
                    ...
                    <br><font face="arial" size="2" color="black">Modify a Processor > <a href="./loan_proc_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&ordering_co=#ordering_co#"><img src="./images/button_modify.gif" border=0></a>. Add a new Processor > </font> <a href="./loan_proc_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&ordering_co=#ordering_co#"><img src="./images/button_add.gif" border=0></a>
                    </td>
                </tr>
            </CFIF>
        <CFELSE>
		...
		<tr>
			...
			<td bgcolor=f1f1f1 width="145" align="center" valign="top" bgcolor="a2a3fe">
				...
				<CFOUTPUT QUERY="read_loan_offcr">
					<option value="#ID#">#lo_fname# #lo_lname#</option>
				</CFOUTPUT>
				<OPTION VALUE=""></OPTION>
				</SELECT>
			</td>
...
<CFOUTPUT>
        <CFIF #emp# neq "0">
            <CFIF isdefined("read_company_user.Administrator") and #read_company_user.Administrator# eq "1">
		        <tr>
			        <td bgcolor=f1f1f1 colspan = 2 width="425" align="center" valign="top">
	                <br><font face="arial" size="2" color="black">Modify an Officer > <a href="./loan_offcr_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&ordering_co=#ordering_co#"><img src="./images/button_modify.gif" border=0></a>. Add a new Officer > <a href="./loan_offcr_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&ordering_co=#ordering_co#"><img src="./images/button_add.gif" border=0></a></font>
                    </td>
                </tr>
            </CFIF>
        <CFELSE>
