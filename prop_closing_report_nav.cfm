...
<table width=700 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
  ...
  <center> <font face=verdana size=2 color=black> If you would like to modify this closing information click here
   <a href="./form_prop_closing_order_request_modify.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_title.prop_id#&company_id=#company_ID#&Title_Ins_Co_Is=#Title_Ins_Co_Is#"><img src="./images/button_modify.gif" border=0 ALT="Modify Closing info"></a>
          </center>   <br>
</cfoutput>
			</TD>
		</TR>
