...
<!--- Take the new Title_ID and send to the temp Table along with a status of 0
which means that the Title Order is not complete.  This is for the Legal Information section. --->
<CFQUERY datasource="#request.dsn#" NAME="insert_filename">
			UPDATE title_temp_dynatek
			set title_id = #get_titleid.Title_ID#,
			legal_status = 0
...
<cfif #read_user.cc_email_1# neq "" and #read_user.cc_email_2# neq "">
<CFMAIL
TO="sazan@firsttitleservices.com"
FROM="#team_email#"
SERVER="127.0.0.1"
Subject="Copy of Customer Order with 1st Title & Escrow, Inc. #get_titleid.title_id#-#get_titleid.bfirstname1# #get_titleid.blastname1#"
TIMEOUT="600"
...
<TABLE WIDTH=770 BORDER=1 CELLSPACING=1 align="center" bgcolor=d3d3d3>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
				...
				<p><br>
				<p>
			<center><font size=3 color=black face=arial><b>YOU HAVE BEEN INVITED TO VIEW TITLE INFORMATION AS ORDERED ON THE <cfoutput>#UCase(session.site.short_name)#</cfoutput> WEB SYSTEM</B></center><br><p>
...
instantly prepared for your viewing! Click <a href="https://#cgi.server_name#/title_view_hud_pg1.cfm?comp_id=#comp_id#&rec_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center><br>
...
<CFLOCATION URL="https://#cgi.server_name#/order_verify_display_title.cfm?comp_id=#comp_id#&title_id=#get_titleid.title_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=0&appraisal=#appraisal#&other=0">
</cfif>
