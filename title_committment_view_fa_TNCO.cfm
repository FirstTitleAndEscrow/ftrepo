...
FROM="#from_email#"
SERVER="127.0.0.1"
Subject="First American Title Insurance Commitment for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#, Loan No: #read_title.loan_number#"
TIMEOUT="600"
type="HTML"
>
<cfoutput>
View/Print <A HREF="https://#cgi.server_name#/title_committment_view_fa_tnco.cfm?comp_id=115&user_id_1=723&lo_id=1217&rec_id=#rec_id#&a_trigger=1&company_id=0">First American Title Insurance Commitment</a> for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#</B></font><br><br>
...
<table width="93%" cellpadding=0 cellspacing=0 border=0 >
	<tr>
		...
		<td align="Center">
            <NOBR>First American Title Company</NOBR>
         </td>
...
<table>
<tr>
<td align="right" width="445">First American Title Insurance Company</td>
<td width="40">&nbsp;</td>
...
<b> See Exhibit "A"<br>Attached Hereto </b>
	  ...
	  <table width="100%" cellpadding=0 cellspacing=0 border=0 >
	   ...
	   <table width="93%" cellpadding=0 cellspacing=0 border=0>
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_tax">
            ...
            <td align="Center"><NOBR>First American Title Company</NOBR></td>
	...
	<cfset auto_number = #auto_number# + 1>
		  <tr align="left" valign="top">
			...
			<cfelse> in Document #read_mortgage2.data24# 
								...
								<!---(end) -- Added by Synechron Development for ticket# 454 ------->
			</cfif> </cfif><cfif #read_mortgage2.data28# neq "">Assigned to #read_mortgage2.data28# recorded on #DateFormat(read_mortgage2.data32, "mm")#/#DateFormat(read_mortgage2.data32, "dd")#/#DateFormat(read_mortgage2.data32, "yyyy")#, <cfif #read_mortgage2.data29# EQ ""> in Book #read_mortgage2.data30#, at Page #read_mortgage2.data31# <cfelse> 
	      ...
	      <tr align="left" valign="top">
			...
			<cfelse> in Document Number #read_mortgage5.data5#
			 ...
			 <cfelse> in Document #read_mortgage5.data29#
					<!---(start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif 	#len(read_mortgage5.data29)# gt 0 AND #len(read_mortgage5.data29)# gt 0 > ,</cfif>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage7.data5# 
		   ...
		   <cfelse> in Document #read_mortgage7.data24# 
						...
						<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		   </cfif> </cfif><cfif #read_mortgage7.data28# neq "">Assigned to #read_mortgage7.data28# recorded on #DateFormat(read_mortgage7.data32, "mm")#/#DateFormat(read_mortgage7.data32, "dd")#/#DateFormat(read_mortgage7.data32, "yyyy")#, <cfif #read_mortgage7.data29# EQ ""> in Book #read_mortgage7.data30#, at Page #read_mortgage7.data31# 
		   <cfelse> in Document #read_mortgage7.data29#
						<!---(start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif 	#len(read_mortgage7.data29)# gt 0 AND #len(read_mortgage7.data29)# gt 0 > ,</cfif>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage12.data5#
		  ...
		  <cfelse> in Document #read_mortgage12.data24# 
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif> </cfif><cfif #read_mortgage12.data28# neq "">Assigned to #read_mortgage12.data28# recorded on #DateFormat(read_mortgage12.data32, "mm")#/#DateFormat(read_mortgage12.data32, "dd")#/#DateFormat(read_mortgage12.data32, "yyyy")#, <cfif #read_mortgage12.data29# EQ ""> in Book #read_mortgage12.data30#, at Page #read_mortgage12.data31# <cfelse>
					in Document #read_mortgage12.data29#
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
              ...
              <cfif #read_lien15.data7# NEQ ""> <cfif #read_lien15.lienintro# NEQ "UCC Financing Statement" >#read_lien15.lienintro# Judgment <cfelse>#read_lien15.lienintro#</cfif> against #read_lien15.data7# in favor of #read_lien15.data6# in the amount of #read_lien15.data5#, dated #DateFormat(read_lien15.data4, "mm")#/#DateFormat(read_lien15.data4, "dd")#/#DateFormat(read_lien15.data4, "yyyy")# and recorded #DateFormat(read_lien15.data9, "mm")#/#DateFormat(read_lien15.data9, "dd")#/#DateFormat(read_lien15.data9, "yyyy")#
			    ...
			    <cfelse> in Document #read_lien15.data1# 
					...
					<cfif #len(read_lien15.data2)# gt 0 AND #len(read_lien15.data3)# gt 0 >
						in Book #read_lien5.data2# at Page #read_lien15.data3# 
					</cfif>
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->	
...
<!--- <p style="page-break-after:always;">&nbsp;</p> --->
<IE:DEVICERECT ID="<CFOUTPUT><CFIF #read_Title.pstate# eq "CA" OR #read_Title.pstate# eq "NV">page10<CFELSE>Page9</CFIF></cfoutput>" CLASS="masterstyle" MEDIA="print">
	    <table width="100%" cellpadding=0 cellspacing=0 border=0 >
