...
<table cellpadding="1" cellspacing="1" bgcolor = "000000" border="0" valign="top" width="770" height="25">
		...
		<!--- <td width="95" bgcolor="#CCD2D2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
         ...
         <CFIF #read_company.companies_switch# eq "1">
            ...
            <!---N 07/27/05 <CFIF #read_company_user.Administrator# eq "1">--->
						<CFIF IsDefined("read_company_user.Administrator") and #read_company_user.Administrator# eq "1">
                <td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onmouseover="this.bgColor='00FF66'" onmouseout="this.bgColor='CCD2D2'" onClick="document.location.href='./loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#';return false;"> <a class="menu1"  href="./loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New"><nobr><img src="/client/images/arrowvendor.jpg" border=0>&nbsp;<strong>USER ADMIN</strong>&nbsp;</nobr></a></td>
            </CFIF>
         <CFELSE>
            <td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onmouseover="this.bgColor='00FF66'" onmouseout="this.bgColor='CCD2D2'" onClick="document.location.href='./loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#';return false;"> <a class="menu1"  href="./loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New"><nobr><img src="/client/images/arrowvendor.jpg" border=0>&nbsp;<strong>USER ADMIN</strong>&nbsp;</nobr></a></td>
        </CFIF>
...
<CFFORM name = "frm" ACTION="./form_title_request_addr.cfm?emp=#emp#&comp_id=#comp_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&zip_trigger=0" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
        ...
        <CFIF #emp# neq "0">
            <!---<CFIF #read_company_user.Administrator# eq "1"> --->
                ...
                <tr>
                    ...
                    <br><font face="arial" size="2" color="black">Modify a Processor > <a href="./loan_proc_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img src="./images/button_modify.gif" border=0></a>. Add a new Processor > </font> <a href="./loan_proc_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img src="./images/button_add.gif" border=0></a>
                    </td>
                </tr>
            </CFIF>
        <CFELSE>
...
<CFOUTPUT>
        <CFIF #emp# neq "0">
            <!---<CFIF #read_company_user.Administrator# eq "1"> --->
		        ...
		        <tr>
			        <td bgcolor=f1f1f1 colspan = 2 width="425" align="center" valign="top">
	                <br><font face="arial" size="2" color="black">Modify an Officer > <a href="./loan_offcr_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img src="./images/button_modify.gif" border=0></a>. Add a new Officer > <a href="./loan_offcr_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img src="./images/button_add.gif" border=0></a></font>
                    </td>
                </tr>
            </CFIF>
        <CFELSE>
...
<p>
		...
		<tr><td width=770 align=center valign=bottom>	<br>
			<cfoutput><a href="./client_acct_mgt.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#"><img src="./images/button_go_back.gif" border=0 ALT="Go to main menu"></a>
			</cfoutput>
