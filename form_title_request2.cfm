...
<table cellpadding="1" cellspacing="1" bgcolor = "000000" border="0" valign="top" width="770" height="25">
	...
	<CFFORM NAME="frm" ACTION="www.google.com" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST >
...
<cfoutput><td width=314  bgcolor="f1f1f1" align=left>
				...
				<INPUT type="text"  NAME="estimated_loan_float" SIZE=20 MAXLENGTH=120
