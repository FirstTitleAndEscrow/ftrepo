...
<CFQUERY datasource="#request.dsn#" NAME="get_title">
		...
		WHERE id = #read_title.comp_id#
			...
			<CFQUERY datasource="#request.dsn#">
				...
				VALUES('Toronicia', 'Woods', #URL.rec_id#, 'Postponed to #DateFormat(requestDate, "mm")# #A_Req_Closing_Time#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'P', '1', '1')
		</CFQUERY>
		<cfelse>
...
<center><b><font face=verdana size=3 color=blue> CLOSING HAS BEEN UPDATED FOR ORDER #READ_TITLE.Prop_ID#</font></b></center>
<P>

<font face=verdana size=2 color=red> NOTE*** An email has been sent to the closing scheduler to confirm the change
...
FROM="#team_email#"
Subject="#session.site.short_name# - Closing Request for order #read_title.prop_id# -- Loan number-#read_title.loan_number#, #read_title.bfirstname1# #read_title.blastname1#"
TIMEOUT="600"
type="HTML"
>
