...
<CFOUTPUT>
 <CFFORM name="frm" ACTION="./prop_modify_hud_A_submit.cfm?lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1" onsubmit="javascript:return locate(this)" ENCTYPE="multipart/form-data" METHOD=POST>
