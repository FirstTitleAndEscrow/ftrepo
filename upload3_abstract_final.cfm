...
<CFQUERY datasource="#request.dsn#" name="write_note">
				...
				VALUES('Web', 'System', #rec_id#, 'Commitment Uploaded by Vendor - Title In Typing', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'T', '1', '1')
		</CFQUERY>
...
SERVER="127.0.0.1"
Subject="There is a file uploaded from abstractor for order #read_title.title_id#"
TIMEOUT="600"
	>

There is a file sent from abstractor for order #read_title.title_id#
