...
<cfif #a_flag# EQ "1">
      <cfquery datasource="#request.dsn#" name="getList">
               ...
               Where (YearMonth = '#YearMonthDay#') and title_ID is not null AND  (comp_id = #getcompany.id# or comp_id IN (select id from Companies where master_co_id = #getcompany.id#))
               order by c_time
      </cfquery>

	  <cfquery datasource="#request.dsn#" name="getList4">
               select * From EventList
               Where (YearMonth = '#YearMonthDay#')  and prop_ID is not null AND  (comp_id = #getcompany.id# or comp_id IN (select id from Companies where master_co_id = #getcompany.id#))
               order by c_time
      </cfquery>
               ...
               select * From EventList
               Where (YearMonth = '#YearMonthDay#') and anc_ID is not null AND  (comp_id = #getcompany.id# or comp_id IN (select id from Companies where master_co_id = #getcompany.id#))
               order by c_time
      </cfquery>

      <cfquery datasource="#request.dsn#" name="getList2">
               select * From Title_Closing_Order_Request a, EventList b where a.title_id = b.title_id and a.request_date = '#YearMonthDay#' and b.yearmonth is null AND (comp_id = #getcompany.id# or comp_id IN (select id from Companies where master_co_id = #getcompany.id#))
               order by b.c_time
      </cfquery>

	  <!---Prop Orders--->
	   <cfquery datasource="#request.dsn#" name="getList3">
               select * From Title_Closing_Order_Request_Prop a, EventList b where a.prop_id = b.prop_id and a.request_date = '#YearMonthDay#' and b.yearmonth is null AND (comp_id = #getcompany.id# or comp_id IN (select id from Companies where master_co_id = #getcompany.id#))
               order by b.c_time
      </cfquery>

			   <cfquery datasource="#request.dsn#" name="getList6">
               select * From Title_Closing_Order_Request_anc a, EventList b where a.anc_id = b.anc_id and a.request_date = '#YearMonthDay#' and b.yearmonth is null AND (comp_id = #getcompany.id# or comp_id IN (select id from Companies where master_co_id = #getcompany.id#))
               order by b.c_time
      </cfquery>
...
<CFSET comparison = DateCompare(tempdate, current)>
     						<td bgcolor="white" colspan = 7 valign=center width="80%" align="center">
								 ...
								 **If you would like to schedule a new closing please
								 <a href="./title_closing_search.cfm?comp_id=#getcompany.id#&YearMonthDay=#plugDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=3 color=red face=verdana><b>click here</b></font></a><br>
		  						<cfelse>
		...
		WHERE title_ID = #title_id#
		    			...
		    			<tr>
            				...
            				<td bgcolor="elelel" valign=center width="25%" align="center">
			  				...
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./title_closing_report_nav.cfm?comp_id=#comp_id#&rec_id=#getlist2.title_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Closing Requested </font></a>
         					</td>
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./form_title_closing_order_request_modify.cfm?comp_id=#comp_id#&rec_id=#getlist2.title_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Modify </font></a>
         					</td>
           					<td bgcolor="elelel" valign=center width="20%" align="center">
		...
		WHERE prop_ID = #prop_id#
		    			...
		    			<tr>
            				...
            				<td bgcolor="elelel" valign=center width="25%" align="center">
			  				...
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./title_closing_report_nav.cfm?comp_id=#comp_id#&rec_id=#getlist3.prop_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Closing Requested </font></a>
         					</td>
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./form_title_closing_order_request_modify.cfm?comp_id=#comp_id#&rec_id=#getlist3.prop_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Modify </font></a>
         					</td>
           					<td bgcolor="elelel" valign=center width="20%" align="center">
								<CFQUERY datasource="#request.dsn#" NAME="read_all_notes">
									SELECT *
		...
		WHERE anc_ID = #anc_id#
		    			...
		    			<tr>
            				...
            				<td bgcolor="elelel" valign=center width="25%" align="center">
			  				...
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./anc_closing_report_nav.cfm?comp_id=#comp_id#&rec_id=#anc_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Closing Requested </font></a>
         					</td>
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./form_title_closing_order_request_modify.cfm?comp_id=#comp_id#&rec_id=#anc_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Modify </font></a>
         					</td>
           					<td bgcolor="elelel" valign=center width="20%" align="center">
								<CFQUERY datasource="#request.dsn#" NAME="read_all_notes">
									SELECT *
		...
		WHERE title_ID = #title_id#
		                ...
		                <tr>
            				...
            				<td bgcolor="elelel" valign=center width="25%" align="center">
			  				...
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./form_title_closing_order_request_modify.cfm?comp_id=#comp_id#&rec_id=#getlist.title_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Modify  </font></a>
         					</td>
                    		<td bgcolor="elelel" valign=center width="20%" align="center">
								<CFQUERY datasource="#request.dsn#" NAME="read_all_notes">
									SELECT *
		...
		WHERE prop_ID = #prop_id#
		                ...
		                <tr>
            				...
            				<td bgcolor="elelel" valign=center width="25%" align="center">
			  				...
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
              					<a href="./Title_Closing_View_info.cfm?comp_id=#comp_id#&rec_id=#getlist4.prop_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Closing Info </font></a>
         					</td>
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./form_title_closing_order_request_modify.cfm?comp_id=#comp_id#&rec_id=#getlist4.prop_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Modify  </font></a>
         					</td>
                    		<td bgcolor="elelel" valign=center width="20%" align="center">
								<CFQUERY datasource="#request.dsn#" NAME="read_all_notes">
									SELECT *
		...
		WHERE anc_ID = #anc_id#
		                ...
		                <tr>
            				...
            				<td bgcolor="elelel" valign=center width="25%" align="center">
			  				...
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
              					<a href="./anc_Closing_View_info.cfm?comp_id=#comp_id#&rec_id=#anc_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Closing Info </font></a>
         					</td>
			  				<td bgcolor="elelel" valign=center width="20%" align="center">
			  					<a href="./form_title_closing_order_request_modify.cfm?comp_id=#comp_id#&rec_id=#anc_id#&company_id=#getcompany.id#&YearMonthDay=#yearMonthDay#&UserID=#getuser.ID#&user_id_1=#URL.user_id_1#&lo_id=#url.lo_id#"><font size=1 color=blue face=verdana> Modify  </font></a>
         					</td>
