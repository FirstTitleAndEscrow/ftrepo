...
of North Carolina real estate transactions in which you are to be the lessee or purchaser of an interest in land or a
lender secured by a mortgage (including any other security instrument) of an interest in land in accordance with N.C.
Gen. Stat. Sec. 58-26-1, the Company, subject to the Conditions and Exclusions set forth below, hereby agrees to
reimburse you for actual loss incurred by you in connection with such closings when conducted by an Issuing Agent
(an agent authorized to issue title insurance for the Company) or an Approved Attorney (an attorney upon whose
certification of title the Company issues title insurance) and when such loss arises out of:
<br>
<br>
...
said mortgage on said interest in land, including the obtaining of documents and the disbursements of funds necessary
...
insurance protection inconsistent with that, set forth in the title insurance binder or commitment issued by the
Company. Instructions that require the removal of specific exceptions to title or compliance with the requirements
...
insolvency or suspension, except such as shall result from failure of the Issuing Agent or Approved Attorney to comply
with your written closing instructions to deposit the funds in a bank which you designated by name.
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Mechanics' and materialmen's liens in connection with your purchase or lease or construction loan transactions,
except to the extent that a title insurance binder, commitment or policy of the Company affords protection against such
liens.
<BR><BR>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <BR><BR>
