...
.taxtext  {font-family:Arial, Helvetica, sans-serif; font-size:8pt;}
</style>

<cfoutput>

<table width="800"><tr><td align="center" valign="top">
<table width="100%">
<tr>
...
<cfoutput>
<tr bgcolor="FFFFFF">
<td align="left" valign="top" class="taxtext">#read_report.tax_address#<br />
#read_report.tax_city#, #read_report.tax_state# #read_report.tax_zip#<br /></td>
<td align="left" valign="top" class="taxtext">#read_report.Tax_Rate_Area#</td>
<td align="left" valign="top" class="taxtext">#read_report.data19#</td>
<td align="left" valign="top" class="taxtext">#read_report.data37#</td>
<td align="left" valign="top" class="taxtext">#read_report.data30#
</td>
<td align="left" valign="top" class="taxtext">#read_report.data34#</td>
