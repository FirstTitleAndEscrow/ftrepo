...
and completed is NULL
and task = 'Review'
<cfif get_typing_work.recordcount gt 0>
...
<cfoutput><form action="vendor_typing.cfm?username=#URLEncodedFormat(get_vendor.Username)#&password=#URLEncodedFormat(get_vendor.Password)#&a_trigger=1&company_id=0" method="post" enctype="multipart/form-data" name="review_form"></cfoutput>
