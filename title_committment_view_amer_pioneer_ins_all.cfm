...
SERVER="127.0.0.1"
Subject="First Title - Title Insurance Commitment for order #rec_id# - #read_title.bfirstname1# #read_title.blastname1#. Loan No: #read_title.loan_number#"
TIMEOUT="600"
type="HTML"
>

<!--- target="new" --->
View/Print <A HREF="https://#cgi.server_name#/title_committment_view_amer_pioneer_ins_all.cfm?comp_id=115&user_id_1=723&lo_id=1217&rec_id=#rec_id#&a_trigger=1&company_id=0" >Ticor Title Insurance Commitment</a> for order #rec_id#  - #read_title.bfirstname1# #read_title.blastname1#</B></font><br><br>
...
<cfFORM NAME="Search" METHOD="post" ACTION="./title_committment_view_amer_pioneer_ins_all.cfm?rec_id=#rec_id#&a_trigger=20">
...
<!-----A 2 starts  ----->
<tr><td lign=center>
		<table width="100%" align="center"><!---Harry--->
     <tr>
...
<tr><td>
	<table width="100%" align="center">
		...
		<tr>
			<td>&nbsp;</td>
			<td><table width="80%" cellpadding="0" cellspacing="0" align="right"><tr><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
<cfif read_title.title_id eq '35649'>
<b>MORTAGE LENDERS NETWORK USA, INC., its Successors and/or Assigns (ISAOA), ATIMA</b>
<cfelse>
<b>#read_title.insured#, it's successors and/or assigns, as their interests may appear.</b>
</cfif></font></td></tr></table></td>
			<td>$&nbsp;&nbsp;&nbsp;<font face="Verdana, Arial, Helvetica, sans-serif" size="2">#NumberFormat(Replace(read_title.loanamt_float, ",", "", "ALL"), "999,999,999.00")#</font></td>
		</tr>
		<tr><td colspan="3">&nbsp;</td></tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td>$&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face="Verdana, Arial, Helvetica, sans-serif" size="2"><cfif #read_title.purchase# neq "">#NumberFormat(Replace(read_title.Purchase, ",", "", "ALL"), "999,999,999.00")#</CFIF></font></td>
		</tr>
		<tr><td colspan="3">&nbsp;</td></tr>
</CFOUTPUT>
		<tr>
	...
	<tr>
        ...
        <tr>
		  ...
		  Issued By:<br><CFIF #read_title.comp_ID# eq 324><!---Eastern Residential will always be Superior Title--->
		   <B>Superior Title & Escrow, LLC<br><cfif NOT DateDiff("d", Now(), "1/30/2012")>
          ...
          <td>Instrument(s) creating the estate or interest to be insured must
			...
			<tr><td colspan="2" height="10"></td></tr>
              <tr>
                ...
                <td>
			Deed of Trust from <cfif #Read_temp_comp_b1.bfirstname1# neq "">#Read_temp_comp_b1.bfirstname1#</cfif>&nbsp;<cfif #Read_temp_comp_b1.bminame1# neq "">#Read_temp_comp_b1.bminame1#.</cfif><cfif #Read_temp_comp_b1.blastname1# neq ""> #Read_temp_comp_b1.blastname1#</cfif><cfif #Read_temp_comp_b1.bfirstname2# neq ""> AND #Read_temp_comp_b1.bfirstname2#</cfif>&nbsp;<cfif #Read_temp_comp_b1.bminame2# neq "">#Read_temp_comp_b1.bminame2#.</cfif><cfif #Read_temp_comp_b1.blastname2# neq ""> #Read_temp_comp_b1.blastname2#</cfif>, securing <cfif #Read_temp_comp_b1.insured# neq "">#Read_temp_comp_b1.insured#</cfif> in the amount of $#Read_temp_comp_b1.loanamt_float#<br></td></tr></table>
		</tr>
...
<!--- 		<tr align="left" valign="top">
		...
		<!---Harry 11/04/2004 per Gary if this is MO then numbering changes and
             next section gets left out
        --->

        <CFIF #read_title.pstate# neq "MO">
         <cfif read_title.title_id neq 35698>
        <tr align="left" valign="top">
          <td>4</td>
		...
		<tr align="left" valign="top">
          <CFIF #read_title.pstate# neq "MO">
            <td>6<cfset auto_number = 6></td>
		  <CFELSE>
            <td>5<cfset auto_number = 5></td>
          </CFIF>
          <td>Satisfactory evidence should be had that improvements and/or repairs
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage6.data5# 
		  ...
		  <cfelse> in Document #read_mortgage6.data29#
			...
			<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage6.data29)# gt 0 AND #len(read_mortgage6.data29)# gt 0 > ,</cfif>
		    ...
		    <td>
					...
					<cfelse> in Document Number #read_mortgage9.data5#
					   ...
					   <cfelse> in Document #read_mortgage9.data29#
						<!---(start) -- Added by Synechron Development for ticket# 454 ------->
						<cfif 	#len(read_mortgage9.data29)# gt 0 AND #len(read_mortgage9.data29)# gt 0 > ,</cfif>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage11.data5# 
		  ...
		  <cfelse> in Document #read_mortgage11.data29#
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage11.data29)# gt 0 AND #len(read_mortgage11.data29)# gt 0 > ,</cfif>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage12.data5# 
		  ...
		  <cfelse> in Document #read_mortgage12.data29#
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage12.data29)# gt 0 AND #len(read_mortgage12.data29)# gt 0 > ,</cfif>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage13.data5# 
		 ...
		 <!---(start) -- Added by Synechron Development for ticket# 454 ------->
		  ...
		  <cfelse> in Document #read_mortgage13.data31#
...
<CFQUERY datasource="#request.dsn#" NAME="read_mortgage14">
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage14.data5# 
		  ...
		  <cfelse> in Document #read_mortgage14.data31#
...
<CFQUERY datasource="#request.dsn#" NAME="read_mortgage16">
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage16.data5# 
		  ...
		  <cfelse> in Document #read_mortgage16.data31#
...
<font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>#read_Title.Title_ID#</b></font></td>
	   ...
	   <tr>
        ...
        <tr>
          <td align = "left"><p><B><cfoutput>
<cfif #read_title_data.addex# neq "">#text_1#</cfif>
		</cfoutput>
		 </b><P></td>
        </tr>
        <tr>
...
<p style="page-break-after:always;">&nbsp;</p>
<IE:DEVICERECT ID="page13" CLASS="masterstyle" MEDIA="print">
<table cellpadding=1 cellspacing=1 border=0 width="100%">
  <tr>
    <td align="center" valign="middle" bgcolor="black" height="30"><font color="white" size="3" face="Arial, Helvetica, sans-serif"><b>COMMITMENT - Schedule B-2 Cont'd</b></font></td>
	</tr></table>
...
<font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>#read_Title.Title_ID#</b></font></td>
	   ...
	   <tr>
        ...
        <tr>
          <td align = "left"><p><B><cfoutput>
<cfif #read_title_data.addex# neq "">#text_2#</cfif>
		</cfoutput>
		 </b><P></td>
        </tr>
        <tr>
...
<cfif #Read_Committment_Doc.deed_status# eq "">
      ...
      Being the same property as transferred by #read_title_data.data5# on #DateFormat(read_title_data.data10, "mm")#/#DateFormat(read_title_data.data10, "dd")#/#DateFormat(read_title_data.data10, "yyyy")# and recorded #DateFormat(read_title_data.data11, "mm")#/#DateFormat(read_title_data.data11, "dd")#/#DateFormat(read_title_data.data11, "yyyy")# from #read_title_data.data1#<cfif #read_title_data.data2# NEQ ""> and #read_title_data.data2#</CFIF> to #read_title_data.data3# <CFIF #read_title_data.data4# NEQ "">and #read_title_data.data4#</CFIF>, <cfif read_title_data.data6 neq 'NULL' and read_title_data.data6 NEQ ''>#read_title_data.data6#, </cfif><cfif #read_title_data.data7# eq ""><CFIF #read_title_data.data8# NEQ ""> recorded in Book #read_title_data.data8#</cfif><cfif #read_title_data.data9# neq ""> and Page #read_title_data.data9#</cfif><cfelse> recorded in Document Number #read_title_data.data7# 
			...
			<!---(end) -- Added by Synechron Development for ticket# 454 ------->
	  </cfif></cfif><cfelse><cfif #Read_Committment_Doc.a_comments# neq "">#read_committment_doc.a_comments#</cfif></cfif></cfoutput>
		 </b><P>
		 <cfoutput>#read_title_data.data14#<br></cfoutput>
		 </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
...
<cfelseif read_comp.ID eq 2368 or read_comp.master_co_id eq 2368>
Funds should be wired to:<br>
<br>
