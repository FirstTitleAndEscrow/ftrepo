...
<CFQUERY datasource="#request.dsn#" NAME="get_title_ins">
			SELECT *
			FROM Doc_Title_Insurance_Title
			WHERE Title_ID = #rec_id#
		</CFQUERY>

		<CFQUERY datasource="#request.dsn#" NAME="get_title_comp">
			SELECT *
			FROM Title_Companies
			WHERE title_co_id = #get_title_ins.Insurance_co#
		</CFQUERY>
...
<cfif #read_data2.a_1102_b# neq "0">&nbsp;
    ...
    <tr >
      <td> <font size="1" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif"><font color=black>1108. Title Insurance
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to
        <font color=blue> <cfif #read_data2.a_1108_a# neq "0" OR #read_data2.a_1108_b# neq ""><b>#get_title_comp.company#</b> </cfif></font></font></td>
      ...
      <td valign=top> <table align="center" width="100%" cellspacing=0 cellpadding=0>
          <tr valign="bottom">
            <td width="45%"><font size="1" face="Arial, Helvetica, sans-serif"><br>
              <cfoutput>#session.site.long_name#</cfoutput> -- <font color="##FF0000">Printed <b>
