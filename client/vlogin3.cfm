...
<div class="container_16" id="main_content">
		...
		<div class="ctnt_left">
			...
			<div class="login_area">
				<img src="https://www.firsttitleservices.com/wp-content/themes/firsttitle/images/login_top.gif" border="0" alt="">
				<div class="login_bg">
					<h1>VENDOR LOGIN <cfif #a_trigger# neq 0>ERROR!</cfif></h1>
					...
					<form action="https://machine1.firsttitleservices.com/vendor_login_submit.cfm" method="post">

						<p><label>Username</label> <input name="user" type="text" class="loginbox"></p>
						<p><label>Password</label> <input name="pass" type="password" class="loginbox"></p>

					<div style="padding-left:100px;"><input type="image" src="https://www.firsttitleservices.com/wp-content/themes/firsttitle/images/btn_submit.gif" border="0" alt=""></div>
					<p>Having trouble logging in? Click one of the links below for help.</p>
					</form>
					<h2>Browser Compatibility</h2>
					<p>We are currently compatible with these browsers:</p>
					<li>Internet Explorer 9 & Above</li>
					<li>Google Chrome</li>
					<li>Firefox</li>
				</div>
				...
				<div class="login_btm">
					...
					<a href="https://machine1.firsttitleservices.com/client/vendor_new2.cfm">Don't Have An Account ?</a>
				</div>
			</div>
		</div>
		<div class="ctnt_right">
			<div class="right_list_area">
				<img src="http://www.firsttitleservices.com/wp-content/themes/firsttitle/images/right_list_top.gif" border="0" alt="">
				...
				<img src="http://www.firsttitleservices.com/wp-content/themes/firsttitle/images/right_list_btm.gif" border="0" alt="">
			</div>
		</div>
		<div class="clear"></div>
