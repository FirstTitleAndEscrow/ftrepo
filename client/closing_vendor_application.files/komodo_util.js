	...
	// clear radio buttons if no judgments/liens checkbox is checked
	...
	// if no lien/judgments is checked, disable all form elements in section
	function disableJudgment() {
