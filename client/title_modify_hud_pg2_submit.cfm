...
<!--
    function Locate(){
		 ...
		 window.location= "https://<cfoutput>#cgi.server_name#</cfoutput>/title_view_hud_pg1_modify.cfm?user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&rec_id=<cfoutput>#rec_id#</cfoutput>&a_trigger=2";
...
codebase="https://www.meadroid.com/scriptx/ScriptX.cab#Version=6,2,433,14">
</object>
<!---
<cfoutput>
...
<div id=idControls align="center" class="noprint">
 ...
 <p>
 <cfoutput>
 <FORM METHOD=POST ACTION="./title_view_hud_pg1.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#" name="frm" ENABLECAB="Yes">
</cfoutput>

 <a href="#" onclick=printWindow();><input disabled type="submit" value="Print the page"
 onclick="factory.printing.Print(true)"></a></form>
 <input disabled type="button" value="Page Setup..."
 onclick="factory.printing.PageSetup()">
 <input class=ie55 disabled type="button" value="Print Preview..."
 onclick="factory.printing.Preview()">
   <a href="./title_view_hud_pg1_modify.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=2&company_id=#get_titleid.comp_ID#"><input class=ie55 disabled type="button" value="Modify..." onclick="Locate();"></a>
<br>
...
<CFSET c_date = #DateFormat(Now(), "mm/dd/yyyy")#>
   ...
   <cfif #read_hud1_after.recordcount# gt 0>
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (title_id, a_105_a, a_105_v, line, c_date, c_time)
				VALUES (#rec_id#, '#read_hud1_before.a_105_a#', '#read_hud1_after.a_105_v#', '105', '#c_date#', '#c_time#')
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (title_id, a_901_a, a_901_v, line, c_date, c_time)
				VALUES (#rec_id#, '#read_hud1_before.a_901_a#', '#read_hud1_after.a_901_a#', '901', '#c_date#', '#c_time#')
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (title_id, a_105_a, line, c_date, c_time)
				VALUES (#rec_id#, '#read_hud1_before.a_105_a#', '105', '#c_date#', '#c_time#')
...
<cfquery  datasource="#request.dsn#">
   ...
   <cfif #read_hud2_after.recordcount# gt 0>
    <cfquery  datasource="#request.dsn#">
			INSERT INTO
				hud_modify (title_id, a_901_a, line, c_date, c_time)
				VALUES (#rec_id#, '#read_hud2_before.a_901_a#', '901', '#c_date#', '#c_time#')
    ...
    <CFQUERY datasource="#request.dsn#" NAME="read_hud1">
			...
			WHERE title_id = #rec_id# and a_105_a is not null
	</cfquery>
  <cfoutput query = "read_hud">

  Line 105 was changed from #a_105_a# to #a_105_v#<br>

 </cfoutput>
     <CFQUERY datasource="#request.dsn#" NAME="read_hud2">
			Select * from hud_modify
			WHERE title_id = #rec_id# and a_901_a is not null
	</cfquery>
  <cfoutput query = "read_hud2">

  Line 901 was changed from #a_901_a# to #a_901_v#<br>
...
<cfif #read_data2.a_1102_b# neq "0">&nbsp;
    ...
    <tr >
      <td> <font size="1" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif"><font color=black>1108. Title Insurance
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to
        <font color=blue> <cfif #read_data2.a_1108_a# neq "0" OR #read_data2.a_1108_b# neq ""><b>#get_ins.company#</b> </cfif></font></font></td>
      ...
      <td valign=top> <table align="center" width="100%" cellspacing=0 cellpadding=0>
          <tr valign="bottom">
            <td width="45%"><font size="1" face="Arial, Helvetica, sans-serif"><br>
              #session.site.long_name# -- <font color="FF0000">Printed <b>
