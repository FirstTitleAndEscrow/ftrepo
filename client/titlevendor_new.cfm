...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		<td  valign="top" width="160" style="vertical-align:top">
...
<center><p><font face="Arial, Helvetica, sans-serif" size="2">
	...
	<p><font face="Arial, Helvetica, sans-serif" size="2">
<cfoutput>#session.site.short_name#</cfoutput> prides itself on its allegiances with the top mortgage lending institutions in the country.  However, these allegiances would not be possible without quality vendor relationships.  Abstractors and Title Search Agents are rewarded for superior service and expedient turn times.  <cfoutput>#session.site.short_name#</cfoutput> makes it easy for Abstractors and Title Search Agents to provide services and receive compensation therefore, through the use of our state of the art, user friendly technology, and helpful and friendly staff.
</font></p>
<p><font face="Arial, Helvetica, sans-serif" size="2">
We are constantly seeking Abstractors and Title Search Agents who take pride in their work, provide superior service and wish to be a part of a team of top quality Abstractors and Title Search Agents.  By choosing to work with <cfoutput>#session.site.short_name#</cfoutput>, you will enjoy:
</font></p>
...
<li><font face="Arial, Helvetica, sans-serif" size="2">One Click Status Reports</font></li></ul>
	<p><font face="Arial, Helvetica, sans-serif" size="2">
If you wish to be part of our team, click <a href="abstractorapp_new.cfm">here</a> to complete our simple Vendor Application.
</font></p>
