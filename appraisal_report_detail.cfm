...
<TABLE BORDER=0 WIDTH=100%>
  <TR><TD>
  <cfoutput><FONT FACE=ARIAL SIZE=5><B>Appraisal Detail: #readin.company#</B></FONT><BR>
...
<cfoutput>
<A HREF="#fileSys.FindFilePath('#getorderinfo.file_upload#', 'url')#">Click to View/Print Report</a><BR>
