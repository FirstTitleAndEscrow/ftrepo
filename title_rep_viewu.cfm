		...
		<CFQUERY datasource="#request.dsn#" NAME="read_pid">
			...
			WHERE ID = #user_id_1#
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./form_Title_Closing_Order_Request.cfm?A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_title_order_req.gif" border=0 ALT="Manage the Title Order Request for this order"></a>
						</td>
					</tr>
