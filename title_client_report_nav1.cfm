...
<table width=830 cellpadding=1 cellspacing=1 border=0 bgcolor="white">
	...
	<cfoutput>
				    		...
				    		A copy of your
order is below. If you require an endorsement to your title binder, please
select our new auto-endorse feature below.<p><a href="https://#cgi.server_name#/endorse_modify.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#read_title_order.title_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><img src="./images/button_auto_endorse.gif" border=0></a>
		            	 </center>
<p>
