...
<CFMAIL
				TO="#to_email#"
				FROM="#from_email#"
				 Subject="New Abstract report request from #requesting_name# - Order #prefix#-#read_title.FDR_id#-#get_comp.ID#"
				TIMEOUT="600"
...
ORDER -   #prefix#-#read_title.FDR_id#-#get_comp.ID# PLEASE REFERENCE ON YOUR INVOICE 
