...
<CFQUERY datasource="#request.dsn#" NAME="read_current_Commitment_Clauses">		
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_appraisal_upload">
			SELECT *
			FROM Appraisal
			WHERE app_ID = #rec_ID#		
		</CFQUERY>
...
<table width=780 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<tr>
		...
		<tr>
	<td width=89 align=center valign=top bgcolor=d3d3d3>
<!--- 			<a href="./title_report_navu.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#"><img src="./images/button_view_order.gif" border=0 ALT="View the Title Report for this order"></a> <br>
 --->			<a href="./title_client_upload.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#rec_id#&a_trigger=1&company_id=#read_title_order.comp_ID#&type=App"><img src="./images/button_upload_file.gif" border=0 ALT="View Uploaded file for this order"></a>&nbsp;<CFIF #read_appraisal_upload.appraisal_doc_upload# EQ ""><img src="./admin_area/images/ind_open.gif" border=0><cfelse><img src="./admin_area/images/ind_closed.gif" border=0></CFIF> 
