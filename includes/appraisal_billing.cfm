...
<!---Initialize Variable--->
<CFSET Flag = "0">
<!---The Appraisal Check box must be checked and a price needs to be entered--->

<CFIF (read_company.blnAppraisal eq "1") AND (#LEN(read_company.FeeAppraisal)# gte "1")>
    <CFSET Flag = "1">
<CFELSE>
    <CFSET Flag = "0">
</CFIF>
