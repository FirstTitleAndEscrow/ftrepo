...
<cfdocument format="pdf" fileName="c:\uploads\#order_type#-#read_property.prop_id#_INVOICE.pdf" overwrite="true">
<cfoutput>
...
<cfelse>
		...
		<td valign="top">
			<table cellpadding="8">
				...
				<tr><td>S&B File No.</td>
					<td>P-#read_property.loan_number#</td>
				</tr>
				<tr><td>Buyer</td>
