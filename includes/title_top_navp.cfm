...
<table width=790 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<CFOUTPUT><tr>
			...
			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./prop_vendor_add_data.cfm?username=#url.username#&password=#url.password#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_raw_data.gif" border=0 ALT="Click this button to add Raw Data for this order"></a>
			</td>
			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./prop_vendor_data_form.cfm?username=#url.username#&password=#url.password#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_data_form.gif" border=0 ALT="Click this button to add data to the Title Insurance Commitment form  for this order"></a>
			</td>

			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./prop_view_file.cfm?username=#url.username#&password=#url.password#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_view_file.gif" border=0 ALT="Click this button to view file for this order"></a>
			</td>
			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./prop_vendor_upload.cfm?username=#url.username#&password=#url.password#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_upload_file.gif" border=0 ALT="Click this button to upload file for this order"></a>
			</td>
<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./admin_area/prop_tax_cert_view.cfm?uid=60&al=1&username=#url.username#&password=#url.password#&rec_id=#rec_id#&a_trigger=1&company_id=#company_ID#"><img src="./images/button_add_tax.gif" border=0 ALT="Click this button to upload file for this order"></a>
			</td>
		</tr>
