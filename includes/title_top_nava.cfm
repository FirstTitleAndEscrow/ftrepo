...
<table width=790 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
	<CFOUTPUT><tr>
			...
			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./abstractor_tu_deed.cfm?rec_id=#rec_id#&a_trigger=1"><img src="./images/button_add_deed.gif" border=0 ALT="Click this button to add Raw Data for this order"></a>
			</td>
			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./abstractor_tu_mortgage.cfm?rec_id=#rec_id#&a_trigger=1"><img src="./images/button_add_mortgage.gif" border=0 ALT="Click this button to add data to the Title Insurance Commitment form  for this order"></a>
			</td>
			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./abstractor_tu_lien.cfm?rec_id=#rec_id#&a_trigger=1"><img src="./images/button_add_lien.gif" border=0 ALT="Click this button to upload file for this order"></a>
			</td>
				<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./abstractor_tu_tax.cfm?rec_id=#rec_id#&a_trigger=1"><img src="./images/button_add_tax.gif" border=0 ALT="Click this button to upload file for this order"></a>
			</td>
			<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./abstractor_tu_legal.cfm?rec_id=#rec_id#&a_trigger=1"><img src="./images/button_add_legal.gif" border=0 ALT="Click this button to upload file for this order"></a>
			</td>
		<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./abstractor_tu_update.cfm?rec_id=#rec_id#&a_trigger=1"><img src="./images/button_add_update.gif" border=0 ALT="Click this button to upload file for this order"></a>
			</td>
		<td width=90 align=center valign=top bgcolor=d3d3d3>
				<a href="./abstractor_tu_recap.cfm?rec_id=#rec_id#&a_trigger=1"><img src="./images/button_add_recap.gif" border=0 ALT="Click this button to upload file for this order"></a>
			</td>
		</tr>
