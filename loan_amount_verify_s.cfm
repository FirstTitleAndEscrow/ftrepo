...
<cfquery  datasource="#request.dsn#">
			...
			UPDATE TITLE SET loanamt_float = '#loanamt_float#', loan_end_date_s = '#DateFormat(Now(), "mmmmm dd, yyyy")#', e_status = 5 WHERE title_ID = #rec_id#</cfif>
...
<cfset reissue_rates = read_title.reissue_rates>
  ...
  <tr>
    <td colspan="3" align="center"> <font size="5">GENERAL ENDORSEMENT</font><br>
      ...
      <p> <font size="1">ISSUED BY</font><br>
        <font size="4"><b>Stewart Title</b></font>
      <p>
    </td>
  </tr>
...
<FONT FACE=verdana SIZE=1 color="blue"><b>#loanamt_float#</b>
  ...
  <tr>
    <td colspan="3">
	  ...
	  <tr>
    <td valign="top" width="22%"> <b><font size="4">Stewart Title </font></b></td>
	  <td colspan="2">

      <p>Dated <b><cfoutput>#get_titleid.loan_end_date_s#</cfoutput></b> and Issued By: </p>
