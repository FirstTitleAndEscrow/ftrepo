          ...
          <tr>
            ...
            <td valign="top"> <table width="100%" valign="top" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td width="20">&nbsp;</td>
                  <td><B><cfif read_title.comp_id eq 3943 or read_title.comp_id eq 4043 or read_title.comp_id eq 4042 or read_title.comp_id eq 4702 or read_title.title_id eq 44907>#read_title.full_vesting#<cfelse><cfif #read_title.purchase# neq ""><cfif Len(read_title.company1)>#read_title.company1#<cfelse>#Buyer_1#<cfif Len(Trim(Buyer_2))>, &nbsp;&nbsp;#Buyer_2#</cfif><cfif Len(read_title.blastname3)>, &nbsp;&nbsp;#read_title.bfirstname3# #read_title.blastname3#</cfif><cfif read_title.manner_of_title neq ''>, #read_title.manner_of_title#</cfif></cfif></cfif></cfif></td>
                </tr>
              </table></td>
...
<cfif #read_mortgage.data1# NEQ ""> <cfif read_mortgage.lienintro neq "" and read_mortgage.lienintro neq 'NULL' or Len(read_mortgage.lienintro) eq 0>#read_mortgage.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage.data2# <cfif #read_mortgage.data3# neq ""> and #read_mortgage.data3#</cfif> securing #read_mortgage.data1# in the original principal amount of #read_mortgage.data4#, as dated #DateFormat(read_mortgage.data8, "mm")#/#DateFormat(read_mortgage.data8, "dd")#/#DateFormat(read_mortgage.data8, "yyyy")# and recorded on #DateFormat(read_mortgage.data9, "mm")#/#DateFormat(read_mortgage.data9, "dd")#/#DateFormat(read_mortgage.data9, "yyyy")# among the Land Records of #read_title.pcounty# County, <cfif #read_mortgage.data5# eq ""><cfif #read_mortgage.data6# neq "">
	in Book #read_mortgage.data6# at Page #read_mortgage.data7# </cfif>
			...
			<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				...
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage.data29)# gt 0 AND #len(read_mortgage.data29)# gt 0 > ,</cfif>
	...
	<cfset auto_number = #auto_number# + 1>
		  <tr align="left" valign="top">
            ...
            <cfif #read_mortgage2.data1# NEQ ""> <cfif read_mortgage2.lienintro neq "" and read_mortgage2.lienintro neq 'NULL'>#read_mortgage2.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage2.data2# <cfif #read_mortgage2.data3# neq ""> and #read_mortgage2.data3#</cfif> securing #read_mortgage2.data1# in the original principal amount of #read_mortgage2.data4#, as dated #DateFormat(read_mortgage2.data8, "mm")#/#DateFormat(read_mortgage2.data8, "dd")#/#DateFormat(read_mortgage2.data8, "yyyy")# and recorded on #DateFormat(read_mortgage2.data9, "mm")#/#DateFormat(read_mortgage2.data9, "dd")#/#DateFormat(read_mortgage2.data9, "yyyy")# among the Land Records of #read_title.pcounty# County, <cfif #read_mortgage2.data5# eq ""><cfif #read_mortgage2.data6# neq "">
				...
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage2.data29)# gt 0 AND #len(read_mortgage2.data29)# gt 0 > ,</cfif>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
		   ...
		   in Book #read_mortgage3.data30#, at Page #read_mortgage3.data31# <cfelse> in Document #read_mortgage3.data29#
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
		    ...
		    <td>
			 ...
			 <cfelse> in Document #read_mortgage5.data19# 
			  ...
			  <cfelse> in Document #read_mortgage5.data24# 
					...
					<!---(end) -- Added by Synechron Development for ticket# 454 ------->
			 </cfif> </cfif><cfif #read_mortgage5.data28# neq "">Assigned to #read_mortgage5.data28# recorded on #DateFormat(read_mortgage5.data32, "mm")#/#DateFormat(read_mortgage5.data32, "dd")#/#DateFormat(read_mortgage5.data32, "yyyy")#, <cfif #read_mortgage5.data29# EQ ""> in Book #read_mortgage5.data30#, at Page #read_mortgage5.data31# 
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		<cfelse> in Document Number #read_mortgage6.data5# 
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif><cfif #read_mortgage6.data13# neq ""> Assigned to #read_mortgage6.data13# recorded on #DateFormat(read_mortgage6.data17, "mm")#/#DateFormat(read_mortgage6.data17, "dd")#/#DateFormat(read_mortgage6.data17, "yyyy")#, in Book <cfif #read_mortgage6.data14# eq "">#read_mortgage6.data15#, at Page #read_mortgage6.data16# 
		  <cfelse> in Document #read_mortgage6.data14#
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif> </cfif><cfif #read_mortgage6.data18# neq "">Assigned to #read_mortgage6.data18# recorded on #DateFormat(read_mortgage6.data22, "mm")#/#DateFormat(read_mortgage6.data22, "dd")#/#DateFormat(read_mortgage6.data22, "yyyy")#, <cfif #read_mortgage6.data19# eq "">in Book #read_mortgage6.data20#, at Page #read_mortgage6.data21# 
		  <cfelse> in Document #read_mortgage6.data19# 
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif> </cfif><cfif #read_mortgage6.data23# neq "">Assigned to #read_mortgage6.data23# recorded on #DateFormat(read_mortgage6.data27, "mm")#/#DateFormat(read_mortgage6.data27, "dd")#/#DateFormat(read_mortgage6.data27, "yyyy")#, <cfif #read_mortgage6.data24# eq ""> in Book #read_mortgage6.data25#, at Page #read_mortgage6.data26# 
	      ...
	      <tr align="left" valign="top">
		    ...
		    <td>
			 ...
			 <cfelse> in Document #read_mortgage8.data29#
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage8.data29)# gt 0 AND #len(read_mortgage8.data29)# gt 0 > ,</cfif>
	      ...
	      <tr align="left" valign="top">
		    ...
		    <td>
					   ...
					   <cfelse> in Document #read_mortgage9.data24# 
						...
						<!---(end) -- Added by Synechron Development for ticket# 454 ------->
					   </cfif> </cfif><cfif #read_mortgage9.data28# neq "">Assigned to #read_mortgage9.data28# recorded on #DateFormat(read_mortgage9.data32, "mm")#/#DateFormat(read_mortgage9.data32, "dd")#/#DateFormat(read_mortgage9.data32, "yyyy")#, <cfif #read_mortgage9.data29# EQ ""> in Book #read_mortgage9.data30#, at Page #read_mortgage9.data31# 
					   <cfelse> in Document #read_mortgage9.data31# 
	...
	<cfset auto_number = #auto_number# + 1>
          ...
          <cfif #read_mortgage10.data1# NEQ ""> <cfif read_mortgage10.lienintro neq "" and read_mortgage10.lienintro neq 'NULL' or Len(read_mortgage10.lienintro) eq 0>#read_mortgage10.lienintro#<cfelse>Satisfaction and/or release of</cfif> Mortgage from #read_mortgage10.data2# <cfif #read_mortgage10.data3# neq ""> and #read_mortgage10.data3#</cfif> securing #read_mortgage10.data1# in the original principal amount of #read_mortgage10.data4#, as dated #DateFormat(read_mortgage10.data8, "mm")#/#DateFormat(read_mortgage10.data8, "dd")#/#DateFormat(read_mortgage10.data8, "yyyy")# and recorded on #DateFormat(read_mortgage10.data9, "mm")#/#DateFormat(read_mortgage10.data9, "dd")#/#DateFormat(read_mortgage10.data9, "yyyy")# among the Land Records of #read_title.pcounty# County, <cfif #read_mortgage10.data5# eq ""><cfif #read_mortgage10.data6# neq "">
			...
			<cfelse> in Document Number #read_mortgage10.data5# 
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif><cfif #read_mortgage10.data13# neq ""> Assigned to #read_mortgage10.data13# recorded on #DateFormat(read_mortgage10.data17, "mm")#/#DateFormat(read_mortgage10.data17, "dd")#/#DateFormat(read_mortgage10.data17, "yyyy")#, in Book <cfif #read_mortgage10.data14# eq "">#read_mortgage10.data15#, at Page #read_mortgage10.data16# 
		  <cfelse> in Document #read_mortgage10.data14#
				  <!---(start) -- Added by Synechron Development for ticket# 454 ------->
						...
						<!---(end) -- Added by Synechron Development for ticket# 454 ------->	
		  </cfif> </cfif><cfif #read_mortgage10.data18# neq "">Assigned to #read_mortgage10.data18# recorded on #DateFormat(read_mortgage10.data22, "mm")#/#DateFormat(read_mortgage10.data22, "dd")#/#DateFormat(read_mortgage10.data22, "yyyy")#, <cfif #read_mortgage10.data19# eq "">in Book #read_mortgage10.data20#, at Page #read_mortgage10.data21# 
		  <cfelse> in Document #read_mortgage10.data19# 
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif> </cfif><cfif #read_mortgage10.data23# neq "">Assigned to #read_mortgage10.data23# recorded on #DateFormat(read_mortgage10.data27, "mm")#/#DateFormat(read_mortgage10.data27, "dd")#/#DateFormat(read_mortgage10.data27, "yyyy")#, <cfif #read_mortgage10.data24# eq ""> in Book #read_mortgage10.data25#, at Page #read_mortgage10.data26# 
		  <cfelse> in Document #read_mortgage10.data24# 
				...
				<!---(end) -- Added by Synechron Development for ticket# 454 ------->
		  </cfif> </cfif><cfif #read_mortgage10.data28# neq "">Assigned to #read_mortgage10.data28# recorded on #DateFormat(read_mortgage10.data32, "mm")#/#DateFormat(read_mortgage10.data32, "dd")#/#DateFormat(read_mortgage10.data32, "yyyy")#, <cfif #read_mortgage10.data29# EQ ""> in Book #read_mortgage10.data30#, at Page #read_mortgage10.data31# 
		  <cfelse> in Document #read_mortgage10.data29#
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage10.data29)# gt 0 AND #len(read_mortgage10.data29)# gt 0 > ,</cfif>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		  ...
		  </cfif><cfif #read_mortgage11.data13# neq ""> Assigned to #read_mortgage11.data13# recorded on #DateFormat(read_mortgage11.data17, "mm")#/#DateFormat(read_mortgage11.data17, "dd")#/#DateFormat(read_mortgage11.data17, "yyyy")#, in Book <cfif #read_mortgage11.data14# eq "">
		  #read_mortgage11.data15#, at Page #read_mortgage11.data16# 
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		  ...
		  </cfif><cfelse> in Document Number #read_mortgage13.data5# 
					<!---(start) -- Added by Synechron Development for ticket# 454 ------->
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		...
		in Book #read_mortgage14.data6# at Page #read_mortgage14.data7# 
		  </cfif><cfelse> in Document Number #read_mortgage14.data5# 
					<!---(start) -- Added by Synechron Development for ticket# 454 ------->
		  ...
		  <cfelse> in Document #read_mortgage14.data29#
						<!---(start) -- Added by Synechron Development for ticket# 454 ------->
							<cfif 	#len(read_mortgage14.data29)# gt 0 AND #len(read_mortgage14.data29)# gt 0 > ,</cfif>
...
<cfset mortgages_liens = 1>
	...
	<cfset auto_number = #auto_number# + 1>
		  ...
		  </cfif><cfelse> in Document Number #read_mortgage15.data5# 
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
		  ...
		  <cfelse> in Document #read_mortgage15.data29#
				<!---(start) -- Added by Synechron Development for ticket# 454 ------->
				<cfif 	#len(read_mortgage15.data29)# gt 0 AND #len(read_mortgage15.data29)# gt 0 > ,</cfif>
		    ...
		    <td>
              <cfif #read_lien9.data7# NEQ ""> <cfif #read_lien9.lienintro# NEQ "UCC Financing Statement" >#read_lien9.lienintro# Judgment <cfelse>#read_lien9.lienintro#</cfif> against #read_lien9.data7# in favor of #read_lien9.data6# in the amount of #read_lien9.data5#, dated #DateFormat(read_lien9.data4, "mm")#/#DateFormat(read_lien9.data4, "dd")#/#DateFormat(read_lien9.data4, "yyyy")#
			   and recorded #DateFormat(read_lien9.data9, "mm")#/#DateFormat(read_lien9.data9, "dd")#/#DateFormat(read_lien9.data9, "yyyy")#
			     <cfif #read_lien9.data1# eq ""> in Book #read_lien9.data2# at Page #read_lien9.data3# 
...
<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
            <td><cfoutput>#auto_number#</cfoutput>.</td>
		    <td>
              <cfoutput>#read_title_data.addreq#</cfoutput><br>
<br>
		</td>
	</tr>
</cfif>
...
<!--- <cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
		    <td><cfoutput>#auto_number#</cfoutput>.</td>
       <td>
Subject to the proper instrument(s) creating the estate or interest to be insured must be executed and duly filed for record to wit:
<BR>
&nbsp;&nbsp;&nbsp;a. Subject to the final order of ratification and audit.<BR>
&nbsp;&nbsp;&nbsp;b. Record trustee deed from __________________, Trustee to __________________ in the amount of _____________.<BR>
&nbsp;&nbsp;&nbsp;c. Record deed from __________________ to __________________ in the amount of _____________.<BR>
&nbsp;&nbsp;&nbsp;d. Record deed of trust from __________________ to __________________ in the amount of _____________.<BR>
<BR>
</td>
		</tr> --->
...
<cfset auto_number = #auto_number# + 1>
	      <tr align="left" valign="top">
		    <td><cfoutput>#auto_number#</cfoutput>.</td>
       <td>
Pay all general and special taxes now due and payable including the following:<BR>
&nbsp;&nbsp;&nbsp;d. homeowners association fees (if applicable)<BR>
&nbsp;&nbsp;&nbsp;d. condominium fees (if applicable)<BR>
&nbsp;&nbsp;&nbsp;d. water usage bills (if applicable)
</td>
		</tr>
	<tr>
		  <td colspan="2">&nbsp;</td>
...
<cfset auto_number = #auto_number# + 1>
	...
	<tr>
		  <td valign="top" width="5%"><cfoutput>#auto_number#</cfoutput>.</td><td colspan="2">Affidavit of mailing of notice of intent to foreclose (Must have been sent no sooner than 45 days after default under the note and at least 45 days prior to the filing of the Order to Docket).</td></tr>
...
<!--- <cfif read_title.searchtype NEQ 'Purchase' and read_title.pstate neq 'MI'>
...
<cfparam name="auto_num" default="9">
	<tr>
		  <td colspan="2">&nbsp;</td>
	</tr>
    <tr>
...
<br></td>
			...
			<cfif len(read_Title_Data.addex) GT 500>
<cfset extra_text = Mid(read_Title_Data.addex, 500, Len(read_Title_Data.addex))>
<cfset stop_number = FindNoCase(" ", read_Title_Data.addex, 500)>

<cfif stop_number GTE 1>
...
<cfif len(read_Title_Data.addex) LTE 500>
...
<table width="93%" cellpadding=0 cellspacing=0 border=0 >
	...
	<tr>
        ...
        <tr>
          <td align = "left" colspan=2><font size=-1><p><B><cfoutput>
#text_2#
		</cfoutput>
		 </b></font></td>
        </tr>
