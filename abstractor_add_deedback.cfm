...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/abstractor_add_deed_submit.cfm?rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes">
...
<!--- ===/ LOAN PROCESSOR INFO \=== --->
	...
	<tr>
		...
		<td width=237 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="grantor2" Required="Yes" Message="You must enter a GRANTOR2 NAME"  size=40 maxlength=600
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
