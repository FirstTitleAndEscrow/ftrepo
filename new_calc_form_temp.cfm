...
<table width="655" cellpadding="3" cellspacing="3" bgcolor="#FFFFFF">
  ...
  <tr>
	...
	<cfif form.property_state neq 'CA'><option value="Purchase" <cfif form.transaction_type eq "Purchase">selected</cfif>>Purchase</option></cfif>
...
<cfif cgi.SCRIPT_NAME eq "/calculator_temp.cfm">
