...
<CFFORM METHOD=POST ACTION="./calyx_loan_procs_add_submit_proc.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&emp=#emp#" name="frm"  ENABLECAB="Yes">
                                                            <tr>
...
<!--- ===/ LOAN PROCESSOR INFO \=== --->
                                                            ...
                                                            <!---If the switch in companies is not sent it means that they are not adding
                                                                user permissions --->
                                                            <CFIF #read_company.Companies_Switch# eq "1">
                                                                <tr>
                                                                    ...
                                                                    <td width=300 align=left valign=top bgcolor=e6e6e6>
			                                                            <CFINPUT Required="Yes" Message="You must enter a user name" type=text name="username"  size=20 maxlength=30
				                                                            style="font-size: 9;
                                                        				    font-family: verdana;
                                                        				    font-style: normal;
                                                        				    color: blue;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width=300 align=left valign=top bgcolor=e6e6e6>
			                                                            <CFINPUT Required="Yes" Message="You must enter a password" type=text name="password"  size=20 maxlength=30
				                                                            style="font-size: 9;
                                                        				    font-family: verdana;
                                                        				    font-style: normal;
                                                        				    color: blue;
                                                            ...
                                                            <CFIF #read_company.Companies_Switch# eq "1">
                                                                ...
                                                                <!---I Commented this out for the time being because when you
                                                                        add a person there is no reason to have an active or inactive choice--->
                                                                <!---<tr>
		                                                            <td width=130 align=right valign=top bgcolor=e6e6e6>
			                                                            <font size=2 color=black face=arial>
			                                                            Status
                                                                    ...
                                                                    <!---<td width=300 align=left valign=top bgcolor=e6e6e6>
                                                                        Active <INPUT TYPE="RADIO" NAME="Status" VALUE="1" checked> Inactive <INPUT TYPE="radio" NAME="Status" VALUE="0" >
                                                                    </td>
                                                                </tr>--->
                                                            </CFIF>
                                                            <tr>
