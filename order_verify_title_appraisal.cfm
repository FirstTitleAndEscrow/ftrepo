...
<CFQUERY datasource="#request.dsn#" NAME="getcompany">
 ...
 <!---Billing--->
    <CFINCLUDE TEMPLATE="./includes/Appraisal_Billing.cfm">
<!-------------------------------------------------------------------->
...
<cfINPUT TYPE="Text" NAME="input_date" size=12 maxlength=20 REQUIRED="Yes" Message="You must enter the Closing Date Request"
								...
								style="font-size: 9;
									...
									border-style: bar;
									clear: none;" >
							 <font face=verdana size=2 color=black> <A href="javascript:ShowCalendar(document.all('calpic'),document.all('input_date'),document.all('null'),'09/1/2004', '12/31/2009')" onclick="event.cancelBubble=true;"><img src="https://<cfoutput>#cgi.server_name#</cfoutput>/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic" style="POSITION: relative"></A>
