...
<td align="left" valign="top" width="350">email to: fanniemae@streamline-title.com</td>
</tr>
</table><br>
...
<br>
You are required to wire seller funds same day of closing in MD - (48 HOURS POST SETTLEMENT IF PROPERTY IS IN VIRGINIA). <span style="color:red">ONCE THIS TRANSACTION HAS FUNDED, A COPY OF THE THE SELLER WIRE CONFIRMATION (WHICH MUST INCLUDE THE FEDERAL REFERENCE NUMBER) AND THE DEED RECORDING RECEIPT MUST BE SENT TO FANNIEMAE@STREAMLINE-TITLE.COM.</span> If you fail to fund within the required timeframe, a penalty will be assessed to your company at a fee of $25 per day in a separate check which should be sent to Shapiro Brown & Alt, LLP c/o Streamline Title & Escrow at 7361 Calhoun Place, Suite 200, Rockville, MD 20855.
...
<td align="left" valign="top" colspan=3><br>
<br>
Return this signed acknowledgement with the approved HUD to: fanniemae@streamline-title.com</td>
</tr>
<tr>
...
<p class=MsoBodyTextCxSpMiddle align=center style='text-align:center'><br><br><b
...
#DateFormat(mods.doc_date, 'm/d/yyyy')#<cfelse>#DateFormat(Now(), 'm/d/yyyy')#
</cfif></cfoutput><br>
...
Contract Closing Date: <cfoutput>#Dateformat(mods.contract_closing_date,'mm/dd/yyyy')#</cfoutput><br>
To:   <cfoutput><cfif mods.recordcount and Len(mods.title_co)>
#mods.title_co#<cfelse>
</cfif></cfoutput></strong><br>

To Whom It May Concern:
<br>
Streamline Title & Escrow, LLC will be representing Fannie Mae in the above referenced transaction. Please review the following closing instructions CAREFULLY. 
...
<ol type="a">
<li>	Seller Settlement Fee payable to Shapiro Brown & Alt, LLP in the amount of $450.00 on the seller side of the HUD on line 1111 or below. <i>If MD property, the amount will be $250.00.</i> ** </li> 
<li>	Seller Abstract Title Fee payable to Shapiro, Brown & Alt, LLP in the amount of $175.00 on the seller side of the HUD on line 1112 or below. **</li> 
<li>	Seller will ONLY pay a $10.00 wire fee payable to your office as their funds must be wired.</li> 
</ol>
...
<i>**Seller Settlement & Abstract Title Fee checks payable to Shapiro Brown & Alt, LLP are to be forward to Streamline Title & Escrow, 7361 Calhoun Place, Suite 200, Rockville, MD 20855 at the time of disbursement.</i><br><br>


<p>
Agents Commissions are to be listed as follow:<br>
A. Listing Agent 2.5% = $<cfoutput>#mods.listingagentamt#</cfoutput><br>
B. Selling Agent 3.0% = $<cfoutput>#mods.sellingagentamt#</cfoutput><br>
C. Tech Fee* Credit on Line 704/705. *PLEASE REVIEW THE TECH FEE EXAMPLE ATTACHED TO SHOW IT PROPERLY ON YOUR HUD. (The Tech Fee only applies to closings where the listing agent’s commission is a minimum of $1,125.00)
...
href="mailto:fanniemae@streamline-title.com">fanniemae@streamline-title.com</a><o:p></o:p></span></p>
...
<strong>ONCE THIS TRANSACTION HAS FUNDED, A COPY OF THE SELLER WIRE CONFIRMATION (WHICH MUST INCLUDE THE 22 DIGIT FEDERAL REFERENCE NUMBER) AND THE DEED RECORDING RECEIPT or COPY OF THE RECORDED DEED MUST BE SENT TO FANNIEMAE@STREAMLINE-TITLE.COM.</strong>
...
_______________________________________<br>
<strong>Printed Name of Signatory</strong><br>


Please email back executed document to: fanniemae@streamline-title.com or fax to 301-315-8197<br><br>
...
Price: <cfoutput>#DollarFormat(get_titleid.purchase)#</cfoutput><o:p></o:p></span></p>
...
IN THE FANNIE MAE CONTRACT ADDENDUM WHICH IS:</span><span style="text-align:center"> <cfoutput>#get_titleid.bfirstname1# #get_titleid.blastname1# <cfif Len(get_titleid.blastname2)>and</cfif> #get_titleid.bfirstname2# #get_titleid.blastname2#</cfoutput><o:p></o:p></span></b></p>



<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
style='font-size:11.0pt;font-family:"Arial Narrow","sans-serif"'>FINANCE TYPE: <cfoutput>#mods.finance_type#</cfoutput></span></b></p>
...
href="mailto:fanniemae@streamline-title.com">fanniemae@streamline-title.com</a>
...
<p class=MsoNormal style='line-height:115%'><span style='font-size:11.0pt;
line-height:115%;font-family:TimesNewRomanPSMT;mso-fareast-font-family:"Arial Unicode MS";
mso-bidi-font-weight:bold'><a href="mailto:fanniemae@streamline-title.com">fanniemae@streamline-title.com</a>
or fax to 301-315-8197<o:p></o:p></span></p>
...
<p class=Default align=center style='text-align:center'><b><span
style='font-size:10.0pt'>THIS WAIVER AND RELEASE IS TO BE EXECUTED ONLY AT
CLOSING</span></b><span style='font-size:10.0pt'><o:p></o:p></span></p>


<p class=Default style='text-align:justify;line-height:115%'><span
style='font-size:10.0pt;line-height:115%'>This Waiver and Release Regarding
Property Condition at Closing is given by </span><span style='font-size:10.0pt;line-height:115%'><cfoutput>#get_titleid.bfirstname1# #get_titleid.blastname1# <cfif Len(get_titleid.blastname2)>and</cfif> #get_titleid.bfirstname2# #get_titleid.blastname2#</cfoutput></span><span
style='font-size:10.0pt;line-height:115%'> (“Purchaser”) to FANNIE MAE A/K/A
FEDERAL NATIONAL MORTGAGE ASSOCIATION (“Seller”) in connection with the
purchase of the property located at </span><span style='font-size:10.0pt;line-height:115%'><cfoutput>#get_titleid.paddress#, #get_titleid.pcity#, #get_titleid.pstate# #get_titleid.pzip#</cfoutput>
</span><span style='font-size:10.0pt;line-height:115%'>(“Property”) pursuant to
the contract of sale between Purchaser and Seller with an Effective Date
of ______________, 201__ (“Contract”). <o:p></o:p></span></p>


<p class=Default style='text-align:justify'><span style='font-size:10.0pt'>Purchaser
...
mso-list:l2 level1 lfo7'><![if !supportLists]><span style='font-size:10.0pt'><span
style='mso-list:Ignore'>(1)<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.0pt'>the physical
...
</span></span></span><![endif]><span style='font-size:10.0pt'>the conformity of
...
</span></span></span><![endif]><span style='font-size:10.0pt'>the habitability,
...
mso-list:l1 level1 lfo8'><![if !supportLists]><span style='font-size:10.0pt'><span
style='mso-list:Ignore'>(1)<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.0pt'>Purchaser is
...
mso-list:l1 level1 lfo8'><![if !supportLists]><span style='font-size:10.0pt'><span
style='mso-list:Ignore'>(2)<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.0pt'>Neither Seller,
...
mso-list:l1 level1 lfo8'><![if !supportLists]><span style='font-size:10.0pt'><span
style='mso-list:Ignore'>(3)<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.0pt'>Purchaser has not
...
</span></span></span><![endif]><span style='font-size:10.0pt'>Purchaser has
...
</span></span></span><![endif]><span style='font-size:10.0pt'>Purchaser will
...
<p class=Default style='text-align:justify'><span style='font-size:10.0pt'>Waiver
and Release 2012&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Revised<o:p></o:p></span></p>
<!---<p align="center">Page 1 of 4</p>--->
</IE:DEVICERECT>

<p style="page-break-after:always;">&nbsp;</p>

<IE:DEVICERECT ID="page2" CLASS="" MEDIA="print">
<p class=Default style='text-align:justify'><b><span style='font-size:10.0pt'>AS
...
style='font-size:10.0pt'>ANY AND ALL CLAIMS ARISING FROM THE ADJUSTMENTS OR
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
style='font-size:10.0pt'>ANY CLAIMS FOR FAILURE OF CONSIDERATION AND/OR MISTAKE
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
style='font-size:10.0pt'>ANY REMEDY OF ANY KIND, OTHER THAN AS EXPRESSLY
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
style='font-size:10.0pt'>TRIAL BY JURY, EXCEPT AS PROHIBITED BY LAW, IN ANY
LITIGATION ARISING FROM OR CONNECTED WITH OR RELATED TO THIS AGREEMENT; <o:p></o:p></span></b></p>

<p class=Default style='text-align:justify'><span style='font-size:10.0pt'><o:p>&nbsp;</o:p></span></p>

<p class=Default style='margin-left:32.25pt;text-align:justify;text-indent:
-18.75pt;mso-list:l9 level1 lfo9'><![if !supportLists]><b><span
style='font-size:10.0pt'><span style='mso-list:Ignore'>(E)<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
style='font-size:10.0pt'>ANY CLAIMS OR LOSSES PURCHASER MAY INCUR AS A RESULT
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
style='font-size:10.0pt'>ANY RIGHT TO AVOID THIS SALE OR REDUCE THE PRICE OR
...
normal'><span style='font-size:10.0pt'><span style='mso-list:Ignore'>(G)<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
style='font-size:10.0pt'>ANY CLAIM ARISING FROM ENCROACHMENTS, EASEMENTS, SHORTAGES
...
<p class=Default style='margin-left:32.25pt;text-align:justify;text-indent:
-18.75pt;mso-list:l9 level1 lfo9'><![if !supportLists]><b><span
style='font-size:10.0pt'><span style='mso-list:Ignore'>(H)<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
style='font-size:10.0pt'>ANY RIGHT TO MEDIATION OR ARBITRATION RELATING TO OR
ARISING UNDER OR FROM THIS AGREEMENT, EXCEPT AS PROHIBITED BY LAW. <o:p></o:p></span></b></p>



<p class=Default style='text-align:justify'><b><span style='font-size:10.0pt'>IF
THE PROPERTY IS LOCATED IN CALIFORNIA THE FOLLOWING PARAGRAPHS SHALL APPLY: <o:p></o:p></span></b></p>


<p class=Default style='text-align:justify'><span style='font-size:10.0pt'>It
...
<p class=Default style='text-align:justify'><b><span style='font-size:10.0pt'>“A
...
<p class=Default style='text-align:justify'><span style='font-size:10.0pt'>The
...
style='font-size:10.0pt;line-height:150%'>Executed this __________day of
__________________________, 201__. <o:p></o:p></span></p>



<p class=Default style='text-align:justify'><span style='font-size:10.0pt'>Witnesses:
Purchaser: <o:p></o:p></span></p>

<p class=Default style='text-align:justify'><span style='font-size:10.0pt'><o:p>_______________________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_______________________</o:p></span></p>

<p class=Default style='text-align:justify'><span style='font-size:10.0pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cfoutput>#get_titleid.bfirstname1# #get_titleid.blastname1#</cfoutput></span></p>


<p class=MsoNormal style='text-align:justify'><span style='font-size:10.0pt'><o:p>_______________________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_______________________</o:p></span></p>

<p class=Default style='text-align:justify'><span style='font-size:10.0pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cfoutput>#get_titleid.bfirstname2# #get_titleid.blastname2#</cfoutput></span></p>



<p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><span
style='font-size:10.0pt'>Waiver and Release 2012&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Revised<o:p></o:p></span></p>
...
TimesNewRomanPSMT'>FANNIE MAE LOAN #: <cfoutput>#get_titleid.loan_number#</cfoutput></span></p>


<p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><span
style='font-size:11.0pt;font-family:TimesNewRomanPSMT;mso-bidi-font-family:
TimesNewRomanPSMT'>REO #: <cfoutput>#get_titleid.reo_number#</cfoutput></span></p>
...
<span style='mso-tab-count:2'>             </span><cfoutput>#get_titleid.bfirstname1# #get_titleid.blastname1# <cfif Len(get_titleid.blastname2)>and</cfif> #get_titleid.bfirstname2# #get_titleid.blastname2#</cfoutput><o:p></o:p></span></p>
...
<p class=MsoNormal style='text-align:left'><span style='font-size:11.0pt;font-family:TimesNewRomanPSMT;
...
Shapiro Brown &amp; Alt, LLP, as Attorney in Fact<o:p></o:p></span></p>
...
_________________________________________<br>
 <span style='mso-tab-count:1'> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cfoutput>#get_titleid.bfirstname1# #get_titleid.blastname1#</cfoutput><o:p></o:p></span></p>
...
<p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><span
style='font-size:11.0pt;font-family:TimesNewRomanPSMT;mso-bidi-font-family:
TimesNewRomanPSMT'><span style='mso-tab-count:2'>                        </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_________________________________________
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cfoutput>#get_titleid.bfirstname2# #get_titleid.blastname2#</cfoutput>
<o:p></o:p></span></p>
...
style='mso-tab-count:2'><cfoutput>#get_titleid.bfirstname1# #get_titleid.blastname1# <cfif Len(get_titleid.blastname2)>and</cfif> #get_titleid.bfirstname2# #get_titleid.blastname2#</cfoutput>                        </span><o:p></o:p></u></span></p>


<p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><span
style='font-size:11.0pt;font-family:TimesNewRomanPSMT;mso-bidi-font-family:
TimesNewRomanPSMT'>LOAN NO: <u><span style='mso-tab-count:8'><cfoutput>#get_titleid.loan_number#</cfoutput></u></span>                                                                                        </span></u>
 &nbsp;&nbsp;&nbsp;REO CASE NO:<u><span style='mso-tab-count:
...
style='mso-spacerun:yes'> </span>By: Shapiro Brown &amp; Alt, LLP, as Attorney
...
<p align="center"><img src="admin_area/images/sb1.jpg" width="700">
<br><br>
<img src="admin_area/images/sb2.jpg" width="700">
</strong><br></P>
