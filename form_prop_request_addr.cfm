...
<table width=607 border="0" cellpadding="0" cellspacing="0" background="./images/back_02.gif">
	...
	<tr>
		<td width=607 align=center valign=top>
				...
				<p>
	<CFFORM NAME="frm" ACTION="./form_prop_request_addr_verify.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_id=0&zip_trigger=0" METHOD=POST>
...
<CFIF #zip_trigger# EQ "1">
					...
					<CFOUTPUT QUERY="read_state_list">
							...
							<option value="#st_abbrev#" SELECTED>#st_abbrev#</option>
								<CFELSE>
<!--- here I'm going to remove Oregon and Washington, unless it's a Vanderbilt account --->
<cfif st_abbrev eq 'OR' or st_abbrev eq 'WA'>
<cfif session.comp_id eq '2395' or session.comp_id eq '2818' or session.comp_id eq '2181'>
