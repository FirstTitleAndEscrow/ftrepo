...
<CFIF #Len(get_old1.a_req_closing_date)# gte 1>
request_dateold = '#DateFormat(get_old1.a_req_closing_date, "mm/dd/yyyy")#'
<cfelse>
request_dateold = '#DateFormat(get_old1.request_date, "mm/dd/yyyy")#'
</CFIF>
where title_id = #URL.rec_id#
</cfquery>
...
<center><b><font face=verdana size=3 color=blue> CLOSING HAS BEEN UPDATED FOR ORDER #READ_TITLE.TITLE_ID#</font></b></center>
<P>
...
<CFMAIL
TO="mhoston@mortgageinvestors.com,#email_address#"
FROM="#team_email#"
Subject="#session.site.short_name# - Closing Request for order #read_title.title_id# -- Loan number-#read_title.loan_number#, #read_title.bfirstname1# #read_title.blastname1#"
TIMEOUT="600"
type="HTML"
