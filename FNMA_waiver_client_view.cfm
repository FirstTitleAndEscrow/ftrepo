...
<table border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td align="left" valign="top">REO# <cfoutput><cfif get_titleid.recordcount and Len(get_titleid.fannie_reo_id)>#get_titleid.fannie_reo_id#</cfif></cfoutput></td>
  </tr>
</table>
...
<cfoutput><cfif mods.recordcount and Len(mods.verbal_ack_date)>#mods.verbal_ack_date#_________
...
<table width="775" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td align="left" valign="top">ANY AND ALL CLAIMS ARISING FROM THE ADJUSTMENTS OR PROBATIONS OR ERRORS IN CALCULATING THE ADJUSTMENTS OR PROBATIONS THAT ARE OR MAY BE DISCOVERED AFTER CLOSING;<br>
<br>
</td>
  </tr>
</table>
