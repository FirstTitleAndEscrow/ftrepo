...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				TITLE (check_date, user_id, comp_id, loan_off_id, oname, ophone, oext, ofax, o_email, pname,
...
<!--- </CFIF>
		...
		<tr><td width=607 align=right valign=bottom>
			<cfoutput> <input type="hidden" name="file_upload" value="#file_upload#"></cfoutput>
