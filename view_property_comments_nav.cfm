...
<CFPARAM NAME="A_Update_DB_Flag" DEFAULT="0">
	...
	<CFIF #A_Update_DB_Flag# GT "0">
		...
		<CFQUERY datasource="#request.dsn#">
				...
				VALUES('#username#', #URL.rec_id#, '#N_Note_1#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'P', '1', '1')
			</CFQUERY>
...
<cfcatch type="Any">
		...
		<hr>
			...
			<CFQUERY datasource="#request.dsn#" NAME="read_all_notes">
				SELECT *
				FROM Title_Notes
				Where Order_Id = #URL.rec_id# and access = 1
...
<CFFORM NAME="frm" ACTION="./view_Title_comments_nav.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#url.rec_id#&a_trigger=1&Title_Ins_Co_Is=#Title_Ins_Co_Is#&A_Update_DB_Flag=1" onsubmit="javascript:return locate(this)" ENCTYPE="multipart/form-data" METHOD=POST>
