...
<CFPARAM NAME="LOGStransactionID" DEFAULT="">
...
<cfif comp_id eq 6872 and search_type eq 'A'>
<cfset search_type = 'B'>
</cfif>
...
<cfif due_date eq '' and IsDate(sale_date)>
<cfset due_date = DateFormat(DateAdd("d", -10, sale_date), "mm/dd/yyyy")>
</cfif>
		<cfquery  datasource="#request.dsn#">
	INSERT INTO
		PROPERTY (type,dateandtime, hud_type, loanamt_float, hud, loan_number,transType, check_date, check_time,
				...
				order_status, prop_use_type, codeP,company1,company2,taxID1,taxID2,search_type, order_date, loantype, cost_per_copy, total_copies <cfif session.logged_in_vendor_id neq 0>, opened_by_vendor_id</cfif>, LOGStransactionID, reo_number, sale_date, due_date)
					   ...
					   '#verifyemail_3#', '#fax_no#','#rptbyemail#', '#a_insert_date#', '#a_insert_time#',
					    '#duedate#', '#order_date_adj#', #a_day_1#, #a_month_1#, #a_year_1#,
						 ...
						 #a_day_of_year_1#, '#polender1#', '#poacctno1#', '#pophone1#', '#polender2#',
						  ...
						  '#trim(company2)#','#trim(taxID1)#','#trim(taxID2)#','#trim(search_type)#', #CreateODBCDate(Now())#, <cfif isDefined("loantype")>'#loantype#'<cfelse>NULL</cfif>,<cfif isDefined("cost_per_copy")>'#cost_per_copy#'<cfelse>NULL</cfif>,<cfif isDefined("total_copies")>'#total_copies#'<cfelse>NULL</cfif> <cfif session.logged_in_vendor_id neq 0>, #session.logged_in_vendor_id#</cfif>, '#LOGStransactionID#', '#reo_number#', '#sale_date#', '#due_date#')
	</cfquery>
...
<CFQUERY DATASOURCE="#request.dsn#">
						...
						VALUES('Web', 'System', #get_propid.prop_ID#, 'Comment from order: #a_COMMENT#', '#DateFormat(Now(), "m/d/yyyy")#', '#TimeFormat(Now(), "HH:mm:ss")#', 'P')
					</CFQUERY>
</cfif>
...
<cftry>
<cfset update_this_prop_id = get_propid.prop_id>
<cfinclude template="rick_tests/update_prop_hud_fee_calc.cfm">
      <cfcatch type="Any">
        <cfoutput>
          <cfmail from="rjermain@firsttitleservices.com" to="rjermain@firsttitleservices.com" subject="Update Fees Failure: Prop Report Ordering: #get_propid.prop_id#">
...
<!---If there is only one person here today then there is no sense in going through the loop--->
	...
	<!--- THIS PART WILL FAIL IF THERE IS NOT AN ACTIVE USER in the FIRST ADMIN table WITH A ROLD_ID OF 17 --->
...
<cfparam name="vendmgmtIH" default="0">
<cfparam name="taxes" default="0">
		<cfquery  datasource="#request.dsn#">
			INSERT INTO
				TblUser_Roles (prop_id,vendor_mgmt_InHouse_ID,vendor_mgmt_InHouse_Start_Datetime,payoff_ID,payoff_Start_Datetime)
						Values(#get_propid.prop_id#, #vendmgmtIH#, getdate(),#taxes#, getdate())
	</CFQUERY>
...
<cfif getcompany.intsales eq 309>
...
<cfif getcompany.intsales eq 311 or getcompany.intsales eq 313>
<CFQUERY datasource="#request.dsn#" NAME="get_sales_email">
  SELECT * FROM first_admin WHERE id = #getcompany.intsales#
  </CFQUERY>
 <cfset b_emails_to_first_title = b_emails_to_first_title & "; " & getcompany.email>
</cfif>

<cfif getcompany.intsales eq 312>
<CFQUERY datasource="#request.dsn#" NAME="get_sales_email">
  SELECT * FROM first_admin WHERE id = #getcompany.intsales#
  </CFQUERY>
 <cfset b_emails_to_first_title = b_emails_to_first_title & "; " & getcompany.email>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Property Order has been Processed. Order number is <a href="https://#cgi.server_name#/view_the_prop_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>P-0232#get_propid.prop_id#</b></a></center><br>
				<cfif #get_propid.hud# eq 1><cfif get_propid.comp_id neq 3889>
<center>A HUD-1 has been
instantly prepared for you! Click <a href="https://#cgi.server_name#/prop_view_hud_pg1.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center></cfif><br>
				</CFIF>
	...
	<TBODY>
		<tr>
			<td width=770 align=center valign=top bgcolor=elelel>
				...
				<p>
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Property Order has been Processed. Order number is <a href="https://#cgi.server_name#/view_the_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>P-0232#get_propid.prop_id#</b></a></center><br>
				<cfif #get_propid.hud# eq 1><cfif get_propid.comp_id neq 3889>
<center>A HUD-1 has been
instantly prepared for you! Click <a href="https://#cgi.server_name#/prop_view_hud_pg1.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center></cfif><br>
				<br></cfif>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				...
				<cfif #get_propid.hud# eq 1><cfif get_propid.comp_id neq 3889>
<center>A HUD-1 has been
instantly prepared for you! Click <a href="https://#cgi.server_name#/prop_view_hud_pg1.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center></cfif><br></CFIF>
...
<TABLE WIDTH=770 BORDER=1 CELLSPACING=1 align="center" bgcolor=d3d3d3>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
				...
				<p>
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Title Commitment Request Order has been Processed. Order number is <a href="https://#cgi.server_name#/view_the_prop_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>P-0232#get_propid.prop_id#</b></a></center><br>
				<cfif #get_propid.hud# eq 1><cfif get_propid.comp_id neq 3889>
<center>A HUD-1 has been
instantly prepared for you! Click <a href="https://#cgi.server_name#/prop_view_hud_pg1.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center></cfif><br></CFIF>
...
<TABLE WIDTH=770 BORDER=1 CELLSPACING=1 align="center" bgcolor=d3d3d3>
	...
	<tr>
		<td width=770 align=center valign=top bgcolor=elelel>
			...
			<center><font size=3 color=black face=arial><b>THANK YOU FOR THE ORDER</B></center><br><p>
				<center>Your Property Order has been Processed. Order number is <a href="https://#cgi.server_name#/view_the_prop_order.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><b>P-0232#get_propid.prop_id#</b></a></center><br>
				<cfif #hud# eq "1"><cfif get_propid.comp_id neq 3889>
<center>A HUD-1 has been
instantly prepared for you! Click <a href="https://#cgi.server_name#/prop_view_hud_pg1.cfm?emp=#emp#&comp_id=#comp_id#&rec_id=#get_propid.prop_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New" onClick="window.open('','New','left=0,top=0,width=1010,height=710,status=0,resizable=0,location=0,menubar=0,toolbar=0,scrollbars=1')"><img border=0 src="https://#cgi.server_name#/images/button_est_hud_1.gif"></a> now.</center></cfif><br></cfif>
