...
//Vsummary is the javascript variable which will contain all error messages at one central location

VSummary =document.getElementById("ValidationSummary");	

frm = document.frm;

 if (frm.mort1.value =="")
 {
 		ErrorMessages+="<li>You must enter a Mortgagee</li>";		
 }
 
 if (frm.mort2.value == "" )
 {
 	
	ErrorMessages+="<li>You must enter a Mortgagor 1</li>"
 }
 
 if (frm.amt.value == "")
 {
 	ErrorMessages+="<li>You must enter an amount</li>"
 }
 else if (isNaN(frm.amt.value))
 {
 	ErrorMessages+="</li>You can enter an amount in numbers only</li>";
 }
 
 if (frm.docnum.value == '') {
		if (frm.book.value=='' || frm.page.value=='') {
		//alert("When document Number is empty book and page fields should be filled in")
		ErrorMessages1+="<li>When document Number is empty book and page fields should be filled in</li>"
 		frm.book.focus();
		//return false;
	 }
}
...
if (frm.inst_mon.value=='' || frm.inst_day.value=='' || frm.inst_year.value=='')
 {
	//alert("The date of Mortgage cannot be left blank")
		ErrorMessages1+="<li>The date of Mortgage cannot be left blank</li>"
	//return false;
 }

if (frm.rec_mon.value=='' || frm.rec_day.value=='' || frm.rec_year.value=='') {
	//alert("The Recording date cannot be left blank")
		ErrorMessages1+="<li>The recording date cannot be left blank</li>"
	//return false; 
}

if (frm.openend.value =="")
	{
		ErrorMessages1+="<li>You must select any 1 option for open end</li>"
	}
...
if (frm.ass1.value != '') {
	if (frm.doc_num1.value=='') {
		if (frm.book1.value=='' || frm.page1.value=='') {
		 //alert("When document Number is empty book and page fields should be filled in")
		 ErrorMessages1+="<li>When document Number is empty book and page fields should be filled in for Assignee 1</li>"
		 frm.book.focus();
		//return false;
	}
}
...
if (frm.rec_mon1.value=='' || frm.rec_day1.value=='' || frm.rec_year1.value=='') {
	...
	ErrorMessages1+="<li>The recording date for Assignee 1 cannot be left blank when Assignee 1 exists</li>"
	//return false;
   }
}
...
if (frm.ass2.value != '') {
		...
		//alert("When document Number is empty either book or page should be filled in as well")
		ErrorMessages1+="<li>When document Number is empty either book or page should be filled in for Assignee 2</li>"
		//return false; 
}
}
if (frm.rec_mon2.value=='' || frm.rec_day2.value=='' || frm.rec_year2.value=='') {
	...
	ErrorMessages1+="<li>The recording date for Assignee 2 cannot be left blank when Assignee 2 exists</li>"
	//return false; 
}
}
...
if (frm.ass3.value != '') {
		...
		ErrorMessages1+="<li>When document Number is empty either book or page should be filled in for Assignee 3</li>"
		//return false;
 }
 }
if (frm.rec_mon3.value=='' || frm.rec_day3.value=='' || frm.rec_year3.value=='') {
	//alert("The Recording date for Assignee 3 cannot be left blank when Assignee 3 exists")
		ErrorMessages1+="<li>The recording date for Assignee 3 cannot be left blank when Assignee 3 exists</li>"
	//return false;
 }
}
...
if (frm.ass4.value != '') {
		...
		//alert("When document Number is filled either book or page should be filled in as well")
		ErrorMessages1+="<li>When document Number is empty either book or page should be filled in for Assignee 4</li>"
		//return false;
 		}
 	}
	...
	//alert("The Recording date for Assignee 4 cannot be left blank when Assignee 4 exists")
		ErrorMessages1+="<li>The recording date for Assignee 4 cannot be left blank when Assignee 4 exists</li>"
	//return false;
 	}
}

	VSummary.innerHTML=ErrorMessages + ErrorMessages1;
	
	if (ErrorMessages != "" || ErrorMessages1 != "") {
...
<tr>
	<td>
			<div id="ValidationSummary" style="color:red; list-style-type:disc; overflow:auto;">
...
<table width=498 cellpadding=1 cellspacing=1 border=0 bgcolor=gray>
	...
	<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/abstractor_add_mortgage_submit.cfm?username=#url.username#&password=#url.password#&rec_id=#url.rec_id#" name="frm" ENABLECAB="Yes" onSubmit="return put();">
...
<!--- ===/ LOAN PROCESSOR INFO \=== --->
	...
	<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="No" Message="You must enter a Mortgagee" type=text name="mort1"  size=40 maxlength=100
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
...
<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT Required="No" Message="You must enter a Mortgagor 1" type=text name="mort2"  size=40 maxlength=100
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
...
<tr>
	...
	<tr>
		...
		<td width=217 align=left valign=top bgcolor=e6e6e6>
			<CFINPUT type=text name="amt" Required="No" Message="You must enter an amount"  size=25 maxlength=30
				style="font-size: 9;
				font-family: verdana;
				font-style: normal;
				color: blue;
