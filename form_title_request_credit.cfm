...
<table width=520 cellpadding=1 cellspacing=1 border=0 bgcolor=BFBFBF>
		<tr>
			<td width=519 align=left valign=top bgcolor=d3d3d3>
				<FONT FACE=ARIAL SIZE=2 color="black">
				<CENTER><B>CREDIT/RISK MANAGEMENT PRODUCTS:</B></CENTER>
			</TD>
		</TR>
   ...
   NAME="SelectedOrgs" VALUE=1>
    Single Infile Report<br>
	</td>
<td width=209 bgcolor="f1f1f1" align=left valign=top>
<INPUT TYPE="radio"
   NAME="SelectedOrgs1" VALUE=2>
    Individual<BR>
	<INPUT TYPE="radio"
   NAME="SelectedOrgs1" VALUE=3>
   Joint<BR>
						</td>
</tr>
...
<td width=209 bgcolor="f1f1f1" align=left valign=top>
<INPUT TYPE="radio"
   NAME="SelectedOrgs2" VALUE=2>
    Individual<BR>
	<INPUT TYPE="radio"
   NAME="SelectedOrgs2" VALUE=3>
   Joint<BR>
						</td>
...
<td width=209  bgcolor="f1f1f1" align=left valign=top>
 ...
 Tri-Merge Report<BR>
		...
		<td width=209 bgcolor="f1f1f1" align=left valign=top>
<INPUT TYPE="radio"
   NAME="SelectedOrgs3" VALUE=6>
    Individual<BR>
	<INPUT TYPE="radio"
   NAME="SelectedOrgs3" VALUE=7>
   Joint<BR>
						</td>
