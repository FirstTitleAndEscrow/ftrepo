...
<!--- for all properties with loan amount greater than 1000000 display in calculator 1109 'Call for quote'--->
		...
		<cfset msg=#UrlEncodedFormat("Call for quote!")#>
			...
			<CFLOCATION URL="https://#cgi.server_name#/calculator.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&msg1109=#msg#&loc=#url.loc#&a_trigger=#url.a_trigger#&srcht=#searchtype#&pst=#pstate#&pcnt=#pcounty#&lnmt=#loanamt_float#&lnmt4=#loanamt_float4#&prev_loan_amt=#form.prev_loan_amt#&prev_loan_mo=#form.prev_loan_mo#&prev_loan_year=#form.prev_loan_year#">



<!---if not MD go back to calculations <cflocation url="https://firsttitleservices.com/calculator.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#msg=#msg#&loc=2&a_trigger=30"> --->

		<cfelseif (pstate eq "MD" and searchtype neq "Purchase") or (pstate eq "NY" and searchtype NEQ "Purchase")>
			<table width="770" cellpadding=1 cellspacing=1 border=0 bgcolor="BFBFBF">
    	   <CFFORM action="https://#cgi.server_name#/calculator.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&loc=#url.loc#&a_trigger=#url.a_trigger#&srcht=#searchtype#&pst=#pstate#&pcnt=#pcounty#&lnmt=#loanamt_float#&lnmt4=#loanamt_float4#&prev_loan_amt=#form.prev_loan_amt#&prev_loan_mo=#form.prev_loan_mo#&prev_loan_year=#form.prev_loan_year#" METHOD=POST>
      			<input type="hidden" name="emp" value = "#emp#">
...
<!--- <td width="770" align="center" valign="top" >    from <table> below      --->
		...
		<cfelse>
			<CFLOCATION URL="https://#cgi.server_name#/calculator.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&loc=#url.loc#&a_trigger=#url.a_trigger#&srcht=#searchtype#&pst=#pstate#&pcnt=#pcounty#&pcty=#pcity#&lnmt=#loanamt_float#&lnmt4=#loanamt_float4#&prev_loan_amt=#form.prev_loan_amt#&prev_loan_mo=#form.prev_loan_mo#&prev_loan_year=#form.prev_loan_year#">
			</cfif>
