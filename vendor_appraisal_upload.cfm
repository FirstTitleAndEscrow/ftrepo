...
<tr>
		...
		<tr>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_appraisal.assign_date#</B>
			</td>
		</tr>
		<tr>
			<td width=200  align=right valign=top bgcolor=d3d3d3>
			...
			<td width=319  align=left valign=top bgcolor=e1e1e1>
				<font size=2 color=blue face=verdana>
				<B>#read_appraisal.assigned_price#</B>
			</td>
		</tr>
...
<FORM ACTION="./appraisal_upload.cfm?rec_id=#get.app_id#&company_id=#get.comp_id#" METHOD=post enctype="multipart/form-data">
		<tr>
			<td width=200 align=right valign=top bgcolor=f3f3f3>
				<font size=2 color=black face=arial>
				UPLOAD APPRAISAL:
			...
			<td width=319 align=left valign=top bgcolor=f3f3f3>
				...
				<CFIF #get.appraisal_doc_upload# EQ "">
	<input type="hidden" name="rec_id" value="#get.app_id#">
	<input type="file" name="file_upload">
<input type="submit" value="Upload File">

		<CFELSE>
<NOBR><font size=2 color=blue face=arial>There is already an uploaded file (#get.appraisal_doc_upload#). <br>
	Click this button to view it

	<A HREF="#fileSys.FindFilePath('#get.appraisal_doc_upload#', 'url')#" target="new"><img src="./images/button_view.gif" border=0 ALT="View Upload file for this order"></a><BR>
<font size=2 color=red face=arial>Adobe Acrobat Reader Required</font><br>
<br>
<A HREF="appraisal_upload.cfm?rec_id=#get.app_id#&company_id=#get.comp_id#&delete=1">delete file</A></TD></tr></NOBR>
...
<input type="hidden" name="username" value="#read_appraisal.username#">
<input type="hidden" name="password" value="#read_appraisal.password#">
</form></td></tr>
</table>
</center>
