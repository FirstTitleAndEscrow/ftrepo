...
<table width=607 border="0" cellpadding="0" cellspacing="0" background="./images/back_02.gif">
	...
	<tr>
		...
		Your form has the following ERROR(S):
		<p>
		...
		<!--- ==================================== --->
					...
					<!--- ===/ Payment Type \=== --->
							...
							<table width=515 cellpadding=1 cellspacing=1 border=0>
								...
								<CFIF #payment_type_1# EQ "Partial COD">
									<OPTION VALUE="Partial COD" SELECTED>Partial COD</OPTION>
								<CFELSE>
								...
								<tr>
									<TD bgcolor="f1f1f1" colspan=3 WIDTH=512 align=right>
										<NOBR><FONT FACE=verdana SIZE=1 color="gray" >(format xxxxxxxxxx.xx)<img src="./images/arrow_right.gif"><FONT FACE=ARIAL SIZE=2 color="gray" ><CFINPUT type="text" name="partial_cod" 	VALUE="#partial_cod#" size=30 maxlength=15
													style="font-size: 9;
													font-family: verdana;
													font-style: normal;
													color: 003F1E;
				...
				<CFLOOP FROM="1" TO="#ArrayLen(a_list_of_all_states_1)#" INDEX="NNN">
					<CFOUTPUT>
						<CFIF #app_ck_state# EQ "#a_list_of_all_states_1[NNN]#">
