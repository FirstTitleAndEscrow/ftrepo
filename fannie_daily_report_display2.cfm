...
<CFQUERY datasource="#request.dsn#" NAME="delete_todays_recs">
		Delete from Fannie_Daily_Reports where report_date = #report_date# and uploaded_filename = 'TR140135X'
</CFQUERY>
...
<CFQUERY datasource="#request.dsn#" NAME="insert_rec">
		...
		values
		('#read_all.column1#', '#read_all.column2#', '#read_all.column3#', '#read_all.column4#', '#read_all.column5#', '#read_all.column6#', '#read_all.column7#', '#read_all.column8#', '#read_all.column9#', '#read_all.column10#', '#read_all.column11#', '#read_all.column12#', '#read_all.column13#', '#read_all.column14#', #report_date#, 'TR140135X')
</CFQUERY>
...
<CFQUERY datasource="#request.dsn#" NAME="yesterdays_recs">
		Select * from Fannie_Daily_Reports where report_date = #yesterdays_report_date# and uploaded_filename = 'TR140135X' order by col01
</CFQUERY>
<CFQUERY datasource="#request.dsn#" NAME="todays_recs">
		Select * from Fannie_Daily_Reports where report_date = #report_date# and uploaded_filename = 'TR140135X' order by col01
</CFQUERY>
...
<tr>
<td colspan=4>Vendor ID: TR140135X</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td bgcolor="FFCC33"></td><td>File removed from list since last upload</td>
</tr>
<tr>
...
<CFQUERY datasource="#request.dsn#" NAME="find_rec">
		...
		and uploaded_filename = 'TR140135X'
