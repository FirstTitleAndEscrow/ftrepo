		...
		<CFQUERY datasource="#request.dsn#" NAME="read_pid">
			...
			WHERE ID = #user_id_1#
						...
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="https://#cgi.server_name#/title_closing_report_nav.cfm?user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=0&company_id=0"><img src="./images/button_details.gif" border=0 ALT="View the details for this record"></a>
						</td>
					</tr>
