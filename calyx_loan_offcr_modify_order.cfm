...
{
var foo;
location.href='calyx_loan_offcr_modify_order.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&title=<cfoutput>#title#</cfoutput>&property=<cfoutput>#property#</cfoutput>&appraisal=<cfoutput>#appraisal#</cfoutput>&other=<cfoutput>#other#</CFOUTPUT>&a_trigger=10&foo=' + frm.user_id_1.value;
}}
</script>
</HEAD>
...
<CFFORM METHOD=POST ACTION="./calyx_loan_offcr_modify_submit_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&emp=#emp#" name="frm"  ENABLECAB="Yes">
            ...
            <CFQUERY datasource="#request.dsn#" NAME="read_foo_users">
	            ...
	            ORDER BY  lo_lname, lo_fname ASC
			                                                            ...
			                                                            <SELECT NAME="user_id_1" onchange="prodSelect()"
			                                                                ...
			                                                                <CFOUTPUT QUERY="read_users"><OPTION VALUE="#ID#">#read_foo_users.lo_fname# #read_foo_users.lo_lname#</OPTION></CFOUTPUT>
			                                                            </SELECT>
			                                                        </td>
	                                                            </tr>
                                                                <!--- ===/ LOAN Officer INFO \=== --->
                                                                	...
                                                                	<tr>
                                                                		<td width=367 colspan=2 align=left valign=top bgcolor=e6e6e6>
                                                                            ...
                                                                            <SELECT NAME="user_id_1" onchange="prodSelect()"
                                                                            			...
                                                                            			<CFOUTPUT QUERY="read_users"><OPTION VALUE="#ID#"> #lo_fname# #lo_lname#</OPTION></CFOUTPUT>
                                                                            			</SELECT>
			                                                                </td>
	                                                                    </tr>
                                                                        <tr>
                                                                        	...
                                                                        	<tr>
                                                                        		...
                                                                        		<td width=300 align=left valign=top bgcolor=e6e6e6>
                                                                        			<CFINPUT Required="Yes" Message="You must enter a Officers FIRST NAME" type=text name="lo_fname"  size=20 maxlength=30
                                                                        				style="font-size: 9;
                                                                        				font-family: verdana;
                                                                        				font-style: normal;
                                                                        				color: blue;
