...
<div style="position:absolute;top:38;left:518"><span class="gray_title">DRAFT - QUOTE VALID UNTIL #DateFormat(DateAdd("d", 60, get_title_data.order_date), "mm/dd/yyyy")#</span></div>
    	-->
 --->
<!-- TABLE: Type of Loan -->
...
<tr>
<td colspan="2">Place of Settlement: <br /> <textarea cols="40" rows="3" name="I_2_SETTLEMENTADDRESS">#get_hud_data.I_2_SETTLEMENTADDRESS#</textarea></td>
<td>&nbsp;</td>
</tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0101_CONTRACTSALESPRICE"  value="#Trim(get_hud_data.A_0101_CONTRACTSALESPRICE)#"  /></td>
<td></td>
<td class="bsilver">401. Contract sales price</td>
<td class="bordered"><input type="text" class="userin" name="A_0401_CONTRACTSALESPRICE"  value="#get_hud_data.A_0401_CONTRACTSALESPRICE#" /></td>
</tr>
<tr>
<td class="bsilver">102. Personal property</td>
<td class="bordered"><input type="text" class="userin" name="A_0102_PERSONALPROPERTY"  value="#get_hud_data.A_0102_PERSONALPROPERTY#"/></td>
<td></td>
<td class="bsilver">402. Personal property</td>
<td class="bordered"><input type="text" class="userin" name="A_0402_PERSONALPROPERTY"  value="#get_hud_data.A_0402_PERSONALPROPERTY#"/></td>
</tr>
<tr>
<td class="bsilver">103. Settlement charges to borrower (line 1400)</td>
<td class="bordered"><input type="text" class="userin" name="A_0103_SETTLEMENTCHARGESTOBORROWER"  value="#get_hud_data.A_0103_SETTLEMENTCHARGESTOBORROWER#"/></td>
<td></td>
<td class="bsilver">403. <input type="text" class="userout" name="A_0403_USERDESC"  value="#get_hud_data.A_0403_USERDESC#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0403_USERAMOUNT" value="#get_hud_data.A_0403_USERAMOUNT#" /></td>
</tr>
<tr>
...
<input type="text" class="date" name="A_0106_CITYTOWNTAXESDATEFROM"  value="<cfif get_hud_data.A_0106_CITYTOWNTAXESDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0106_CITYTOWNTAXESDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic2'),document.all('A_0106_CITYTOWNTAXESDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic2" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0106_CITYTOWNTAXESDATETO"  value="<cfif get_hud_data.A_0106_CITYTOWNTAXESDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0106_CITYTOWNTAXESDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic3'),document.all('A_0106_CITYTOWNTAXESDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic3" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0106_CITYTOWNTAXESAMOUNT"  value="#get_hud_data.A_0106_CITYTOWNTAXESAMOUNT#" /></td>
<td></td>
<td class="bsilver">406. City/town taxes
<input type="text" class="date" name="A_0406_CITYTOWNTAXESDATEFROM" value="<cfif get_hud_data.A_0406_CITYTOWNTAXESDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0406_CITYTOWNTAXESDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic4'),document.all('A_0406_CITYTOWNTAXESDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic4" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0406_CITYTOWNTAXESDATETO" value="<cfif get_hud_data.A_0406_CITYTOWNTAXESDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0406_CITYTOWNTAXESDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic5'),document.all('A_0406_CITYTOWNTAXESDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic5" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0406_CITYTOWNTAXESAMOUNT"  value="#get_hud_data.A_0406_CITYTOWNTAXESAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">107. County taxes
<input type="text" class="date" name="A_0107_COUNTYTAXESDATEFROM" value="<cfif get_hud_data.A_0107_COUNTYTAXESDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0107_COUNTYTAXESDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic6'),document.all('A_0107_COUNTYTAXESDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic6" style="POSITION: relative"></A>
...
<td class="bordered"><input type="text" class="userin" name="A_0107_COUNTYTAXESAMOUNT" value="#get_hud_data.A_0107_COUNTYTAXESAMOUNT#" /></td>
<td></td>
<td class="bsilver">407. County taxes
<input type="text" class="date" name="A_0407_COUNTYTAXESDATEFROM" value="<cfif get_hud_data.A_0407_COUNTYTAXESDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0407_COUNTYTAXESDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic8'),document.all('A_0407_COUNTYTAXESDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic8" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0407_COUNTYTAXESDATETO" value="<cfif get_hud_data.A_0407_COUNTYTAXESDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0407_COUNTYTAXESDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic9'),document.all('A_0407_COUNTYTAXESDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic9" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0407_COUNTYTAXESAMOUNT" value="#get_hud_data.A_0407_COUNTYTAXESAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">108. Assessments
<input type="text" class="date" name="A_0108_ASSESSMENTSDATEFROM" value="<cfif get_hud_data.A_0108_ASSESSMENTSDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0108_ASSESSMENTSDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic10'),document.all('A_0108_ASSESSMENTSDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic10" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0108_ASSESSMENTSDATETO" value="<cfif get_hud_data.A_0108_ASSESSMENTSDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0108_ASSESSMENTSDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic11'),document.all('A_0108_ASSESSMENTSDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic11" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0108_ASSESSMENTSAMOUNT" value="#get_hud_data.A_0108_ASSESSMENTSAMOUNT#" /></td>
<td></td>
<td class="bsilver">408. Assessments
<input type="text" class="date" name="A_0408_ASSESSMENTSDATEFROM" value="<cfif get_hud_data.A_0408_ASSESSMENTSDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0408_ASSESSMENTSDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic12'),document.all('A_0408_ASSESSMENTSDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic12" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0408_ASSESSMENTSDATETO" value="<cfif get_hud_data.A_0408_ASSESSMENTSDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0408_ASSESSMENTSDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic13'),document.all('A_0408_ASSESSMENTSDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic13" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0408_ASSESSMENTSAMOUNT" value="#get_hud_data.A_0408_ASSESSMENTSAMOUNT#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0201_EARNESTMONEYAMOUNT" value="#get_hud_data.A_0201_EARNESTMONEYAMOUNT#" /></td>
<td></td>
<td class="bsilver">501. Excess deposit (see instructions)</td>
<td class="bordered"><input type="text" class="userin" name="A_0501_EXCESSDEPOSITAMOUNT" value="#get_hud_data.A_0501_EXCESSDEPOSITAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">202. Principal amount of new loan(s)</td>
<td class="bordered"><input type="text" class="userin" name="A_0202_PRINCIPALNEWLOANAMOUNT" value="#get_hud_data.A_0202_PRINCIPALNEWLOANAMOUNT#" /></td>
<td></td>
<td class="bsilver">502. Settlement charges to seller (line 1400)</td>
<td class="bordered"><input type="text" class="userin" name="A_0502_SETTLEMENTCHARGESTOSELLERAMOUNT" value="#get_hud_data.A_0502_SETTLEMENTCHARGESTOSELLERAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">203. Existing loan(s) taken subject to</td>
<td class="bordered"><input type="text" class="userin" name="A_0203_EXISTINGLOANSAMOUNT" value="#get_hud_data.A_0203_EXISTINGLOANSAMOUNT#" /></td>
<td></td>
<td class="bsilver">503. Existing loan(s) taken subject to</td>
<td class="bordered"><input type="text" class="userin" name="A_0503_EXISTINGLOANSAMOUNT" value="#get_hud_data.A_0503_EXISTINGLOANSAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">204. <input type="text" class="userout" name="A_0204_USERDESC" value="#get_hud_data.A_0204_USERDESC#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0204_USERAMOUNT" value="#get_hud_data.A_0204_USERAMOUNT#" /></td>
<td></td>
<td class="bsilver">504. Payoff of first mortgage loan</td>
<td class="bordered"><input type="text" class="userin" name="A_0504_PAYOFFFIRSTMORTGAGEAMOUNT" value="#get_hud_data.A_0504_PAYOFFFIRSTMORTGAGEAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">205. <input type="text" class="userout" name="A_0205_USERDESC" value="#get_hud_data.A_0205_USERDESC#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0205_USERAMOUNT" value="#get_hud_data.A_0205_USERAMOUNT#" /></td>
<td></td>
<td class="bsilver">505. Payoff of second mortgage loan</td>
<td class="bordered"><input type="text" class="userin" name="A_0505_PAYOFFSECONDMORTGAGEAMOUNT" value="#get_hud_data.A_0505_PAYOFFSECONDMORTGAGEAMOUNT#" /></td>
</tr>
<tr>
...
<input type="text" class="date" name="A_0210_CITYTOWNTAXESDATEFROM" value="<cfif get_hud_data.A_0210_CITYTOWNTAXESDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0210_CITYTOWNTAXESDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic14'),document.all('A_0210_CITYTOWNTAXESDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic14" style="POSITION: relative"></A>
 to <input type="text" class="date" name="A_0210_CITYTOWNTAXESDATETO" value="<cfif get_hud_data.A_0210_CITYTOWNTAXESDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0210_CITYTOWNTAXESDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic15'),document.all('A_0210_CITYTOWNTAXESDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic15" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0210_CITYTOWNTAXESAMOUNT" value="#get_hud_data.A_0210_CITYTOWNTAXESAMOUNT#" /></td>
<td></td>
...
to <input type="text" class="date" name="A_0510_CITYTOWNTAXESDATETO" value="<cfif get_hud_data.A_0510_CITYTOWNTAXESDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0510_CITYTOWNTAXESDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic17'),document.all('A_0510_CITYTOWNTAXESDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic17" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0510_CITYTOWNTAXESAMOUNT" value="#get_hud_data.A_0510_CITYTOWNTAXESAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">211. County taxes
<input type="text" class="date" name="A_0211_COUNTYTAXESDATEFROM" value="<cfif get_hud_data.A_0211_COUNTYTAXESDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0211_COUNTYTAXESDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic18'),document.all('A_0211_COUNTYTAXESDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic18" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0211_COUNTYTAXESDATETO" value="<cfif get_hud_data.A_0211_COUNTYTAXESDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0211_COUNTYTAXESDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic19'),document.all('A_0211_COUNTYTAXESDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic19" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0211_COUNTYTAXESAMOUNT" value="#get_hud_data.A_0211_COUNTYTAXESAMOUNT#" /></td>
<td></td>
<td class="bsilver">511. County taxes
<input type="text" class="date" name="A_0511_COUNTYTAXESDATEFROM" value="<cfif get_hud_data.A_0511_COUNTYTAXESDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0511_COUNTYTAXESDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic20'),document.all('A_0511_COUNTYTAXESDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic20" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0511_COUNTYTAXESDATETO" value="<cfif get_hud_data.A_0511_COUNTYTAXESDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0511_COUNTYTAXESDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic21'),document.all('A_0511_COUNTYTAXESDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic21" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0511_COUNTYTAXESAMOUNT" value="#get_hud_data.A_0511_COUNTYTAXESAMOUNT#" /></td>
</tr>
<tr>
<td class="bsilver">212. Assessments
<input type="text" class="date" name="A_0212_ASSESSMENTSDATEFROM" value="<cfif get_hud_data.A_0212_ASSESSMENTSDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0212_ASSESSMENTSDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic22'),document.all('A_0212_ASSESSMENTSDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic22" style="POSITION: relative"></A>
to <input type="text" class="date" name="A_0212_ASSESSMENTSDATETO" value="<cfif get_hud_data.A_0212_ASSESSMENTSDATETO NEQ 'NULL'>#DateFormat(get_hud_data.A_0212_ASSESSMENTSDATETO, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic23'),document.all('A_0212_ASSESSMENTSDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic23" style="POSITION: relative"></A></td>
<td class="bordered"><input type="text" class="userin" name="A_0212_ASSESSMENTSAMOUNT" value="#get_hud_data.A_0212_ASSESSMENTSAMOUNT#" /></td>
<td></td>
...
<td class="bordered"><input type="text" class="userin" name="A_0512_ASSESSMENTSAMOUNT" value="#get_hud_data.A_0512_ASSESSMENTSAMOUNT#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0220_TOTALPAIDBYSELLERAMOUNT" value="#get_hud_data.A_0220_TOTALPAIDBYSELLERAMOUNT#" /></td>
<td></td>
<td class="bsilver"><br /><b>520. Total Reduction Amount Due Seller</b></td>
<td class="bordered"><input type="text" class="userin" name="A_0520_REDUCTIONDUESELLERAMOUNT" value="#get_hud_data.A_0520_REDUCTIONDUESELLERAMOUNT#" /></td>
</tr>
...
<td class="bordered"><input type="text" class="text" name="A_0301_GROSSDUEFROMBORROWERAMOUNT" value="#get_hud_data.A_0301_GROSSDUEFROMBORROWERAMOUNT#" /></td>
<td></td>
<td class="bsilver">601. Gross amount due to seller (line 420)</td>
<td class="bordered"><input type="text" class="text" name="A_0601_GROSSDUETOSELLERAMOUNT" value="#get_hud_data.A_0601_GROSSDUETOSELLERAMOUNT#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0703_BORROWER_COMMISSIONAMOUNT" value="#get_hud_data.A_0703_BORROWER_COMMISSIONAMOUNT#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0703_SELLER_COMMISSIONAMOUNT" value="#get_hud_data.A_0703_SELLER_COMMISSIONAMOUNT#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0801_BORROWER_ORIGINATIONCHARGE" value="#get_hud_data.A_0801_BORROWER_ORIGINATIONCHARGE#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0801_SELLER_ORIGINATIONCHARGE" value="#get_hud_data.A_0801_SELLER_ORIGINATIONCHARGE#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0802_BORROWER_POINTS" value="#get_hud_data.A_0802_BORROWER_POINTS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0802_SELLER_POINTS" value="#get_hud_data.A_0802_SELLER_POINTS#" /></td>
</tr>
<tr>
<td class="bsilver">803. Your adjusted origination charges</td>
<td class="bordered"><input type="text" class="userin" name="A_0803_BORROWER_ADJORIGINATIONCHARGE" value="#get_hud_data.A_0803_BORROWER_ADJORIGINATIONCHARGE#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0803_SELLER_ADJORIGINATIONCHARGE" value="#get_hud_data.A_0803_SELLER_ADJORIGINATIONCHARGE#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0804_BORROWER_APPRAISALFEE" value="#get_hud_data.A_0804_BORROWER_APPRAISALFEE#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0804_SELLER_APPRAISALFEE" value="#get_hud_data.A_0804_SELLER_APPRAISALFEE#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0805_BORROWER_CREDITREPORT" value="#get_hud_data.A_0805_BORROWER_CREDITREPORT#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0805_SELLER_CREDITREPORT" value="#get_hud_data.A_0805_SELLER_CREDITREPORT#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0806_BORROWER_TAXSERVICE" value="#get_hud_data.A_0806_BORROWER_TAXSERVICE#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0806_SELLER_TAXSERVICE" value="#get_hud_data.A_0806_SELLER_TAXSERVICE#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0807_BORROWER_FLOODCERT" value="#get_hud_data.A_0807_BORROWER_FLOODCERT#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0807_SELLER_FLOODCERT" value="#get_hud_data.A_0807_SELLER_FLOODCERT#" /></td>
</tr>
<tr>
...
<input type="text" class="date" name="A_0901_DAILYINTERESTDATEFROM" value="<cfif get_hud_data.A_0901_DAILYINTERESTDATEFROM NEQ 'NULL'>#DateFormat(get_hud_data.A_0901_DAILYINTERESTDATEFROM, 'm/d/yyyy')#</cfif>" /><A href="javascript:ShowCalendar(document.all('calpic26'),document.all('A_0901_DAILYINTERESTDATEFROM'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic26" style="POSITION: relative"></A> to <input type="text" name="A_0901_DAILYINTERESTDATETO" class="date" value="#DateFormat(get_hud_data.A_0901_DAILYINTERESTDATETO, 'm/d/yyyy')#"/><A href="javascript:ShowCalendar(document.all('calpic27'),document.all('A_0901_DAILYINTERESTDATETO'),document.all('null'),'#dateCalendarStart#','#dateCalendarEnd#')" onclick="event.cancelBubble=true;"><img src="https://#CGI.SERVER_NAME#/calendar/images/calendarSm.gif" width="25" height="19" alt="" border="0" id="calpic27" style="POSITION: relative"></A>
...
<td class="bordered"><input type="text" class="userin" name="A_0901_SELLER_DAILYINTEREST" value="#get_hud_data.A_0901_SELLER_DAILYINTEREST#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0902_BORROWER_MORTGAGEINS" value="#get_hud_data.A_0902_BORROWER_MORTGAGEINS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0902_SELLER_MORTGAGEINS" value="#get_hud_data.A_0902_SELLER_MORTGAGEINS#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_0903_BORROWER_HOMEOWNERSINS" value="#get_hud_data.A_0903_BORROWER_HOMEOWNERSINS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_0903_SELLER_HOMEOWNERSINS" value="#get_hud_data.A_0903_SELLER_HOMEOWNERSINS#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1001_BORROWER_INITIALESCROWDEPOSIT" value="#get_hud_data.A_1001_BORROWER_INITIALESCROWDEPOSIT#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1001_SELLER_INITIALESCROWDEPOSIT" value="#get_hud_data.A_1001_SELLER_INITIALESCROWDEPOSIT#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1002_BORROWER_HOMEOWNERSINS" value="#get_hud_data.A_1002_BORROWER_HOMEOWNERSINS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1002_SELLER_HOMEOWNERSINS" value="#get_hud_data.A_1002_SELLER_HOMEOWNERSINS#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1003_BORROWER_MORTGAGEINS" value="#get_hud_data.A_1003_BORROWER_MORTGAGEINS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1003_SELLER_MORTGAGEINS" value="#get_hud_data.A_1003_SELLER_MORTGAGEINS#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1004_BORROWER_CITYPROPTAX" value="#get_hud_data.A_1004_BORROWER_CITYPROPTAX#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1004_SELLER_CITYPROPTAX" value="#get_hud_data.A_1004_SELLER_CITYPROPTAX#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1005_BORROWER_COUNTYPROPTAX" value="#get_hud_data.A_1005_BORROWER_COUNTYPROPTAX#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1005_SELLER_COUNTYPROPTAX" value="#get_hud_data.A_1005_SELLER_COUNTYPROPTAX#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1006_BORROWER_ASSESSMENTS" value="#get_hud_data.A_1006_BORROWER_ASSESSMENTS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1006_SELLER_ASSESSMENTS" value="#get_hud_data.A_1006_SELLER_ASSESSMENTS#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1007_BORROWER_AGGREGATEADJUSTMENT" value="#get_hud_data.A_1007_BORROWER_AGGREGATEADJUSTMENT#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1007_SELLER_AGGREGATEADJUSTMENT" value="#get_hud_data.A_1007_SELLER_AGGREGATEADJUSTMENT#" /></td>
</tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1101_BORROWER_TITLESERVICES" value="#get_hud_data.A_1101_BORROWER_TITLESERVICES#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1101_SELLER_TITLESERVICES" value="#get_hud_data.A_1101_SELLER_TITLESERVICES#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1102_BORROWER_CLOSINGFEE" value="#get_hud_data.A_1102_BORROWER_CLOSINGFEE#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1102_SELLER_CLOSINGFEE" value="#get_hud_data.A_1102_SELLER_CLOSINGFEE#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1103_BORROWER_OWNERSTITLEINS" value="#get_hud_data.A_1103_BORROWER_OWNERSTITLEINS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1103_SELLER_OWNERSTITLEINS" value="#get_hud_data.A_1103_SELLER_OWNERSTITLEINS#" /></td>
</tr>
<tr>
...
<td class="bordered"><input type="text" class="userin" name="A_1104_BORROWER_LENDERSTITLEINS" value="#get_hud_data.A_1104_BORROWER_LENDERSTITLEINS#" /></td>
<td class="bordered"><input type="text" class="userin" name="A_1104_SELLER_LENDERSTITLEINS" value="#get_hud_data.A_1104_SELLER_LENDERSTITLEINS#" /></td>
</tr>
<tr>
