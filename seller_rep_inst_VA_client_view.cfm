...
<br>
<br>
<strong>Date: <cfoutput><cfif mods.recordcount and Len(mods.doc_date)>#DateFormat(mods.doc_date, 'm/d/yyyy')#<cfelse>#DateFormat(Now(), 'm/d/yyyy')#</cfif></cfoutput><br>
...
To:  Sarah Spiers-Legacy Law Group - <cfoutput><cfif mods.recordcount and Len(mods.title_co)>#mods.title_co#<cfelse>TBD
...
<li>If there is an HOA involved, seller will only pay from the date of foreclosure, which in this case is <cfoutput><cfif mods.recordcount and Len(mods.foreclosure_date)>#DateFormat(mods.foreclosure_date, 'm/d/yyyy')#<cfelse>TBD
</cfif></cfoutput><br></li>
