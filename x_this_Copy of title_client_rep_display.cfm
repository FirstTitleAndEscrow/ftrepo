...
<CFQUERY datasource="#request.dsn#" NAME="read_report">
			...
			<cfif read_branches.RecordCount>
			<cfloop query="read_branches">
			or comp_id = '#read_branches.ID#'
			</cfloop>
			</cfif>
...
WHERE id = '#read_report.comp_id#'
	...
	<!--- 
						...
						<cfif #calc# eq "yes">
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_client_report_nav_calc.cfm?emp=#emp#&confirm_mon=#confirm_mon#&comfirm_day=#comfirm_day#&confirm_year=#confirm_year#&confirm_mon_to=#confirm_mon_to#&comfirm_day_to=#comfirm_day_to#&confirm_year_to=#confirm_year_to#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&code=T"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
					<cfelse>
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
...
<cfif #titlemail# neq "">
		...
		Loan Number #loan_number# -	<A HREF="./title_committment_view_amer_pioneer_ins_all.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&company_id=0&ordering_co=#ordering_co#" target="new">American Pioneer Title Insurance Commitment</a> - Order Number #title_id# - #bfirstname1# #blastname1#</B></font><br>
			<cfelseif #read_ins_committments.insurance_co# eq "16">
			Loan Number #loan_number# - <A HREF="./title_committment_view_stewart_title_ins.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&company_id=0&ordering_co=#ordering_co#" target="new">Stewart Title Insurance Commitment</a> - Order Number #title_id# - #bfirstname1# #blastname1#</B></font><br>
<cfelse>
Loan Number #loan_number# - <A HREF="./title_committment_view_amer_pioneer_ins_fl.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&company_id=0&ordering_co=#ordering_co#" target="new">Florida Title Insurance Commitment</a> - Order Number #title_id# - #bfirstname1# #blastname1#</B></font><br>
...
<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<FONT FACE=verdana SIZE=1 color="black">
							<a href="./title_closing_report_nav.cfm?emp=#emp#&comp_id=#comp_id#&company_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#">C-#title_id#</a>
						</td>	
			...
			<td bgcolor=#a_bgcolor# width=10 align=center valign=top>
				...
				<!--- <cfif (#read_all_notes.recordcount# gt 0)> ---> 
							<a href="./view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&ordering_co=#ordering_co#&code=CL" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
...
<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
			...
			<td bgcolor=#a_bgcolor# width=10 align=center valign=top>
				...
				<!--- <cfif (#read_all_notes.recordcount# gt 0)> ---> 
							<a href="./view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&ordering_co=#ordering_co#" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
...
WHERE id = '#read_report.comp_id#'
				...
				ORDER BY Note_ID ASC
							...
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<a href="./view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#prop_id#&ordering_co=#ordering_co#&code=P" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./view_the_prop_order.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#prop_id#&a_trigger=1&ordering_co=#ordering_co#&code=P"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
WHERE id = '#read_report.comp_id#'
				...
				ORDER BY Note_ID ASC
							...
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<a href="./view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#app_id#&ordering_co=#ordering_co#&code=A" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_report_nav_appraisal.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#app_id#&a_trigger=1&ordering_co=#ordering_co#&code=A"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
				...
				ORDER BY Note_ID ASC
							...
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<a href="./view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=F" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&code=F"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
				...
				ORDER BY Note_ID ASC
						...
						<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<a href="./view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=CR" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&code=CR"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
				...
				ORDER BY Note_ID ASC
							...
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<a href="./view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=AVM" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&code=AVM"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
<td bgcolor=#a_bgcolor# width=120 align=center valign=top>
				...
				ORDER BY Note_ID ASC
							...
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<a href="./view_title_comments_nav_sn.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&ordering_co=#ordering_co#&code=SN" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
					...
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_report_nav_credit.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#anc_id#&a_trigger=1&ordering_co=#ordering_co#&code=SN"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
...
WHERE id = '#read_report.comp_id#'
				...
				ORDER BY Note_ID ASC
							...
							<!--- <cfif (#read_all_notes.recordcount# gt 0)>  --->
							<a href="./view_title_comments_nav.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&ordering_co=#ordering_co#&code=T" target="prop_hud_pg1" onClick="window.open('','prop_hud_pg1','width=620,height=400,status=0,resizable=1,scrollbars=1')"><FONT FACE=verdana SIZE=1 color="blue">add/view</a>
	<!--- 
							<cfelse>
					...
					<cfif #calc# eq "yes">
						<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_client_report_nav_calc.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&code=T"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
					<cfelse>
					<td bgcolor=#a_bgcolor# width=50 align=center valign=top>
							<a href="./title_client_report_nav.cfm?emp=#emp#&comp_id=#comp_id#&A_Update_DB_Flag=0&user_id_1=#USER_ID_1#&lo_id=#lo_id#&rec_id=#title_id#&a_trigger=1&ordering_co=#ordering_co#&code=T"><img src="./images/button_details.gif" border=0 ALT="View Order details"></a>
						</td>
					</cfif>
