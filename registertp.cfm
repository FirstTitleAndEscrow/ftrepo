...
<tr>
  ...
  style='font-size:7.5pt;font-family:Verdana;color:black'><br>
        <font size="3">Thank you for adding #First# as a Third Party!<br><br>Would you like to add an additional third party?<br><br>
				<input TYPE="button" VALUE=" Yes " NAME="foo" onClick="window.location='registertp.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_id=#zip_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&a_trigger=0'">&nbsp;&nbsp;<input TYPE="button" VALUE=" No " NAME="foo" onClick="window.location='form_title_request.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_id=#zip_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#'; window.close(); if (!window.opener.closed) { window.opener.location.reload(); window.opener.focus(); }">&nbsp;&nbsp;
...
<CFFORM METHOD=POST ACTION="https://#cgi.server_name#/registertp.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_id=#zip_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#&a_trigger=1">
 <tr>
    <td colspan=2 style='padding:2.25pt 2.25pt 2.25pt 2.25pt'> <p class=MsoNormal align=center style='margin-bottom:12.0pt;text-align:center'><font size="2" face="Times New Roman"><b><span
  style='font-size:7.5pt;font-family:Verdana;color:black'><br>
  ...
  style='font-size:7.5pt;font-family:Verdana;color:black'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <cfoutput> <INPUT NAME="B2" TYPE="submit" value="Submit">   <input TYPE="button" VALUE=" Cancel " NAME="foo" onClick="window.location='form_title_request.cfm?comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&zip_id=#zip_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#'; window.close(); if (!window.opener.closed) { window.opener.location.reload(); window.opener.focus(); }">
