	...
	<cfif read_quotes.recordcount>
		<table cellpadding="5" cellspacing="0" border="1" style="text-align:center">
			...
			<cfoutput query="read_quotes">
				<cfwddx action="wddx2cfml" input="#formdata#" output="quotestruct">
				<tr>
					<td>#DateFormat(dateAdded,"mm/dd/yyyy")#</td>
					<td>#quotestruct.property_city#</td>
					<td>#quotestruct.property_state#</td>
					<td>#quotestruct.property_county#</td>
					<td>#quotestruct.property_zip#</td>
					<td>#quotestruct.loan_amount#</td>
					<td><a target="_blank" href="calculator.cfm?emp=0&comp_id=#comp_id#&user_id_1=0&lo_id=0&company_id=#comp_id#&calc_id=#savedCalcID#">View Quote</a></td>
					<td><a href="saved_quotes.cfm?emp=0&comp_id=#comp_id#&user_id_1=0&lo_id=0&company_id=#comp_id#&calc_id=#savedCalcID#">Delete Quote</a></td>
				</tr>
			</cfoutput>
		
		</table>
	<cfelse>
	<b>You have not yet saved any calculator quotes.</b>
	</cfif>
	</div>
