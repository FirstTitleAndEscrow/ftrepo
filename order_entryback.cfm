...
All orders received after 3:00 pm (EST) will be processed the next business day.<br>
...
<tr>
<td colspan=2 bgcolor="#a2a3fe" align=right><FONT FACE=ARIAL SIZE=1 color="black">
<b>Your Email Address</b><br>
</td>

<td colspan=2 bgcolor="#a2a3fe" width=""><FONT FACE=ARIAL SIZE=1 color="black">

<CFINPUT REQUIRED="yes" Message="Enter an email address  in the Client Specific Info Section" NAME="abc_email_1"  size=25 maxlength=120>
</td>
...
<CFINPUT REQUIRED="yes" Message="Enter an email address  in the Client Specific Info Section" NAME="abc_email_2"  size=25 maxlength=120>
</td>
...
<tr>
<TD bgcolor="#a2a3fe" WIDTH=150 align=right>
<FONT FACE=ARIAL SIZE=2 color="black" >Property Use</FONT>
</td>
<td><SELECT NAME="prop_use_type">
...
<tr>
<TD bgcolor="#a2a3fe" WIDTH=150 align=right>
<FONT FACE=ARIAL SIZE=2 color="black" >Is this a Condo or PUD - </FONT>
</td>
<td>
...
<TABLE BORDER=1 CELLSPACING=0 width=520 bgcolor="#a2a3fe">
	...
	<TR>
		...
		<td>
			<NOBR>&nbsp;&nbsp;&nbsp;&nbsp;No
            <img src="./images/arrow_01.gif"> <INPUT TYPE="RADIO" NAME="do_appraisal" VALUE="No" checked>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yes
            <img src="./images/arrow_01.gif"> <INPUT TYPE="RADIO"  NAME="do_appraisal" VALUE="Yes"></NOBR>
...
<TABLE BORDER=1 CELLSPACING=0 width=520 bgcolor="#a2a3fe">
	...
	<tr>
		...
		<TD bgcolor="#a2a3fe" WIDTH=220 align=left>
            ...
            <img src="./images/arrow_blue_left.gif">If Partial COD<br> <font size=1 color=black face=verdana><NOBR>Fill in the Partial COD Amount<img src="./images/arrow_blue_down.gif"></NOBR>
...
<input type=hidden name="loan_type_111" value="">
<input type=hidden name="loan_program_333" value="">
...
<input type="hidden" name="co_name_222" value="#getcompany.company#">
