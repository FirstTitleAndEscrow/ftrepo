...
<!--- ====================================================================== --->
	...
	<tr>
		<td width=499 align=left valign=top bgcolor=e1e1e1>
			<nobr><a href="javascript:window.close();"><img src="./images/button_close.gif" border=0></a><img src="./images/clear.gif" height=15 width=410><a href="./zip_search_help.cfm" target="search_help" onClick="window.open('','search_help','width=530,height=500,status=0,resizable=0,scrollbars=1')"><img src="./images/button_help.gif" border=0 ALT="Click for Help !"></a>	</NOBR>
