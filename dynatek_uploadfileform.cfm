...
<CFFORM name = "frm" ACTION="./dynatek_uploadfileaction.cfm?comp_id=#comp_id#&amp;user_id_1=#USER_ID_1#&amp;lo_id=#lo_id#&amp;title=#title#&amp;appraisal=#appraisal#"
          ENCTYPE="multipart/form-data"
          METHOD="POST">



<P>Please browse to your Morvision Folder and select the File "FirstTitleExport.txt": <INPUT TYPE="file" NAME="Filetoupload" SIZE="45"
         > </P> <INPUT TYPE="submit" VALUE="Submit Query" VALUE?upload?>
