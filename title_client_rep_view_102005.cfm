...
<CFQUERY datasource="#request.dsn#" NAME="read_titleid">
		...
		<CFQUERY datasource="#request.dsn#" NAME="read_titleidclosing">
			...
			SELECT a.title_id
			FROM title a, title_closing_order_request b where a.title_id = b.title_id and b.a_req_closing_day is not null and
...
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=3&company_id=0";
  }
else if (frm.product.value == 'property') {
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=2&company_id=0";

}
else if (frm.product.value == 'title') {
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=1&company_id=0";

}

else if (frm.product.value == 'flood') {
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=4&company_id=0";

}


else if (frm.product.value == 'credit') {
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=5&company_id=0";

}
else if (frm.product.value == 'avm') {
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=6&company_id=0";

}
else if (frm.product.value == 'signing') {
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=7&company_id=0";

}

else  if (frm.product.value == 'all') {

 location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=8&company_id=0";
} else {
location.href="./title_client_rep_view.cfm?emp=<cfoutput>#emp#</cfoutput>&comp_id=<cfoutput>#comp_id#</cfoutput>&user_id_1=<cfoutput>#USER_ID_1#</cfoutput>&lo_id=<cfoutput>#lo_id#</cfoutput>&a_trigger=9&company_id=0";
...
<cfif #url.a_trigger# eq "1">
	<CFFORM NAME="frm"  ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=1" METHOD=POST>
...
<!--- ====================================================================== --->
	...
	<CFFORM NAME="frm"  ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=2" METHOD=POST>
	<table width=776 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	<tr>
		<td width=776 align=center valign=top bgcolor=e1e1e1>
		<FONT FACE=verdana SIZE=1 color="blUE">
...
<!--- ====================================================================== --->
	...
	<cfelseif #a_trigger# eq "3">
		...
		<CFFORM NAME="frm" ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=3" METHOD=POST>
<table width=776 cellpadding=1 cellspacing=1 border=0 bgcolor=white>
	<tr>
		<td width=776 align=center valign=top bgcolor=e1e1e1>
		<FONT FACE=verdana SIZE=1 color="blUE">
...
<!--- ====================================================================== --->
	...
	<CFFORM NAME="frm" ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=4" METHOD=POST>
...
<!--- ====================================================================== --->
	...
	<CFFORM NAME="frm" ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=5" METHOD=POST>
...
<!--- ====================================================================== --->
	...
	<CFFORM NAME="frm" ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=6" METHOD=POST>
...
<!--- ====================================================================== --->
	...
	<CFFORM NAME="frm" ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=7" METHOD=POST>
...
<!--- ====================================================================== --->
	...
	<CFFORM NAME="frm"  ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=8" METHOD=POST>
...
<!--- ====================================================================== --->
	...
	<CFFORM NAME="frm"  ACTION="./title_client_rep_display.cfm?emp=#emp#&comp_id=#comp_id#&calc=#calc#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&a_trigger=9" METHOD=POST>
