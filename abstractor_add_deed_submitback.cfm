...
<CFQUERY datasource="#request.dsn#" NAME="read_type">
			...
			SELECT type
			FROM title_ins_add
			where title_id = #rec_id# and type = 'DEED'
		</CFQUERY>
...
<cfquery  datasource="#request.dsn#">
			INSERT INTO
				title_ins_add (title_id, type, seq_num, status, insert_date, insert_time, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17)
