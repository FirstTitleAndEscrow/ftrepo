...
<table  width="98%" cellpadding="3" cellspacing="0" border="0">
  ...
  <tr align="left" valign="top">
    <td colspan="3"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">1.
        ...
        <cfif #DATEDIFF("m", testDate, read_data_info.merge_date)# LT 12>&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/checked.jpg">YES&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/unchecked.jpg" width="73" height="23">NO
     ...
     <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2. Are
        there any items that need to be cleared:<br>
         <cfif #read_data_info.cleared# neq "" OR #read_data_info.clear_needed# neq "">&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/checked.jpg">YES&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/unchecked.jpg" width="73" height="23">NO
         <cfelse>&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/unchecked.jpg">YES&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/checked.jpg" width="73" height="23">NO </cfif><font size="1">(if YES, explain in comments below.)</font> </font></strong>
   <font size="1">(if YES, explain in comments below.)</font></font></strong>
     <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">3.
        ...
        <cfif #read_tax_info.data31# eq "Paid">&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/checked.jpg">YES&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/unchecked.jpg" width="73" height="23">NO
  ...
  <tr>
	...
	<tr>
		...
		<td width="50%"   background="e6e6e6">
			...
			1101. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Settlement or Closing Fee">
	...
	<tr>
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1102. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Abstract or Title Search">
...
<td width="50%"   background="e6e6e6">
	...
	<tr>
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1103. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Title Examination">
Title Examination
					 </td>
<td width="50%"   background="e6e6e6">
			<font size=2 color=blue face=arial>
...
#read_this_sets_billing_values.a_1103#
	...
	<tr>
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1104. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Title Insurance Binder">
Title Insurance Binder
	...
	<tr>
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1105. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Document Preparation">
	...
	<tr>
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1106. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Notary Fees">
		Notary Fees
	 </td>
	 	<td width="50%"   background="e6e6e6">
			<font size=2 color=blue face=arial>
	...
	<tr>
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1107. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Attorney's Fees">
		Attorney's Fees
	...
	<cfif #read_hud.a_1108_a# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1109. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Title Insurance Premium">
	...
	<cfif #read_this_sets_billing_values.a_1111# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1111.  <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Data on this line is variable">
	...
	<cfif #read_this_sets_billing_values.a_1112# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1112. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Data on this line is variable">
	...
	<cfif #read_this_sets_billing_values.a_1113# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1113.  <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Data on this line is variable">
...
<cfif #rec_fee# neq "0">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1201. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Recording fee">
...
<cfif #rel_fee# neq "0">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1201. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Release Fee">
Release Fee
...
<cfif #a_fee_total# neq "0">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1201. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Total Recording Fee">
Total Recording Fee
...
<cfif #city_mort_stamps# neq "0">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1202. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="	City Mortgage Stamps">
...
<cfif #state_deed_1# neq "0">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1203. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="State Deed">
State Deed
...
<cfif #intang_tax# neq "0">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1204. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Intagible Tax">
Intagible Tax
	...
	<cfif #read_this_sets_billing_values.a_1205# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1205.  <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Data on this line is variable">
	...
	<cfif #read_this_sets_billing_values.a_1303# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1303.  <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Data on this line is variable">
#read_this_sets_billing_values.a_1303_text#
	...
	<cfif #read_this_sets_billing_values.a_1304# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1304.  <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Data on this line is variable">
	...
	<cfif #read_this_sets_billing_values.a_1305# neq "">
		...
		<td width="50%"   background="e6e6e6">
			<font size=2 color=black face=arial>
			1305. <img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/info-01.gif" ALT="Data on this line is variable">
...
<table>
<tr>
<td align="right" width="445"><img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_logo.jpg"></td>
<td width="40">&nbsp;</td>
...
Due Upon Receipt</FONT>
			...
			<cfelse>
<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_logo.jpg">
			</cfif><br></div>
            <BR><BR>
...
#read_title_data.data14#<br><br>
		...
		<b>Tax Account Number: #read_tax.data19#</b></cfif> --->
		<b>
     ...
     <!---    <tr align="right" valign="top">
          <td COLSPAN = 2><img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_logo.jpg"></td>
        </tr> --->
      </table>
	   </IE:DEVICERECT>
...
<cfset text_3 = Mid(temp, stop_number + 1, Len(temp))>
          ...
          <td ALIGN = "CENTER" colspan="2"><BR><B>ADDITIONAL EXCEPTIONS</B><BR></td>
        </tr>
        <tr>
          <td align = "left" colspan=2><BR><B><cfoutput>
		  <font size=-2><cfif len(read_Title_Data.addex) LTE 650>
...
<table width="93%" cellpadding=0 cellspacing=0 border=0 >
	...
	<tr>
		...
		<tr>
          <td ALIGN = "CENTER" colspan="2"><BR><B>ADDITIONAL EXCEPTIONS (CONT'D)</B><br></td>
        </tr>
        <tr>
          <td align = "left" colspan=2><BR><B><cfoutput>
<font size=-2>#text_2#</font>
		</cfoutput>
		 </b></td>
        </tr>
...
<IE:DEVICERECT ID="page8" CLASS="masterstyle" MEDIA="print">
    ...
    <tr>
          <td>
<center><br>
<font size=3><B><span class="withserifheader"><strong>Stewart Title Guaranty Company</strong></span></font><BR>
<br>
<br>
...
<p style="page-break-after:always;">&nbsp;</p>
<IE:DEVICERECT ID="<CFOUTPUT>Page10</cfoutput>" CLASS="masterstyle" MEDIA="print">
	    <table width="100%" cellpadding=0 cellspacing=0 border=0 >
...
&nbsp;
	...
	<img src="http://<cfoutput>#cgi.server_name#</cfoutput>/images/stewart_icl.jpg"><BR>
