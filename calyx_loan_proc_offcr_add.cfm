...
<CFIF #read_Company.Companies_Switch# eq "1">
    <CFQUERY datasource="#request.dsn#" NAME="read_user1">
        ...
        WHERE     (Users.ID = #read_company.id#) and status = 1
        ORDER BY Users.lp_fname
    </CFQUERY>
<CFELSE>
    <CFQUERY datasource="#request.dsn#" NAME="read_user1">
        SELECT *
...
<CFIF IsDefined("form.title") is True OR #title# eq 1>
    <cfset title=#title#>
<cfelse>
    <cfset title=0>
</cfif>

<CFIF IsDefined("form.property") is True OR #property# eq 1>
    <cfset property=#property#>
<cfelse>
    <cfset property=0>
</cfif>

<CFIF IsDefined("form.appraisal") is True OR #appraisal# eq 1>
    <cfset appraisal=#appraisal#>
<cfelse>
    <cfset appraisal=0>
</cfif>

<CFIF IsDefined("form.other") is True OR #other# eq 1>
    <cfset other=#other#>
<cfelse>
    <cfset other=0>
</cfif>
...
<CFOUTPUT>
                        <TR>
                            ...
                            <CFIF #read_Company.Companies_Switch# eq "1">
                                ...
                                <td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onmouseover="this.bgColor='00FF66'" onmouseout="this.bgColor='CCD2D2'" onClick="document.location.href='./calyx_loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#';return false;"> <a class="menu1"  href="./calyx_loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New"><nobr><img src="/client/images/arrowvendor.jpg" border=0>&nbsp;<strong>USER ADMIN</strong>&nbsp;</nobr></a></td>
                                </CFIF>
	                        <CFELSE>
                                <td width="95" height="20" valign="middle"  align = "center" bgcolor="CCD2D2" nowrap onmouseover="this.bgColor='00FF66'" onmouseout="this.bgColor='CCD2D2'" onClick="document.location.href='./calyx_loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#';return false;"> <a class="menu1"  href="./calyx_loan_offcr_add.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#" target="New"><nobr><img src="/client/images/arrowvendor.jpg" border=0>&nbsp;<strong>USER ADMIN</strong>&nbsp;</nobr></a></td>
                            </CFIF>
...
<cfelse>
    ...
    <CFIF #read_Company.Companies_Switch# eq "1">
        <CFQUERY datasource="#request.dsn#" NAME="read_users">
            ...
            FROM         Users LEFT OUTER JOIN
                      Companies_User ON Users.ID = Companies_User.User_ID
            WHERE     (Users.comp_ID = #read_company.id#) and status = 1
            ORDER BY Users.lp_fname
    </CFQUERY>
<CFELSE>
     <CFQUERY datasource="#request.dsn#" NAME="read_users">
...
<CFFORM name = "frm" ACTION="./uploadfileform.cfm?emp=#emp#&comp_id=#comp_id#&title=#title#&appraisal=#appraisal#" onsubmit="javascript:return ValidateForm(this)" ENCTYPE="multipart/form-data" METHOD=POST>
...
<CFOUTPUT>
                                    <CFIF #emp# neq "0">
									<!--- get rid bug 07/25/05 N --->
                                        <cfif #isdefined("read_company_user.Administrator")# >
										<CFIF #read_company_user.Administrator# eq "1">
                                            <tr>
			                                    <td bgcolor=f1f1f1 colspan = 2 width="425" align="center" valign="top">
                                                    <br><font face="arial" size="2" color="black">Modify a Processor > <a href="./calyx_loan_proc_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img src="./images/button_modify.gif" border=0></a>. Add a new Processor > </font> <a href="./calyx_loan_proc_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#">
                                                    <img src="./images/button_add.gif" border=0></a>
                                                </td>
                                            </tr>
                                        </CFIF></cfif>
                                    <CFELSE>
...
<CFIF #read_Company.Companies_Switch# eq "1">
        <CFQUERY datasource="#request.dsn#" NAME="read_loan_offcr">
            SELECT    Loan_Officers.ID, Loan_Officers.comp_id, Loan_Officers.lo_fname, Loan_Officers.lo_lname,
                      Loan_Officers.lo_email, Loan_Officers.a_date, Loan_Officers.a_time, Loan_Officers.a_admin_id, Loan_Officers.m_date,
                      Loan_Officers.m_time, Loan_Officers.m_admin_id, Loan_Officers.a_status, Loan_Officers.lo_phone, Loan_Officers.lo_fax,
                      Loan_Officers.lo_ext, Companies_User.Job_Title, Companies_User.username, Companies_User.password,
                      Companies_User.Administrator, Companies_User.Status
            FROM         Loan_Officers INNER JOIN
                      Companies_User ON Loan_Officers.ID = Companies_User.User_ID
            WHERE     (Companies_User.Status = 1) AND (Loan_Officers.comp_id = #read_company.id#)
            ORDER BY Loan_Officers.lo_fname
    </CFQUERY>
<CFELSE>
   <CFQUERY datasource="#request.dsn#" NAME="read_loan_offcr">
    SELECT *
		                            ...
		                            <tr>
			                            ...
			                            <td bgcolor=f1f1f1 width="145" align="center" valign="top" bgcolor="a2a3fe">
				                            <select name="lo_id"
					                            ...
					                            <option value="#ID#">#read_loan_offcr.lo_fname# #read_loan_offcr.lo_lname#</option>
				                                </CFOUTPUT>
				                                <OPTION VALUE="">
                                                </OPTION>
				                            </SELECT>
                                        ...
                                        <CFIF #read_company_user.Administrator# eq "1">
                                            <tr>
			                                    <td bgcolor=f1f1f1 colspan = 2 width="425" align="center" valign="top">
		                                            ...
		                                            <br><font face="arial" size="2" color="black">Modify an Officer > <a href="./calyx_loan_offcr_modify_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img src="./images/button_modify.gif" border=0></a>. Add a new Officer > <a href="./calyx_loan_offcr_add_order.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&title=#title#&property=#property#&appraisal=#appraisal#&other=#other#"><img src="./images/button_add.gif" border=0></a></font>
                                                </td>
                                            </tr>
                                        </CFIF></cfif>
                                    <CFELSE>
...
<nobr><cfoutput><a href="./client_acct_mgt.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#&company_id=#read_company.id#"><IMG border=0 alt="Go back to main menu" src  ="./images/button_go_back.gif"></a>
      </cfoutput>
                    <INPUT TYPE=image SRC="./images/button_continue.gif" border=0></nobr>
</cfform>
	            </td>
            </tr>
        </table>
...
<CFOUTPUT>
		...
		<tr>
            <td width=770 align=center valign=bottom>
                <br>
<cfoutput>      <a href="/client_acct_mgt.cfm?emp=#emp#&comp_id=#comp_id#&user_id_1=#USER_ID_1#&lo_id=#lo_id#"><img src="./images/button_go_back.gif" border=0 ALT="Go to main menu"></a>
</cfoutput>
		        <tr>
